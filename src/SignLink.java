...
public class SignLink implements Runnable
{
										...
										if ((i ^ 0xffffffff) == -7) {
											...
											if (aBoolean4005 && (i ^ 0xffffffff) == -15) {
												...
												if (aBoolean3985) {
													...
													Class.forName("Class208").getDeclaredMethod("method2046", new Class[] { Integer.TYPE, Integer.TYPE }).invoke(anObject3990, new Object[] { new Integer(i_16_), new Integer(i_17_) });
												}
	...
	SignLink(int i, String string, int i_20_, boolean bool) throws Exception {
		...
		if (aBoolean4005) {
			...
			if (aBoolean3985) {
				try {
					anObject3991 = Class.forName("Class149").newInstance();
				} catch (Throwable throwable) {
					/* empty */
				}
			}
			...
			try {
				if (aBoolean3985) {
					...
					anObject3990 = Class.forName("Class208").newInstance();
				}
			} catch (Throwable throwable) {
				/* empty */
			}
