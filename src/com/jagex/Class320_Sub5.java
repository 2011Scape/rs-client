...
public class Class320_Sub5 extends Class320 {
    ...
    static void method3695(Class179 class179) {
    ...
    static Node_Sub13 method3699(int i) {
        anInt8249++;
        if (i <= 82) {
            method3695(null);
        }
    ...
    static boolean method3700(int i, byte b, int i_1_) {
        anInt8245++;
        if (b <= 122) {
    ...
    final void method3673(byte b) {
        ...
        if ((~anInt4064) < -2 && (~i) > -129) {
            anInt4064 = 1;
        }
        if ((~anInt4064) < -3 && i < 192) {
            anInt4064 = 2;
        }
