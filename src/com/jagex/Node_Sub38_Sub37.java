...
public class Node_Sub38_Sub37 extends Node_Sub38 {
    ...
    static void method2907(int i, int i_7_, Class121 class121, int i_8_, int i_9_, int i_10_) {
        if (i_7_ != -14347) {
            method2906((byte) -91);
        }
        anInt10467++;
        if ((~i_10_) <= -2 && i_8_ >= 1 && (~i_10_) >= (~(Node_Sub54.anInt7675 - 2)) && Class377_Sub1.anInt8774 - 2 >= i_8_) {
    ...
    static void method2908(byte b, Node_Sub4 node_sub4, int i) {
        anInt10470++;
    ...
    static boolean method2911(int i, byte b, int i_43_, int i_44_) {
        anInt10481++;
    ...
    static void method2912(String string, boolean bool) {
        anInt10474++;
        if (string != null) {
    ...
    final void method2780(boolean bool, Buffer buffer, int i) {
        ...
        if ((~i) == -1) {
            ...
            for (int i_11_ = 0; (~i_11_) > (~anIntArrayArray10476.length); i_11_++) {
    ...
    private void method2909(boolean bool) {
        anInt10471++;
        int i = anInt10482;
        while_267_:
        do {
            do {
                if (i != 2) {
                    ...
                    for (i = 0; (~i) > -258; i++) {
                        int i_12_ = i << 4;
                        int i_13_;
                        for (i_13_ = 1; (~(-1 + anIntArrayArray10476.length)) < (~i_13_); i_13_++) {
                            if ((~i_12_) > (~anIntArrayArray10476[i_13_][0])) {
                                break;
                            }
                        }
                ...
                for (i = 0; i < 257; i++) {
                    ...
                    for (i_30_ = 1; i_30_ < anIntArrayArray10476.length - 1; i_30_++) {
                        if ((~anIntArrayArray10476[i_30_][0]) < (~i_29_)) {
                            break;
                        }
                    }
            ...
            for (i = 0; (~i) > -258; i++) {
                int i_36_ = i << 4;
                int i_37_;
                for (i_37_ = 1; (~i_37_) > (~(anIntArrayArray10476.length + -1)); i_37_++) {
    ...
    private int[] method2910(int i, int i_42_) {
        anInt10469++;
        if ((~i_42_) > i) {
