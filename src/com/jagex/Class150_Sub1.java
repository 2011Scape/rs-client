...
public class Class150_Sub1 extends Class150 {
    ...
    static void method1656(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
        anInt8948++;
    ...
    static void method1657(boolean bool) {
    ...
    static boolean method1658(Animable animable, boolean bool, byte[][][] bs, int i, byte b) {
