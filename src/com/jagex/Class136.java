...
public class Class136 {
    ...
    static int method1590(byte b, Class372 class372) {
        int i = -28 % ((44 - b) / 53);
        anInt1697++;
    ...
    final Class169_Sub2 method1593(byte b, int i) {
        ...
        if (class91.aBoolean1215 && aGLToolkit1696.w()) {
            ...
            int[] is;
            if ((~class91.anInt1226) != -3 && Class377_Sub1.method4129((byte) 83, class91.aByte1214)) {
                is = aD1698.method11(i_0_, true, i_0_, i, (byte) 0, 0.7F);
            } else {
                is = aD1698.method8(0.7F, i, i_0_, false, false, i_0_);
            }
            class169_sub2 = new Class169_Sub2(aGLToolkit1696, 3553, 6408, i_0_, i_0_, (~class91.aByte1207) != -1, is, 0, 0, false);
        }
