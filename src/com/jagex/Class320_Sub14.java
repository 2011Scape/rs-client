...
public class Class320_Sub14 extends Class320 {
    ...
    static short[][] method3735(int i, float[][] fs, short[][] ses) {
        for (int i_0_ = i; (~i_0_) > (~fs.length); i_0_++) {
    ...
    static Class270 method3736(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_) {
        anInt8343++;
