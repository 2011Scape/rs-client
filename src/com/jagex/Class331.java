...
public class Class331 {
    ...
    static Class129 method3841(int i, int i_2_) {
        anInt4132++;
        if (i != 20568) {
            aBoolean4129 = false;
        }
    ...
    static void method3842(int i, int i_4_, int i_5_, int i_6_, int i_7_, byte b) {
        anInt4136++;
        if (b != -54) {
            aBoolean4129 = true;
        }
    ...
    static void processAdminTeleport(boolean bool, int i, int i_8_, int i_9_) {
        anInt4137++;
