...
public class Class320_Sub16 extends Class320 {
    ...
    static int method3742(int i, int i_0_) {
        anInt8357++;
        if ((~i_0_) == -6408 || i_0_ == 34843 || (~i_0_) == -34838) {
            return 6407;
        }
        if (i_0_ == 6408 || (~i_0_) == -34843 || i_0_ == 34836) {
            return 6408;
        }
        if ((~i_0_) == -6407 || (~i_0_) == -34845) {
            return 6406;
        }
        if (i_0_ == 6409 || i_0_ == 34846) {
            return 6409;
        }
        if (i_0_ == 6410 || (~i_0_) == -34848) {
            return 6410;
        }
        if (i != 6406) {
            method3743((byte) -98);
    ...
    final int method3675(int i, byte b) {
        anInt8365++;
        if ((~i) == -1 || (~aNode_Sub27_4063.aClass320_Sub23_7290.method3770(false)) == -2) {
            return 1;
        }
        if (b != 54) {
            method3676(false, 84);
