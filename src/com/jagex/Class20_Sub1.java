...
public class Class20_Sub1 extends Class20 {
    ...
    static void method295(int i) {
        ...
        if ((~Class218.worldResponseBuffer.aPacket1570.anInt7002) != (~Class218.worldResponseBuffer.anInt1581)) {
        ...
        for (int i_4_ = 0; (~i_4_) > (~Node_Sub25_Sub3.anInt9987); i_4_++) {
        ...
        if (i == -25132) {
            for (int i_5_ = 0; (~i_5_) > (~Node_Sub32.anInt7380); i_5_++) {
                if ((~Class314.aNode_Sub41Array4017[i_5_].aNpc7518.anInt10880) != (~Plane.anInt3423)) {
