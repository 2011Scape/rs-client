...
public class Class191 {
    ...
    static boolean method1944(int i, int i_0_) {
        anInt2346++;
    ...
    static void method1946(Player player, int i, boolean bool, byte b, int i_16_) {
        anInt2341++;
        int i_17_ = player.anIntArray10910[0];
        int i_18_ = player.anIntArray10908[0];
        if (i_17_ >= 0 && i_17_ < Node_Sub54.anInt7675 && i_18_ >= 0 && Class377_Sub1.anInt8774 > i_18_ && (i >= 0 && i < Node_Sub54.anInt7675 && (~i_16_) <= -1 && Class377_Sub1.anInt8774 > i_16_)) {
    ...
    static String method1947(int i, int i_21_) {
        anInt2347++;
