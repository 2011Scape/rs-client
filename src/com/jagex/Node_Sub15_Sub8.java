...
public class Node_Sub15_Sub8 extends Node_Sub15 {
    ...
    static void method2575(int i, int i_0_, int i_1_) {
        anInt9832++;
        if (Class44.aGraphicsToolkit668 != null) {
            ...
            if (i_1_ >= 82) {
                ...
                } else if ((~Class320_Sub20.anInt8397) == -2 && (Class352.anInterface6Array4332 == null || (~i_2_) != (~Class117.anInt1479) || (~i_3_) != (~Class290_Sub11.anInt8181))) {
    ...
    final void method2556(ClanChat clanchat, int i) {
        anInt9830++;
        clanchat.method496(anInt9831, 0);
    }
