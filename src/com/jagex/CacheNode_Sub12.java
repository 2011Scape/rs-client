...
public class CacheNode_Sub12 extends CacheNode {
    ...
    static Class98 method2341(int i, Buffer buffer) {
        anInt9557++;
    ...
    static void method2343(ObjectDefinition objectdefinition, byte b, int i, GraphicsToolkit graphicstoolkit, int i_10_, int i_11_) {
        anInt9553++;
        Class140 class140 = Node_Sub54.aClass338_7671.method3909(objectdefinition.anInt3006, 34);
        if ((~class140.anInt1740) != 0) {
