...
public class Node_Sub33 extends Node {
    ...
    static void method2733(int i, int i_12_) {
        anInt7396++;
    ...
    final void method2732(int i, int[] is, int i_0_) {
        ...
        if (i < i_1_) {
            ...
            aGLToolkit7407.method1458(anInt7400, (~(aGLPlane7390.anInt7911 & 0x7)) != -1, (~(aGLPlane7390.anInt7911 & 0x8)) != -1, false);
    ...
    final void method2734(int i, int i_13_, float f, int i_14_, int i_15_) {
        ...
        if (anInt7400 != -1) {
            ...
            if (i_16_ != 0 && (~class91.aByte1214) != -5) {
                int i_17_;
                if (i_13_ >= 0) {
                    if ((~i_13_) >= -128) {
                        i_17_ = 131586 * i_13_;
