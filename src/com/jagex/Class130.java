...
public class Class130 {
    ...
    static void method1557(byte b, Class302 class302, GraphicsToolkit graphicstoolkit) {
        anInt1671++;
        ...
        for (int i_1_ = 0; (~i_1_) > (~class383s.length); i_1_++)
        ...
        for (int i_2_ = 0; (~i_2_) > (~class383s.length); i_2_++)
        ...
        for (int i_3_ = 0; (~i_3_) > (~class383s.length); i_3_++)
        ...
        for (int i_4_ = 0; (~class383s.length) < (~i_4_); i_4_++)
        ...
        for (int i_8_ = 0; (~i_8_) > (~class383s.length); i_8_++)
    ...
    static int method1559(int i, int i_9_) {
        anInt1672++;
        int i_10_ = i_9_ & 0x3f;
