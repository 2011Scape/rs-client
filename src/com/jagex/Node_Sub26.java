...
public class Node_Sub26 extends Node {
    ...
    private final GLToolkit aGLToolkit7240;
    private final int anInt7242;
    private final Class69 aClass69_7244;
    private final Node_Sub29 aNode_Sub29_7247;
    private final Class69 aClass69_7248;
    private final int anInt7249;
    private final Interface1 anInterface1_7256;
    private final int anInt7258;
    private final int anInt7261;
    private final GLPlane aGLPlane7262;
    ...
    Node_Sub26(GLToolkit gltoolkit, GLPlane glplane, Node_Sub29 node_sub29, int[] is) {
        ...
        for (int i_41_ = 0; (~i_41_) >= (~i_40_); i_41_++) {
            ...
            if ((~i_42_) < -1 && (~i_42_) > (~(-1 + aGLPlane7262.anInt3404))) {
                for (int i_43_ = 0; i_39_ >= i_43_; i_43_++) {
                    int i_44_ = anInt7258 + i_43_;
                    if ((~i_44_) < -1 && aGLPlane7262.anInt3408 - 1 > i_44_) {
                        ...
                        float f = (float) (1.0 / Math.sqrt(i_45_ * i_45_ - (-65536 - (i_46_ * i_46_))));
        ...
        for (int i_48_ = anInt7249; anInt7261 >= i_48_; i_48_++) {
            if ((~i_48_) > -1 || i_48_ >= glplane.anInt3404) {
                ...
                for (int i_49_ = anInt7258; (~i_49_) >= (~anInt7242); i_49_++) {
        ...
        if ((~anInt7243) >= -1) {
            ...
            for (int i_54_ = anInt7249; i_54_ <= anInt7261; i_54_++) {
                if ((~i_54_) > -1 || (~i_54_) <= (~glplane.anInt3404)) {
                    ...
                    int i_55_ = 0;
                    for (int i_56_ = anInt7258; (~anInt7242) <= (~i_56_); i_56_++) {
    ...
    private void method2684(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
        anInt7260++;
        long l = -1L;
        ...
        float f_22_ = (float) Math.sqrt(f_21_ * f_21_ + (f_19_ * f_19_ + f_20_ * f_20_));
    ...
    final void method2685(int i, boolean[][] bools, byte b, int i_33_, int i_34_) {
        anInt7245++;
        if (anInterface1_7256 != null && (~(i_33_ + i)) <= (~anInt7258) && (~anInt7242) <= (~(i - i_33_)) && (~anInt7249) >= (~(i_33_ + i_34_)) && -i_33_ + i_34_ <= anInt7261) {
            if (b >= -104) {
                anInt7243 = -112;
            }
            for (int i_35_ = anInt7249; i_35_ <= anInt7261; i_35_++) {
                for (int i_36_ = anInt7258; (~i_36_) >= (~anInt7242); i_36_++) {
                    int i_37_ = i_36_ - i;
    ...
    private void method2686(byte b, short s) {
        anInt7252++;
        if (aGLToolkit7240.aBoolean6736) {
