...
public class ja extends Class336 implements Interface3 {
    ...
    private native void XA(long l, int i, int i_0_, int i_1_, int[] is);
    ...
    private native void l(long l, long l_9_);
    ...
    private native void a(long l, int i, int i_12_, int i_13_);
    ...
    private native void P(long l, int i, int i_14_, int i_15_, int i_16_, int i_17_, int i_18_);
    ...
    private native void b(long l, int i, int i_19_, int i_20_, int[] is);
    ...
    private native void FA(long l, int i, int i_27_, int i_28_);
    ...
    private native void va(long l, int i, int i_30_, int i_31_, int[] is);
