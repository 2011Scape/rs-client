...
public class Node_Sub38_Sub16 extends Node_Sub38 {
    ...
    static void method2841(boolean bool, int i, int i_11_, int i_12_, int i_13_, int i_14_) {
        anInt10267++;
        if (i <= -119) {
            ...
            if (i_12_ >= node_sub16.anIntArray7137.length) {
                ...
                for (int i_16_ = 0; (~node_sub16.anIntArray7137.length) < (~i_16_); i_16_++) {
                    is[i_16_] = node_sub16.anIntArray7137[i_16_];
                    is_15_[i_16_] = node_sub16.anIntArray7138[i_16_];
                }
                for (int i_17_ = node_sub16.anIntArray7137.length; (~i_17_) > (~i_12_); i_17_++) {
                    is[i_17_] = -1;
                    is_15_[i_17_] = 0;
                }
