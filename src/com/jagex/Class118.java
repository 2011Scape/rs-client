...
public class Class118 implements Interface17 {
    ...
    static boolean method1175(byte[] bs, int i, int i_0_, int i_1_, int i_2_, int i_3_) {
        anInt5411++;
        boolean bool = true;
            ...
            for (; ; ) {
                if (bool_7_) {
                    ...
                    if ((~i_13_) < -1 && i_14_ > 0 && (~(-1 + i_1_)) < (~i_13_) && (~(-1 + i_3_)) < (~i_14_)) {
                        ...
                        if (i_12_ != 22 || Class213.aNode_Sub27_2512.aClass320_Sub6_7267.method3701(false) != 0 || (~objectdefinition.anInt3057) != -1 || (~objectdefinition.anInt3010) == -2 || objectdefinition.aBoolean3051) {
                            bool_7_ = true;
