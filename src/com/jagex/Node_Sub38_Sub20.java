...
public class Node_Sub38_Sub20 extends Node_Sub38 {
    ...
    static int method2855(int i, byte b) {
        anInt10301++;
        int i_17_ = 0;
        if ((~i) > -1 || i >= 65536) {
            i >>>= 16;
    ...
    static boolean method2856(int i, Class84 class84, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_, int i_25_, int i_26_, int i_27_) {
        anInt10305++;
        int i_28_ = i_18_;
        int i_29_ = i_21_;
        int i_30_ = 64;
        ...
        while ((~i_34_) != (~i_35_)) {
                            ...
                            do {
                                if (i_38_ != -4) {
                                    if ((~i_38_) != 2) {
                                        if (i_38_ != -2) {
                                            if ((~i_38_) != 0) {
                                                if (i_38_ == 0 || i_38_ == 1 || (~i_38_) == -3 || (~i_38_) == -4 || (~i_38_) == -10) {
                                                    break while_193_;
                                                }
                                                break while_194_;
                                            }
            ...
            while_196_:
            do {
                if ((~i_30_) < -1 && (~Node_Sub36_Sub2.anIntArrayArray10047[-1 + i_30_][i_31_]) == -1 && (~(0x43a40000 & is[i_36_ + -1][i_37_])) == -1 && (~(0x4e240000 & is[i_36_ - 1][-1 + (i_25_ + i_37_)])) == -1) {
                    for (int i_39_ = 1; i_39_ < i_25_ - 1; i_39_++) {
                        if ((~(0x4fa40000 & is[-1 + i_36_][i_37_ + i_39_])) != -1) {
                            break while_196_;
                        }
                    }
            ...
            while_197_:
            do {
                if (128 - i_25_ > i_30_ && (~Node_Sub36_Sub2.anIntArrayArray10047[i_30_ - -1][i_31_]) == -1 && (~(is[i_36_ - -i_25_][i_37_] & 0x60e40000)) == -1 && (0x78240000 & is[i_36_ + i_25_][-1 + (i_37_ + i_25_)]) == 0) {
            ...
            while_198_:
            do {
                if ((~i_31_) < -1 && Node_Sub36_Sub2.anIntArrayArray10047[i_30_][i_31_ - 1] == 0 && (0x43a40000 & is[i_36_][-1 + i_37_]) == 0 && (is[i_36_ + (i_25_ - 1)][-1 + i_37_] & 0x60e40000) == 0) {
                    for (int i_41_ = 1; -1 + i_25_ > i_41_; i_41_++) {
                        if ((~(is[i_41_ + i_36_][-1 + i_37_] & 0x63e40000)) != -1) {
                            break while_198_;
                        }
                    }
                    Node_Sub39.anIntArray7494[i_34_] = i_28_;
            ...
            while_199_:
            do {
                if (128 - i_25_ > i_31_ && Node_Sub36_Sub2.anIntArrayArray10047[i_30_][1 + i_31_] == 0 && (~(is[i_36_][i_37_ - -i_25_] & 0x4e240000)) == -1 && (~(is[i_36_ - (-i_25_ + 1)][i_25_ + i_37_] & 0x78240000)) == -1) {
                    for (int i_42_ = 1; (~(i_25_ + -1)) < (~i_42_); i_42_++) {
            ...
            while_200_:
            do {
                if (i_30_ > 0 && i_31_ > 0 && (~Node_Sub36_Sub2.anIntArrayArray10047[i_30_ + -1][-1 + i_31_]) == -1 && (is[-1 + i_36_][i_37_ - 1] & 0x43a40000) == 0) {
                    for (int i_43_ = 1; i_43_ < i_25_; i_43_++) {
                        if ((~(0x4fa40000 & is[-1 + i_36_][i_43_ + (i_37_ + -1)])) != -1 || (0x63e40000 & is[i_36_ - 1 + i_43_][i_37_ - 1]) != 0) {
                            break while_200_;
                        }
                    }
                    Node_Sub39.anIntArray7494[i_34_] = i_28_ - 1;
            ...
            while_201_:
            do {
                if ((~(128 - i_25_)) < (~i_30_) && (~i_31_) < -1 && (~Node_Sub36_Sub2.anIntArrayArray10047[1 + i_30_][i_31_ + -1]) == -1 && (~(0x60e40000 & is[i_36_ + i_25_][i_37_ + -1])) == -1) {
            ...
            while_202_:
            do {
                if (i_30_ > 0 && i_31_ < 128 - i_25_ && Node_Sub36_Sub2.anIntArrayArray10047[i_30_ - 1][1 + i_31_] == 0 && (~(0x4e240000 & is[-1 + i_36_][i_25_ + i_37_])) == -1) {
                    for (int i_45_ = 1; (~i_45_) > (~i_25_); i_45_++) {
            ...
            if (i_30_ < -i_25_ + 128 && (~i_31_) > (~(-i_25_ + 128)) && Node_Sub36_Sub2.anIntArrayArray10047[1 + i_30_][1 + i_31_] == 0 && (~(is[i_25_ + i_36_][i_25_ + i_37_] & 0x78240000)) == -1) {
                for (int i_46_ = 1; i_25_ > i_46_; i_46_++) {
                    if ((~(0x7e240000 & is[i_46_ + i_36_][i_37_ - -i_25_])) != -1 || (0x78e40000 & is[i_36_ + i_25_][i_37_ + i_46_]) != 0) {
                        continue while_203_;
                    }
                }
                Node_Sub39.anIntArray7494[i_34_] = 1 + i_28_;
    ...
    static void method2857(int i) {
        ...
        for (int i_53_ = (-(Node_Sub54.anInt7675 >> 4) + i_48_) / 8; ((Node_Sub54.anInt7675 >> 4) + i_48_) / 8 >= i_53_; i_53_++) {
            for (int i_54_ = (-(Class377_Sub1.anInt8774 >> 4) + i_49_) / 8; (~i_54_) >= (~((i_49_ + (Class377_Sub1.anInt8774 >> 4)) / 8)); i_54_++) {
    ...
    private boolean method2853(int i, int i_1_, int i_2_) {
        anInt10297++;
    ...
    private boolean method2854(int i, int i_13_, int i_14_) {
        anInt10308++;
        if (i != 504017132) {
            return true;
        }
        ...
        if ((~(-i_13_ + i_14_)) <= (~i_16_) || (~-i_16_) <= (~(-i_13_ + i_14_))) {
            return false;
        }
        return true;
    }
