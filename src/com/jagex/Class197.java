...
public class Class197 {
    ...
    static String method1998(String string, String string_0_, byte b, char c) {
        int i = 111 / ((-28 - b) / 50);
        anInt2424++;
    ...
    static boolean method1999(int i, int i_8_) {
        if (i_8_ != 128) {
            anInt2415 = 13;
        }
        anInt2421++;
    ...
    static String method2001(byte b, int i, byte[] bs, int i_9_) {
        anInt2412++;
        char[] cs = new char[i];
        int i_10_ = 0;
        if (b != -124) {
            ...
            if ((~i_13_) > -129) {
                ...
                if ((~i_13_) <= -225) {
                    if (i_13_ >= 240) {
                        if ((~i_13_) <= -249) {
                            i_14_ = 65533;
                        } else if ((~(i_11_ - -2)) <= (~i_12_) || (~(bs[i_11_] & 0xc0)) != -129 || (~(0xc0 & bs[i_11_ + 1])) != -129 || (0xc0 & bs[2 + i_11_]) != 128) {
                            i_14_ = 65533;
                        } else {
                    ...
                    } else if ((~i_12_) >= (~(i_11_ + 1)) || (~(0xc0 & bs[i_11_])) != -129 || (0xc0 & bs[i_11_ + 1]) != 128) {
                        i_14_ = 65533;
                    } else {
                ...
                } else if ((~i_11_) <= (~i_12_) || (~(0xc0 & bs[i_11_])) != -129) {
                    i_14_ = 65533;
                } else {
    ...
    final boolean method2002(int i, Class197 class197_15_) {
        ...
        if (class197_15_ != null) {
            if ((~class197_15_.worldId) != (~worldId) || !aString2422.equals(class197_15_.aString2422)) {
                return false;
            }
            return true;
        }
