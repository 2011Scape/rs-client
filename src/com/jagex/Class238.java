...
public class Class238 {
    ...
    static void method3019(int i, int i_0_, int[] is, Object[] objects, boolean bool) {
        anInt2914++;
        if ((~i_0_) > (~i)) {
            int i_1_ = (i_0_ + i) / 2;
            int i_2_ = i_0_;
    ...
    static void method3020(int i, Actor actor) {
        anInt2910++;
    ...
    static boolean method3021(int i, int i_11_, int i_12_) {
        anInt2916++;
        if ((~i_11_) > -1 || i < 0 || i_11_ >= CacheNode_Sub11.aByteArrayArrayArray9550[1].length || (~i) <= (~CacheNode_Sub11.aByteArrayArrayArray9550[1][i_11_].length)) {
            return false;
        }
        int i_13_ = 90 % ((i_12_ - 38) / 41);
        if ((~(CacheNode_Sub11.aByteArrayArrayArray9550[1][i_11_][i] & 0x2)) != -1) {
            return true;
        }
        return false;
    }
