...
public class Class312 {
    ...
    static GraphicsToolkit method3612(d var_d, int i, int i_0_, int i_1_, java.awt.Canvas canvas) {
        anInt3954++;
        if (i_1_ != -25440) {
            method3624(-29);
        }
    ...
    static void method3618(int i) {
        anInt3971++;
        if (Node_Sub38_Sub5.aBoolean10125 && i == 16711680) {
            while ((~Class180.aClass377_Sub1Array2143.length) < (~EntityNode_Sub3_Sub1.anInt9163)) {
                Class377_Sub1 class377_sub1 = Class180.aClass377_Sub1Array2143[EntityNode_Sub3_Sub1.anInt9163];
                if (class377_sub1 == null || (~class377_sub1.anInt8779) != 0) {
    ...
    static Class244[] method3624(int i) {
        anInt3965++;
        if (i != 0) {
        ...
        if (Node_Sub52.aClass244Array7654 == null) {
            ...
            for (int i_10_ = 0; i_10_ < class244s.length; i_10_++) {
                ...
                if (((~class244.anInt3079) >= -1 || (~class244.anInt3079) <= -25) && (~class244.anInt3084) <= -801 && (~class244.anInt3078) <= -601 && (i_9_ != 2 || (~class244.anInt3084) >= -801 && (~class244.anInt3078) >= -601) && (i_9_ != 1 || (~class244.anInt3084) >= -1025 && class244.anInt3078 <= 768)) {
                    for (int i_11_ = 0; i_11_ < i_8_; i_11_++) {
                        Class244 class244_12_ = class244s_7_[i_11_];
                        if ((~class244.anInt3084) == (~class244_12_.anInt3084) && class244.anInt3078 == class244_12_.anInt3078) {
    ...
    final boolean method3616(int i) {
        ...
        anInt3972++;
        return aNode3958 == aNode3958.aNode2800;
    }

    private void method3617(Node node, Class312 class312_3_, byte b) {
        anInt3967++;
