...
public class Class188_Sub1_Sub1 extends Class188_Sub1 {
    ...
    static boolean method1894(int i, byte b, int i_3_) {
        if (b > -2) {
    ...
    static void method1895(int i, boolean bool, int i_4_, byte b, int i_5_, int i_6_, int i_7_) {
        ...
        if (bool && (~ItemDefinition.anInt1858) <= -101) {
