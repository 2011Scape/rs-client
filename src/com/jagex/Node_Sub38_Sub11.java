...
public class Node_Sub38_Sub11 extends Node_Sub38 {
    ...
    static void method2826(boolean bool, double d) {
        anInt10214++;
    ...
    static boolean method2828(int i, int i_9_) {
        if (i_9_ != 0) {
            method2828(116, -108);
        }
        anInt10207++;
    ...
    private void method2827(int i) {
        ...
        for (int i_2_ = 0; anInt10204 > i_2_; i_2_++) {
            ...
            for (int i_5_ = 0; (~anInt10222) < (~i_5_); i_5_++) {
                if ((~i_5_) < -1) {
                    int i_6_ = anInt10206;
    ...
    final int[] method2775(int i, int i_10_) {
        ...
        if (aClass146_7460.aBoolean1819) {
            ...
            for (/**/; (~i_12_) < -4097; i_12_ -= 4096) {
                /* empty */
            }
            for (/**/; (~i_11_) > (~anInt10204); i_11_++) {
                if ((~anIntArray10210[i_11_]) < (~i_12_)) {
                    break;
                }
            }
            int i_13_ = i_11_ - 1;
            ...
            if ((~(anInt10211 + i_15_)) > (~i_12_) && i_12_ < -anInt10211 + i_14_) {
                for (int i_16_ = 0; (~i_16_) > (~Class339_Sub7.anInt8728); i_16_++) {
                    int i_17_ = 0;
                    int i_18_ = !bool ? -anInt10213 : anInt10213;
                    int i_19_;
                    for (i_19_ = CacheNode_Sub3.anIntArray9442[i_16_] + (i_18_ * anInt10206 >> 12); (~i_19_) > -1; i_19_ += 4096) {
                        /* empty */
                    }
                    for (/**/; i_19_ > 4096; i_19_ -= 4096) {
                        /* empty */
                    }
                    for (/**/; (~i_17_) > (~anInt10222); i_17_++) {
                        if ((~anIntArrayArray10203[i_13_][i_17_]) < (~i_19_)) {
                            break;
                        }
                    }
                    int i_20_ = i_17_ - 1;
                    ...
                    if (i_19_ > anInt10211 + i_22_ && (~i_19_) > (~(i_21_ + -anInt10211))) {
