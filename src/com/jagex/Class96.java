...
public class Class96 {
    ...
    static int method1075(int i, int i_7_) {
        anInt1262++;
    ...
    private Node_Sub45_Sub1 method1071(int i, int i_0_, int i_1_, int[] is) {
        anInt1266++;
    ...
    private Node_Sub45_Sub1 method1072(int[] is, int i, int i_3_, byte b) {
        anInt1263++;
    ...
    final Node_Sub45_Sub1 method1073(boolean bool, int[] is, int i) {
        ...
        if ((~aClass302_1264.method3537(-2, i)) == -2) {
    ...
    final Node_Sub45_Sub1 method1074(int[] is, byte b, int i) {
        ...
        if ((~aClass302_1260.method3537(-2, i)) == -2) {
