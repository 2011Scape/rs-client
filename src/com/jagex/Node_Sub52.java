...
public class Node_Sub52 extends Node {
    ...
    static int method2972(boolean bool) {
        if (bool) {
            aClass244Array7654 = null;
        }
        anInt7638++;
    ...
    static void method2974(int i, CacheNode_Sub13 cachenode_sub13) {
        anInt7656++;
    ...
    final boolean method2973(int i, int i_18_, int i_19_) {
        ...
        anInt7637++;
        return (~i_18_) <= (~anInt7636) && (~i_18_) >= (~anInt7641) && (~i) <= (~anInt7646) && (~i) >= (~anInt7635);
    }
    ...
    final boolean method2975(int i, byte b, int i_21_, int i_22_) {
        ...
        return (~anInt7645) == (~i_21_) && (~i_22_) <= (~anInt7653) && i_22_ <= anInt7643 && i >= anInt7642 && i <= anInt7649;
    }
    ...
    final boolean method2977(int i, byte b, int i_25_) {
        ...
        return (~i) <= (~anInt7653) && i <= anInt7643 && i_25_ >= anInt7642 && (~i_25_) >= (~anInt7649);
    }
}
