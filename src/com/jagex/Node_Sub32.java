...
public class Node_Sub32 extends Node {
    ...
    static void method2729(boolean bool) {
        anInt7384++;
        ...
        for (int i = 0; Class159.anInt1995 > i; i++) {
            for (int i_2_ = 0; Class328.anInt4115 > i_2_; i_2_++) {
                for (int i_3_ = 0; (~Node_Sub50.anInt7623) < (~i_3_); i_3_++) {
                    ...
                    if (class261 != null) {
                        ...
                        if ((~class261.aShort3318) > -1) {
                            ...
                            for (/**/; (~i_5_) < -1 && class261_9_ != null && class261_9_.aShort3318 < 0 && class261.aShort3318 == class261_9_.aShort3318 && (~class261.aShort3322) == (~class261_9_.aShort3322); class261_9_ = Class175.aClass261ArrayArrayArray2099[i][i_3_][-1 + i_5_]) {
                                if ((~Node_Sub38_Sub37.aPlaneArray10466[i].method3251(i_5_ - 1, i_3_, (byte) -118)) != (~i_10_)) {
                                    break;
                                }
                            ...
                            for (class261_9_ = Class175.aClass261ArrayArrayArray2099[i][i_3_][i_6_ + 1]; Node_Sub50.anInt7623 > i_6_ && class261_9_ != null && class261_9_.aShort3318 < 0 && class261.aShort3318 == class261_9_.aShort3318 && class261.aShort3322 == class261_9_.aShort3322; class261_9_ = Class175.aClass261ArrayArrayArray2099[i][i_3_][1 + i_6_]) {
                                ...
                                if (Node_Sub50.anInt7623 > i_6_ + 1 && (~i_10_) != (~Node_Sub38_Sub37.aPlaneArray10466[i].method3251(2 + i_6_, i_3_, (byte) -118))) {
                                    break;
                                }
                                i_6_++;
                            }
                            ...
                            for (int i_19_ = i_7_; (~i_8_) <= (~i_19_); i_19_++) {
                        ...
                        if (class261.aShort3313 < 0) {
                            ...
                            for (/**/; i_21_ > 0 && class261_25_ != null && class261_25_.aShort3313 < 0 && class261_25_.aShort3313 == class261.aShort3313 && class261_25_.aShort3320 == class261.aShort3320; class261_25_ = Class175.aClass261ArrayArrayArray2099[i][i_21_ - 1][i_2_]) {
                                ...
                                if (-1 + i_21_ > 0 && (~i_26_) != (~Node_Sub38_Sub37.aPlaneArray10466[i].method3251(i_2_, i_21_ + -2, (byte) -118))) {
                                    break;
                                }
                                i_21_--;
                            }
                            for (class261_25_ = Class175.aClass261ArrayArrayArray2099[i][1 + i_22_][i_2_]; i_22_ < Class328.anInt4115 && class261_25_ != null && class261_25_.aShort3313 < 0 && (~class261.aShort3313) == (~class261_25_.aShort3313) && class261.aShort3320 == class261_25_.aShort3320; class261_25_ = Class175.aClass261ArrayArrayArray2099[i][1 + i_22_][i_2_]) {
                                if ((~Node_Sub38_Sub37.aPlaneArray10466[i].method3251(i_2_, 1 + i_22_, (byte) -118)) != (~i_26_)) {
                                    break;
                                }
                                if (1 + i_22_ < Class328.anInt4115 && (~i_26_) != (~Node_Sub38_Sub37.aPlaneArray10466[i].method3251(i_2_, i_22_ + 2, (byte) -118))) {
                                    break;
                                }
                                i_22_++;
                            }
                            ...
                            for (int i_35_ = i_23_; (~i_24_) <= (~i_35_); i_35_++) {
    ...
    static void method2731(boolean bool, int i, long l, int i_37_, int i_38_, String string, int i_39_, boolean bool_40_, int i_41_, String string_42_, long l_43_, byte b, boolean bool_44_) {
        anInt7383++;
