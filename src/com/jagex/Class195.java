...
public class Class195 {
    ...
    static Node_Sub14 method1985(boolean bool) {
        anInt2383++;
    ...
    static void method1988(int i, float f, float f_17_, int i_18_, Class328 class328, byte[] bs, float f_19_, int i_20_, byte b, float f_21_, int i_22_, int i_23_, int i_24_, float f_25_) {
        anInt2403++;
        int i_26_ = i * i_22_;
        if (b >= -53) {
            method1984(1);
    ...
    static void method1990(byte b) {
        ...
        if (Node_Sub38_Sub8.anInt10163 != 0 && Node_Sub38_Sub8.anInt10163 != 10) {
            ...
            try {
                ...
                if ((~Class159.anInt1996) != -3 || Node_Sub38_Sub8.anInt10163 != 20 && (~Class339_Sub2.anInt8653) != -43) {
                ...
                if (Node_Sub38_Sub8.anInt10163 == 5) {
                    ...
                    if (!Animable_Sub2_Sub1.aBoolean10628 || (~Class188_Sub2_Sub1.method1910((byte) 84, Class240.aSignLink2946, string, string_36_, 1).anInt2953) == -3) {
                        Class140.method1610(0, string, string_36_, Class240.aSignLink2946, (~Class213.aNode_Sub27_2512.aClass320_Sub29_7270.method3791(false)) == -2, true);
                    }
                ...
                if ((~Node_Sub38_Sub8.anInt10163) == -7) {
                    ...
                    if ((~(Class320_Sub23.aClass123_8432.aPacket1570.aByteArray7019[0] & 0xff)) == -2) {
                ...
                if (Node_Sub38_Sub8.anInt10163 == 8) {
                    ...
                    if (Class159.anInt1996 == 2) {
                        ...
                        if (!FixedAnimator.aBoolean5503) {
                            ...
                            packet.method2226((~Class151.anInt1843) == -15 ? 1 : 0, false);
                                    ...
                                    if ((~i_43_) == -16) {
                                        ...
                                        if (i_43_ == 23 && Class45.anInt5264 < 3) {
                                            ...
                                            if ((~i_43_) == -43) {
                                                ...
                                                if (!Class296.aBoolean5428 || FixedAnimator.aBoolean5503 || (~Class336_Sub2.anInt8586) == 0 || i_43_ != 35) {
                                                    Node_Sub38_Sub8.anInt10163 = 0;
                                                    Animable_Sub2.method836(i_43_, true);
                                                    Class320_Sub23.aClass123_8432.aClass365_1557.method4062(-2);
                                                    Class320_Sub23.aClass123_8432.aClass365_1557 = null;
                ...
                if (Node_Sub38_Sub8.anInt10163 == 11) {
                    ...
                    if (Node_Sub38_Sub8.anInt10163 == 14) {
                        ...
                        if (Class159.anInt1996 != 2) {
                            ...
                            Class24.aBoolean436 = (~packet.method2233(255)) == -2;
                            ProducingGraphicsBuffer.aBoolean9900 = (~packet.method2233(255)) == -2;
                            ...
                            Class64.aBoolean5046 = (~(0x1 & i_45_)) != -1;
                            Class229.aBoolean2725 = (~(0x2 & i_45_)) != -1;
                            Node_Sub33.anInt7402 = packet.method2186(-120);
                            Class364.aBoolean4512 = (~packet.method2233(255)) == -2;
                            ...
                            Class225.aBoolean2676 = (~packet.method2233(255)) == -2;
                            ...
                            if (CacheNode_Sub2.aClass329_9436 != Node_Sub38_Sub1.aClass329_10086 && (Node_Sub38_Sub1.aClass329_10086 != Class379.aClass329_4873 || (~Class339_Sub7.playerPrivilege) > -3) && Class181.aClass197_2155.method2002(-129, Class320_Sub24.aClass197_8443)) {
                            ...
                            Class64.aBoolean5046 = (~packet.method2233(255)) == -2;
                            Class56.anInt837 = packet.method2229((byte) 94);
                            Class101.aBoolean1313 = (~packet.method2233(255)) == -2;
    ...
    final DrawableModel method1986(byte b, boolean bool, int i, Animator animator, Plane plane, byte b_0_, int i_1_, Plane plane_2_, int i_3_, int i_4_, GraphicsToolkit graphicstoolkit) {
        ...
        if (drawablemodel == null || graphicstoolkit.b(drawablemodel.ua(), i_5_) != 0) {
            ...
            if (aShortArray2386 != null) {
                for (int i_8_ = 0; (~aShortArray2386.length) < (~i_8_); i_8_++)
        ...
        if ((~anInt2400) != -129 || anInt2396 != 128) {
    ...
    private void method1987(int i, Buffer buffer, int i_11_) {
        anInt2393++;
        if ((~i) == -2) {
