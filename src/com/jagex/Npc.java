...
public class Npc extends Actor {
    ...
    static void method880(byte b) {
        ...
        synchronized (Class158.aClient1983) {
            ...
            if (Node_Sub38_Sub1.aClass329_10086 != Class240.aClass329_2943) {
                if (Class360.windowWidth < 1024 && Class205.anInt5115 < 768) {
                    /* empty */
                }
            }
    ...
    final boolean method810(int i, int i_2_, boolean bool, GraphicsToolkit graphicstoolkit) {
        ...
        for (int i_5_ = 0; (~i_5_) > (~aDrawableModelArray10909.length); i_5_++) {
            if (aDrawableModelArray10909[i_5_] != null) {
                boolean bool_6_ = (~aNpcDefinition11122.anInt2831) < -1 || ((~aNpcDefinition11122.anInt2803) == 0 ? aNpcDefinition11122.anInt2811 == 1 : (~aNpcDefinition11122.anInt2803) == -2);
                boolean bool_7_;
        ...
        for (int i_8_ = 0; (~i_8_) > (~aDrawableModelArray10909.length); i_8_++)
    ...
    final EntityNode_Sub6 method807(int i, GraphicsToolkit graphicstoolkit) {
        ...
        if (class261 == null || class261.anAnimable_Sub1_3317 == null) {
            ...
            anInt10849 -= (int) ((float) i_10_ / 10.0F);
        }
        ...
        for (int i_15_ = 0; (~i_15_) > (~aDrawableModelArray10909.length); i_15_++) {
    ...
    private boolean method875(int i, boolean bool, GraphicsToolkit graphicstoolkit) {
        anInt11114++;
        int i_16_ = i;
        ...
        if ((~i_18_) != -1 || i_19_ != 0 || class259.anInt3250 != 0 || class259.anInt3285 != 0) {
            i |= 0x7;
        }
        boolean bool_20_ = aByte10888 != 0 && anInt10895 <= Class174.anInt2092 && (~Class174.anInt2092) > (~anInt10882);
        if (bool_20_) {
            i |= 0x80000;
        }
    ...
    final int method855(byte b) {
        ...
        if (aNpcDefinition11122.anIntArray2827 != null) {
            NpcDefinition npcdefinition = aNpcDefinition11122.method2999(65535, Class24.aClass275_442);
            if (npcdefinition != null && (~npcdefinition.anInt2814) != 0) {
    ...
    final void method876(int i, int i_22_, byte b) {
        ...
        if (b < -95) {
            ...
            if (anAnimator10876.method245(-124) && (~anAnimator10876.method243((byte) -24).anInt718) == -2) {
                anIntArray10817 = null;
                anAnimator10876.method249(true, -1);
            }
            for (int i_25_ = 0; (~i_25_) > (~aClass165Array10886.length); i_25_++) {
                if ((~aClass165Array10886[i_25_].anInt2030) != 0) {
    ...
    final void method877(int i, boolean bool, int i_27_, int i_28_, int i_29_, int i_30_) {
        ...
        if (anAnimator10876.method245(-127) && (~anAnimator10876.method243((byte) -24).anInt718) == -2) {
            anIntArray10817 = null;
            anAnimator10876.method249(true, -1);
        }
        for (int i_31_ = 0; i_31_ < aClass165Array10886.length; i_31_++) {
            if ((~aClass165Array10886[i_31_].anInt2030) != 0) {
    ...
    private boolean method881(int i) {
