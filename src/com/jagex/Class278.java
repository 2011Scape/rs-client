...
public class Class278 {
    ...
    static boolean method3367(int i, int i_6_, byte b) {
        int i_7_ = 112 % ((b + 59) / 45);
        anInt3540++;
        return (~(0x220 & i_6_)) == -545 | (0x18 & i_6_) != 0;
    }
    ...
    private Class82 method3364(int i, int i_1_) {
        anInt3544++;
        Class82 class82;
        synchronized (aClass61_3543) {
            if (i_1_ != -26726) {
            ...
            class82 = (Class82) aClass61_3543.method607(i, 0);
        }
        if (class82 != null) {
            return class82;
        }
        ...
        synchronized (aClass61_3543) {
            aClass61_3543.method601(class82, i_1_ ^ ~0xbbb, i);
        }
        return class82;
    }
