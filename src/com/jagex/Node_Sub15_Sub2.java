...
public class Node_Sub15_Sub2 extends Node_Sub15 {
    ...
    static boolean method2559(int i, int i_0_, int i_1_, int i_2_, byte[] bs, int i_3_, int i_4_) {
        anInt9775++;
        int i_5_ = i_3_ % i_1_;
        int i_6_;
        if (i_5_ != 0) {
    ...
    static short method2560(int i, int i_11_) {
        anInt9777++;
