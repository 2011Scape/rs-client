...
public class Class132 {
    ...
    static int method1560(byte b, Class139 class139) {
        anInt1680++;
        int i = -117 % ((-61 - b) / 41);
    ...
    static boolean method1561(int i) {
        anInt1681++;
        if (i != -1) {
            return false;
        }
    ...
    static int method1564(int i, boolean bool) {
        anInt1678++;
    ...
    static void method1565(String string, int i, int i_1_) {
        anInt1676++;
