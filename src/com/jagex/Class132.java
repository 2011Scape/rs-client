...
public class Class132
{
	...
	static final void method1563(int i) {
		...
		anInt1675++;
		Class277.aCacheNode_Sub13_3509 = new CacheNode_Sub13(Localization.cancel.getLocalizationString(-12273, Class35.clientLanguage), "", Class239.anInt2928, 1012, -1, 0L, 0, 0, true, false, 0L, true);
	}
	...
	static final void method1565(String string, int i, int i_1_) {
		...
		if (!bool) {
			Class41.method436(i_1_ ^ ~0x1c6b, Localization.unableToFindAddedFriend.getLocalizationString(-12273, Class35.clientLanguage) + string, 4);
		}
	}
}
