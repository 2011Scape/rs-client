...
public class r_Sub2 extends r {
    ...
    static Frame method2371(int i, SignLink signlink, int i_9_, int i_10_, int i_11_, int i_12_) {
        anInt11060++;
        ...
        if (i == 0) {
            ...
            for (int i_13_ = 0; (~i_13_) > (~class244s.length); i_13_++) {
                if (class244s[i_13_].anInt3084 == i_11_ && class244s[i_13_].anInt3078 == i_10_ && (i_12_ == 0 || (~class244s[i_13_].anInt3077) == (~i_12_)) && (!bool || class244s[i_13_].anInt3079 > i)) {
                    bool = true;
    ...
    static void method2375(boolean bool, byte b, Actor actor) {
        anInt11059++;
        int i = -1;
        if (b != -49) {
        ...
        int i_22_ = 0;
        if ((~actor.anInt10892) < (~Class174.anInt2092)) {
            Class238.method3020(b + 49, actor);
        } else if ((~Class174.anInt2092) < (~actor.anInt10887)) {
        ...
        if ((~actor.anInt5934) > -513 || (~actor.anInt5940) > -513 || (~(Node_Sub54.anInt7675 * 512 + -512)) >= (~actor.anInt5934) || (~actor.anInt5940) <= (~(Class377_Sub1.anInt8774 * 512 - 512))) {
        ...
        if (actor == Class295.aPlayer3692 && ((~actor.anInt5934) > -6145 || actor.anInt5940 < 6144 || (~actor.anInt5934) <= (~(-6144 + 512 * Node_Sub54.anInt7675)) || (~(-6144 + Class377_Sub1.anInt8774 * 512)) >= (~actor.anInt5940))) {
            actor.anAnimator10876.method249(true, -1);
    ...
    static void method2376(int i) {
        ...
        boolean bool = true;
        for (int i_26_ = 0; (~Class188_Sub1_Sub1.aByteArrayArray9334.length) < (~i_26_); i_26_++) {
            ...
            if (Class204.anIntArray2460 != null && Class194.aByteArrayArray2373[i_26_] == null && (~Class204.anIntArray2460[i_26_]) != 0) {
        ...
        if (!bool) {
            ...
            for (int i_27_ = 0; (~Class188_Sub1_Sub1.aByteArrayArray9334.length) < (~i_27_); i_27_++) {
            ...
            if (!bool) {
                ...
                if (Class93.aGraphicsToolkit1241.z() && Class213.aNode_Sub27_2512.aClass320_Sub26_7269.method3779(false) == 2) {
                    for (int i_34_ = 0; (~Class188_Sub1_Sub1.aByteArrayArray9334.length) < (~i_34_); i_34_++) {
                ...
                for (int i_38_ = 0; (~i_38_) > -5; i_38_++) {
                    for (int i_39_ = 0; i_39_ < Node_Sub54.anInt7675; i_39_++) {
                        for (int i_40_ = 0; (~i_40_) > (~Class377_Sub1.anInt8774); i_40_++)
            ...
            if ((~i_0_) >= (~i_2_) && (~i_0_) >= (~i_3_)) {
                if ((~i_3_) < (~i_2_)) {
                    ...
                    if ((i_0_ == i_2_ || (~i_6_) >= (~i_8_)) && ((~i_0_) != (~i_2_) || (~i_8_) >= (~i_7_))) {
                        ...
                        i_0_ *= anInt11057;
                        while (--i_2_ >= 0) {
                            Class262_Sub16.method3196(i_4_ >> 16, aByteArray11058, i_0_, (byte) -24, i >> 16);
                            i += i_6_;
                            i_0_ += anInt11057;
                            i_4_ += i_8_;
                        }
                        while ((~--i_3_) <= -1) {
                            Class262_Sub16.method3196(i_4_ >> 16, aByteArray11058, i_0_, (byte) -24, i_1_ >> 16);
                            i_0_ += anInt11057;
                            i_4_ += i_8_;
                            i_1_ += i_7_;
                        }
                        ...
                        while (--i_2_ >= 0) {
                            Class262_Sub16.method3196(i >> 16, aByteArray11058, i_0_, (byte) -24, i_4_ >> 16);
                            i_4_ += i_8_;
                            i_0_ += anInt11057;
                            i += i_6_;
                        }
                        while (--i_3_ >= 0) {
                            Class262_Sub16.method3196(i_1_ >> 16, aByteArray11058, i_0_, (byte) -24, i_4_ >> 16);
                            i_0_ += anInt11057;
                            i_1_ += i_7_;
                            i_4_ += i_8_;
                        }
                    ...
                    if ((~i_0_) != (~i_3_) && (~i_8_) > (~i_6_) || (~i_3_) == (~i_0_) && i_7_ > i_6_) {
                        ...
                        i_0_ *= anInt11057;
                        while (--i_3_ >= 0) {
                            Class262_Sub16.method3196(i >> 16, aByteArray11058, i_0_, (byte) -24, i_1_ >> 16);
                            i_1_ += i_8_;
                            i += i_6_;
                            i_0_ += anInt11057;
                        }
                        ...
                        i_0_ *= anInt11057;
                        while (--i_3_ >= 0) {
                            Class262_Sub16.method3196(i_1_ >> 16, aByteArray11058, i_0_, (byte) -24, i >> 16);
                            i += i_6_;
                            i_1_ += i_8_;
                            i_0_ += anInt11057;
                        }
                ...
                if (i_0_ < i_2_) {
                    ...
                    if (i_8_ > i_7_) {
                        ...
                        while (--i_0_ >= 0) {
                            Class262_Sub16.method3196(i_4_ >> 16, aByteArray11058, i_3_, (byte) -24, i_1_ >> 16);
                            i_1_ += i_7_;
                            i_3_ += anInt11057;
                            i_4_ += i_8_;
                        }
                        while (--i_2_ >= 0) {
                            Class262_Sub16.method3196(i >> 16, aByteArray11058, i_3_, (byte) -24, i_1_ >> 16);
                            i += i_6_;
                            i_1_ += i_7_;
                            i_3_ += anInt11057;
                        }
                        ...
                        i_3_ = anInt11057 * i_3_;
                        while (--i_0_ >= 0) {
                            Class262_Sub16.method3196(i_1_ >> 16, aByteArray11058, i_3_, (byte) -24, i_4_ >> 16);
                            i_3_ += anInt11057;
                            i_4_ += i_8_;
                            i_1_ += i_7_;
                        }
                        while ((~--i_2_) <= -1) {
                            Class262_Sub16.method3196(i_1_ >> 16, aByteArray11058, i_3_, (byte) -24, i >> 16);
                            i_1_ += i_7_;
                            i += i_6_;
                            i_3_ += anInt11057;
                        }
                    ...
                    if ((~i_8_) < (~i_7_)) {
                        ...
                        i_3_ = anInt11057 * i_3_;
                        while (--i_2_ >= 0) {
                            Class262_Sub16.method3196(i_4_ >> 16, aByteArray11058, i_3_, (byte) -24, i >> 16);
                            i_3_ += anInt11057;
                            i += i_7_;
                            i_4_ += i_8_;
                        }
                        ...
                        i_3_ *= anInt11057;
                        while ((~--i_2_) <= -1) {
                            Class262_Sub16.method3196(i >> 16, aByteArray11058, i_3_, (byte) -24, i_4_ >> 16);
                            i += i_7_;
                            i_4_ += i_8_;
                            i_3_ += anInt11057;
                        }
                ...
                if (i_2_ != i_3_ && (~i_6_) > (~i_7_) || i_2_ == i_3_ && (~i_6_) < (~i_8_)) {
                    ...
                    i_2_ *= anInt11057;
                    while (--i_3_ >= 0) {
                        Class262_Sub16.method3196(i_1_ >> 16, aByteArray11058, i_2_, (byte) -24, i >> 16);
                        i += i_6_;
                        i_1_ += i_7_;
                        i_2_ += anInt11057;
                    }
                    while (--i_0_ >= 0) {
                        Class262_Sub16.method3196(i_4_ >> 16, aByteArray11058, i_2_, (byte) -24, i >> 16);
                        i_4_ += i_8_;
                        i_2_ += anInt11057;
                        i += i_6_;
                    }
                    ...
                    i_2_ *= anInt11057;
                    while ((~--i_3_) <= -1) {
                        Class262_Sub16.method3196(i >> 16, aByteArray11058, i_2_, (byte) -24, i_1_ >> 16);
                        i_1_ += i_7_;
                        i_2_ += anInt11057;
                        i += i_6_;
                    }
                    while (--i_0_ >= 0) {
                        Class262_Sub16.method3196(i >> 16, aByteArray11058, i_2_, (byte) -24, i_4_ >> 16);
                        i_2_ += anInt11057;
                        i += i_6_;
                        i_4_ += i_8_;
                    }
                ...
                if ((~i_7_) >= (~i_6_)) {
                    ...
                    while ((~--i_0_) <= -1) {
                        Class262_Sub16.method3196(i_4_ >> 16, aByteArray11058, i_2_, (byte) -24, i_1_ >> 16);
                        i_1_ += i_7_;
                        i_2_ += anInt11057;
                        i_4_ += i_6_;
                    }
                    ...
                    i_2_ = anInt11057 * i_2_;
                    while (--i_0_ >= 0) {
                        Class262_Sub16.method3196(i_1_ >> 16, aByteArray11058, i_2_, (byte) -24, i_4_ >> 16);
                        i_4_ += i_6_;
                        i_2_ += anInt11057;
                        i_1_ += i_7_;
                    }
    ...
    final boolean method2373(int i, int i_18_, int i_19_) {
        ...
        return (~(i * i_19_)) >= (~aByteArray11058.length);
    }
    ...
    final void method2374(int i) {
        ...
        while ((~i_20_) > (~(-1 + aByteArray11058.length)))
            aByteArray11058[++i_20_] = (byte) 0;
    }
}
