...
public class Class239 {
    ...
    static void method3022(boolean bool) {
        if (bool != false) {
            aClass302_2931 = null;
        }
        Class229.aGraphicsToolkit2732.L(Class138.anInt1726, (~Class213.aNode_Sub27_2512.aClass320_Sub16_7316.method3744(bool)) == -2 ? Node_Sub12.anInt5455 + 256 << 2 : -1, 0);
        anInt2920++;
    }
    ...
    final Class364 method3026(int i, int i_1_) {
        ...
        Class364 class364;
        synchronized (aClass61_2919) {
            class364 = (Class364) aClass61_2919.method607((long) i_1_, 0);
        }
        if (class364 != null) {
            return class364;
        }
