...
public class Node_Sub28 extends Node {
    ...
    static void method2701(int i, int i_0_, Class302 class302, int i_1_, boolean bool, int i_2_, long l, byte b) {
    ...
    static void method2703(boolean bool, long l) {
        anInt7333++;
        int i = Class234.anInt2792;
        if ((~Mobile_Sub4.anInt10987) != (~i)) {
