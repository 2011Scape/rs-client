...
abstract class Class134 implements Interface13 {
    ...
    static boolean method1567(char c, int i) {
        anInt5316++;
        if (i != 4493) {
    ...
    static Class210 method1568(String string, GLToolkit gltoolkit, int i, int i_0_) {
        anInt5298++;
    ...
    static boolean method1574(boolean bool, int i) {
        anInt5300++;
    ...
    private void method1576(int i, int i_26_) {
        anInt5302++;
    ...
    final void method1577(int i, int i_27_, int i_28_, byte[] bs, int i_29_) {
        ...
        if ((~i) < -1 && !Class371.method4094(i, false)) {
            throw new IllegalArgumentException("");
        }
    ...
    final void method1578(float[] fs, int i, int i_46_, boolean bool, int i_47_) {
        ...
        if ((~i_46_) < -1 && !Class371.method4094(i_46_, false)) {
            throw new IllegalArgumentException("");
        }
