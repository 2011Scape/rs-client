...
class Class230 implements Interface10 {
    ...
    static void method2127(byte b, String string) {
        anInt5216++;
        System.exit(1);
        if (b != 7) {
            anInt5209 = -94;
    ...
    static boolean method2128(int i, int i_0_, byte b, int i_1_, int i_2_, int i_3_) {
        anInt5218++;
        for (int i_4_ = i_1_; i_4_ <= i; i_4_++) {
            for (int i_5_ = i_2_; i_5_ <= i_0_; i_5_++) {
                if (Node_Sub38_Sub16.anIntArrayArray10269[i_4_][i_5_] == i_3_ && (~Class79.anIntArrayArray1070[i_4_][i_5_]) >= -2) {
                    return true;
                }
            }
        }
    ...
    static Node_Sub9_Sub1 method2129(byte b) {
        if (b > -60) {
            anInt5209 = -61;
        }
        anInt5215++;
