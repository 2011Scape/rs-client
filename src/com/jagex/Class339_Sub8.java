...
public class Class339_Sub8 extends Class339 {
    ...
    static void method3944(int i, int i_0_) {
        if (i != 12000) {
            method3946(24, -117, -69, null, true, 121);
        }
        anInt8740++;
        CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(i ^ 0x2ee3, 3, (long) i_0_);
        cachenode_sub2.method2291((byte) 121);
    }

    static int method3945(boolean bool, int i) {
        anInt8734++;
        int i_1_;
        if (i > 12000) {
            i_1_ = 4;
    ...
    static void method3946(int i, int i_3_, int i_4_, Class302 class302, boolean bool, int i_5_) {
        anInt8732++;
        if (i_5_ != 23732) {
            anInt8739 = 44;
        }
    ...
    final void method3919(int i, int i_6_, int i_7_) {
        anInt8738++;
        if (i != -13437) {
            method3944(-109, 50);
        }
