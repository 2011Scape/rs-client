...
public class Class50 {
    ...
    static void method511(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
        if ((~i) <= (~i_0_)) {
    ...
    static void method512(int i, int i_6_, String string, GraphicsToolkit graphicstoolkit, byte b, int i_7_, int i_8_, int i_9_) {
    ...
    static void method513(String string, byte b) {
        anInt772++;
        if (b > -14) {
            aClass211Array782 = null;
        }
