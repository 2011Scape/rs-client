...
public class Node_Sub38_Sub19 extends Node_Sub38 {
    ...
    static void method2847(int i, CacheNode cachenode, CacheNode cachenode_0_) {
        anInt10293++;
    ...
    static boolean method2849(int i, int i_1_, Class261[][][] class261s, int i_2_, int i_3_, boolean bool) {
        anInt10285++;
        int i_4_ = 82 / ((i - 38) / 54);
        byte b = !bool ? (byte) (Class110.anInt1412 & 0xff) : (byte) 1;
        if ((~Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.anInt11089][i_3_][i_1_]) == (~b)) {
            return false;
        }
        ...
        while ((~i_6_) != (~i_5_)) {
            ...
            if ((~(CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.anInt11089][i_7_][i_10_] & 0x4)) == -1) {
                bool_12_ = true;
            }
                    ...
                    if (class261s[i_14_] != null && (CacheNode_Sub11.aByteArrayArrayArray9550[i_14_][i_7_][i_10_] & 0x8) == 0) {
                        if (bool_12_ && class261s[i_14_][i_7_][i_10_] != null) {
                            if (class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3314 != null) {
                                ...
                                if ((~class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3314.aShort9110) == (~i_15_) || class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308 != null && i_15_ == class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308.aShort9110) {
                                    continue;
                                }
                                if ((~i_9_) != -1) {
                                    int i_16_ = Class130.method1559(-124, i_9_);
                                    if (class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3314.aShort9110 == i_16_ || class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308 != null && (~i_16_) == (~class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308.aShort9110)) {
                                        continue;
                                    }
                                }
                                if (i_11_ != 0) {
                                    int i_17_ = Class130.method1559(-125, i_11_);
                                    if (class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3314.aShort9110 == i_17_ || class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308 != null && (~class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308.aShort9110) == (~i_17_)) {
                                        continue;
                                    }
                                }
                            }
                            ...
                            if (class261.aClass256_3312 != null) {
                                for (Class256 class256 = class261.aClass256_3312; class256 != null; class256 = class256.aClass256_3238) {
                                    ...
                                    if (mobile instanceof Interface19) {
                                        ...
                                        if ((~i_20_) == (~i_8_) || i_9_ != 0 && i_9_ == i_20_ || (~i_11_) != -1 && (~i_20_) == (~i_11_)) {
                                            continue while_186_;
                                        }
                                    }
                                }
                        ...
                        if (class261 != null && class261.aClass256_3312 != null) {
                            for (Class256 class256 = class261.aClass256_3312; class256 != null; class256 = class256.aClass256_3238) {
                                ...
                                if (mobile.aShort9130 != mobile.aShort9119 || mobile.aShort9120 != mobile.aShort9124) {
                                    for (int i_21_ = mobile.aShort9119; (~i_21_) >= (~mobile.aShort9130); i_21_++) {
                                        for (int i_22_ = mobile.aShort9120; (~i_22_) >= (~mobile.aShort9124); i_22_++)
            ...
            if (bool_13_) {
                ...
                if ((~Class259.anIntArray3296[i_2_]) > (~i_23_)) {
                    Class259.anIntArray3296[i_2_] = i_23_;
                }
                int i_24_ = i_7_ << 9;
                int i_25_ = i_10_ << 9;
                if (Class6.anIntArray135[i_2_] <= i_24_) {
                    if ((~Class246.anIntArray3107[i_2_]) > (~i_24_)) {
                ...
                } else if ((~i_25_) < (~Class84.anIntArray1147[i_2_])) {
                    Class84.anIntArray1147[i_2_] = i_25_;
                }
            }
            if (!bool_12_) {
                if ((~i_7_) <= -2 && b != Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.anInt11089][-1 + i_7_][i_10_]) {
                ...
                if (++i_10_ < Class377_Sub1.anInt8774) {
                    if ((-i_7_) <= -1 && (~b) != (~Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.anInt11089][-1 + i_7_][i_10_]) && (~(CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.anInt11089][i_7_][i_10_] & 0x4)) == -1 && (~(CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.anInt11089][i_7_ + -1][-1 + i_10_] & 0x4)) == -1) {
                ...
                if (--i_10_ >= 0) {
                    if (i_7_ - 1 >= 0 && (~Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.anInt11089][i_7_ - 1][i_10_]) != (~b) && (~(0x4 & CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.anInt11089][i_7_][i_10_])) == -1 && (CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.anInt11089][-1 + i_7_][i_10_ + 1] & 0x4) == 0) {
                    ...
                    if ((~Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.anInt11089][i_7_][i_10_]) != (~b)) {
        ...
        if ((~Class259.anIntArray3296[i_2_]) != 999999) {
    ...
    static void method2850(int i, int i_26_, int i_27_, boolean bool, int i_28_) {
    ...
    static void method2851(int i, int i_48_, int i_49_, byte b, int i_50_, int i_51_) {
        anInt10294++;
    ...
    final int[][] method2778(int i, boolean bool) {
        ...
        if (aClass348_7454.aBoolean4300) {
            ...
            int[] is_35_ = is[1];
            int[] is_36_ = is[2];
            for (int i_37_ = 0; (~i_37_) > (~Class339_Sub7.anInt8728); i_37_++) {
