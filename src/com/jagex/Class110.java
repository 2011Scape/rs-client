...
public class Class110 {
    ...
    static void method1129(byte b, int i) {
        if (b <= 62) {
    ...
    static void method1131(int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_) {
        anInt1381++;
        if ((~i_7_) <= -1 && (~i_4_) <= -1 && -1 + Node_Sub54.anInt7675 > i_7_ && (-Class377_Sub1.anInt8774) < (~i_4_)) {
            ...
            if ((~i_10_) == -1) {
                ...
                if (interface19 != null && i_5_ != 2) {
                    if (!(interface19 instanceof Animable_Sub2_Sub1)) {
                        Class128.method1544(i_4_, i_5_, i_8_, i_7_, i_6_, i_10_, i, 58, interface19.method72(-32136));
                    } else {
    ...
    static void method1132(int i, boolean bool, boolean bool_13_) {
        if (i == 0) {
            anInt1388++;
            if (bool_13_) {
                Class233.anInt2783++;
    ...
    static Class110[] method1133(byte b) {
        anInt1386++;
        int i = 87 % ((b - 5) / 47);
    ...
    static boolean method1135(int i, int i_18_, boolean bool) {
        anInt1380++;
