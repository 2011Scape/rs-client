...
class Class277 {
    ...
    static void method3344(int i, boolean bool, int i_135_) {
        if (i != 1420162185) {
            method3342(true);
        }
        anInt3529++;
    ...
    final void method3337(Buffer buffer, int i, Class84[] class84s, int i_0_, byte b, int i_1_, int i_2_) {
        if (!aBoolean3516) {
            for (int i_3_ = 0; (~i_3_) > -5; i_3_++) {
                ...
                for (int i_4_ = 0; (~i_4_) > -65; i_4_++) {
                    for (int i_5_ = 0; i_5_ < 64; i_5_++) {
                        int i_6_ = i_4_ + i_2_;
                        int i_7_ = i_5_ + i;
                        if (i_6_ >= 0 && (~anInt3524) < (~i_6_) && i_7_ >= 0 && i_7_ < anInt3521) {
        ...
        int i_8_ = i_2_ + i_1_;
        int i_9_ = i_0_ + i;
        for (int i_10_ = 0; (~i_10_) > (~anInt3535); i_10_++) {
            for (int i_11_ = 0; i_11_ < 64; i_11_++) {
                for (int i_12_ = 0; (~i_12_) > -65; i_12_++)
    ...
    final void method3339(int i, int[][][] is, GraphicsToolkit graphicstoolkit, Class84[] class84s) {
        if (!aBoolean3516) {
            for (int i_18_ = 0; (~i_18_) > -5; i_18_++) {
                for (int i_19_ = 0; (~i_19_) > (~anInt3524); i_19_++) {
                    for (int i_20_ = 0; (~i_20_) > (~anInt3521); i_20_++) {
                        if ((~(0x1 & CacheNode_Sub11.aByteArrayArrayArray9550[i_18_][i_19_][i_20_])) != -1) {
                            int i_21_ = i_18_;
        ...
        anInt3519++;
        if (i == -2) {
            for (int i_22_ = 0; (~anInt3535) < (~i_22_); i_22_++) {
                int i_23_ = 0;
                int i_24_ = 0;
                if (!aBoolean3516) {
    ...
    private void method3340(int i, byte b, GraphicsToolkit graphicstoolkit, int[][] is, Plane plane, Plane plane_26_, Plane plane_27_) {
        for (int i_28_ = 0; (~anInt3524) < (~i_28_); i_28_++) {
            for (int i_29_ = 0; i_29_ < anInt3521; i_29_++) {
                if (Class256.anInt3237 == -1 || Class369.method4085(i_29_, 0, Class256.anInt3237, i_28_, i)) {
                    ...
                    if (class289 != null && (~class289.anInt3631) == 0 && (~class289.anInt3629) == 0) {
                    ...
                    if (class289 != null || class236 != null) {
                        ...
                        if (bool && (~i) < -2 || !bool && i > 0) {
                            boolean bool_71_ = true;
                            if (class236 != null && !class236.aBoolean2892) {
                                bool_71_ = false;
                            } else if ((~i_33_) != -1 || b_30_ == 0) {
                                if ((~i_32_) < -1 && class289_34_ != null && !class289_34_.aBoolean3636) {
                                    bool_71_ = false;
                                }
                            } else {
                                bool_71_ = false;
                            }
                            if (bool_71_ && (~i_68_) == (~i_67_) && (~i_69_) == (~i_67_) && i_67_ == i_70_) {
    ...
    private void method3341(int i, Class289 class289, byte[][] bs, int i_75_, int i_76_, int i_77_, int i_78_, int i_79_, GraphicsToolkit graphicstoolkit, int i_80_, boolean[] bools, Class236 class236, byte[][] bs_81_, byte[][] bs_82_) {
        anInt3533++;
        ...
        if (i_80_ > 0) {
            if (i_77_ > 0) {
                ...
                if ((~i_84_) < -1) {
                    ...
                    if ((~class289_85_.anInt3631) != 0 && class289_85_.aBoolean3643) {
            ...
            if (-1 + i_75_ > i_77_) {
                ...
                if ((~i_88_) < -1) {
                    ...
                    if ((~class289_89_.anInt3631) != 0 && class289_89_.aBoolean3643) {
        ...
        if (class289 != null) {
            ...
            if (class289.aBoolean3643) {
                for (int i_129_ = 0; (~i_129_) > -9; i_129_++) {
                    ...
                    if (GLPlane.aBooleanArrayArray7950[i][i_129_] && (~class289.anInt3633) <= (~Class327.anIntArray5348[i_130_])) {
    ...
    final void method3343(int[][] is, byte b, int i) {
        ...
        for (int i_133_ = 0; 1 + anInt3524 > i_133_; i_133_++) {
            for (int i_134_ = 0; (~i_134_) > (~(1 + anInt3521)); i_134_++)
                is_132_[i_133_][i_134_] += is[i_133_][i_134_];
        }
    }

    private void method3345(int i, int i_136_, int i_137_, int i_138_, int i_139_, Buffer buffer, int i_140_, int i_141_, int i_142_, int i_143_, boolean bool) {
        if (i == 1) {
            i_137_ = 1;
        } else if (i != 2) {
            if (i == 3) {
        ...
        anInt3515++;
        if (i_138_ < 0 || (~anInt3524) >= (~i_138_) || i_136_ < 0 || i_136_ >= anInt3521) {
            for (; ; ) {
    ...
    final void method3346(byte b, GraphicsToolkit graphicstoolkit, Plane plane, Plane plane_147_) {
        ...
        if (b == 75) {
            ...
            for (int i = 0; (~anInt3535) < (~i); i++) {
                ...
                for (int i_149_ = -5; (~anInt3524) < (~i_149_); i_149_++) {
                    for (int i_150_ = 0; (~anInt3521) < (~i_150_); i_150_++) {
                        int i_151_ = i_149_ + 5;
                        if (i_151_ < anInt3524) {
                ...
                if (!Class382.aBoolean5254) {
                    method3340(i, (byte) -78, graphicstoolkit, is, i == 0 ? plane_147_ : null, Class320_Sub10.aPlaneArray8300[i], (~i) == -1 ? plane : null);
                } else {
                    method3348((~i) == -1 ? plane_147_ : null, false, is, (~i) != -1 ? null : plane, Class320_Sub10.aPlaneArray8300[i], graphicstoolkit, i);
                }
    ...
    final void method3347(int i, int i_163_, int i_164_, int i_165_, int i_166_, int i_167_) {
        ...
        for (int i_168_ = i_164_; (~i_168_) > (~(i_163_ + i_164_)); i_168_++) {
            for (int i_169_ = i_165_; i_165_ + i_167_ > i_169_; i_169_++) {
                if (i_169_ >= 0 && (~anInt3524) < (~i_169_) && i_168_ >= 0 && i_168_ < anInt3521) {
                    anIntArrayArrayArray3520[i_166_][i_169_][i_168_] = (~i_166_) >= -1 ? 0 : anIntArrayArrayArray3520[i_166_ - 1][i_169_][i_168_] - 960;
                }
            }
        }
        if (i_165_ > 0 && (~i_165_) > (~anInt3524)) {
        ...
        if ((~i_165_) <= -1 && (~i_164_) <= -1 && (~anInt3524) < (~i_165_) && (~anInt3521) < (~i_164_)) {
            if ((~i_166_) == -1) {
                if ((~i_165_) < -1 && (~anIntArrayArrayArray3520[i_166_][i_165_ + -1][i_164_]) != -1) {
                    ...
                    if (i_165_ > 0 && i_164_ > 0 && (~anIntArrayArrayArray3520[i_166_][-1 + i_165_][-1 + i_164_]) != -1) {
            ...
            } else if ((~i_165_) >= -1 || anIntArrayArrayArray3520[i_166_][i_165_ - 1][i_164_] == anIntArrayArrayArray3520[i_166_ - 1][i_165_ - 1][i_164_]) {
                if (i_164_ <= 0 || anIntArrayArrayArray3520[i_166_][i_165_][i_164_ - 1] == anIntArrayArrayArray3520[i_166_ - 1][i_165_][-1 + i_164_]) {
                    if (i_165_ > 0 && i_164_ > 0 && (~anIntArrayArrayArray3520[-1 + i_166_][i_165_ - 1][-1 + i_164_]) != (~anIntArrayArrayArray3520[i_166_][i_165_ + -1][-1 + i_164_])) {
    ...
    private void method3348(Plane plane, boolean bool, int[][] is, Plane plane_172_, Plane plane_173_, GraphicsToolkit graphicstoolkit, int i) {
        anInt3531++;
            ...
            for (int i_179_ = 0; i_179_ < anInt3521; i_179_++) {
                ...
                if (Class256.anInt3237 == -1 || Class369.method4085(i_179_, 0, Class256.anInt3237, i_177_, i)) {
                    ...
                    if (i_184_ != 0 || i_185_ != 0) {
                        Class289 class289 = (~i_184_) == -1 ? null : aClass71_3512.method743(-1 + i_184_, (byte) 118);
                        ...
                        if (class289 != null) {
                            if ((~class289.anInt3631) != 0 || class289.anInt3629 != -1) {
                                if (class236 != null && (~b) != -1) {
                        ...
                        if (((~b) == -1 || b == 12) && (~i_177_) < -1 && i_179_ > 0 && i_177_ < anInt3524 && anInt3521 > i_179_) {
                            int i_190_ = 0;
                            int i_191_ = 0;
                            int i_192_ = 0;
                            ...
                            int i_193_ = 0;
                            if ((~bs_175_[i_177_][i_179_ + -1]) != (~i_185_)) {
                                i_191_--;
                                i_190_--;
                            } else {
                                i_191_++;
                        ...
                        boolean bool_198_ = class289 != null && (~class289.anInt3631) != (~class289.anInt3629);
                        if (!bool_198_) {
                        ...
                        if ((~i_207_) >= -1) {
                            ...
                            if (class289 == null) {
                                ...
                                for (int i_223_ = 0; i_223_ < i_204_; i_223_++) {
                                    ...
                                    int i_225_;
                                    if (!bools[-i_183_ & 0x3] || (~is_201_[0]) != (~i_208_)) {
                                        if (!bools[0x3 & 2 - i_183_] || (~is_201_[2]) != (~i_208_)) {
                                            if (!bools[1 - i_183_ & 0x3] || (~is_201_[1]) != (~i_208_)) {
                                                if (bools[3 - i_183_ & 0x3] && (~is_201_[3]) == (~i_208_)) {
                                ...
                                if ((~b) != -13 && (~class289.anInt3631) != 0 && class289.aBoolean3638) {
                                    bool_181_ = true;
                                }
                            }
                            if (class236 != null) {
                                ...
                                for (int i_243_ = 0; (~i_202_) < (~i_243_); i_243_++) {
                                    ...
                                    if (bools[0x3 & -i_183_] && is_201_[0] == i_208_) {
                                        ...
                                        if (!bools[-i_183_ + 3 & 0x3] || (~is_201_[3]) != (~i_208_)) {
                                            Node_Sub38_Sub26.anIntArray10370[0] = is_205_[i_208_];
                                            Node_Sub38_Sub26.anIntArray10370[1] = is_206_[i_208_];
                                            i_245_ = 3;
                                            Node_Sub38_Sub26.anIntArray10370[2] = is_203_[i_208_];
                            ...
                            if (bool_265_ && (~i) < -2 || !bool_265_ && i > 0) {
                                boolean bool_266_ = true;
                                if (class236 == null || class236.aBoolean2892) {
                                    if (i_185_ == 0 && b != 0) {
                                        bool_266_ = false;
                                    } else if ((~i_184_) < -1 && class289_189_ != null && !class289_189_.aBoolean3636) {
                                        bool_266_ = false;
                                    }
                                } else {
                                    bool_266_ = false;
                                }
                                if (bool_266_ && i_262_ == i_261_ && i_263_ == i_261_ && (~i_261_) == (~i_264_)) {
        ...
        if (!aBoolean3516) {
            ...
            for (int i_278_ = 0; i_278_ < 8; i_278_++) {
                for (int i_279_ = 0; i_279_ < 8; i_279_++) {
                    ...
                    if ((~i_280_) < -1 && (~(anInt3524 + -1)) < (~i_280_) && i_281_ > 0 && (~i_281_) > (-anInt3521)) {
