...
public class Class143 {
    ...
    static int[] method1622(int i, int i_0_, boolean bool, int i_1_, int i_2_, int i_3_, float f, int i_4_) {
        anInt1770++;
        int[] is = new int[i_2_];
    ...
    static void method1623(int i, int i_5_, int i_6_, int i_7_, int i_8_) {
        anInt1780++;
        int i_9_ = 0;
        if (i_6_ == -957563775) {
            int i_10_ = i_7_;
    ...
    final boolean method1625(int i, Class143 class143_19_) {
        ...
        return class143_19_.anInt1767 == anInt1767 && class143_19_.anInt1776 == anInt1776 && (~class143_19_.anInt1769) == (~anInt1769);
    }
}
