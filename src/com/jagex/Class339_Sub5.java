...
public class Class339_Sub5 extends Class339 {
    ...
    private final Class301 aClass301_8688;
    private final Class25 aClass25_8692;
    ...
    static boolean method3935(int i, Packet packet, int i_0_) {
        if (i_0_ != 28460) {
    ...
    static boolean method3937(byte b, int i, int i_33_) {
        anInt8686++;
        if (b != -97) {
            return false;
        }
        return (0x800 & i_33_) != 0 | Class294.method3466(i_33_, b + 96, i) || Node_Sub41.method2932(b ^ 0x5, i_33_, i);
    }
    ...
    final void method3919(int i, int i_28_, int i_29_) {
        ...
        float f_31_ = (~(i_29_ & 0x40)) == -1 ? 4.8828125E-4F : 9.765625E-4F;
        boolean bool = (~(0x80 & i_29_)) != -1;
