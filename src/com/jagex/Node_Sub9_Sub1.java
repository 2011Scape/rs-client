...
public class Node_Sub9_Sub1 extends Node_Sub9 {
    ...
    static Class205 method2458(Buffer buffer, int i) {
        anInt9630++;
    ...
    private void method2433(int i, long l) {
        if (i == 0) {
            anInt9693++;
            long l_0_;
            for (/**/; aLong9697 <= l; aLong9697 = l_0_) {
                ...
                while (i_2_ == anInt9702) {
                    while ((~aClass27_9666.anIntArray459[i_1_]) == (~i_2_)) {
    ...
    private synchronized void method2434(byte b, boolean bool) {
        anInt9645++;
        aClass27_9666.method319();
        if (b == 87) {
    ...
    private synchronized void method2436(boolean bool, boolean bool_7_, Node_Sub4 node_sub4, int i) {
    ...
    private int method2437(int i, Node_Sub10 node_sub10) {
        anInt9690++;
        ...
        if ((~class240.anInt2938) < -1 && ((~class240.anInt2937) < -1 || (~anIntArray9668[node_sub10.anInt7080]) < -1)) {
    ...
    private void method2440(int i, int i_19_) {
        anInt9633++;
        if ((~(0x4 & anIntArray9680[i_19_])) != -1) {
    ...
    private void method2442(byte b, int i) {
        anInt9691++;
        if (i < 0) {
            for (i = 0; i < 16; i++)
    ...
    private int method2443(Node_Sub10 node_sub10, byte b) {
        anInt9638++;
        if ((~anIntArray9631[node_sub10.anInt7080]) == -1) {
            return 0;
        }
        Class240 class240 = node_sub10.aClass240_7094;
    ...
    final boolean method2444(Node_Sub10 node_sub10, byte b) {
        ...
        if (node_sub10.aNode_Sub9_Sub2_7095 == null) {
            if (node_sub10.anInt7100 >= 0) {
                ...
                if ((~node_sub10.anInt7093) < -1 && aNode_Sub10ArrayArray9683[node_sub10.anInt7080][node_sub10.anInt7093] == node_sub10) {
    ...
    private int method2446(int i, Node_Sub10 node_sub10) {
        anInt9651++;
    ...
    private void method2447(int i, int i_44_) {
        anInt9678++;
        int i_45_ = 0xf0 & i;
        if (i_45_ == 128) {
            int i_46_ = 0xf & i;
    ...
    private void method2451(int i, int i_69_, byte b) {
        if (b <= 33) {
            aClass27_9666 = null;
        }
    ...
    private void method2453(int i, int i_72_) {
        if (i != 15) {
            aClass27_9666 = null;
        }
    ...
    private void method2455(byte b) {
        anInt9649++;
        int i = anInt9700;
        int i_73_ = anInt9702;
        long l = aLong9697;
        if (aNode_Sub4_9705 != null && (~anInt9703) == (~i_73_)) {
            method2436(aBoolean9699, aBoolean9704, aNode_Sub4_9705, 18429);
            method2455((byte) -98);
        } else {
            while ((~anInt9702) == (~i_73_)) {
            ...
            aLong9697 = l;
            anInt9702 = i_73_;
            if (aNode_Sub4_9705 != null && (~i_73_) < (~anInt9703)) {
                anInt9702 = anInt9703;
                anInt9700 = -1;
                aLong9697 = aClass27_9666.method316(anInt9702);
            }
    ...
    private void method2459(int i, int i_83_, int i_84_, boolean bool) {
        ...
        if (node_sub6 != null) {
            ...
            if (node_sub45_sub1 != null) {
                ...
                if (anIntArray9659[i] == 0) {
                    ...
                    method2466((~node_sub6.aShortArray7044[i_83_]) > -1, node_sub10, -26045);
                }
    ...
    private void method2460(int i, int i_87_, int i_88_) {
        if (i_87_ != -5807) {
            anInt9700 = -101;
        }
        anInt9673++;
    ...
    private void method2461(int i, int i_89_) {
    ...
    private void method2462(int i, int i_90_, int i_91_, int i_92_) {
        if (i_92_ < 57) {
            method2429();
        }
        anInt9635++;
    ...
    private void method2463(int i, boolean bool, int i_93_) {
    ...
    private void method2464(byte b, int i) {
        anInt9665++;
        int i_94_ = 49 % ((-31 - b) / 43);
        if ((~(0x2 & anIntArray9680[i])) != -1) {
    ...
    private void method2465(int i, boolean bool) {
        if (!bool) {
            method2461(15025, -1);
        } else {
            method2453(15, -1);
    ...
    final boolean method2468(Node_Sub10 node_sub10, int i, int[] is, int i_106_, int i_107_) {
        ...
        if ((~node_sub10.anInt7100) <= -1 && (node_sub10.aNode_Sub9_Sub2_7095 == null || node_sub10.aNode_Sub9_Sub2_7095.method2474())) {
        ...
        if ((~node_sub10.anInt7100) <= -1 && class240.aByteArray2942 != null && (anIntArray9680[node_sub10.anInt7080] & 0x1) == 0 && ((~node_sub10.anInt7093) > -1 || node_sub10 != aNode_Sub10ArrayArray9683[node_sub10.anInt7080][node_sub10.anInt7093])) {
            ...
            for (/**/; -2 + class240.aByteArray2942.length > node_sub10.anInt7090; node_sub10.anInt7090 += 2) {
                if ((~node_sub10.anInt7100) >= (~((class240.aByteArray2942[node_sub10.anInt7090 + 2] & 0xff) << 8))) {
                    break;
                }
            }
            if (class240.aByteArray2942.length - 2 == node_sub10.anInt7090) {
    ...
    private void method2469(int i, int i_109_, int i_110_) {
        if (i_110_ == 8383743) {
            anInt9669++;
        }
    }

    private void method2470(int i, int i_111_, byte b) {
        if ((~anIntArray9675[i]) != (~i_111_)) {
