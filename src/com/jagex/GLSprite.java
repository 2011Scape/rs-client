...
abstract class GLSprite implements Interface4 {
    ...
    private void method1182(float f, float f_28_, float f_29_, float f_30_, int i, int i_31_, int i_32_, int i_33_, int i_34_) {
        if (i != 0) {
    ...
    private void method1185(float f, float f_56_, float f_57_, float f_58_, float f_59_, float f_60_, aa var_aa, int i, int i_61_) {
    ...
    private void method1198(float f, float f_95_, float f_96_, float f_97_, float f_98_, float f_99_, int i, int i_100_, int i_101_) {
