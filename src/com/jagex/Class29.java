...
public class Class29 {
    ...
    private void method334(boolean bool, GLToolkit gltoolkit) {
        anInt471++;
    ...
    private void method336(byte b, GLToolkit gltoolkit, int i) {
        anInt472++;
        ...
        if (!gltoolkit.aBoolean6736) {
            for (int i_14_ = i - 1; i_14_ >= 0; i_14_--) {
                ...
                if (i_15_ > 0) {
                    ...
                    if ((~anIntArray488[i_14_]) < -65) {
                        int i_26_ = -1 + (-64 + anIntArray488[i_14_]);
                        for (int i_27_ = anIntArray490[i_26_] - 1; (~i_27_) <= -1; i_27_--) {
            ...
            for (int i_37_ = i - 1; i_37_ >= 0; i_37_--) {
                int i_38_ = (~anIntArray488[i_37_]) < -65 ? 64 : anIntArray488[i_37_];
                if ((~i_38_) < -1) {
                    ...
                    if ((~anIntArray488[i_37_]) < -65) {
                        int i_49_ = -1 + (-64 + anIntArray488[i_37_]);
                        for (int i_50_ = anIntArray490[i_49_] - 1; (~i_50_) <= -1; i_50_--) {
        ...
        if ((~aFloatBuffer476.anInt7002) != -1) {
    ...
    private void method337(int i, GLToolkit gltoolkit) {
    ...
    private void method338(int i, GLToolkit gltoolkit, int i_60_) {
        anInt481++;
        Node_Sub37.aFloat7446 = gltoolkit.aFloat6737;
