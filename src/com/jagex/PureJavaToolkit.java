...
public class PureJavaToolkit extends GraphicsToolkit {
    ...
    private void method1490(int i, int i_71_, int i_72_, int i_73_, int i_74_, int i_75_, int i_76_, int i_77_) {
    ...
    private void method1491(EntityNode_Sub3_Sub2 entitynode_sub3_sub2, int i, int i_108_, int i_109_, int i_110_) {
    ...
    private void method1497(int i, int i_316_, int i_317_, int i_318_, int i_319_, int i_320_) {
        if (i_318_ < 0) {
            i_318_ = -i_318_;
        }
    ...
    final GLSprite a(Class383 class383, boolean bool) {
        ...
        if (bool && class383.aByteArray4905 == null) {
            ...
            for (int i_420_ = 0; i_420_ < i_417_; i_420_++) {
                int i_421_ = i_420_ * i;
                if (i >= 0) System.arraycopy(bs, i_421_ + 0, bs_419_, i_421_ + 0, i);
            }
            System.arraycopy(is, 0, is_418_, 0, is.length);
    ...
    private void method1501(int i, int i_491_, int i_492_, int i_493_, int i_494_, int i_495_, int i_496_, int i_497_) {
