...
public class Class93_Sub1 extends Class93 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    private void method1052(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
    ...
    private void method1053(boolean bool, int i, int i_4_) {
        anInt6039 = i_4_;
        if (bool) {
            method1038((byte) 17);
        }
    ...
    private void method1054(int i, Component component) {
        if (i == -30273) {
            method1056(-89);
    ...
    private int method1055(MouseEvent mouseevent, byte b) {
