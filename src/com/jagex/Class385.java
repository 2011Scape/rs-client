...
public class Class385 {
    ...
    static void method4204(GraphicsToolkit graphicstoolkit, int i, byte b) {
        anInt4909++;
        if (!Class12.aBoolean194 || !Mobile_Sub1.aBoolean10959) {
            ...
            if ((~Class144_Sub1.anInt6806) != (~((int) ((float) FileOnDisk.anIntArray1329[0] / 3.0F))) || (~((int) ((float) FileOnDisk.anIntArray1329[1] / 3.0F))) != (~Class331.anInt4130)) {
            ...
            if ((~Class320_Sub21.anInt8406) < -1) {
                ...
                for (int i_6_ = 0; (~Class320_Sub21.anInt8406) < (~i_6_); i_6_++) {
    ...
    static void method4205(boolean bool, double d) {
        if (bool != false) {
            aClass94_4911 = null;
        }
        anInt4910++;
        if (GLSprite_Sub1.aDouble8857 != d) {
            for (int i = 0; (~i) > -257; i++) {
                ...
                Class323.anIntArray4084[i] = (~i_7_) < -256 ? 255 : i_7_;
            }
