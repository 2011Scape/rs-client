...
public class D3DToolkit extends AbstractToolkit {
    ...
    private static int method1385(Class94 class94, boolean bool) {
    ...
    private static boolean method1387(D3DPRESENT_PARAMETERS d3dpresent_parameters, int i, IDirect3D idirect3d, int k, int l, int i1) {
        int j1;
        int k1;
        int l1;
        j1 = 0;
    ...
    private static int method1388(int i, Class228 class228) {
    ...
    static GraphicsToolkit createToolkit(java.awt.Canvas canvas, d var_d, Class302 class302, Integer integer) {
    ...
    private static int method1390(Class135 class135, byte b) {
        if (b != -86) {
            return 50;
        }
    ...
    private static int method1391(int i, Class346 class346) {
    ...
    private static int method1393(int i, Class104 class104) {
    ...
    static int method1396(Class372 class372, Class68 class68, int i) {
        if (i > -23) {
            return 83;
        }
    ...
    final void method1308(byte b) {
        anIDirect3DDevice9199.a(28, aBoolean6338 && aBoolean6299 && -1 >= (~anInt6355));
        if (b < 74) {
    ...
    private boolean method1389(byte b) {
