...
public class Class76 {
    ...
    static void method767(boolean bool, CacheNode cachenode, CacheNode cachenode_0_) {
    ...
    static void method769(Actor actor, boolean bool) {
        anInt1012++;
    ...
    static void method770(int i, int i_12_, int i_13_) {
        anInt1014++;
        if (i < 113) {
    ...
    static Widget method771(byte b, int i) {
        if (b != 107) {
