...
public class Class380 {
    ...
    static Class150_Sub3 method4169(byte b, Buffer buffer) {
        anInt4884++;
    ...
    static void method4170(String string, int i, String string_30_, int i_31_, boolean bool) {
    ...
    private void method4168(byte b) {
        anInt4874++;
        int i = 0;
        int i_13_ = 0;
        for (/**/; (~i) > -9; i++) {
        ...
        for (int i_15_ = 1; (~i_15_) >= -11; i_15_++) {
            ...
            System.arraycopy(aLongArray4888, 0, aLongArray4882, 0, 8);
