...
public class Class91 {
    ...
    static void method1032(int i, Player player, int i_0_, Packet packet, int i_1_) {
        anInt1209++;
        byte b = -1;
        if ((0x8000 & i_1_) != 0) {
        ...
        if ((~(0x2000 & i_1_)) != -1) {
            ...
            player.aBoolean10871 = (~(i_14_ & 0x8000)) != -1;
        ...
        if ((~(0x100000 & i_1_)) != -1) {
            player.aBoolean11135 = (~packet.method2238(true)) == -2;
        }
        if ((~(0x4 & i_1_)) != -1) {
    ...
    static void method1033(int i, int i_46_, int i_47_, int i_48_, int i_49_, int i_50_) {
        anInt1224++;
    ...
    static void method1035(int i) {
        anInt1219++;
        Packet packet = Class218.worldResponseBuffer.aPacket1570;
        while ((~packet.method2264(Class218.worldResponseBuffer.anInt1581, -92)) <= -16) {
    ...
    static int method1036(int i, float f, float f_58_, float f_59_) {
        anInt1208++;
        if (i != 2) {
            method1034((byte) -50);
        }
