...
class Class20 {
    ...
    static CacheNode_Sub11 method269(int i) {
        return (CacheNode_Sub11) aHashTable316.method1518(3512, (long) i);
    }

    static void method270(GraphicsToolkit graphicstoolkit) {
    ...
    private static void method271(GraphicsToolkit graphicstoolkit, int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, short[] ses, byte[] bs, boolean bool) {
    ...
    static void method272(int i, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_, int i_25_, int i_26_) {
        anInt349 = i - anInt354;
    ...
    private static void method273(GraphicsToolkit graphicstoolkit, int i, int i_27_, int i_28_, int i_29_, short[] ses, byte[] bs) {
        if (ses != null) {
    ...
    private static void method274(byte[] bs, byte[] bs_37_, short[] ses, int i, int i_38_) {
    ...
    static void method275(Class302 class302, Class71 class71, Class58 class58, Class112 class112, Class215 class215, Class338 class338, Interface17 interface17) {
    ...
    private static void method276(GraphicsToolkit graphicstoolkit, int i, int i_64_, int i_65_, int i_66_) {
    ...
    static void method277(d var_d, int i, int i_124_) {
        for (int i_125_ = 0; i_125_ < aClass71_320.anInt956; i_125_++)
            anIntArray342[i_125_ + 1] = method278(var_d, i_125_, i, i_124_);
    }

    private static int method278(d var_d, int i, int i_126_, int i_127_) {
    ...
    static void method281(GraphicsToolkit graphicstoolkit, Node_Sub14 node_sub14, Class79 class79) {
    ...
    static void method282(int i) {
        aCacheNode_Sub11_318 = (CacheNode_Sub11) aHashTable316.method1518(3512, (long) i);
    }

    private static void method283(GraphicsToolkit graphicstoolkit, Node_Sub14 node_sub14, int i, int i_151_, int i_152_, int i_153_) {
    ...
    private static void method284(GraphicsToolkit graphicstoolkit, Buffer buffer, int i, int i_154_, int i_155_, int i_156_, int[] is, int[] is_157_) {
    ...
    static Class158 method286(int i, int i_178_) {
    ...
    static CacheNode_Sub11 method288(int i, int i_179_) {
    ...
    static void method290(GraphicsToolkit graphicstoolkit, int i, int i_180_) {
    ...
    static Class312 method291(GraphicsToolkit graphicstoolkit) {
        int i = anInt341 - anInt349;
    ...
    private static Class312 method292(GraphicsToolkit graphicstoolkit, int i, int i_209_, int i_210_, int i_211_) {
