...
public class Node_Sub38_Sub38 extends Node_Sub38 {
    ...
    static Class169_Sub2_Sub1 method2913(int i, int i_0_, int i_1_, GLToolkit gltoolkit) {
        if (false) {
            return null;
        }
        anInt10487++;
        if (gltoolkit.aBoolean6652 || Class371.method4094(i_0_, false) && Class371.method4094(i, false)) {
            ...
            if (Class243.aClass340_3069 != null) {
                ...
                if (Class235_Sub1.anInterface16Array8978 != null) {
                    for (int i_3_ = Class51_Sub1.anInt9064 + 1; Class235_Sub1.anInterface16Array8978.length > i_3_; i_3_++) {
                        if (Class235_Sub1.anInterface16Array8978[i_3_].method58(27285) >= 100 && Class51_Sub1.anInt9064 == -1 + i_3_ && (~Class151.anInt1843) <= -2 && Class243.aClass340_3069.method3956(-79)) {
                            try {
            ...
            if ((~Class151.anInt1843) == -12) {
                ...
                if (node_sub5 != null || Class38.aLong562 < Class313.method3650(false) - 2000L) {
                    ...
                    for (Node_Sub5 node_sub5_8_ = (Node_Sub5) Node_Sub38_Sub35.aClass312_10452.method3613(65280); node_sub5_8_ != null; node_sub5_8_ = (Node_Sub5) Node_Sub38_Sub35.aClass312_10452.method3620(16776960)) {
                        if (node_sub13 != null && (~(-i_7_ + node_sub13.aPacket7113.anInt7002)) <= -241) {
                            break;
                        }
                        ...
                        if (Class99.anInt1283 != i_10_ || (~i_9_) != (~Class340.anInt4217)) {
                            ...
                            if (i_13_ >= 8 || i_11_ < -32 || i_11_ > 31 || (~i_12_) > 31 || i_12_ > 31) {
                                if (i_13_ < 32 && i_11_ >= -128 && i_11_ <= 127 && i_12_ >= -128 && (~i_12_) >= -128) {
                ...
                if (node_sub5 != null) {
                    ...
                    int i_16_ = 0;
                    if ((~node_sub5.method2267(true)) == -3) {
                        i_16_ = 1;
                    }
                    Animable.anInt5942++;
                    int i_17_ = (int) l;
                ...
                if (Class151.anInt1843 == 11) {
                    ...
                    if ((~Class218.worldResponseBuffer.anInt1578) < -751) {
                        Class262_Sub13.method3182(false);
                    } else {
                        if (aa.anInt101 != 0) {
                            if ((~aa.anInt101) == -2 && Class191.method1944(Class200_Sub2.anInt4935, i ^ 0x38b7)) {
                            ...
                            if (aa.anInt101 == 3) {
                                ...
                                if ((~Class214.aClass262Array2528.length) < (~Class320_Sub19.anInt8385)) {
                                    ...
                                    } while ((~++Class320_Sub19.anInt8385) > (~Class214.aClass262Array2528.length));
                                }
                                if ((~aa.anInt101) == -4) {
                        ...
                        for (int i_22_ = Class24.aClass275_442.method3334(-114, true); (~i_22_) != 0; i_22_ = Class24.aClass275_442.method3334(i ^ ~0x3891, false)) {
                                    ...
                                    if (i_23_ != 3) {
                                        if ((~i_23_) != -5) {
                                            if (i_23_ == 5) {
                                                ...
                                                if ((~widget.anInt4773) != (~cachenode_sub2.anInt9434)) {
                                                ...
                                                if (i_23_ != 7) {
                                                    if ((~i_23_) != -9) {
                                                        if ((~i_23_) == -10) {
                                                            Widget widget = Class76.method771((byte) 107, (int) l);
                                                            if ((~cachenode_sub2.anInt9434) != (~widget.anInt4718) || cachenode_sub2.anInt9432 != widget.anInt4831) {
                                                            ...
                                                            Widget widget = Class76.method771((byte) 107, (int) l);
                                                            if (cachenode_sub2.anInt9434 != widget.anInt4681 || (~widget.anInt4811) != (~cachenode_sub2.anInt9432) || cachenode_sub2.anInt9429 != widget.anInt4682) {
                                                            ...
                                                            if (i_23_ == 12) {
                                                                ...
                                                                if (widget != null && (~widget.anInt4841) == -1) {
                                                                    if ((~i_24_) < (~(widget.anInt4691 - widget.anInt4695))) {
                                                        ...
                                                        Widget widget = Class76.method771((byte) 107, (int) l);
                                                        if ((~cachenode_sub2.anInt9434) != (~widget.anInt4815) || cachenode_sub2.anInt9432 != widget.anInt4821 || (~widget.anInt4787) != (~cachenode_sub2.anInt9429)) {
                        ...
                        for (; ; ) {
                            ...
                            if ((~widget.anInt4687) <= -1) {
                                ...
                                if (widget_36_ == null || widget_36_.aWidgetArray4804 == null || (~widget.anInt4687) <= (~widget_36_.aWidgetArray4804.length) || widget_36_.aWidgetArray4804[widget.anInt4687] != widget) {
                                    continue;
                                }
                            }
                            Class305.method3556(node_sub37);
                        ...
                        for (; ; ) {
                            ...
                            if (widget.anInt4687 >= 0) {
                                ...
                                if (widget_37_ == null || widget_37_.aWidgetArray4804 == null || (~widget_37_.aWidgetArray4804.length) >= (~widget.anInt4687) || widget != widget_37_.aWidgetArray4804[widget.anInt4687]) {
                                    continue;
                                }
                            }
                            Class305.method3556(node_sub37);
                        ...
                        if ((~Class339_Sub7.playerPrivilege) < -1 && Class175.aClass291_2100.method3450(i ^ 0x38a0, 82) && Class175.aClass291_2100.method3450(-71, 81) && (~Class339_Sub8.anInt8739) != -1) {
                        ...
                        if ((~Node_Sub36_Sub1.anInt10040) > 39) {
                            anInt10492 = 1;
                        }
                        if (Class76.anInt1011 > 55) {
                            Class203.anInt2449 = -2;
                        ...
                        if ((~Class218.worldResponseBuffer.anInt1579) < -51) {
                            Class365.anInt4524++;
        ...
        do {
            do {
                if (i_4_ != 0) {
                    ...
                    aBoolean10483 = (~buffer.method2233(255)) == -2;
                    break while_268_;
                }
                aBoolean10486 = (~buffer.method2233(255)) == -2;
                break while_268_;
            } while (false);
