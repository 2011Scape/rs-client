...
public class Class291_Sub1 extends Class291 implements KeyListener, FocusListener {
    ...
    static void method3454(int i, int i_0_, int i_1_, int i_2_) {
        anInt8196++;
    ...
    private void method3456(char c, int i, int i_9_, int i_10_) {
        anInt8190++;
    ...
    private void method3458(byte b, int i, KeyEvent keyevent) {
        anInt8194++;
        int i_13_ = keyevent.getKeyCode();
        if ((~i_13_) != -1) {
            if ((~i_13_) > -1 || (~i_13_) <= (~Node_Sub38_Sub24.anIntArray10352.length)) {
                i_13_ = 0;
            } else {
    ...
    private void method3459(int i, Component component) {
        anInt8192++;
        method3460((byte) -44);
    ...
    private void method3460(byte b) {
        anInt8200++;
