...
public class Class343 {
    ...
    static Class241 method3962(String string, int i, int i_0_, SignLink signlink) {
        if (i > -102) {
            return null;
        }
        anInt4259++;
    ...
    static boolean method3967(int i, int i_13_, int i_14_) {
        if (i_14_ < 10) {
            aShortArray4255 = null;
        }
        anInt4243++;
        if (!((~(0x40000 & i)) != -1 | Class320_Sub7.method3711((byte) 76, i, i_13_)) && !Class110.method1135(i, i_13_, false)) {
            return false;
        }
        return true;
    }
    ...
    final void method3966(Buffer buffer, int i) {
        ...
        if ((~Class213.aNode_Sub27_2512.aClass320_Sub24_7317.method3773(false)) != -2 || Class229.aGraphicsToolkit2732.e() <= 0) {
            if ((~(0x1 & i_6_)) != -1) {
    ...
    final boolean method3968(byte b, Class343 class343_15_) {
        anInt4246++;
        int i = 39 / ((b + 4) / 42);
        if (anInt4253 != class343_15_.anInt4253 || class343_15_.aFloat4254 != aFloat4254 || aFloat4256 != class343_15_.aFloat4256 || aFloat4250 != class343_15_.aFloat4250 || class343_15_.aFloat4239 != aFloat4239 || aFloat4244 != class343_15_.aFloat4244 || aFloat4251 != class343_15_.aFloat4251 || (~anInt4257) != (~class343_15_.anInt4257) || (~class343_15_.anInt4258) != (~anInt4258) || class343_15_.aClass270_4240 != aClass270_4240 || class343_15_.aClass119_4238 != aClass119_4238) {
            return false;
        }
        return true;
    }
