...
public class Class128 {
    ...
    static void method1544(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
        anInt1653++;
        if ((~i_3_) <= -2 && (~i) <= -2 && (~(-2 + Node_Sub54.anInt7675)) <= (~i_3_) && (~(-2 + Class377_Sub1.anInt8774)) <= (~i)) {
            int i_9_ = i_6_;
            if (i_9_ < 3 && Class238.method3021(i, i_3_, 106)) {
                i_9_++;
            }
            if ((~Class213.aNode_Sub27_2512.aClass320_Sub19_7301.method3751(false)) == -1 && !Class369.method4085(i, 0, Class94.anInt1249, i_3_, i_9_) || Class175.aClass261ArrayArrayArray2099 == null) {
                return;
            }
            ...
            if (i_8_ >= 0) {
                ...
                Node_Sub38_Sub1.aClass277_Sub1_10084.method3352(i_1_, i_8_, Class304.aClass84Array3833[i_6_], i, Class93.aGraphicsToolkit1241, i_3_, i_2_, -102, i_9_, i_6_, i_4_);
                Class213.aNode_Sub27_2512.method2690(33, i_10_, Class213.aNode_Sub27_2512.aClass320_Sub6_7267);
            }
        }
        int i_11_ = -67 % ((-91 - i_7_) / 32);
    }
    ...
    static Class262 method1548(Buffer buffer, byte b) {
        anInt1647++;
    ...
    static int method1550(int i, int i_18_, int i_19_) {
        if (i != -13892) {
            return 98;
        }
        anInt1654++;
    ...
    final Class70 method1549(int i, int i_17_) {
        ...
        Class70 class70;
        synchronized (aClass61_1656) {
            class70 = (Class70) aClass61_1656.method607((long) i, 0);
        }
        if (i_17_ != 11) {
            method1549(54, -65);
        }
