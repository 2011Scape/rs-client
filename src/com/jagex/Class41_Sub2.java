...
public class Class41_Sub2 extends Class41 {
    ...
    private Socket method438(byte b, Proxy proxy) throws IOException {
        ...
        if (proxy.type() == Proxy.Type.HTTP) {
            ...
            try {
                ...
                Object object = method.invoke(null, new Object[]{inetsocketaddress.getHostName(), Integer.valueOf(inetsocketaddress.getPort())});
                if (null != object) {
    ...
    private Socket method439(String string, int i, String string_5_) throws IOException {
