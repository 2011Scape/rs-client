...
public class Class261 {
    ...
    static int[][] method3142(boolean bool, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, float f) {
        anInt3307++;
    ...
    static int method3144(boolean bool, int i, int i_7_) {
        anInt3321++;
        if (bool != false) {
            aHashTable3306 = null;
        }
