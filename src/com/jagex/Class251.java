...
public class Class251 {
    ...
    static void method3097(Actor actor, int i) {
        if (actor instanceof Npc) {
            Npc npc = (Npc) actor;
            if (npc.aNpcDefinition11122 != null) {
                Class352.method4013(-16456, (~Class295.aPlayer3692.aByte5933) != (~npc.aByte5933), npc);
            }
    ...
    static int method3098(boolean bool) {
        anInt3184++;
    ...
    static void method3099(byte b, int i, int i_0_, int i_1_, int i_2_, int[] is, int[] is_3_, int i_4_, int i_5_, int[] is_6_, boolean bool, boolean bool_7_, int i_8_, int[] is_9_, byte[][][] bs, int[] is_10_, int i_11_, int i_12_) {
        anInt3183++;
        if (Class320_Sub20.anInt8397 != -1) {
            ...
            if (!Class194_Sub1.aBoolean6892) {
                ...
                if (i_25_ >= 0 && i_26_ >= 0 && (~CacheNode_Sub15.anInt9589) <= (~i_27_) && i_28_ <= Class303.anInt3831 || (~Class320_Sub20.anInt8397) == -3) {
                ...
                } else if ((~i_27_) >= -1 || (~i_28_) >= -1 || CacheNode_Sub15.anInt9589 <= i_25_ || Class303.anInt3831 <= i_26_) {
                    ...
                    for (EntityNode_Sub6 entitynode_sub6 = (EntityNode_Sub6) class103.method1113((byte) 115); entitynode_sub6 != null; entitynode_sub6 = (EntityNode_Sub6) class103.method1108(109)) {
                        ...
                        for (int i_53_ = 0; entitynode_sub5s.length > i_53_; i_53_++) {
                            ...
                            if (bool_52_) {
                                int i_59_ = -i_58_ + ((~i_54_) <= (~i_56_) ? i_56_ : i_54_);
                                if ((~CacheNode_Sub15.anInt9589) <= (~i_59_)) {
                                    ...
                                    if (i_60_ <= Class303.anInt3831) {
                                        ...
                                        if (i_61_ >= 0) {
                                            int i_62_ = ((~i_55_) <= (~i_57_) ? i_55_ : i_57_) + i_58_;
                                            if ((~i_62_) <= -1) {
                                                bool_52_ = false;
                                            }
                                        }
                    ...
                    if (Class320_Sub20.anInt8397 == 1) {
                        ...
                        for (int i_63_ = 0; (~i_63_) > (~Class290_Sub11.anInt8181); i_63_++) {
                            ...
                            for (int i_65_ = 0; (~i_65_) > (~Class117.anInt1479); i_65_++) {
                                ...
                                boolean bool_67_ = (~i_63_) <= (~i_36_) && (~i_63_) > (~(i_36_ + i_37_)) || i_39_ <= i_63_ && (~i_63_) > (~(i_41_ + i_39_)) && i_65_ >= i_38_ && (~i_65_) > (~(i_40_ + i_38_));
    ...
    static void method3100(boolean bool) {
        ...
        for (int i_71_ = 0; i_71_ < 4; i_71_++) {
            for (int i_72_ = 0; Node_Sub54.anInt7675 >> 3 > i_72_; i_72_++) {
                for (int i_73_ = 0; (~i_73_) > (~(Class377_Sub1.anInt8774 >> 3)); i_73_++) {
        ...
        if (bool == false) {
            ...
            for (int i_78_ = 0; i_78_ < 4; i_78_++) {
                for (int i_79_ = 0; (~i_79_) > (~(Node_Sub54.anInt7675 >> 3)); i_79_++) {
    ...
    static boolean method3101(int i, byte b) {
        if (b != -62) {
            return true;
        }
        anInt3187++;
        if (i != 20 && i != 18 && (~i) != -1003 && (~i) != -13 && i != 10) {
            return false;
        }
        return true;
    }
