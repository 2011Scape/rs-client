...
public class Node_Sub16 extends Node {
    ...
    static void method2589(Class302 class302, int i) {
    ...
    static int method2591(byte b, char c) {
        if (b != -115) {
            return -13;
        }
        anInt7134++;
        if ((~c) <= -1 && (~Class346.anIntArray4275.length) < (~c)) {
    ...
    static boolean method2593(int i, int i_24_, int i_25_, int i_26_, int i_27_, int i_28_, int i_29_, int i_30_, boolean bool, int i_31_, Class84 class84) {
        anInt7130++;
        int i_32_ = i_24_;
        int i_33_ = i_31_;
        int i_34_ = 64;
        ...
        while ((~i_38_) != (~i_39_)) {
                            ...
                            do {
                                if ((~i_42_) != 3) {
                                    if ((~i_42_) != 2) {
                                        if (i_42_ != -2) {
                                            if ((~i_42_) != 0) {
                                                if (i_42_ == 0 || (~i_42_) == -2 || (~i_42_) == -3 || (~i_42_) == -4 || i_42_ == 9) {
                                                    break while_98_;
                                                }
                                                break while_99_;
                                            }
            ...
            if ((~i_34_) < -1 && Node_Sub36_Sub2.anIntArrayArray10047[-1 + i_34_][i_35_] == 0 && (0x43a40000 & is[-1 + i_40_][i_41_]) == 0 && (~(is[i_40_ + -1][1 + i_41_] & 0x4e240000)) == -1) {
            ...
            if ((~i_34_) > -127 && Node_Sub36_Sub2.anIntArrayArray10047[1 + i_34_][i_35_] == 0 && (~(0x60e40000 & is[2 + i_40_][i_41_])) == -1 && (0x78240000 & is[2 + i_40_][i_41_ + 1]) == 0) {
                Node_Sub39.anIntArray7494[i_38_] = 1 + i_32_;
                Class339_Sub6.anIntArray8700[i_38_] = i_33_;
            ...
            if (i_35_ > 0 && (~Node_Sub36_Sub2.anIntArrayArray10047[i_34_][-1 + i_35_]) == -1 && (is[i_40_][-1 + i_41_] & 0x43a40000) == 0 && (0x60e40000 & is[1 + i_40_][-1 + i_41_]) == 0) {
                Node_Sub39.anIntArray7494[i_38_] = i_32_;
            ...
            if ((~i_35_) > -127 && (~Node_Sub36_Sub2.anIntArrayArray10047[i_34_][i_35_ - -1]) == -1 && (~(is[i_40_][i_41_ - -2] & 0x4e240000)) == -1 && (is[1 + i_40_][2 + i_41_] & 0x78240000) == 0) {
                Node_Sub39.anIntArray7494[i_38_] = i_32_;
            ...
            if (i_34_ > 0 && i_35_ > 0 && Node_Sub36_Sub2.anIntArrayArray10047[-1 + i_34_][-1 + i_35_] == 0 && (~(0x4fa40000 & is[-1 + i_40_][i_41_])) == -1 && (0x43a40000 & is[i_40_ - 1][i_41_ - 1]) == 0 && (is[i_40_][i_41_ - 1] & 0x63e40000) == 0) {
            ...
            if ((~i_34_) > -127 && i_35_ > 0 && Node_Sub36_Sub2.anIntArrayArray10047[i_34_ + 1][i_35_ - 1] == 0 && (is[i_40_ + 1][-1 + i_41_] & 0x63e40000) == 0 && (~(is[2 + i_40_][i_41_ - 1] & 0x60e40000)) == -1 && (is[i_40_ + 2][i_41_] & 0x78e40000) == 0) {
                Node_Sub39.anIntArray7494[i_38_] = i_32_ + 1;
                Class339_Sub6.anIntArray8700[i_38_] = -1 + i_33_;
                i_38_ = 0xfff & i_38_ + 1;
            ...
            if ((~i_34_) < -1 && i_35_ < 126 && (~Node_Sub36_Sub2.anIntArrayArray10047[i_34_ + -1][1 + i_35_]) == -1 && (~(is[-1 + i_40_][i_41_ + 1] & 0x4fa40000)) == -1 && (~(is[-1 + i_40_][i_41_ + 2] & 0x4e240000)) == -1 && (0x7e240000 & is[i_40_][2 + i_41_]) == 0) {
                Node_Sub39.anIntArray7494[i_38_] = -1 + i_32_;
                Class339_Sub6.anIntArray8700[i_38_] = i_33_ + 1;
                i_38_ = 0xfff & i_38_ + 1;
            ...
            if (i_34_ < 126 && i_35_ < 126 && (~Node_Sub36_Sub2.anIntArrayArray10047[1 + i_34_][i_35_ - -1]) == -1 && (is[1 + i_40_][2 + i_41_] & 0x7e240000) == 0 && (~(is[i_40_ - -2][i_41_ - -2] & 0x78240000)) == -1 && (is[i_40_ + 2][1 + i_41_] & 0x78e40000) == 0) {
                Node_Sub39.anIntArray7494[i_38_] = i_32_ + 1;
                Class339_Sub6.anIntArray8700[i_38_] = i_33_ + 1;
    ...
    static boolean method2594(boolean bool) {
        anInt7135++;
    ...
    private long method2587(boolean bool, int i, int[] is, int[] is_0_, boolean bool_1_) {
        anInt7133++;
    ...
    final DrawableModel method2588(int i, int i_4_, GraphicsToolkit graphicstoolkit, int i_5_, boolean bool, Animator animator, PlayerDefinition playerdefinition) {
        ...
        if (class259 != null && class259.anIntArray3276 != null) {
            ...
            for (int i_7_ = 0; (~i_7_) > (~class259.anIntArray3276.length); i_7_++) {
                ...
                if (i_8_ >= 0 && (~anIntArray7137.length) < (~i_8_)) {
