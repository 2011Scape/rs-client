...
public class Class277_Sub1 extends Class277 {
    ...
    static void method3357(boolean bool) {
        ...
        if (!Class372.aBoolean4599 || !Class180.aBoolean2135) {
            if ((~RuntimeException_Sub1.anInt4916) < -2) {
            ...
            if (Class106.aClass93_1356.method1041((byte) 34)) {
                if (Class58.aWidget861.anInt4795 < RuntimeException_Sub1.anInt4916) {
                    ...
                    if ((~Class58.aWidget861.anInt4708) > (~i_158_) || (~-Class58.aWidget861.anInt4708) < (~i_158_) || (~Class58.aWidget861.anInt4708) > (~i_159_) || i_159_ < -Class58.aWidget861.anInt4708) {
    ...
    static void method3360(byte b, Node_Sub14 node_sub14, GraphicsToolkit graphicstoolkit, Class79 class79) {
        anInt8044++;
        ...
        if (glsprite != null) {
            ...
            } else if ((~(Class20.anInt339 + -i)) > (~i_167_)) {
    ...
    final void method3350(int i, int i_0_, int i_1_, Class84[] class84s, GraphicsToolkit graphicstoolkit, byte[] bs) {
        ...
        for (; ; ) {
            ...
            for (; ; ) {
                ...
                int i_13_ = i_8_ + i;
                int i_14_ = i_0_ + i_7_;
                if (i_13_ > 0 && (~i_14_) < -1 && i_13_ < -1 + anInt3524 && (~i_14_) > (~(anInt3521 + -1))) {
                    Class84 class84 = null;
                    if (!aBoolean3516) {
                        int i_15_ = i_9_;
                        if ((~(CacheNode_Sub11.aByteArrayArrayArray9550[1][i_13_][i_14_] & 0x2)) == -3) {
                            i_15_--;
                        }
                        if ((~i_15_) <= -1) {
                                ...
                                for (int i_19_ = 0; i_19_ < 4; i_19_++) {
                                    ...
                                    if (b != 0 || aByteArrayArrayArray3518[i_19_] == null) {
                                        if ((~b) != -2) {
                                            ...
                                            for (int i_24_ = 0; (~i_24_) > -65; i_24_ += 4) {
                                                for (int i_25_ = 0; i_25_ < 64; i_25_ += 4) {
                                                    byte b_26_ = buffer.method2214((byte) -124);
                                                    for (int i_27_ = i_24_ + i_16_; (~i_27_) > (~(4 + (i_24_ + i_16_))); i_27_++) {
                                                        for (int i_28_ = i + i_25_; (~i_28_) > (~(i + (i_25_ - -4))); i_28_++) {
                                                            if ((~i_27_) <= -1 && (~anInt3524) < (~i_27_) && i_28_ >= 0 && anInt3521 > i_28_) {
            ...
            if (class343 != null) {
                for (int i_39_ = 0; (~i_39_) > -9; i_39_++) {
                    for (int i_40_ = 0; i_40_ < 8; i_40_++) {
                        ...
                        int i_42_ = i_40_ + (i >> 3);
                        if ((~i_41_) <= -1 && anInt3524 >> 3 > i_41_ && i_42_ >= 0 && (~(anInt3521 >> 3)) < (~i_42_)) {
    ...
    final void method3352(int i, int i_48_, Class84 class84, int i_49_, GraphicsToolkit graphicstoolkit, int i_50_, int i_51_, int i_52_, int i_53_, int i_54_, int i_55_) {
        anInt8048++;
        if ((~Class213.aNode_Sub27_2512.aClass320_Sub19_7301.method3751(false)) != -1 || Class369.method4085(i_49_, 0, Class94.anInt1249, i_50_, i_53_)) {
            if ((~i_54_) > (~anInt8046)) {
                anInt8046 = i_54_;
            }
            ...
            if (Class213.aNode_Sub27_2512.aClass320_Sub30_7275.method3796(false) != 0 || !objectdefinition.aBoolean2990) {
                ...
                if (!Class326.aBoolean4109 || (!r.method2361(i, 35) || (~objectdefinition.anInt2977) == -2) && (!Node_Sub38_Sub18.method2844(i, true) || objectdefinition.anInt2977 != 0)) {
                    if (i == 22) {
                        if (Class213.aNode_Sub27_2512.aClass320_Sub6_7267.method3701(false) != 0 || (~objectdefinition.anInt3057) != -1 || objectdefinition.anInt3010 == 1 || objectdefinition.aBoolean3051) {
                        ...
                        if (Class217.aBoolean2552 && !aBoolean3516 && i >= 12 && i <= 17 && (~i) != -14 && (~i_54_) < -1 && objectdefinition.anInt2977 != 0) {
                    ...
                    if ((~i_94_) < -1) {
                        for (int i_95_ = 0; (~i_95_) > (~i_94_); i_95_++) {
                            ...
                            if (graphicstoolkit.e() > 0) {
                                ...
                                if (i_89_ == class326.anInt4092 && i_96_ >= i_91_ && (~i_96_) > (~(8 + i_91_)) && (~i_97_) <= (~i_92_) && i_92_ + 8 > i_97_) {
                                    ...
                                    i_97_ = i_99_ >> 9;
                                    if ((~i_96_) <= -1 && i_97_ >= 0 && i_96_ < anInt3524 && anInt3521 > i_97_) {
                                        ...
                                        for (int i_108_ = i_105_; (~i_108_) > (~(i_105_ - -4)); i_108_++) {
                                            for (int i_109_ = i_106_; (~(4 + i_106_)) < (~i_109_); i_109_++) {
                                                if ((~i_108_) <= (~i_91_) && 8 + i_91_ > i_108_ && i_109_ >= i_92_ && (~(i_92_ - -8)) < (~i_109_)) {
                                                    ...
                                                    if (i_110_ >= 0 && i_110_ < anInt3524 && (~i_111_) <= -1 && i_111_ < anInt3521) {
        ...
        for (; ; ) {
            ...
            for (; ; ) {
                ...
                if ((~i_124_) == (~i_132_) && i <= i_131_ && (~i_131_) > (~(i + 8)) && i_125_ <= i_130_ && i_130_ < 8 + i_125_) {
                    ...
                    if (i_136_ > 0 && i_137_ > 0 && (~i_136_) > (~(-1 + anInt3524)) && (~i_137_) > (~(-1 + anInt3521))) {
                        Class84 class84 = null;
                        if (!aBoolean3516) {
                            int i_138_ = i_120_;
        ...
        if (!bool) {
            if ((~anInt3535) < -2) {
                for (int i = 0; (~i) > (~anInt3524); i++) {
                    for (int i_139_ = 0; (~anInt3521) < (~i_139_); i_139_++) {
            ...
            for (int i = 0; anInt3535 > i; i++) {
                for (int i_140_ = 0; (~anInt3521) <= (~i_140_); i_140_++) {
                    for (int i_141_ = 0; (~i_141_) >= (~anInt3524); i_141_++) {
                        if ((~(aByteArrayArrayArray3526[i][i_141_][i_140_] & 0x4)) != -1) {
                            int i_142_ = i_141_;
                            int i_143_ = i_141_;
                            int i_144_ = i_140_;
                            int i_145_ = i_140_;
                            for (/**/; (~i_144_) < -1 && (~(aByteArrayArrayArray3526[i][i_141_][-1 + i_144_] & 0x4)) != -1; i_144_--) {
                                if ((~(i_145_ + -i_144_)) <= -11) {
                                    break;
                                }
                            }
                            for (/**/; i_145_ < anInt3521 && (~(0x4 & aByteArrayArrayArray3526[i][i_141_][1 + i_145_])) != -1; i_145_++) {
                                if (i_145_ - i_144_ >= 10) {
                                    break;
                                }
                            }
                            ...
                            for (/**/; (~i_142_) < -1; i_142_--) {
                                ...
                                for (int i_146_ = i_144_; i_145_ >= i_146_; i_146_++) {
                                    if ((~(aByteArrayArrayArray3526[i][i_142_ - 1][i_146_] & 0x4)) == -1) {
                                        break while_237_;
                                    }
                                }
                            }
                            while_238_:
                            for (/**/; (~anInt3524) < (~i_143_); i_143_++) {
                                if (i_143_ - i_142_ >= 10) {
                                    break;
                                }
                                for (int i_147_ = i_144_; (~i_147_) >= (~i_145_); i_147_++) {
                            ...
                            if ((1 + (-i_142_ + i_143_)) * (1 + (i_145_ - i_144_)) >= 4) {
                                ...
                                for (int i_149_ = i_142_; (~i_149_) >= (~i_143_); i_149_++) {
                                    for (int i_150_ = i_144_; (~i_145_) <= (~i_150_); i_150_++)
        ...
        if (interface19 != null) {
            ...
            if (i != 0) {
                if (i == 1) {
                    ...
                    if (objectdefinition.anInt3010 != 0 && (~anInt3524) < (~(objectdefinition.anInt3055 + i_162_)) && anInt3521 > objectdefinition.anInt3055 + i_160_ && i_162_ + objectdefinition.anInt2986 < anInt3524 && objectdefinition.anInt2986 + i_160_ < anInt3521) {
