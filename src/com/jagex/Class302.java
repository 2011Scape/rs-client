...
public class Class302 {
    ...
    static void method3535(java.awt.Canvas canvas, boolean bool) {
        anInt3806++;
    ...
    private void method3508(int i, int i_3_) {
        if (!aBoolean3819) {
    ...
    private int method3509(boolean bool, int i) {
        anInt3794++;
    ...
    final int method3511(int i) {
        ...
        for (int i_6_ = 0; anObjectArray3783.length > i_6_; i_6_++) {
            if ((~anArchive3797.anIntArray295[i_6_]) < -1) {
                i_4_ += 100;
    ...
    final byte[] method3512(int[] is, int i, int i_8_, int i_9_) {
        ...
        if ((~anInt3795) != -2) {
            ...
            if ((~anArchive3797.anIntArray285[i_9_]) == -2) {
                anObjectArrayArray3786[i_9_] = null;
            }
        }
        return bs;
    ...
    private boolean method3513(int i, int i_11_, byte b) {
        anInt3781++;
        if (!method3530(0)) {
            return false;
        }
        if (i_11_ < 0 || (~i) > -1 || i_11_ >= anArchive3797.anIntArray285.length || anArchive3797.anIntArray285[i_11_] <= i) {
            if (Class144_Sub3.aBoolean6833) {
                throw new IllegalArgumentException(i_11_ + "," + i);
            }
            return false;
        }
        if (b < 126) {
    ...
    private boolean method3514(int i, int[] is, int i_12_, int i_13_) {
        if (i != 0) {
            aClass34_3804 = null;
        }
        anInt3817++;
        ...
        byte[] bs;
        if (is == null || (~is[0]) == -1 && (~is[1]) == -1 && (~is[2]) == -1 && (~is[3]) == -1) {
    ...
    final boolean method3515(int i, int i_48_, int i_49_) {
        ...
        return anObjectArray3783[i_48_] != null;
    }
    ...
    private void method3517(int i, int i_51_) {
        anInt3807++;
        if (i > -103) {
            anObjectArray3783 = null;
        }
    ...
    final byte[] method3518(byte b, int i) {
        ...
        if ((~anArchive3797.anIntArray285.length) == -2) {
    ...
    final void method3521(byte b) {
        if (anObjectArrayArray3786 != null) {
            for (int i = 0; (~anObjectArrayArray3786.length) < (~i); i++)
    ...
    final void method3523(byte b) {
        ...
        if (anObjectArray3783 != null) {
            for (int i = 0; (~anObjectArray3783.length) < (~i); i++)
    ...
    private boolean method3525(byte b, int i) {
        anInt3792++;
        if (!method3530(0)) {
            return false;
        }
        if ((~i) > -1 || i >= anArchive3797.anIntArray285.length || (~anArchive3797.anIntArray285[i]) == -1) {
            if (!Class144_Sub3.aBoolean6833) {
                return false;
            }
    ...
    private boolean method3530(int i) {
        if (i != 0) {
            return false;
        }
        anInt3808++;
    ...
    private boolean method3533(boolean bool, String string, String string_63_) {
        anInt3816++;
        if (!method3530(0)) {
            return false;
        }
    ...
    final boolean method3536(int i, int i_66_) {
        ...
        method3508(i_66_, 0);
        return anObjectArray3783[i_66_] != null;
    }
