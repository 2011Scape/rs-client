...
abstract class Class169 implements Interface2 {
    ...
    static char method1755(int i, int i_0_, char c) {
        anInt4959++;
        if (c >= 192 && c <= 255) {
            if ((~c) <= -193 && c <= 198) {
                return 'A';
    ...
    static void method1760(boolean bool) {
    ...
    static int method1762(byte b, int i) {
        if (b != 114) {
            return 89;
        }
        anInt4952++;
    ...
    private void method1756(byte b, int i) {
    ...
    private void method1758(boolean bool) {
        anInt4956++;
