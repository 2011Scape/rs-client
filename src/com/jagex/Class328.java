...
abstract class Class328 {
    ...
    static void method3825(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
        anInt4113++;
        int i_5_ = 0;
        int i_6_ = i_1_;
        if (i_2_ == 68) {
    ...
    static Animable_Sub2 method3827(int i, int i_33_, int i_34_) {
    ...
    static void method3829(int i, int i_35_) {
