...
public class CacheNode_Sub8 extends CacheNode {
    ...
    static void method2318(int i, int i_0_, byte b, long l, aa var_aa, int i_1_, int i_2_, int i_3_, Widget widget) {
        anInt9492++;
        if (b == 124) {
    ...
    static Animable_Sub4 method2320(int i, int i_13_, int i_14_) {
    ...
    final long method2319(boolean bool) {
        ...
        return (long) (aShortArrayArray9491.length | aShortArrayArray9491[0].length);
    }
}
