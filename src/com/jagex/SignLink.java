...
public class SignLink implements Runnable {
    ...
    SignLink(int i, String string, int i_20_, boolean bool) throws Exception {
        ...
        if (aBoolean4005 && !aBoolean3985) {
            ...
            for (int i_23_ = 0; (~threads.length) < (~i_23_); i_23_++) {
    ...
    private static FileOnDisk method3630(String string, int i, String string_5_, int i_6_) {
        if (i_6_ != 19613) {
            osArchitecture = null;
        }
        String string_7_;
    ...
    final void method3635(int i) {
        ...
        if (aFileOnDiskArray4003 != null) {
            for (int i_10_ = 0; (~aFileOnDiskArray4003.length) < (~i_10_); i_10_++) {
                                ...
                                if ((~i) == -10) {
                                    ...
                                    if ((~i) == -4) {
                                        ...
                                        if ((~i) == -7) {
                                            ...
                                            if (aBoolean4005 && (~i) == -15) {
                                                int i_16_ = class241.anInt2952;
                                                int i_17_ = class241.anInt2951;
                                                if (aBoolean3985) {
                                                    aCallback_Sub1_3988.method81(i_16_, -33, i_17_);
                                                } else {
                                                    Class.forName("com.jagex.Class208").getDeclaredMethod("method2046", new Class[]{Integer.TYPE, Integer.TYPE}).invoke(anObject3990, new Object[]{Integer.valueOf(i_16_), Integer.valueOf(i_17_)});
                                                }
                                            } else if (aBoolean4005 && i == 15) {
                                                boolean bool = (~class241.anInt2952) != -1;
                                                Component component = (Component) class241.anObject2954;
                                                Class.forName("com.jagex.Class208").getDeclaredMethod("method2045", new Class[]{aClass4007 == null ? aClass4007 = method3646("java.awt.Component") : aClass4007, Boolean.TYPE}).invoke(anObject3990, new Object[]{component, Boolean.valueOf(bool)});
                                            } else if (!aBoolean3985 && (~i) == -18) {
                                                Object[] objects = (Object[]) class241.anObject2954;
                                                Class.forName("com.jagex.Class208").getDeclaredMethod("method2047", new Class[]{aClass4007 == null ? aClass4007 = method3646("java.awt.Component") : aClass4007, aClass4008 == null ? aClass4008 = method3646("[I") : aClass4008, Integer.TYPE, Integer.TYPE, aClass4009 == null ? aClass4009 = method3646("java.awt.Point") : aClass4009}).invoke(anObject3990, new Object[]{(Component) objects[0], (int[]) objects[1], Integer.valueOf(class241.anInt2952), Integer.valueOf(class241.anInt2951), (Point) objects[2]});
                                            } else if (i == 16) {
                                                try {
