...
class Node_Sub38_Sub8 extends Node_Sub38 {
    ...
    static boolean method2812(int i, boolean bool, int i_0_) {
        anInt10167++;
        if (bool != false) {
            aFloatArray10162 = null;
        }
        boolean bool_1_ = (~(0x37 & i_0_)) != -1 ? Class303.method3538(i_0_, -128, i) : Node_Sub41.method2932(-125, i, i_0_);
        return bool_1_ | (Class278.method3367(i_0_, i, (byte) 87) | (~(i & 0x10000)) != -1);
    }

    static void method2813(int i) {
    ...
    static void method2815(boolean bool, int i) {
        if (bool == false) {
            anInt10161++;
    ...
    int[][] method2778(int i, boolean bool) {
        ...
        if (aClass348_7454.aBoolean4300 && method2814((byte) 80)) {
            ...
            if ((~anInt10169) == (~Class339_Sub7.anInt8728)) {
