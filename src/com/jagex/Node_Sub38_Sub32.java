...
public class Node_Sub38_Sub32 extends Node_Sub38 {
    ...
    private final int[] anIntArray10432;
    ...
    static int method2894(int i, int i_15_, int i_16_, int i_17_) {
        anInt10435++;
        if (i_16_ != 929798380) {
            return 77;
        }
    ...
    private void method2896(byte b) {
        anInt10434++;
        double d = Math.cos((float) anInt10426 / 4096.0F);
        anIntArray10432[0] = (int) (d * Math.sin((float) anInt10425 / 4096.0F) * 4096.0);
        if (b > -113) {
            method2895(true);
        }
        anIntArray10432[1] = (int) (4096.0 * (d * Math.cos((float) anInt10425 / 4096.0F)));
        anIntArray10432[2] = (int) (4096.0 * Math.sin((float) anInt10426 / 4096.0F));
        ...
        int i_20_ = (int) (Math.sqrt(i + (i_18_ + i_19_) >> 12) * 4096.0);
        if ((~i_20_) != -1) {
