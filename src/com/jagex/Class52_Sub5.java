...
public class Class52_Sub5 extends Class52 {
    ...
    private void method552(byte[] bs, int[] is, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, aa var_aa, int i_9_, int i_10_) {
    ...
    private void method553(byte[] bs, int[] is, int i, int i_24_, int i_25_, int i_26_, int i_27_, int i_28_, int i_29_, int i_30_, int i_31_, int i_32_, aa var_aa, int i_33_, int i_34_) {
        aa_Sub1 var_aa_Sub1 = (aa_Sub1) var_aa;
    ...
    private void method554(byte[] bs, int[] is, int i, int i_78_, int i_79_, int i_80_, int i_81_, int i_82_, int i_83_) {
        int i_84_ = i >>> 24;
        int i_85_ = 255 - i_84_;
    ...
    private void method555(byte[] bs, int[] is, int i, int i_90_, int i_91_, int i_92_, int i_93_, int i_94_, int i_95_) {
        int i_96_ = -(i_92_ >> 2);
        i_92_ = -(i_92_ & 0x3);
