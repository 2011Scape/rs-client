...
public class Class160 {
    ...
    static void method1726(boolean bool) {
    ...
    static void method1727(boolean bool, byte b, boolean bool_0_) {
        if (b < 27) {
            method1728((byte) 87);
        }
        anInt1997++;
    ...
    static void method1729(int i, Buffer buffer) {
        ...
        for (int i_3_ = 0; (~Class254.anInt3212) < (~i_3_); i_3_++) {
    ...
    static void method1730(int i) {
        Class262_Sub23.method3212(false, 1295);
        anInt1999++;
        int i_5_ = -22 / ((24 - i) / 34);
        if (CacheNode_Sub8.anInt9493 >= 0 && (~CacheNode_Sub8.anInt9493) != -1) {
