...
public class Class126 {
    ...
    private Class126(int i, int i_44_, Class372 class372) {
        anInt1621 = i;
        anInt1624 = i_44_ * class372.anInt4591;
        if ((~anInt1621) <= -17) {
            throw new RuntimeException();
        }
    }

    static void method1532(int i) {
        if (Class93.aGraphicsToolkit1241 != null) {
            ...
            for (int i_2_ = 0; (~i_2_) > (~Node_Sub32.anInt7380); i_2_++) {
    ...
    static Class126 method1534(int i, int i_5_) {
        anInt1613++;
        if (i_5_ > -103) {
            aClass192_1633 = null;
        }
    ...
    static void method1535(int i, int i_7_, int i_8_, int i_9_, int i_10_) {
        anInt1614++;
    ...
    static int method1536(int i, String string) {
        if (i != -20826) {
            return -51;
        }
        anInt1611++;
    ...
    static RuntimeException_Sub1 method1537(Throwable throwable, String string) {
        anInt1619++;
    ...
    static void method1539(boolean bool, String string, byte b) {
        anInt1622++;
        if (string != null) {
