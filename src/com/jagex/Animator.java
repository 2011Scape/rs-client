...
class Animator {
    ...
    static Class288 method224(byte b, Class237[] class237s, GLXToolkit glxtoolkit) {
        anInt265++;
    ...
    static void method230(int i, int i_8_, int i_9_, int i_10_, int i_11_) {
        anInt240++;
    ...
    static Class256 method231(boolean bool, Mobile mobile) {
        anInt246++;
        Class256 class256;
    ...
    static int method236(boolean bool, int i) {
        if (bool != false) {
            aClass346_252 = null;
        }
        anInt242++;
    ...
    static void method239(DrawableModel drawablemodel, int i, int i_16_, int i_17_, Class171 class171, int i_18_) {
        anInt264++;
    ...
    final void method228(int i, int i_4_, byte b, int i_5_, boolean bool) {
        ...
        if ((~method250((byte) -62)) != (~i)) {
            if ((~i) == 0) {
                ...
                anInt243 = 1 + anInt259;
                if ((~anInt243) > -1 || anInt243 >= aClass48_233.anIntArray715.length) {
                    anInt243 = -1;
                }
                if (anInt237 == 0) {
    ...
    final boolean method248(int i, int i_21_) {
        ...
        if (i_21_ > 100 && (~aClass48_233.anInt696) < -1) {
            int i_22_;
            ...
            anInt243 = 1 + anInt259;
            bool = true;
            if ((~anInt243) <= (~aClass48_233.anIntArray715.length)) {
                anInt243 -= aClass48_233.anInt696;
                if ((~anInt243) > -1 || (~aClass48_233.anIntArray715.length) >= (~anInt243)) {
                    anInt243 = -1;
                }
            }
        }
        while (aClass48_233.anIntArray707[anInt259] < i_21_) {
            ...
            if (aClass48_233.anIntArray715.length <= anInt259) {
                if ((~aClass48_233.anInt696) != 0 && anInt253 != 2) {
