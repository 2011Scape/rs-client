...
abstract class Class34 {
    ...
    static Class345 method367(int i, Model model, int i_0_, int[] is) {
        anInt533++;
        int[] is_1_ = null;
        int[] is_2_ = null;
        int[] is_3_ = null;
        ...
        if (model.aByteArray2610 != null) {
            ...
            for (int i_12_ = 0; i_12_ < i_0_; i_12_++) {
                int i_13_ = is[i_12_];
                if ((~model.aByteArray2610[i_13_]) != 0) {
                    ...
                    for (int i_15_ = 0; (~i_15_) > -4; i_15_++) {
                        ...
                        if ((~is_7_[i_14_]) < (~i_17_)) {
                            is_7_[i_14_] = i_17_;
                        }
                        if (i_17_ > is_8_[i_14_]) {
                            is_8_[i_14_] = i_17_;
                        }
                        if ((~is_9_[i_14_]) < (~i_18_)) {
                            is_9_[i_14_] = i_18_;
                        }
    ...
    static void method370(Actor actor, byte b) {
        anInt530++;
        ...
        for (/**/; i < actor.aClass165Array10886.length; i++) {
            if ((~actor.aClass165Array10886[i].anInt2030) != 0) {
                ...
                if (animator_24_.method242((byte) -77)) {
                    ...
                    if (class195.aBoolean2402) {
                        if (class48.anInt698 == 3) {
                            if (actor.anInt10900 > 0 && (~Class174.anInt2092) <= (~actor.anInt10892) && actor.anInt10887 < Class174.anInt2092) {
                                animator_24_.method249(true, -1);
                                actor.aClass165Array10886[i].anInt2030 = -1;
                                continue;
                            }
                        } else if (class48.anInt698 == 1 && (~actor.anInt10900) < -1 && actor.anInt10892 <= Class174.anInt2092 && (~Class174.anInt2092) < (~actor.anInt10887)) {
                            continue;
                        }
                    }
                }
        ...
        do {
            if (animator_25_.method245(-127)) {
                ...
                if (class48.anInt698 == 3) {
                    if ((~actor.anInt10900) < -1 && actor.anInt10892 <= Class174.anInt2092 && Class174.anInt2092 > actor.anInt10887) {
                        actor.anIntArray10817 = null;
                        animator_25_.method249(true, -1);
                        break;
                    }
                } else if ((~class48.anInt698) == -2) {
                    if ((~actor.anInt10900) < -1 && Class174.anInt2092 >= actor.anInt10892 && actor.anInt10887 < Class174.anInt2092) {
    ...
    static void method371(int i, int i_27_, byte b) {
        anInt529++;
