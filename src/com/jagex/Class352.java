...
public class Class352 {
    ...
    static GLSprite method4008(byte b, int i, GraphicsToolkit graphicstoolkit) {
        anInt4327++;
        int i_2_ = 96 % ((68 - b) / 40);
        Node_Sub3 node_sub3 = (Node_Sub3) Class56.aHashTable839.method1518(3512, i);
        if (node_sub3 != null) {
    ...
    static void method4009(int i, int i_3_, int i_4_, int i_5_, Actor actor) {
        anInt4328++;
        ...
        if (i == -1) {
            ...
            if ((~i) == -3 && class259.anInt3252 != -1) {
                if (i_3_ < 0 && (~class259.anInt3282) != 0) {
            ...
            } else if ((~i) != -1 || class259.anInt3262 == -1) {
                if ((~i_3_) > -1 && (~class259.anInt3298) != 0) {
            ...
            } else if ((~i_3_) <= -1 || class259.anInt3275 == -1) {
    ...
    static void method4011(int[] is, int i, boolean bool, Actor actor, int i_8_) {
        anInt4331++;
        ...
        for (int i_13_ = 0; i_13_ < is.length; i_13_++) {
            ...
            if (actor.anIntArray10817 == null || actor.anIntArray10817[i_13_] == -1 || (~Class18.aClass37_306.method395(is[i_13_], (byte) -125).anInt710) <= (~Class18.aClass37_306.method395(actor.anIntArray10817[i_13_], (byte) -100).anInt710)) {
    ...
    static boolean method4012(int i) {
        int i_14_ = -7 / ((-59 - i) / 51);
        anInt4340++;
    ...
    static void method4013(int i, boolean bool, Npc npc) {
        if (i != -16456) {
            method4012(-74);
        }
        anInt4339++;
        if ((~Class315.anInt4035) > -401) {
            ...
            if (npcdefinition.aBoolean2854) {
                if (npc.anInt11127 != 0) {
                    ...
                    string += Class368.method4077(i - 1625916277, Class295.aPlayer3692.anInt11152, npc.anInt11127) + " (" + string_15_ + npc.anInt11127 + ")";
                }
                if (Class87.aBoolean1185 && !bool) {
                    ...
                    if ((0x2 & Class200_Sub2.anInt4943) != 0 && (class267 == null || (~npcdefinition.method3009(86, Class324.anInt4087, class267.anInt3443)) != (~class267.anInt3443))) {
                        Class13.anInt205++;
                        Node_Sub32.method2731(false, -1, npc.anInt10858, 0, 0, Class84.aString1148, 23, true, Class201.anInt2444, Class66.aString5177 + " -> <col=ffff00>" + string, npc.anInt10858, (byte) -18, false);
                    }
                }
                if (!bool) {
                    ...
                    if (strings != null) {
                        for (int i_16_ = strings.length - 1; (~i_16_) <= -1; i_16_--) {
                            if (strings[i_16_] != null && ((~npcdefinition.aByte2855) == -1 || !strings[i_16_].equalsIgnoreCase(Class22.aClass22_386.method297(-12273, Class35.anInt537)) && !strings[i_16_].equalsIgnoreCase(Class22.aClass22_385.method297(-12273, Class35.anInt537)))) {
                                int i_17_ = 0;
                                ...
                                Node_Sub32.method2731(false, -1, npc.anInt10858, 0, 0, strings[i_16_], i_17_, true, strings[i_16_].equalsIgnoreCase(Class22.aClass22_386.method297(-12273, Class35.anInt537)) ? npcdefinition.anInt2860 : i_18_, "<col=ffff00>" + string, npc.anInt10858, (byte) -18, false);
                                Class216.anInt2548++;
                            }
                        }
                        if ((~npcdefinition.aByte2855) == -2) {
                            for (int i_19_ = 0; strings.length > i_19_; i_19_++) {
                                if (strings[i_19_] != null && (strings[i_19_].equalsIgnoreCase(Class22.aClass22_386.method297(i ^ 0x6fb7, Class35.anInt537)) || strings[i_19_].equalsIgnoreCase(Class22.aClass22_385.method297(-12273, Class35.anInt537)))) {
                                    short s = 0;
                                    if ((~npc.anInt11127) < (~Class295.aPlayer3692.anInt11152)) {
                                        s = (short) 2000;
                                    }
                                    short s_20_ = 0;
                                    ...
                                    if ((~npcdefinition.anInt2815) == (~i_19_)) {
                                    ...
                                    Actor.anInt10847++;
                                    Node_Sub32.method2731(false, -1, npc.anInt10858, 0, 0, strings[i_19_], s_20_, true, !strings[i_19_].equalsIgnoreCase(Class22.aClass22_386.method297(-12273, Class35.anInt537)) ? i_21_ : npcdefinition.anInt2860, "<col=ffff00>" + string, npc.anInt10858, (byte) -18, false);
                                }
                            }
                        }
                    }
    ...
    private void method4006(Buffer buffer, int i, byte b, int i_0_) {
        anInt4337++;
        if (i_0_ != 1) {
            if ((~i_0_) != -3) {
                if ((~i_0_) == -4) {
