	...
	static final void method4013(int i, boolean bool, Npc npc) {
		...
		if ((Class315.anInt4035 ^ 0xffffffff) > -401) {
			...
			if (npcdefinition.aBoolean2854) {
				if (npc.anInt11127 != 0) {
					String string_15_ = Class169_Sub4.aClass353_8825 != Class209.aClass353_2483 ? Localization.level.getLocalizationString(i ^ 0x6fb7, Class35.clientLanguage) : Localization.rating.getLocalizationString(i ^ 0x6fb7, Class35.clientLanguage);
				...
				if (!bool) {
					...
					if (strings != null) {
						for (int i_16_ = strings.length - 1; (i_16_ ^ 0xffffffff) <= -1; i_16_--) {
							if (strings[i_16_] != null && ((npcdefinition.aByte2855 ^ 0xffffffff) == -1 || !strings[i_16_].equalsIgnoreCase(Localization.attack.getLocalizationString(-12273, Class35.clientLanguage)) && !strings[i_16_].equalsIgnoreCase(Localization.examine.getLocalizationString(-12273, Class35.clientLanguage)))) {
								int i_17_ = 0;
								...
								Node_Sub32.method2731(false, -1, (long) npc.anInt10858, 0, 0, strings[i_16_], i_17_, true, strings[i_16_].equalsIgnoreCase(Localization.attack.getLocalizationString(-12273, Class35.clientLanguage)) ? npcdefinition.anInt2860 : i_18_, "<col=ffff00>" + string, (long) npc.anInt10858, (byte) -18, false);
								Class216.anInt2548++;
							}
						}
						if ((npcdefinition.aByte2855 ^ 0xffffffff) == -2) {
							for (int i_19_ = 0; strings.length > i_19_; i_19_++) {
								if (strings[i_19_] != null && (strings[i_19_].equalsIgnoreCase(Localization.attack.getLocalizationString(i ^ 0x6fb7, Class35.clientLanguage)) || strings[i_19_].equalsIgnoreCase(Localization.examine.getLocalizationString(-12273, Class35.clientLanguage)))) {
									short s = 0;
									...
									Actor.anInt10847++;
									Node_Sub32.method2731(false, -1, (long) npc.anInt10858, 0, 0, strings[i_19_], s_20_, true, !strings[i_19_].equalsIgnoreCase(Localization.attack.getLocalizationString(-12273, Class35.clientLanguage)) ? i_21_ : npcdefinition.anInt2860, "<col=ffff00>" + string, (long) npc.anInt10858, (byte) -18, false);
								}
							}
						}
					}
