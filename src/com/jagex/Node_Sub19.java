...
public class Node_Sub19 extends Node {
    ...
    static void method2608(int i, byte b, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
        anInt7158++;
    ...
    static int method2609(byte b, CacheNode_Sub13 cachenode_sub13) {
        anInt7157++;
        int i = 99 % ((b - 25) / 47);
    ...
    static boolean method2610(byte b, boolean bool) {
        anInt7162++;
        if (b != -58) {
            anInt7173 = -19;
        }
    ...
    static void method2611(boolean bool) {
        anInt7155++;
