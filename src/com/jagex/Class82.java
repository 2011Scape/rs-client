...
public class Class82 {
    ...
    static void method797(GraphicsToolkit graphicstoolkit, int i) {
        anInt1116++;
        int i_2_ = 0;
        int i_3_ = 0;
        ...
        if (i == 32712) {
            ...
            if (Class194_Sub3_Sub1.aBoolean9375) {
                ...
                for (CacheNode_Sub4 cachenode_sub4 = (CacheNode_Sub4) Class184.aClass158_2189.method1723(i - 32699); cachenode_sub4 != null; cachenode_sub4 = (CacheNode_Sub4) Class184.aClass158_2189.method1721(0)) {
                    ...
                    if (i_9_ > i_2_ + Node_Sub6.anInt7043 && (~i_9_) > (~(i_2_ + (Node_Sub6.anInt7043 - -Class362.anInt4492))) && i_10_ > i_12_ - 13 && i_10_ < i_12_ + 4 && (cachenode_sub4.anInt9462 > 1 || ((CacheNode_Sub13) cachenode_sub4.aClass158_9457.aCacheNode1984.aCacheNode7035).aBoolean9571)) {
                ...
                if (Class73.aCacheNode_Sub4_988 != null) {
                    ...
                    for (CacheNode_Sub13 cachenode_sub13 = (CacheNode_Sub13) Class73.aCacheNode_Sub4_988.aClass158_9457.method1723(i ^ 0x7fc5); cachenode_sub13 != null; cachenode_sub13 = (CacheNode_Sub13) Class73.aCacheNode_Sub4_988.aClass158_9457.method1721(i ^ 0x7fc8)) {
                        ...
                        if (Class367.anInt4539 < i_9_ && Class367.anInt4539 + CacheNode.anInt7033 > i_9_ && i_10_ > i_13_ - 13 && (~i_10_) > (~(4 + i_13_)) && cachenode_sub13.aBoolean9571) {
                ...
                for (CacheNode_Sub13 cachenode_sub13 = (CacheNode_Sub13) Class368.aClass312_4549.method3613(65280); cachenode_sub13 != null; cachenode_sub13 = (CacheNode_Sub13) Class368.aClass312_4549.method3620(16776960)) {
                    ...
                    i_14_++;
                    if (i_2_ + Node_Sub6.anInt7043 < i_9_ && i_2_ + (Node_Sub6.anInt7043 + Class362.anInt4492) > i_9_ && (~i_10_) < (~(i_15_ - 13)) && 4 + i_15_ > i_10_ && cachenode_sub13.aBoolean9571) {
    ...
    private void method794(int i, int i_0_, Buffer buffer) {
        anInt1117++;
        if (i_0_ == -12897) {
            if ((~i) != -2) {
                if (i == 2) {
