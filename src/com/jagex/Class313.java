...
public class Class313 {
    ...
    static boolean method3649(boolean bool, int i, int i_2_, int i_3_) {
        anInt4010++;
    ...
    static synchronized long method3650(boolean bool) {
        anInt4012++;
        long l = System.currentTimeMillis();
        if ((~Node_Sub38_Sub11.aLong10215) < (~l)) {
