...
public class Class321 {
    ...
    static void method3799(long l, int i) {
        anInt4066++;
        ...
        if ((~(-i_0_ + Mobile_Sub4.anInt10987)) > 1999 || -i_0_ + Mobile_Sub4.anInt10987 > 2000 || (~(-i_1_ + Class25.anInt444)) > 1999 || (~(Class25.anInt444 - i_1_)) < -2001) {
            Class25.anInt444 = i_1_;
            Mobile_Sub4.anInt10987 = i_0_;
        }
        if ((~i_0_) != (~Mobile_Sub4.anInt10987)) {
    ...
    static boolean method3800(int i, int i_6_, int i_7_) {
        if (i_7_ != 126) {
            method3799(64L, -95);
        }
        anInt4070++;
    ...
    static boolean method3801(byte b, char c) {
        anInt4069++;
        if (c >= 32 && c <= 126) {
            return true;
        }
        ...
        if ((~c) == -8365 || (~c) == -339 || (~c) == -8213 || c == 339 || c == 376) {
            return true;
        }
        return false;
    }
