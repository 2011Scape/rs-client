...
public class Mobile_Sub1 extends Mobile {
    ...
    private DrawableModel method896(int i, GraphicsToolkit graphicstoolkit, int i_8_) {
        anInt10952++;
                ...
                if (actor != null) {
                    ...
                    if (anInt10920 >= 0) {
                        ...
                        if ((~i) != -1 || i_10_ != 0) {
                            ...
                            int i_12_ = i_11_;
                            if (actor.anIntArray10881 != null && (~actor.anIntArray10881[anInt10920]) != 0) {
    ...
    private void method899(byte b, GraphicsToolkit graphicstoolkit, Class336 class336, DrawableModel drawablemodel) {
