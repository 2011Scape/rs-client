...
public class Class39 {
    ...
    static void method408(int i, int i_19_, int i_20_, boolean bool, int i_21_, Class302 class302, boolean bool_22_) {
    ...
    static short[] method413(short[] ses, byte b) {
        anInt573++;
        if (b != -32) {
    ...
    static void method414(int i, String string) {
        anInt575++;
        if (i != 30482) {
            aClass318_584 = null;
        }
        if (Class87.aBoolean1185 && (0x18 & Class200_Sub2.anInt4943) != 0) {
            ...
            for (int i_32_ = 0; (~i_31_) < (~i_32_); i_32_++) {
                ...
                if (player.aString11142 != null && player.aString11142.equalsIgnoreCase(string) && (Class295.aPlayer3692 == player && (~(0x10 & Class200_Sub2.anInt4943)) != -1 || (Class200_Sub2.anInt4943 & 0x8) != 0)) {
                    Class270.anInt3475++;
    ...
    static void method415(int i, String string, String string_33_, int i_34_) {
        anInt582++;
            ...
            if (i == 3) {
                ...
                if ((~i) == -6 || i == 6) {
                    ...
                    for (int i_44_ = 0; i_44_ < anInt586; i_44_++) {
                        ...
                        integers[i_45_] = Integer.valueOf(buffer.method2186(Node_Sub19.method2612(i_37_, 80)));
                    }
    ...
    private void method419(boolean bool) {
        try {
            if (bool == false) {
                anInt591++;
                if (anObject589 instanceof HashTable) {
