...
public class Class212 implements Interface8 {
    ...
    static void method2051(int i, int i_0_, int i_1_, int i_2_, byte b, int i_3_, byte[] bs) {
        anInt5132++;
        ...
        for (; ; ) {
            ...
            int i_11_ = i_4_ * i_2_;
            for (int i_12_ = 0; (~i_4_) < (~i_12_); i_12_++) {
                int i_13_ = i_12_;
                int i_14_ = i_12_;
    ...
    static void method2053(int i, int i_20_, int i_21_, float[] fs, int i_22_, float f, float[] fs_23_, int i_24_, int i_25_, int i_26_, int i_27_) {
        i_20_ -= i_22_;
        anInt5131++;
        i_21_ -= i_27_;
        i_25_ -= i;
    ...
    static void method2054(byte b, int i, Actor actor, int i_36_, Actor actor_37_, int i_38_, int i_39_, int i_40_, int i_41_, int i_42_) {
        anInt5129++;
