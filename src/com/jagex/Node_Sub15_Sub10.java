...
public class Node_Sub15_Sub10 extends Node_Sub15 {
    ...
    final void method2554(int i, Buffer buffer) {
        anInt9852++;
        anInt9846 = buffer.method2219(-130546744);
        anInt9845 = buffer.method2186(70);
        anInt9848 = buffer.method2233(i - 28892);
        anInt9847 = buffer.method2233(255);
        if (i != 29147) {
            aBoolean9850 = true;
        }
    }
