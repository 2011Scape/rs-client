...
public class Class320_Sub30 extends Class320 {
    ...
    static boolean method3797(r var_r, int i, int i_0_, int i_1_, boolean[] bools) {
        boolean bool = false;
    ...
    static void method3798(int i) {
        anInt8493++;
        if ((~Class213.aNode_Sub27_2512.aClass320_Sub19_7301.method3751(false)) == -1 && (~Class94.anInt1249) != (~CacheNode_Sub20_Sub1.anInt11089)) {
