...
public class Class250 {
        ...
        if (i_7_ <= 3) {
            ...
            if (bool) {
                ...
                for (int i_13_ = 0; i_11_ > i_13_; i_13_++) {
                    ...
                    aBooleanArray3173[i_14_] = (~buffer.method2233(255)) == -2;
    ...
    static Class329 method3095(int i, int i_4_) {
        anInt3169++;
    ...
    static boolean method3096(int i, int i_6_) {
        if (i_6_ >= -60) {
            return false;
        }
        anInt3171++;
    ...
    final int[] method3091(int i, byte b) {
        anInt3174++;
        if (i < 0 || (~anIntArrayArray3172.length) >= (~i)) {
            if ((~anInt3178) != 0) {
