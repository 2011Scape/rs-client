...
public class Class270_Sub1_Sub1 extends Class270_Sub1 {
    ...
    static int method3301(int i, int i_3_, int i_4_, int i_5_) {
        anInt10535++;
    ...
    static void method3302(int i, int i_14_, byte b, int i_15_, int i_16_) {
        if (b >= 90) {
            anInt10534++;
            if (i_15_ != 8 && (~i_15_) != -17) {
                ...
                for (int i_17_ = 0; (~Class83.anInt5183) < (~i_17_); i_17_++) {
                    ...
                    if (class54.aByte822 == i_15_ && (~i) == (~class54.aShort821) && (~i_16_) == (~class54.aShort815) || (~class54.aShort818) == (~i) && i_16_ == class54.aShort815) {
    ...
    static Animable_Sub1 method3303(int i, int i_18_, int i_19_) {
