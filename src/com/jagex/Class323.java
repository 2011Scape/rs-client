...
public class Class323 {
    ...
    static void method3807(int i, int i_0_, int i_1_) {
    ...
    static void method3808(boolean bool, int i) {
        anInt4075++;
    ...
    static void method3809(int i, int i_2_, int i_3_, CacheNode_Sub4 cachenode_sub4) {
        anInt4081++;
        if (Class213.aBoolean2510) {
            ...
            int i_9_ = -i_8_ + i + 13;
            if ((~Class205.anInt5115) > (~(i_6_ + i_9_))) {
    ...
    static byte method3810(int i, boolean bool, int i_10_) {
        if (bool != false) {
            return (byte) 71;
        }
        anInt4078++;
