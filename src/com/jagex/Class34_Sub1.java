...
public class Class34_Sub1 extends Class34 {
    ...
    static void method375(int i, boolean bool, int i_0_, int i_1_, byte b, int i_2_) {
        anInt5523++;
        if ((~i_2_) > -2) {
            i_2_ = 1;
        }
    ...
    static void method382(Animable[] animables, int i, int i_15_) {
        if (i < i_15_) {
            int i_16_ = (i + i_15_) / 2;
            int i_17_ = i;
    ...
    final void method380(int i) {
        ...
        if (aClass312_5544 != null) {
            ...
            if (!aBoolean5543) {
                ...
                while (anArchive5540.anIntArray295.length > anInt5542) {
                    if ((~anArchive5540.anIntArray295[anInt5542]) == -1) {
                        anInt5542++;
                    } else {
        ...
        if (aBoolean5546 && (~Class313.method3650(false)) <= (~aLong5547)) {
    ...
    private CacheNode_Sub16 method383(int i, int i_21_, int i_22_) {
        anInt5516++;
        if (i_22_ != -1) {
            return null;
        }
        ...
        if (cachenode_sub16 instanceof CacheNode_Sub16_Sub2) {
            try {
                ...
                if (anArchive5540.aByteArrayArray298 != null && anArchive5540.aByteArrayArray298[i] != null) {
                    ...
                    for (int i_26_ = 0; (~i_26_) > -65; i_26_++) {
                ...
                if ((~i_27_) != (~(0xffff & anArchive5540.anIntArray293[i]))) {
                    throw new RuntimeException();
                }
                if (aByteArray5525[i] != 1) {
                    anInt5537++;
        ...
        try {
            ...
            if (anArchive5540.aByteArrayArray298 != null && anArchive5540.aByteArrayArray298[i] != null) {
                ...
                for (int i_31_ = 0; (~i_31_) > -65; i_31_++) {
                    if ((~bs_29_[i_31_]) != (~bs_30_[i_31_])) {
                        throw new RuntimeException();
                    }
                }
            }
    ...
    final Archive method374(byte b) {
        ...
        if (!(aCacheNode_Sub16_5519 instanceof CacheNode_Sub16_Sub2)) {
            ...
            try {
                ...
                anArchive5540 = new Archive(bs, anInt5522, aByteArray5526);
                if ((~anInt5536) != (~anArchive5540.anInt292)) {
                    throw new RuntimeException();
                }
            } catch (RuntimeException runtimeexception) {
                anArchive5540 = null;
