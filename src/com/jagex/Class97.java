...
public class Class97 {
    ...
    static void method1076(Packet packet, int i) {
        anInt1274++;
    ...
    static GLSprite method1077(int i, byte[] bs) {
        if (i > -123) {
            aClass103_1277 = null;
        }
        anInt1276++;
        ...
        for (; ; ) {
            try {
                ...
                if (mediatracker.isErrorAny() || i_9_ < 0 || (~i_10_) > -1) {
                    throw new RuntimeException("");
                }
    ...
    static void method1079(byte b, int i, int i_11_, boolean bool, int i_12_, boolean bool_13_, int i_14_) {
        if ((~i) < (~i_11_)) {
            int i_15_ = (i_11_ + i) / 2;
            int i_16_ = i_11_;
    ...
    static void method1080(int i, byte b, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_) {
        anInt1278++;
        if (b >= 62) {
            if ((~Class262_Sub4.anInt7722) >= (~i_23_) && za_Sub2.anInt10513 >= i_21_ && Class384.anInt4906 <= i_22_ && Node_Sub25_Sub1.anInt9936 >= i) {
                if (i_20_ == 1) {
