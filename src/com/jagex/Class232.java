...
public class Class232 {
    ...
    static void method2141(int i, Plane plane) {
    ...
    private Class34_Sub1 method2138(boolean bool, Class6 class6, int i, Class6 class6_6_, int i_7_) {
        anInt2780++;
        if (aBuffer2775 == null) {
            throw new RuntimeException();
        }
        if ((~i) > -1 || i >= aClass34_Sub1Array2777.length) {
            throw new RuntimeException();
        }
    ...
    final void method2140(int i) {
        ...
        if (aClass34_Sub1Array2777 != null) {
            for (int i_10_ = 0; (~i_10_) > (~aClass34_Sub1Array2777.length); i_10_++) {
                if (aClass34_Sub1Array2777[i_10_] != null) {
                    aClass34_Sub1Array2777[i_10_].method385(false);
                }
            }
            for (int i_11_ = i; (~aClass34_Sub1Array2777.length) < (~i_11_); i_11_++) {
