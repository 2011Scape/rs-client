...
public class Node_Sub38_Sub27 extends Node_Sub38 {
    ...
    static void method2878(int i, String string, boolean bool, int i_0_) {
    ...
    static void method2881(int i, byte b, int i_52_, int i_53_, int i_54_) {
        anInt10385++;
    ...
    static Class38 method2882(Buffer buffer, ItemDefinition itemdefinition, int i) {
        anInt10373++;
        Class38 class38 = new Class38(itemdefinition);
        int i_56_ = buffer.method2233(255);
        boolean bool = (i_56_ & 0x1) != 0;
        boolean bool_57_ = (~(i_56_ & 0x2)) != -1;
        boolean bool_58_ = (~(i_56_ & 0x4)) != -1;
        ...
        if (bool) {
            ...
            if ((~itemdefinition.anInt1867) != 0 || itemdefinition.anInt1915 != -1) {
                        ...
                        do {
                            do {
                                if ((~i_64_) != -1) {
                                    ...
                                    aBoolean10377 = (~buffer.method2233(255)) == -2;
                                    return;
                                }
    ...
    private int method2883(int i, int i_65_, int i_66_, int i_67_, int i_68_, int i_69_, int i_70_) {
        anInt10383++;
        int i_71_ = i_67_ >> 12;
        int i_72_ = 1 + i_71_;
        i_67_ &= 0xfff;
