...
public class Class357 {
    ...
    Class357(byte[] bs) {
        ...
        boolean bool = (~buffer.method2233(255)) == -2;
        ...
        if (bool) {
            ...
            for (int i_44_ = 0; (~i_44_) > -257; i_44_++) {
                bs_43_[i_44_] = new byte[is[i_44_]];
                byte b = 0;
                for (int i_45_ = 0; (~i_45_) > (~bs_43_[i_44_].length); i_45_++) {
                    b += buffer.method2214((byte) -86);
                    bs_43_[i_44_][i_45_] = b;
                }
            }
            byte[][] bs_46_ = new byte[256][];
            for (int i_47_ = 0; (~i_47_) > -257; i_47_++) {
            ...
            for (int i_49_ = 0; (~i_49_) > -257; i_49_++) {
                if ((~i_49_) != -33 && (~i_49_) != -161) {
                    for (int i_50_ = 0; i_50_ < 256; i_50_++) {
                        if ((~i_50_) != -33 && (~i_50_) != -161) {
            ...
            if ((~i_13_) == -61) {
                                    ...
                                    if (!string_16_.equals("euro")) {
                                        if (!string_16_.equals("copy")) {
                                            if (string_16_.equals("reg")) {
                                                ...
                                                if (aByteArrayArray4433 != null && (~i_8_) != 0) {
                ...
                if (i_14_ > 0) {
                    ...
                    if (is != null) {
                        ...
                        if ((~is[(~is.length) >= (~i_9_) ? -1 + is.length : i_9_]) > (~i_2_)) {
                            if (i_4_ < 0) {
    ...
    final String method4032(String string, GLSprite[] glsprites, int i, int i_30_) {
        anInt4440++;
        if ((~i) <= (~method4031(104, glsprites, string))) {
            return string;
        }
