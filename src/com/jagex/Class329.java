...
public class Class329 {
    ...
    static boolean method3833(byte b, int i) {
        anInt4124++;
        if (b != -61) {
            method3835(null, true);
        }
        if ((~i) != -8 && i != 8 && (~i) != -10 && (~i) != -11) {
            return false;
        }
        return true;
    }

    static void method3834(int i, int i_0_, int i_1_, aa var_aa, GraphicsToolkit graphicstoolkit, int i_2_, int i_3_, int i_4_, Widget widget) {
        anInt4120++;
        ...
        if (class79 != null && class79.aBoolean1079 && class79.method784((byte) 109, Class24.aClass275_442)) {
            if (class79.anIntArray1049 != null) {
                ...
                if (class79.anInt1074 > 0) {
                    ...
                    for (int i_24_ = 0; (~i_24_) > (-(is.length / 2)); i_24_++)
    ...
    static String method3835(byte[] bs, boolean bool) {
        if (bool != true) {
            return null;
        }
        anInt4121++;
    ...
    static void method3836(int i, int i_26_, int i_27_, int i_28_, int i_29_, int i_30_, int i_31_) {
