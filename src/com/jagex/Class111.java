...
public class Class111 {
    ...
    static synchronized void method1137(byte[] bs, int i) {
        anInt1414++;
        if ((~bs.length) == -101 && AnimableAnimator_Sub1.anInt9090 < 1000) {
            Class144.aByteArrayArray1782[AnimableAnimator_Sub1.anInt9090++] = bs;
        } else if ((~bs.length) == -5001 && (~CacheNode_Sub16_Sub2.anInt11085) > -251) {
            Animable_Sub4_Sub2.aByteArrayArray10804[CacheNode_Sub16_Sub2.anInt11085++] = bs;
        } else if ((~bs.length) == -30001 && Class22.anInt429 < 50) {
            ...
            if (Class113.aByteArrayArrayArray1447 != null) {
                for (int i_0_ = 0; CacheNode_Sub1.anIntArray9427.length > i_0_; i_0_++) {
                    if ((~CacheNode_Sub1.anIntArray9427[i_0_]) == (~bs.length) && (~Class113.aByteArrayArrayArray1447[i_0_].length) < (~Class132.anIntArray1682[i_0_])) {
    ...
    static int method1138(String string, byte[] bs, byte b, int i) {
        anInt1417++;
        if (b >= -65) {
            anInt1418 = -11;
        }
        ...
        for (int i_3_ = 0; (~i_3_) > (~i_2_); i_3_ += 4) {
            ...
            int i_5_ = (~(i_3_ - -1)) <= (~i_2_) ? -1 : Node_Sub16.method2591((byte) -115, string.charAt(i_3_ + 1));
            int i_6_ = (~i_2_) < (~(i_3_ - -2)) ? Node_Sub16.method2591((byte) -115, string.charAt(2 + i_3_)) : -1;
    ...
    static synchronized byte[] method1139(boolean bool, int i) {
        anInt1416++;
        ...
        if (i == 5000 && (~CacheNode_Sub16_Sub2.anInt11085) < -1) {
        ...
        if (Class113.aByteArrayArrayArray1447 != null) {
            for (int i_8_ = 0; i_8_ < CacheNode_Sub1.anIntArray9427.length; i_8_++) {
                if ((~i) == (~CacheNode_Sub1.anIntArray9427[i_8_]) && Class132.anIntArray1682[i_8_] > 0) {
