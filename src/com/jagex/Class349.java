...
public class Class349 {
    ...
    static void method3984(int i, int i_0_) {
    ...
    static void method3985(Widget widget, int i, int i_3_, int i_4_) {
        anInt4317++;
    ...
    static boolean method3988(byte b, int i, int i_15_) {
        anInt4309++;
    ...
    static int method3989(int i, byte b) {
        anInt4301++;
        if (i != 6406) {
            if (i != 6409) {
                if ((~i) != -32842) {
    ...
    private void method3983(boolean bool, int i, Interface1 interface1) {
        anInt4302++;
        if (i != 0) {
            if (bool != false) {
    ...
    private void method3986(byte b) {
        anInt4306++;
        if (aBoolean4307) {
            if (b != 97) {
