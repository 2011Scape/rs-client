...
public class Class242 {
    ...
    Class242() {
        ...
        if (i > 0) {
            ...
            int[] anIntArray3059 = new int[i_27_];
    ...
    private static int method3054(int i, int i_0_) {
        int i_1_;
            ...
            if (i_13_ != 0) {
                ...
                for (int i_16_ = 0; i_16_ < i_13_; i_16_++) {
                    ...
                    if (i_15_ >= anIntArray3063.length) {
                        ...
                        System.arraycopy(anIntArray3063, 0, is_18_, 0, anIntArray3063.length);
                        anIntArray3063 = is_18_;
                    }
                    i_17_ >>>= 1;
                }
                anIntArray3063[i_15_] = ~i_12_;
                if (i_15_ >= i) {
                    i = i_15_ + 1;
                }
            }
