...
public class Class240 {
    ...
    static Class151 method3028(byte b, int i) {
        anInt2950++;
    ...
    static String method3030(int i, Throwable throwable) throws IOException {
        anInt2936++;
        if (i != 0) {
            method3029(-11);
        }
    ...
    static void method3031(int i, int i_8_, int i_9_, boolean bool, int i_10_, int i_11_, int i_12_, int i_13_) {
        anInt2935++;
