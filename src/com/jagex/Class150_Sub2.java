...
public class Class150_Sub2 extends Class150 {
    ...
    static boolean method1659(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_) {
        anInt8961++;
        if ((~i_1_) <= (~(i - -i_3_)) || i >= i_1_ + i_0_) {
            return false;
        }
        if ((~(i_6_ + i_4_)) >= (~i_5_) || (~i_6_) <= (~(i_7_ + i_5_))) {
            return false;
        }
        if (i_2_ >= -12) {
            return false;
    ...
    static Class357 method1660(byte b, int i, GraphicsToolkit graphicstoolkit) {
        int i_8_ = -37 / ((b - 30) / 52);
        anInt8957++;
