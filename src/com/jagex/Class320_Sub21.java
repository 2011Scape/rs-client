...
public class Class320_Sub21 extends Class320 {
    ...
    static void method3760(boolean bool, GraphicsToolkit graphicstoolkit) {
    ...
    static Class169_Sub2_Sub1 method3761(int i, int i_0_, int i_1_, byte[] bs, int i_2_, GLToolkit gltoolkit, int i_3_, boolean bool) {
        if (i_1_ != 8222) {
            anInt8406 = -66;
        }
        anInt8409++;
    ...
    static byte[] method3763(int i, String string) {
        anInt8404++;
    ...
    final int method3677(int i) {
        ...
        if ((~aNode_Sub27_4063.method2694(i + -13725).method1881((byte) 25)) < -2) {
            return 4;
        }
        return 2;
    }
