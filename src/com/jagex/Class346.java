...
public class Class346 {
    ...
    static boolean method3973(int i, int i_0_, int i_1_) {
        if (i_0_ != 18518) {
    ...
    static GraphicsToolkit method3974(int i, int i_2_, d var_d, int i_3_, java.awt.Canvas canvas) {
        if (i_2_ != 31206) {
            return null;
        }
        anInt4279++;
    ...
    static void method3975(int i, int i_4_, Widget[] widgets) {
        for (int i_5_ = 0; i_5_ < widgets.length; i_5_++) {
            ...
            if (widget != null && widget.anInt4692 == i_4_ && !client.method112(widget)) {
                if ((~widget.anInt4841) == -1) {
                    ...
                    Node_Sub2 node_sub2 = (Node_Sub2) Class289.aHashTable3630.method1518(3512, widget.anInt4822);
                    if (node_sub2 != null) {
                        Class290_Sub1.method3424(-23620, node_sub2.anInt6933);
                    }
                }
                if (widget.anInt4841 == 6 && (~widget.anInt4773) != 0) {
