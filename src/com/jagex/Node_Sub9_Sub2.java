...
public class Node_Sub9_Sub2 extends Node_Sub9 {
    ...
    private static int method2473(byte[] bs, int[] is, int i, int i_12_, int i_13_, int i_15_, int i_16_, Node_Sub9_Sub2 node_sub9_sub2) {
        i >>= 8;
        i_16_ >>= 8;
        i_13_ <<= 2;
        int i_14_;
    ...
    private static int method2475(byte[] bs, int[] is, int i_18_, int i_19_, int i_20_, int i_21_, int i_23_, int i_24_, Node_Sub9_Sub2 node_sub9_sub2, int i_25_, int i_26_) {
        int i_22_;
    ...
    private static int method2476(byte[] bs, int[] is, int i_28_, int i_29_, int i_30_, int i_31_, int i_32_, int i_33_, int i_35_, int i_36_, Node_Sub9_Sub2 node_sub9_sub2, int i_37_, int i_38_) {
    ...
    private static int method2479(byte[] bs, int[] is, int i_41_, int i_42_, int i_43_, int i_45_, int i_46_, Node_Sub9_Sub2 node_sub9_sub2, int i_47_, int i_48_) {
        int i_44_;
    ...
    private static int method2484(byte[] bs, int[] is, int i, int i_54_, int i_55_, int i_56_, int i_58_, int i_59_, Node_Sub9_Sub2 node_sub9_sub2) {
        i >>= 8;
        i_59_ >>= 8;
        i_55_ <<= 2;
        i_56_ <<= 2;
    ...
    private static int method2487(byte[] bs, int[] is, int i_61_, int i_62_, int i_63_, int i_64_, int i_66_, int i_67_, Node_Sub9_Sub2 node_sub9_sub2, int i_68_, int i_69_) {
        int i_65_;
    ...
    private static int method2488(byte[] bs, int[] is, int i_70_, int i_71_, int i_72_, int i_73_, int i_74_, int i_75_, int i_77_, int i_78_, Node_Sub9_Sub2 node_sub9_sub2) {
        i_70_ >>= 8;
        i_78_ >>= 8;
        i_72_ <<= 2;
        i_73_ <<= 2;
    ...
    private static int method2489(byte[] bs, int[] is, int i_80_, int i_81_, int i_82_, int i_83_, int i_84_, int i_85_, int i_87_, int i_88_, Node_Sub9_Sub2 node_sub9_sub2, int i_89_, int i_90_) {
    ...
    private static int method2491(int i, int i_91_) {
        if (i_91_ < 0) {
            return -i;
        }
    ...
    private static int method2492(byte[] bs, int[] is, int i_92_, int i_93_, int i_94_, int i_95_, int i_97_, int i_98_, Node_Sub9_Sub2 node_sub9_sub2) {
        i_92_ >>= 8;
        i_98_ >>= 8;
        i_94_ <<= 2;
        i_95_ <<= 2;
    ...
    private static int method2493(int i, int i_99_) {
        if (i_99_ < 0) {
            return i;
        }
    ...
    private static int method2494(byte[] bs, int[] is, int i_101_, int i_102_, int i_103_, int i_104_, int i_106_, int i_107_, Node_Sub9_Sub2 node_sub9_sub2, int i_108_, int i_109_) {
    ...
    private static int method2495(byte[] bs, int[] is, int i, int i_110_, int i_111_, int i_112_, int i_114_, int i_115_, Node_Sub9_Sub2 node_sub9_sub2) {
        i >>= 8;
        i_115_ >>= 8;
        i_111_ <<= 2;
        i_112_ <<= 2;
    ...
    private static int method2497(byte[] bs, int[] is, int i_116_, int i_117_, int i_118_, int i_119_, int i_121_, int i_122_, Node_Sub9_Sub2 node_sub9_sub2) {
        i_116_ >>= 8;
        i_122_ >>= 8;
        i_118_ <<= 2;
        i_119_ <<= 2;
    ...
    private static int method2502(byte[] bs, int[] is, int i_130_, int i_131_, int i_132_, int i_134_, int i_135_, Node_Sub9_Sub2 node_sub9_sub2, int i_136_, int i_137_) {
        int i_133_;
    ...
    private static int method2505(byte[] bs, int[] is, int i_138_, int i_139_, int i_140_, int i_141_, int i_142_, int i_143_, int i_145_, int i_146_, Node_Sub9_Sub2 node_sub9_sub2) {
        i_138_ >>= 8;
        i_146_ >>= 8;
        i_140_ <<= 2;
        i_141_ <<= 2;
    ...
    private static int method2506(byte[] bs, int[] is, int i, int i_153_, int i_154_, int i_156_, int i_157_, Node_Sub9_Sub2 node_sub9_sub2) {
        i >>= 8;
        i_157_ >>= 8;
        i_154_ <<= 2;
        int i_155_;
    ...
    static Node_Sub9_Sub2 method2509(Node_Sub45_Sub1 node_sub45_sub1, int i, int i_161_, int i_162_) {
    ...
    private static int method2510(byte[] bs, int[] is, int i_164_, int i_165_, int i_166_, int i_167_, int i_169_, int i_170_, Node_Sub9_Sub2 node_sub9_sub2, int i_171_, int i_172_) {
    ...
    private int method2472(int[] is, int i, int i_0_, int i_1_, int i_2_) {
        while (anInt9715 > 0) {
            ...
            if (anInt9710 == -256 && (anInt9718 & 0xff) == 0) {
                if (DrawableModel.aBoolean913) {
                    i = method2505(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9711, anInt9708, anInt9714, anInt9719, i_3_, i_0_, this);
                } else {
                    i = method2495(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9707, anInt9709, i_3_, i_0_, this);
                }
            } else if (DrawableModel.aBoolean913) {
                i = method2489(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9711, anInt9708, anInt9714, anInt9719, i_3_, i_0_, this, anInt9710, i_2_);
            } else {
                i = method2510(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9707, anInt9709, i_3_, i_0_, this, anInt9710, i_2_);
            }
            anInt9715 -= i;
            if (anInt9715 != 0) {
                return i;
        ...
        if (anInt9710 == -256 && (anInt9718 & 0xff) == 0) {
            if (DrawableModel.aBoolean913) {
                return method2497(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9711, anInt9708, i_1_, i_0_, this);
            }
            return method2506(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9707, i_1_, i_0_, this);
        }
        if (DrawableModel.aBoolean913) {
            return method2487(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9711, anInt9708, i_1_, i_0_, this, anInt9710, i_2_);
        }
        return method2502(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9707, i_1_, i_0_, this, anInt9710, i_2_);
    }
    ...
    private int method2480(int[] is, int i, int i_49_, int i_50_, int i_51_) {
        while (anInt9715 > 0) {
            ...
            if (anInt9710 == 256 && (anInt9718 & 0xff) == 0) {
                if (DrawableModel.aBoolean913) {
                    i = method2488(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9711, anInt9708, anInt9714, anInt9719, i_52_, i_49_, this);
                } else {
                    i = method2484(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9707, anInt9709, i_52_, i_49_, this);
                }
            } else if (DrawableModel.aBoolean913) {
                i = method2476(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9711, anInt9708, anInt9714, anInt9719, i_52_, i_49_, this, anInt9710, i_51_);
            } else {
                i = method2494(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9707, anInt9709, i_52_, i_49_, this, anInt9710, i_51_);
            }
            anInt9715 -= i;
            if (anInt9715 != 0) {
                return i;
        ...
        if (anInt9710 == 256 && (anInt9718 & 0xff) == 0) {
            if (DrawableModel.aBoolean913) {
                return method2492(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9711, anInt9708, i_50_, i_49_, this);
            }
            return method2473(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9707, i_50_, i_49_, this);
        }
        if (DrawableModel.aBoolean913) {
            return method2475(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9711, anInt9708, i_50_, i_49_, this, anInt9710, i_51_);
        }
        return method2479(((Node_Sub45_Sub1) aNode_Sub45_7075).aByteArray10504, is, anInt9718, i, anInt9707, i_50_, i_49_, this, anInt9710, i_51_);
    }
    ...
    private synchronized void method2485(int i) {
    ...
    private synchronized void method2500(int i, int i_123_) {
        anInt9716 = i;
        anInt9713 = i_123_;
        anInt9715 = 0;
        method2477();
