...
public class Class320_Sub3 extends Class320 {
    ...
    static void method3690(int i, int i_0_) {
        Class320_Sub23.aClass123_8432 = Class218.worldResponseBuffer;
        anInt8227++;
        Class159.anInt1996 = 2;
        Node_Sub38_Sub23.anInt10347 = i_0_;
        Class129.method1556(Class188_Sub1_Sub1.aString9327.isEmpty(), Class188_Sub1_Sub1.aString9327, true, true, "");
        if (i != -11055) {
            method3687(102);
        }
    }

    static void method3692(byte[] bs, byte b, boolean bool) {
        anInt8231++;
    ...
    final void method3673(byte b) {
        if (b < -35) {
            ...
            if (method3689((byte) 124)) {
                ...
                if ((~aNode_Sub27_4063.aClass320_Sub1_7313.method3678(false)) == -2) {
                    anInt4064 = 1;
                }
            }
            if (anInt4064 == 3) {
