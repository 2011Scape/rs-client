...
public class Node_Sub3 extends Node {
    ...
    static Widget method2169(int i, int i_0_, int i_1_) {
        anInt6940++;
        if (i != -101) {
        ...
        if (widget == null || widget.aWidgetArray4804 == null || (~i_0_) <= (~widget.aWidgetArray4804.length)) {
            return null;
        }
        return widget.aWidgetArray4804[i_0_];
    }

    static void method2170(int i, long[] ls, int[] is) {
        Class125.method1530((byte) -114, -1 + ls.length, is, ls, 0);
        anInt6938++;
        int i_2_ = -117 / ((64 - i) / 43);
    }

    static boolean method2171(int i, int i_4_, byte b, Class171 class171, int i_5_, int i_6_, int i_7_) {
        anInt6939++;
    ...
    static String method2172(byte b, Buffer buffer) {
        anInt6944++;
        if (b != -72) {
            return null;
        }
