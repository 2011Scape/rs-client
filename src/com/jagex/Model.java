...
public class Model {
        ...
        for (int i_222_ = 0; i_222_ < i; i_222_++) {
            ...
            if (model_223_ != null) {
                for (int i_224_ = 0; i_224_ < model_223_.anInt2572; i_224_++) {
                    if (bool_206_) {
                        aByteArray2610[i_221_++] = (byte) (model_223_.aByteArray2610 == null || (~model_223_.aByteArray2610[i_224_]) == 0 ? -1 : model_223_.aByteArray2610[i_224_] + anInt2611);
                    }
                }
    ...
    static void method2092(int i, byte b, int i_191_, int i_192_) {
        anInt2595++;
    ...
    final int method2079(int i, int i_0_, int i_1_, int i_2_) {
        ...
        for (int i_3_ = 0; i_3_ < anInt2599; i_3_++) {
            if ((~i_2_) == (~anIntArray2616[i_3_]) && i_1_ == anIntArray2576[i_3_] && i_0_ == anIntArray2574[i_3_]) {
                return i_3_;
            }
        }
    ...
    final void method2081(int i, int i_9_) {
        for (int i_10_ = i_9_; (~i_10_) > (~anInt2599); i_10_++) {
    ...
    private void method2084(byte[] bs, boolean bool) {
        anInt2597++;
        ...
        boolean bool_31_ = (~(i & 0x1)) == -2;
        boolean bool_32_ = (i & 0x2) == 2;
        boolean bool_33_ = (~(i & 0x4)) == -5;
        boolean bool_34_ = (~(i & 0x8)) == -9;
        if (bool_34_) {
            buffer.anInt7002 -= 7;
        ...
        if ((~anInt2611) < -1) {
            aByteArray2586 = new byte[anInt2611];
            buffer.anInt7002 = 0;
            for (int i_48_ = 0; (~anInt2611) < (~i_48_); i_48_++) {
        ...
        short s_82_ = 0;
        int i_83_ = 0;
        for (int i_84_ = 0; (~anInt2572) < (~i_84_); i_84_++) {
    ...
    final void method2085(int i, int i_102_, int i_103_, int i_104_) {
        if (i != 0) {
            ...
            for (int i_107_ = 0; (~anInt2599) < (~i_107_); i_107_++) {
        ...
        if ((~i_104_) != -1) {
            ...
            for (int i_115_ = 0; (~anInt2599) < (~i_115_); i_115_++) {
    ...
    final int[][] method2088(byte b) {
        ...
        int[] is = new int[256];
        int i = 0;
        for (int i_128_ = 0; (~i_128_) > (~aClass17Array2621.length); i_128_++) {
    ...
    final int[][] method2090(byte b) {
        ...
        for (int i_141_ = 0; (~i_141_) > (~anInt2572); i_141_++) {
    ...
    private void method2091(int i, byte[] bs) {
        anInt2579++;
        boolean bool = false;
    ...
    private int method2093(Model model_193_, int i, int i_194_, short s) {
        anInt2601++;
        ...
        for (int i_198_ = i; anInt2599 > i_198_; i_198_++) {
            if ((~anIntArray2616[i_198_]) == (~i_195_) && (~anIntArray2576[i_198_]) == (~i_196_) && i_197_ == anIntArray2574[i_198_]) {
