...
class Class235 implements Interface7 {
    static int anInt5117;
    static Class318 aClass318_5119;
    static int anInt5120;
    static int anInt5121;
    static int anInt5122 = 0;
    static Class318 aClass318_5126;
    static int anInt5127;

    static {
        aClass318_5119 = new Class318(22, 2);
        aClass318_5126 = new Class318(32, -1);
    }
    ...
    static boolean method2157(String string, int i) {
        anInt5121++;
        if (i != -7746) {
            method2157(null, 61);
        }
