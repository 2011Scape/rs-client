...
public class Class382 implements Interface11 {
    ...
    static int method4179(Class289 class289, byte b, GraphicsToolkit graphicstoolkit) {
        int i = -55 / ((-77 - b) / 43);
        anInt5255++;
        if (class289.anInt3629 != -1) {
            return class289.anInt3629;
        }
        if ((~class289.anInt3640) != 0) {
    ...
    private void method4176(int i, Class169_Sub1 class169_sub1, int i_1_, int i_2_, boolean bool) {
        anInt5235++;
        if (bool != false) {
            aBoolean5254 = true;
        }
    ...
    final void method4178(CacheNode_Sub17 cachenode_sub17, int i, int i_4_) {
        ...
        } else if ((~anInt5256) != (~cachenode_sub17.anInt8837) || (~cachenode_sub17.anInt8850) != (~anInt5238)) {
            throw new RuntimeException();
        }
    ...
    private void method4184(int i, int i_11_, int i_12_, Class169_Sub2 class169_sub2) {
        anInt5253++;
        if (anInt5234 == -1) {
            throw new RuntimeException();
        }
        int i_13_ = 1 << i;
        if (((~i_13_) & anInt5259) == i_12_) {
