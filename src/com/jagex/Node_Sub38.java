...
abstract class Node_Sub38 extends Node {
    ...
    static void method2779(Widget widget, int i, GraphicsToolkit graphicstoolkit) {
        anInt7448++;
        if (i == 28564) {
    ...
    static int method2781(int i, int i_4_, int i_5_, int i_6_) {
        i_4_ &= 0x3;
        anInt7459++;
        if (i_4_ == 0) {
            return i;
    ...
    static float[] method2784(boolean bool, float[] fs, int i) {
        if (bool) {
            return null;
        }
        anInt7455++;
    ...
    void method2782(int i, int i_7_, boolean bool) {
        ...
        int i_8_ = (~anInt7450) == -256 ? i : anInt7450;
        if (!aBoolean7463) {
