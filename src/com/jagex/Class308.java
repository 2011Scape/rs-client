...
public class Class308 {
    ...
    private final Class302 aClass302_3906;
    private final Class61 aClass61_3908 = new Class61(64);
    ...
    static Widget method3585(Widget widget, boolean bool) {
        anInt3911++;
        if (bool) {
    ...
    final CacheNode_Sub6 method3584(int i, int i_0_) {
        ...
        synchronized (aClass61_3908) {
            cachenode_sub6 = (CacheNode_Sub6) aClass61_3908.method607(i, 0);
        }
        ...
        synchronized (aClass61_3908) {
            aClass61_3908.method601(cachenode_sub6, 25566, i);
        }
        if (i_0_ != -13798) {
