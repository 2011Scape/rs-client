...
public class Class371 {
    ...
    static void method4092(int i, int i_0_, Rectangle[] rectangles) throws Exception_Sub1 {
    ...
    static boolean method4094(int i, boolean bool) {
        anInt4580++;
        if (bool != false) {
            method4097(17, -80, 66);
        }
    ...
    static void method4097(int i, int i_2_, int i_3_) {
        anInt4573++;
    ...
    private int method4098(int i, int i_5_) {
        if (i_5_ != 0) {
            anInt4574 = -53;
        }
        anInt4582++;
    ...
    private void method4100(int i, byte b) {
        anInt4584++;
    ...
    private void method4101(byte b, int i, String string) {
        anInt4578++;
        int i_7_ = 1 / ((-32 - b) / 50);
        if ((~anInt4576) > (~i)) {
            anInt4576 = i;
