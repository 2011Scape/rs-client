...
abstract class Animable_Sub3 extends Animable {
    ...
    static void method919(int i, int i_2_, int i_3_, int i_4_, int i_5_, boolean bool, int i_6_) {
        anInt9143++;
        if (i_2_ > i_5_ || i_3_ < 512 || (~(-1024 + Node_Sub54.anInt7675 * 512)) > (~i_5_) || (~(-1024 + Class377_Sub1.anInt8774 * 512)) > (~i_3_)) {
    ...
    static void method921(int i, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_) {
        anInt9133++;
