...
public class Node_Sub38_Sub9 extends Node_Sub38 {
    ...
    static void method2820(boolean bool) {
        anInt10177++;
    ...
    static void method2822(Class302 class302, int i) {
        anInt10189++;
        Packet.anInt9386 = i;
    ...
    private void method2819(int i, int i_1_, int i_2_, int i_3_) {
        anInt10179++;
        if (i_1_ == 2) {
    ...
    private void method2823(int i, byte b, int i_13_, int i_14_) {
        anInt10178++;
        ...
        if (b == -2) {
            if ((~i_17_) < -1) {
                ...
                if (i_15_ == i) {
                    anInt10185 = (~i_14_) != (~i_16_) ? 4096 - i_19_ : 20480 + i_20_;
                } else if (i_15_ == i_14_) {
                    anInt10185 = i_16_ == i_13_ ? 4096 + i_18_ : -i_20_ + 12288;
                } else {
                    anInt10185 = (~i_16_) != (~i) ? -i_18_ + 20480 : i_19_ + 12288;
                }
                anInt10185 /= 6;
            } else {
                anInt10185 = 0;
            }
            if (anInt10176 > 0 && (~anInt10176) > -4097) {
    ...
    final int[][] method2778(int i, boolean bool) {
        ...
        if (aClass348_7454.aBoolean4300) {
            ...
            for (int i_28_ = 0; (~i_28_) > (~Class339_Sub7.anInt8728); i_28_++) {
                ...
                for (/**/; (~anInt10185) < -4097; anInt10185 -= 4096) {
                    /* empty */
                }
                if (anInt10174 < 0) {
                    anInt10174 = 0;
