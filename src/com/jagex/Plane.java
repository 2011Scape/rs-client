...
abstract class Plane {
    ...
    static int method3249(int i, int i_6_, int i_7_, int i_8_) {
        if (i_6_ < 18) {
            anInt3423 = 33;
        }
        anInt3405++;
    ...
    static void method3258(int i, int i_55_, int i_56_) {
        anInt3402++;
        ...
        if ((~Class360.windowWidth) > (~(i_57_ + i_61_))) {
    ...
    final int method3260(int i, int i_68_, int i_69_) {
        ...
        if ((~i_70_) > -1 || i_71_ < 0 || (~(anInt3408 + -1)) > (~i_70_) || -1 + anInt3404 < i_71_) {
            return 0;
        }
