...
public class Class28 {
    ...
    static void method331(String string, String string_0_, int i, int i_1_, String string_2_, String string_3_, int i_4_) {
        Node_Sub50.method2966(string_3_, string_0_, -1, string, null, false, i_1_, string_2_, i_4_);
        int i_5_ = 33 % ((i - 36) / 62);
        anInt467++;
    }

    static void method332(int i, Widget widget) {
        anInt469++;
    ...
    static void method333(Class37 class37, int i) {
        anInt468++;
