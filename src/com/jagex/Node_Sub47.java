...
public class Node_Sub47 extends Node {
    ...
    static int method2952(boolean bool, int i) {
        anInt7585++;
        if (bool != false) {
            return -87;
        }
    ...
    static void method2953(int i, int i_2_, boolean bool, int i_3_, int i_4_, float[] fs, int i_5_) {
        anInt7557++;
        if ((~i_3_) < -1 && !Class371.method4094(i_3_, false)) {
            throw new IllegalArgumentException("");
        }
        if ((~i_2_) < -1 && !Class371.method4094(i_2_, false)) {
            throw new IllegalArgumentException("");
        }
    ...
    final void method2951(int i) {
        ...
        if (i == 918119625) {
            ...
            if (((~anInt7564) != (~i_0_) || !aBoolean7580 == bool) && aNode_Sub9_Sub2_7568 != null) {
