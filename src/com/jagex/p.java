...
public class p extends Node implements Interface3 {
    ...
    private native void K(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_);

    private native void H(int i, int i_6_, int i_7_, int i_8_);
    ...
    private void method2769(Exception exception) {
        if (!aBoolean5017) {
    ...
    private native void sa(oa var_oa, java.awt.Canvas canvas, int i, int i_13_);
    ...
    private native void oa(java.awt.Canvas canvas, int i, int i_15_);
}
