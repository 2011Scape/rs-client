	...
	static final void method3470(GraphicsToolkit graphicstoolkit, int i) {
		...
		if (((Class315.anInt4035 ^ 0xffffffff) <= -3 || Class87.aBoolean1185) && Class58.aWidget861 == null) {
			...
			if (!Class87.aBoolean1185 || (Class315.anInt4035 ^ 0xffffffff) <= -3) {
				...
				string = Class84.aString1148 + Localization.spaceCharacter.getLocalizationString(-12273, Class35.clientLanguage) + Class66.aString5177 + " ->";
			}
			if ((Class315.anInt4035 ^ 0xffffffff) < -3) {
				string += "<col=ffffff> / " + (Class315.anInt4035 - 2) + Localization.moreOptions.getLocalizationString(-12273, Class35.clientLanguage);
			}
