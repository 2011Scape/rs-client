...
public class Class295 {
    ...
    static Widget method3468(byte b, Widget widget) {
        anInt3699++;
        if ((~widget.anInt4692) != 0) {
    ...
    static void method3469(int i, byte b) {
    ...
    static void method3470(GraphicsToolkit graphicstoolkit, int i) {
        anInt3696++;
        if (((~Class315.anInt4035) <= -3 || Class87.aBoolean1185) && Class58.aWidget861 == null) {
            int i_0_ = 87 / ((-34 - i) / 61);
            String string;
            if (!Class87.aBoolean1185 || (~Class315.anInt4035) <= -3) {
    ...
    static int method3471(byte b) {
        anInt3693++;
        int i = 37 / ((b - 15) / 35);
        return Class243.aClass340_3069.method3959(255);
    }

    static Node_Sub16 method3472(int i, byte b, boolean bool) {
        if (b != 18) {
            return null;
        }
        anInt3698++;
