...
public class Class310 {
    ...
    static void method3589(int i, int i_0_, byte b, int i_1_, int i_2_) {
    ...
    static byte[] method3593(int i, int i_5_, boolean bool, byte[] bs) {
        anInt3922++;
    ...
    static Class192[] method3596(byte b) {
        if (b != -59) {
            return null;
        }
        anInt3937++;
    ...
    static boolean method3601(String string, String string_18_, int i, String string_19_, String string_20_) {
        anInt3940++;
        if (i != 30195) {
    ...
    private void method3595(int i, int i_7_, byte b, boolean bool) {
        if (b < -54) {
            anInt3952++;
            int i_8_ = i_7_;
            ...
            if (i_8_ == -1) {
                ...
                if (objectdefinition.anIntArray2984 != null) {
                    objectdefinition = objectdefinition.method3038(13, (~aa.anInt101) != -4 ? (Interface17) Class24.aClass275_442 : ProducingGraphicsBuffer.anInterface17_9901);
                }
    ...
    final DrawableModel method3597(GraphicsToolkit graphicstoolkit, boolean bool, boolean bool_11_, boolean bool_12_, int i) {
        ...
        if (!aBoolean3919 && (~anInt3928) != (~objectdefinition.anInt3030)) {
        ...
        if (bool_12_) {
            bool_12_ = bool_12_ & (aBoolean3932 & !aBoolean3949 & (~Class213.aNode_Sub27_2512.aClass320_Sub12_7282.method3730(false)) != -1);
        }
        if (bool && !bool_12_) {
        ...
        Plane plane_13_;
        if (!aBoolean3921) {
            plane_13_ = (~aByte3944) <= -4 ? null : Class320_Sub10.aPlaneArray8300[1 + aByte3944];
        } else {
        ...
        if (anAnimator3918.method245(-125)) {
            ...
            drawablemodel = objectdefinition.method3048(anInt3926 != 11 ? anInt3951 : 4 + anInt3951, anAnimable3920.anInt5940, (~anInt3926) != -12 ? anInt3926 : 10, anAnimable3920.anInt5934, plane_13_, anAnimator3918, 1521375267, graphicstoolkit, plane, aClass121_3930, i, plane.method3260(anAnimable3920.anInt5940, -127, anAnimable3920.anInt5934));
            ...
            aDrawableModel3939 = null;
        } else if (aDrawableModel3939 != null && (i & aDrawableModel3939.ua()) == i && (~objectdefinition.anInt3030) == (~anInt3928)) {
            drawablemodel = aDrawableModel3939;
        } else {
            if (aDrawableModel3939 != null) {
                i |= aDrawableModel3939.ua();
            }
            Class243 class243 = objectdefinition.method3046((~anInt3926) != -12 ? anInt3951 : anInt3951 + 4, anAnimable3920.anInt5940, anAnimable3920.anInt5934, plane, bool_12_, (byte) 0, plane.method3260(anAnimable3920.anInt5940, -124, anAnimable3920.anInt5934), (~anInt3926) == -12 ? 10 : anInt3926, graphicstoolkit, aClass121_3930, i, plane_13_);
            if (class243 != null) {
    ...
    private void method3599(Animable animable, boolean bool) {
        anInt3950++;
    ...
    final void method3600(int i, DrawableModel drawablemodel, boolean bool, int i_14_, GraphicsToolkit graphicstoolkit, int i_15_, int i_16_, int i_17_, Class336 class336) {
        ...
        if (i_14_ == -9827) {
            ...
            if ((anEntityNode_Sub4_3931 == null || anEntityNode_Sub4_3931.aBoolean5972) && (class300s != null || class218s != null)) {
                ...
                if (objectdefinition.anIntArray2984 != null) {
                    objectdefinition = objectdefinition.method3038(i_14_ + 9840, (~aa.anInt101) == -4 ? (Interface17) ProducingGraphicsBuffer.anInterface17_9901 : Class24.aClass275_442);
                }
                if (objectdefinition != null) {
