...
public class ProducingGraphicsBuffer extends GraphicsBuffer implements ImageProducer {
    ...
    static boolean method2603(int i, boolean bool, int i_9_) {
        if (bool != false) {
    ...
    static void method2604(int i, int i_10_) {
        anInt9885++;
    ...
    private synchronized void method2599(int i, int i_6_, int i_7_, boolean bool, int i_8_) {
        anInt9891++;
    ...
    private synchronized void method2600(int i) {
        anInt9883++;
        if (anImageConsumer9899 != null) {
