...
public class RuntimeException_Sub1 extends RuntimeException {
    ...
    static boolean method4207(int i, int i_0_) {
        anInt4917++;
        if (i_0_ != 19154) {
            aClass318_4920 = null;
        }
    ...
    static void method4209(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_) {
        anInt4915++;
        if (i_3_ > -41) {
            method4207(38, 72);
        }
        if ((~i_8_) == (~i_5_) && i_1_ == i && i_4_ == i_9_ && (~i_7_) == (~i_6_)) {
            ...
            for (int i_24_ = 128; (~i_24_) >= -4097; i_24_ += 128) {
