...
abstract class Class189 {
    ...
    static short[] method1916(byte b, int i, short[] ses) {
        anInt2293++;
        int i_1_ = -3 % ((39 - b) / 35);
    ...
    private Node_Sub25 method1915(byte b) throws IOException {
        anInt2312++;
        if (aBoolean2299) {
    ...
    private void method1918(int i) throws IOException {
        anInt2314++;
    ...
    private boolean method1919(int i) {
        anInt2323++;
        if (i <= 124) {
            method1927(98);
        }
            ...
            while (!aBoolean2299) {
                ...
                if (node_sub25 != aNode_Sub25_Sub1_2310) {
                    if (!(node_sub25 instanceof Node_Sub25_Sub4)) {
                        if (aNode_Sub25_Sub3_2316 == node_sub25) {
                            if (aNode_Sub25_Sub1_2310 == null && !aBoolean2304) {
                                for (int i = 0; (~i) > -11 && method1919(126); i++) {
                                    method1918(-17507);
                                    if (aBoolean2299) {
                                        break;
                                    }
                    ...
                    while (aNode_Sub25_Sub1_2310.anOggStreamState7235.packetOut(anOggPacket2324) == 1) {
                        ...
                        if ((~aNode_Sub25_Sub1_2310.method2663(-103)) <= -51) {
                            return;
                        }
                    }
                }
    ...
    private void method1923(byte b) {
        anInt2303++;
    ...
    private void method1931(byte b) {
