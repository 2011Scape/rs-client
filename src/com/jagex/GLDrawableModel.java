...
public class GLDrawableModel extends DrawableModel {
    ...
    GLDrawableModel(GLToolkit gltoolkit, Model model, int i, int i_663_, int i_664_, int i_665_) {
        ...
        for (int i_666_ = 0; (~model.anInt2572) < (~i_666_); i_666_++) {
            if (model.aByteArray2594 == null || model.aByteArray2594[i_666_] != 2) {
                if (model.aShortArray2587 != null && (~model.aShortArray2587[i_666_]) != 0) {
                    ...
                    if (((~(0x40 & anInt5653)) == -1 || !class91.aBoolean1223) && class91.aBoolean1205) {
                        continue;
                    }
                }
                is[anInt5709++] = i_666_;
        ...
        for (int i_667_ = 0; i_667_ < anInt5709; i_667_++) {
            ...
            if (model.aShortArray2587 != null) {
                ...
                if ((~i_676_) != 0) {
                    ...
                    if ((~(0x40 & anInt5653)) == -1 || !class91.aBoolean1223) {
            ...
            gldrawablemodel_678_.aBoolean5670 = gldrawablemodel_678_.aBoolean5670 | (class91 != null && ((~class91.aByte1211) != -1 || class91.aByte1203 != 0));
        }
        ...
        if (model.aClass17Array2621 != null) {
            ...
            for (int i_679_ = 0; i_679_ < anInt5659; i_679_++) {
                ...
                Class352 class352 = Class215.method2067(0, class17.anInt279);
                int i_680_ = -1;
                for (int i_681_ = 0; (~i_681_) > (~anInt5709); i_681_++) {
        ...
        for (int i_687_ = 0; model.anInt2572 > i_687_; i_687_++) {
            ...
            int i_698_;
            for (i_698_ = -(i_691_ * i_693_) + i_690_ * i_694_; (~i_696_) < -8193 || (~i_697_) < -8193 || i_698_ > 8192 || i_696_ < -8192 || i_697_ < -8192 || (~i_698_) > 8191; i_698_ >>= 1) {
                i_697_ >>= 1;
                i_696_ >>= 1;
            }
        ...
        for (int i_700_ = 0; i_700_ < anInt5709; i_700_++) {
            ...
            if ((~b) != -1) {
                if (b == 1) {
                    ...
                    long l = ((long) (i_702_ << 8) + ((long) (i_712_ << 24) + (long) i_704_) << 32) + (long) ((256 + class132.anInt1674 << 12) + ((i_703_ << 2) - (-((~class132.anInt1679) >= -1 ? 2048 : 1024) - (256 + class132.anInt1683 << 22))));
        ...
        int i_774_ = 0;
        short s = -10000;
        for (int i_775_ = 0; (~i_775_) > (~anInt5616); i_775_++) {
        ...
        s = (short) -10000;
        i_774_ = 0;
        for (int i_777_ = 0; (~anInt5616) < (~i_777_); i_777_++) {
    ...
    final void aa(short s, short s_0_) {
        ...
        if (s_0_ != -1) {
            ...
            if (class91.aByte1211 != 0 || (~class91.aByte1203) != -1) {
                aBoolean5670 = true;
            }
        }
        if (b_2_ != b | b_1_ != b_3_) {
    ...
    private boolean method639(Class336 class336, boolean bool, int i, int i_6_, int i_7_, int i_8_, int i_9_) {
        anInt5666++;
        ...
        if (bool_13_ && (float) i_7_ > f_14_ && (float) i_7_ < f_15_ && f_16_ < (float) i_6_ && (float) i_6_ < f_17_) {
            ...
            if ((~aGLToolkit5692.anIntArray6747.length) > (~anInt5665)) {
            ...
            for (int i_59_ = 0; i_59_ < anInt5709; i_59_++) {
                if ((~is[aShortArray5622[i_59_]]) != 999998 && is[aShortArray5683[i_59_]] != -999999 && is[aShortArray5706[i_59_]] != -999999 && method647(is[aShortArray5683[i_59_]], is[aShortArray5622[i_59_]], is_41_[aShortArray5706[i_59_]], i_7_, 46, is_41_[aShortArray5683[i_59_]], is[aShortArray5706[i_59_]], is_41_[aShortArray5622[i_59_]], i_6_)) {
                    return true;
                }
            }
        }
    ...
    private void method641(byte b) {
        ...
        if (aBoolean5611) {
            ...
            if (b == -122) {
                ...
                if (anIntArray5687 != null && (~(anInt5639 & 0x800)) == -1 && (~(0x40000 & anInt5639)) == -1) {
                    anIntArray5687 = null;
                }
            }
        }
    ...
    private int method643(boolean bool, byte b, int i, int i_94_, short s) {
        if (bool != false) {
            aShort5619 = (short) -31;
        }
        anInt5625++;
    ...
    final void a(int i) {
        ...
        for (int i_106_ = 0; (~i_106_) > (~anInt5672); i_106_++) {
    ...
    private void method645(r_Sub2 var_r_Sub2, boolean bool) {
        anInt5601++;
        ...
        for (int i = 0; (~anInt5616) < (~i); i++) {
            if (aByteArray5658 == null || (~aByteArray5658[i]) >= -129) {
    ...
    final void H(int i, int i_123_, int i_124_) {
        anInt5700++;
        for (int i_125_ = 0; (~i_125_) > (~anInt5672); i_125_++) {
            if (i != 0) {
    ...
    private void method646(boolean bool) {
        anInt5603++;
        if (anInt5616 != 0) {
            if (aByte5651 != 0) {
            ...
            if (aClass107_5675 != null) {
                if (aClass107_5675.anInterface1_1365 == null) {
                    method648((~(0x10 & aByte5651)) != -1, 5123);
                }
                if (aClass107_5675.anInterface1_1365 != null) {
    ...
    private boolean method647(int i, int i_130_, int i_131_, int i_132_, int i_133_, int i_134_, int i_135_, int i_136_, int i_137_) {
        ...
        if ((~i_130_) < (~i_132_) && (~i) < (~i_132_) && (~i_132_) > (~i_135_)) {
            return false;
        }
        if (i_130_ < i_132_ && (~i) > (~i_132_) && i_135_ < i_132_) {
            return false;
        }
        return true;
    }
    ...
    final void method614(Class336 class336) {
        ...
        if (aClass300Array5681 != null) {
            for (int i = 0; (~aClass300Array5681.length) < (~i); i++) {
        ...
        if (aClass218Array5596 != null) {
            for (int i = 0; (~i) > (~aClass218Array5596.length); i++) {
    ...
    final void method630(Class336 class336, int i, boolean bool) {
        ...
        if (aShortArray5618 != null) {
            int[] is = new int[3];
            for (int i_141_ = 0; (~i_141_) > (~anInt5672); i_141_++) {
    ...
    private void method648(boolean bool, int i) {
        if ((~(6 * anInt5616)) >= (~aGLToolkit5692.aFloatBuffer6661.aByteArray7019.length)) {
        ...
        if (!aGLToolkit5692.aBoolean6736) {
            ...
            for (int i_170_ = 0; (~anInt5616) < (~i_170_); i_170_++) {
    ...
    final void method619(DrawableModel drawablemodel, int i, int i_171_, int i_172_, boolean bool) {
        ...
        if ((~anInt5709) != -1 && gldrawablemodel_173_.anInt5709 != 0) {
            ...
            for (int i_195_ = 0; (~i_195_) > (~anInt5672); i_195_++) {
    ...
    final void method617() {
        anInt5695++;
        if ((~anInt5665) < -1 && anInt5616 > 0) {
            method649(false, (byte) 41);
            if ((~(0x10 & aByte5651)) == -1 && aClass107_5675.anInterface1_1365 == null) {
                ...
                if (!(f_219_ / (float) i >= aGLToolkit5692.aFloat6674) && !(aGLToolkit5692.aFloat6711 >= f_220_ / (float) i)) {
                    ...
                    if (!(f_224_ / (float) i >= aGLToolkit5692.aFloat6663) && !(f_223_ / (float) i <= aGLToolkit5692.aFloat6687)) {
                        ...
                        if (entitynode_sub5 != null) {
                            ...
                            if ((~i_229_) <= (~aGLToolkit5692.anInt6693) || (~i_232_) <= (~aGLToolkit5692.anInt6693)) {
                                entitynode_sub5.aBoolean5987 = true;
    ...
    final void P(int i, int i_233_, int i_234_, int i_235_) {
        ...
        if ((~i) == -1) {
            ...
            Class378.anInt4676 = 0;
            Class297.anInt3702 = 0;
            for (int i_237_ = 0; (~i_237_) > (~anInt5672); i_237_++) {
            ...
            for (int i_250_ = 0; (~anInt5709) < (~i_250_); i_250_++) {
            ...
            if (aClass72Array5627 != null) {
                for (int i_252_ = 0; (~i_252_) > (~anInt5659); i_252_++) {
            ...
            for (int i_253_ = 0; (~anInt5709) < (~i_253_); i_253_++) {
            ...
            if (aClass72Array5627 != null) {
                for (int i_258_ = 0; (~anInt5659) < (~i_258_); i_258_++) {
            ...
            for (int i_261_ = 0; (~anInt5659) < (~i_261_); i_261_++) {
    ...
    final void VA(int i) {
        ...
        for (int i_264_ = 0; (~i_264_) > (~anInt5672); i_264_++) {
    ...
    final void I(int i, int[] is, int i_266_, int i_267_, int i_268_, boolean bool, int i_269_, int[] is_270_) {
        ...
        if (i == 0) {
            ...
            for (int i_273_ = 0; (~i_273_) > (~i_271_); i_273_++) {
                ...
                if ((~i_274_) > (~anIntArrayArray5684.length)) {
            ...
            for (int i_281_ = 0; i_271_ > i_281_; i_281_++) {
                ...
                if ((~anIntArrayArray5684.length) < (~i_282_)) {
        ...
        } else if ((~i) == -10 && anIntArrayArray5615 != null) {
            for (int i_434_ = 0; (~i_434_) > (~i_271_); i_434_++) {
                int i_435_ = is[i_434_];
                if ((~i_435_) > (~anIntArrayArray5615.length)) {
    ...
    final boolean method612() {
        ...
        for (int i = 0; (~aShortArray5699.length) < (~i); i++) {
    ...
    final void k(int i) {
        ...
        for (int i_440_ = 0; (~anInt5672) < (~i_440_); i_440_++) {
        ...
        for (int i_442_ = 0; (~anInt5665) < (~i_442_); i_442_++) {
    ...
    final void method626(int i, int i_444_, int i_445_, int i_446_) {
        anInt5647++;
        for (int i_447_ = 0; (~i_447_) > (~anInt5709); i_447_++) {
    ...
    private void method649(boolean bool, byte b) {
        anInt5655++;
        ...
        if (bool) {
            bool_454_ = bool_454_ & (~(0x4 & aByte5651)) != -1;
    ...
    private DrawableModel method650(GLDrawableModel gldrawablemodel_502_, int i, boolean bool, boolean bool_503_, int i_504_, GLDrawableModel gldrawablemodel_505_) {
        ...
        if (!bool_509_) {
            ...
            if (bool_506_) {
                if (gldrawablemodel_502_.anIntArray5595 != null && (~gldrawablemodel_502_.anIntArray5595.length) <= (~anInt5644)) {
            ...
            if (!bool_507_) {
                gldrawablemodel_505_.anIntArray5588 = anIntArray5588;
            } else if (gldrawablemodel_502_.anIntArray5588 == null || (~anInt5644) < (~gldrawablemodel_502_.anIntArray5588.length)) {
        ...
        if (!CacheNode_Sub3.method2296(anInt5653, (byte) 98, i_504_)) {
            ...
            if (anInt5709 >= 0)
                System.arraycopy(aShortArray5693, 0, gldrawablemodel_505_.aShortArray5693, 0, anInt5709);
        }
        if (Class320_Sub7.method3711((byte) 46, i_504_, anInt5653)) {
            if (gldrawablemodel_502_.aByteArray5658 == null || (~gldrawablemodel_502_.aByteArray5658.length) > (~anInt5709)) {
            ...
            for (int i_512_ = 0; (~anInt5709) < (~i_512_); i_512_++)
        ...
        if (!Class73.method749((byte) -65, i_504_, anInt5653)) {
            ...
            if (gldrawablemodel_502_.aShortArray5635 != null && (~anInt5665) >= (~gldrawablemodel_502_.aShortArray5635.length)) {
            ...
            if (aClass319_5592 != null) {
                ...
                if (class319.aShortArray4061 == null || (~anInt5665) < (~class319.aShortArray4061.length)) {
                ...
                for (int i_515_ = 0; (~anInt5665) < (~i_515_); i_515_++) {
        ...
        if (Class377.method4127(anInt5653, i ^ ~0x7c03, i_504_)) {
            ...
            for (int i_518_ = 0; (~i_518_) > (~anInt5665); i_518_++) {
        ...
        if (Class262_Sub16.method3193(anInt5653, i_504_, (byte) -61)) {
            if (gldrawablemodel_502_.aShortArray5622 == null || (~anInt5709) < (~gldrawablemodel_502_.aShortArray5622.length)) {
            ...
            for (int i_520_ = 0; (~i_520_) > (~anInt5709); i_520_++) {
        ...
        if (!Class150_Sub3.method1663((byte) -20, i_504_, anInt5653)) {
            ...
            for (int i_522_ = 0; (~i_522_) > (~anInt5709); i_522_++)
        ...
        if (!Class71.method741(anInt5653, -23003, i_504_)) {
            ...
            for (int i_524_ = 0; (~i_524_) > (~anInt5659); i_524_++)
            ...
            for (int i_525_ = 0; (~i_525_) > (~anInt5659); i_525_++)
    ...
    final void ia(short s, short s_526_) {
        for (int i = 0; anInt5709 > i; i++) {
            if ((~s) == (~aShortArray5693[i])) {
                aShortArray5693[i] = s_526_;
            }
        }
        anInt5605++;
        if (aClass72Array5627 != null) {
            for (int i = 0; (~anInt5659) < (~i); i++) {
                Class72 class72 = aClass72Array5627[i];
                Class190 class190 = aClass190Array5674[i];
    ...
    final void method637(int i, int[] is, int i_527_, int i_528_, int i_529_, int i_530_, boolean bool) {
        ...
        if ((~i) == -1) {
            ...
            for (int i_586_ = 0; i_586_ < i_531_; i_586_++) {
                ...
                if ((~anIntArrayArray5684.length) < (~i_587_)) {
            ...
            if (anIntArrayArray5591 != null) {
                for (int i_591_ = 0; (~i_591_) > (~i_531_); i_591_++) {
                    ...
                    if (i_592_ < anIntArrayArray5591.length) {
                        ...
                        if ((~is_593_.length) < -1 && aClass69_5604 != null) {
                            aClass69_5604.anInterface9_939 = null;
                        }
                    }
                }
                if (aClass72Array5627 != null) {
                    for (int i_597_ = 0; (~i_597_) > (~anInt5659); i_597_++) {
            ...
            if (anIntArrayArray5591 != null) {
                for (int i_598_ = 0; i_598_ < i_531_; i_598_++) {
                    ...
                    if (i_599_ < anIntArrayArray5591.length) {
                        ...
                        if ((~is_600_.length) < -1 && aClass69_5604 != null) {
                            aClass69_5604.anInterface9_939 = null;
                        }
                    }
                }
                if (aClass72Array5627 != null) {
                    for (int i_607_ = 0; (~i_607_) > (~anInt5659); i_607_++) {
            ...
            if (anIntArrayArray5615 != null) {
                for (int i_612_ = 0; (~i_612_) > (~i_531_); i_612_++) {
                    ...
                    if ((~i_613_) > (~anIntArrayArray5615.length)) {
            ...
            for (int i_616_ = 0; (~i_616_) > (~i_531_); i_616_++) {
                ...
                if ((~anIntArrayArray5615.length) < (~i_617_)) {
    ...
    final void p(int i, int i_620_, Plane plane, Plane plane_621_, int i_622_, int i_623_, int i_624_) {
        ...
        if (i != 1 && i != 2 && (~i) != -4 && (~i) != -6 || i_625_ >= 0 && plane.anInt3408 > plane.anInt3398 + i_626_ >> plane.anInt3410 && (~i_627_) <= -1 && i_628_ + plane.anInt3398 >> plane.anInt3410 < plane.anInt3404) {
            if ((~i) != -5 && (~i) != -6) {
                ...
                if (plane.method3251(i_627_, i_625_, (byte) -118) == i_623_ && i_623_ == plane.method3251(i_627_, i_626_, (byte) -118) && (~plane.method3251(i_628_, i_625_, (byte) -118)) == (~i_623_) && (~i_623_) == (~plane.method3251(i_628_, i_626_, (byte) -118))) {
                    return;
                }
            } else if (plane_621_ == null || (i_625_ < 0 || plane_621_.anInt3408 <= i_626_ + plane_621_.anInt3398 >> plane_621_.anInt3410 || i_627_ < 0 || (~plane_621_.anInt3404) >= (~(plane_621_.anInt3398 + i_628_ >> plane_621_.anInt3410)))) {
                return;
            }
            if (i != 1) {
                if (i == 2) {
                    ...
                    for (int i_630_ = 0; (~anInt5672) < (~i_630_); i_630_++) {
                    ...
                    if ((~(-(i_632_ >> 1) + i_622_)) > -1 || plane.anInt3408 << plane.anInt3410 <= (i_632_ >> 1) + i_622_ + plane.anInt3398 || -(i_633_ >> 1) + i_624_ < 0 || (~(i_624_ - -(i_633_ >> 1) - -plane.anInt3398)) <= (~(plane.anInt3404 << plane.anInt3410))) {
                        return;
                    }
    ...
    private short method651(long l, int i, float f, float f_649_, int i_650_, int i_651_, int i_652_, Model model, int i_653_, int i_654_) {
        anInt5705++;
        if (i_650_ != 13) {
    ...
    final void FA(int i) {
        ...
        for (int i_661_ = 0; (~anInt5672) < (~i_661_); i_661_++) {
