...
public class CacheNode_Sub14_Sub2 extends CacheNode_Sub14 {
    ...
    static boolean method2352(int i, int i_0_, int i_1_) {
        anInt11033++;
        if (i != 0) {
            method2352(-85, -123, -8);
        }
    ...
    static void method2353(byte b, Buffer buffer) {
        anInt11031++;
        if ((~(buffer.aByteArray7019.length - buffer.anInt7002)) <= -2) {
            ...
            if (i >= 0 && (~i) >= -2) {
                ...
                if ((~(buffer.aByteArray7019.length + -buffer.anInt7002)) <= -3) {
                    int i_2_ = buffer.method2219(-130546744);
                    if ((~(6 * i_2_)) >= (~(buffer.aByteArray7019.length - buffer.anInt7002))) {
                        for (int i_3_ = 0; (~i_2_) < (~i_3_); i_3_++) {
                            int i_4_ = buffer.method2219(-130546744);
                            int i_5_ = buffer.method2186(71);
                            if ((~i_4_) > (~Class320_Sub22.anIntArray8417.length) && FileOnDisk.aBooleanArray1332[i_4_] && ((~Node_Sub53.aClass176_7667.method1805(i_4_, -4409).aChar3210) != -50 || i_5_ >= -1 && (~i_5_) >= -2)) {
    ...
    static void method2354(Class302 class302, int i, boolean bool, int i_6_, int i_7_, int i_8_, boolean bool_9_) {
        anInt11036++;
        if ((~i_8_) >= -1) {
    ...
    static void method2355(Packet packet, byte b) {
        if (b >= -94) {
            aClass192_11037 = null;
        }
    ...
    static DrawableModel method2356(int i, DrawableModel drawablemodel, int i_12_, int i_13_, int i_14_, int i_15_, boolean bool, GraphicsToolkit graphicstoolkit, int i_16_, Animator animator, int i_17_, int i_18_, int i_19_) {
        anInt11038++;
        ...
        if (drawablemodel_21_ == null || graphicstoolkit.b(drawablemodel_21_.ua(), i_20_) != 0) {
            ...
            for (int i_33_ = 0; (~i_23_) < (~i_33_); i_33_++) {
