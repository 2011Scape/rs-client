...
public class Node_Sub20 extends Node {
    ...
    static GraphicsToolkit method2613(int i, int i_0_, Class302 class302, d var_d, java.awt.Canvas canvas) {
        anInt7176++;
    ...
    static void method2614(boolean bool, Actor actor, boolean bool_1_) {
        anInt7180++;
        ...
        if ((~actor.anInt10904) == -1) {
            ...
            if (actor.anAnimator10876.method245(-124) && !actor.anAnimator10876.method242((byte) -77)) {
                ...
                if ((~actor.anInt10900) >= -1 && class48.anInt718 == 0) {
                    Class275.anInt5412 = -1;
                    actor.anInt10901++;
                    Class320_Sub23.anInt8431 = 0;
                    return;
            ...
            for (int i = 0; (~actor.aClass165Array10886.length) < (~i); i++) {
                if ((~actor.aClass165Array10886[i].anInt2030) != 0 && actor.aClass165Array10886[i].anAnimator2026.method242((byte) -77)) {
            ...
            if (!bool_1_ && (i_3_ - i > 1024 || i_3_ - i < -1024 || (~(-i_2_ + i_4_)) < -1025 || (~(i_4_ + -i_2_)) > 1023)) {
                ...
                if (!bool_6_) {
                    ...
                    if (!bool_1_ && (~actor.anInt10904) < -4) {
                        i_5_ = 32;
                    }
                }
                if (actor.anInt10901 > 0 && (~actor.anInt10904) < -2) {
                    actor.anInt10901--;
                    i_5_ = 32;
                }
                if ((~b) != -3) {
                ...
                if (class259.anInt3256 != -1) {
                    ...
                    if (actor.anInt10904 != 1) {
                        ...
                        int i_9_ = ((~i_3_) <= (~actor.anInt5934) ? i_3_ - actor.anInt5934 : actor.anInt5934 - i_3_) << 9;
                ...
                if (actor.anInt5934 == i_3_ && (~i_4_) == (~actor.anInt5940)) {
                    actor.anInt10904--;
                    if (actor.anInt10900 > 0) {
                        actor.anInt10900--;
                    }
    ...
    static void method2615(Class52 class52, String string, Class357 class357, int i, int i_13_, int i_14_, boolean bool, Widget widget, aa var_aa, int i_15_, int i_16_, int i_17_) {
        anInt7179++;
        int i_18_;
        ...
        if ((~(i_19_ * i_19_)) <= (~i_20_)) {
            ...
            if (i_23_ >= -widget.anInt4809 && (~widget.anInt4809) <= (~i_23_) && i_24_ >= -widget.anInt4695 && (~widget.anInt4695) <= (~i_24_)) {
