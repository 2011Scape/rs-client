...
public class Class304 {
    ...
    static void method3544(int i, int i_0_, int i_1_) {
        if (i_1_ <= 15) {
    ...
    static boolean method3545(int i, int i_3_, int i_4_) {
        if (i_3_ != 10215) {
            aClass84Array3833 = null;
        }
        anInt3832++;
        if (!((~(0x70000 & i)) != -1 | Class320_Sub5.method3700(i_4_, (byte) 124, i)) && !Class262_Sub15_Sub1.method3192(i_4_, i, 512)) {
            return false;
        }
        return true;
    }
