		...
		if (i_7_ >= 0 && i_4_ >= 0 && -1 + Node_Sub54.anInt7675 > i_7_ && i_4_ < Class377_Sub1.anInt8774 - 1) {
			...
			if (i_10_ == 0) {
				...
				if (i_10_ != 2) {
					...
					Interface19 interface19 = (Interface19) Class262_Sub20.method3203(i, i_7_, i_4_, aClass1413 != null ? aClass1413 : (aClass1413 = method1136("com.jagex.runescape.Interface19")));
					if (interface19 != null) {
						if (i_5_ == 11) {
							i_5_ = 10;
						}
