...
public class Node_Sub38_Sub19 extends Node_Sub38
{
	...
	static final boolean method2849(int i, int i_1_, Class261[][][] class261s, int i_2_, int i_3_, boolean bool) {
		...
		if (b == Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.anInt11089][i_3_][i_1_]) {
			return false;
		}
		...
		while (i_5_ != i_6_) {
			...
			i_6_ = i_6_ + 1 & 0xfff;
			boolean bool_12_ = (CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.anInt11089][i_7_][i_10_] & 0x4) == 0;
					...
					if (class261s[i_14_] != null && (CacheNode_Sub11.aByteArrayArrayArray9550[i_14_][i_7_][i_10_] & 0x8) == 0) {
						if (bool_12_ && class261s[i_14_][i_7_][i_10_] != null) {
							if (class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3314 != null) {
								...
								if (i_15_ == class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3314.aShort9110 || class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308 != null && i_15_ == class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308.aShort9110) {
									continue;
								}
								if (i_9_ != 0) {
									int i_16_ = Class130.method1559(-124, i_9_);
									if (class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3314.aShort9110 == i_16_ || class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308 != null && class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308.aShort9110 == i_16_) {
										continue;
									}
								}
								if (i_11_ != 0) {
									int i_17_ = Class130.method1559(-125, i_11_);
									if (class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3314.aShort9110 == i_17_ || class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308 != null && i_17_ == class261s[i_14_][i_7_][i_10_].anAnimable_Sub2_3308.aShort9110) {
										continue;
									}
								}
							}
							...
							if (class261.aClass256_3312 != null) {
								for (Class256 class256 = class261.aClass256_3312; class256 != null; class256 = class256.aClass256_3238) {
									...
									if (mobile instanceof Interface19) {
										...
										if (i_8_ == i_20_ || i_9_ != 0 && i_9_ == i_20_ || i_11_ != 0 && i_11_ == i_20_) {
											continue while_186_;
										}
									}
								}
						...
						if (class261 != null && class261.aClass256_3312 != null) {
							for (Class256 class256 = class261.aClass256_3312; class256 != null; class256 = class256.aClass256_3238) {
								...
								if (mobile.aShort9130 != mobile.aShort9119 || mobile.aShort9120 != mobile.aShort9124) {
									for (int i_21_ = mobile.aShort9119; mobile.aShort9130 >= i_21_; i_21_++) {
										for (int i_22_ = mobile.aShort9120; mobile.aShort9124 >= i_22_; i_22_++)
			...
			if (bool_13_) {
				...
				if (i_23_ > Class259.anIntArray3296[i_2_]) {
					Class259.anIntArray3296[i_2_] = i_23_;
				}
				int i_24_ = i_7_ << 9;
				int i_25_ = i_10_ << 9;
				if (Class6.anIntArray135[i_2_] <= i_24_) {
					if (i_24_ > Class246.anIntArray3107[i_2_]) {
				...
				} else if (Class84.anIntArray1147[i_2_] < i_25_) {
					Class84.anIntArray1147[i_2_] = i_25_;
				}
			}
			if (!bool_12_) {
				if (i_7_ >= 1 && b != Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.anInt11089][-1 + i_7_][i_10_]) {
				...
				if (++i_10_ < Class377_Sub1.anInt8774) {
					if (i_7_ - 1 >= 0 && Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.anInt11089][-1 + i_7_][i_10_] != b && (CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.anInt11089][i_7_][i_10_] & 0x4) == 0 && (CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.anInt11089][i_7_ + -1][-1 + i_10_] & 0x4) == 0) {
				...
				if (--i_10_ >= 0) {
					if (i_7_ - 1 >= 0 && b != Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.anInt11089][i_7_ - 1][i_10_] && (0x4 & CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.anInt11089][i_7_][i_10_]) == 0 && (CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.anInt11089][-1 + i_7_][i_10_ + 1] & 0x4) == 0) {
					...
					if (i_7_ + 1 < Node_Sub54.anInt7675 && b != Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.anInt11089][i_7_ + 1][i_10_] && (CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.anInt11089][i_7_][i_10_] & 0x4) == 0 && (CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.anInt11089][i_7_ - -1][1 + i_10_] & 0x4) == 0) {
		...
		if (Class259.anIntArray3296[i_2_] != -1000000) {
		...
		if (bool == false) {
			...
			do {
				if (i_30_ != 0) {
					...
					anInt10290 = buffer.readUnsignedShort();
					break;
				}
				aBoolean10287 = buffer.readUnsignedByte() == 1;
			} while (false);
		}
	}
	...
	final int[][] method2778(int i, boolean bool) {
		...
		if (aClass348_7454.aBoolean4300) {
			...
			int[] is_35_ = is[1];
			int[] is_36_ = is[2];
			for (int i_37_ = 0; Class339_Sub7.anInt8728 > i_37_; i_37_++) {
