...
public class Player extends Actor
{
	...
	final void method889(Buffer buffer, int i) {
		buffer.anInt7002 = 0;
		anInt11181++;
		int i_45_ = buffer.readUnsignedByte();
		...
		aByte11154 = buffer.readByte();
		anInt11129 = buffer.readByte();
		anInt11130 = buffer.readByte();
		aBoolean11131 = buffer.readByte() == 1;
		...
		for (int i_49_ = 0; Class63.aClass363_922.anIntArray4508.length > i_49_; i_49_++) {
			if (Class63.aClass363_922.anIntArray4508[i_49_] != 1) {
				int i_50_ = buffer.readUnsignedByte();
				if (i_50_ == 0) {
					is[i_49_] = 0;
				} else {
					int i_51_ = buffer.readUnsignedByte();
					int i_52_ = (i_50_ << 8) - -i_51_;
					if (i_49_ == 0 && i_52_ == 65535) {
						i_48_ = buffer.readUnsignedShort();
						anInt11134 = buffer.readUnsignedByte();
						break;
					}
					if (i_52_ >= 32768) {
		...
		if (i_48_ == -1) {
			int i_54_ = buffer.readUnsignedShort();
			int i_55_ = 0;
		...
		anInt11151 = buffer.readUnsignedShort();
		aString11132 = buffer.readString();
		if (this == Class295.aPlayer3692) {
			Node_Sub40.aString7513 = aString11132;
		}
		aString11142 = aString11132;
		anInt11152 = buffer.readUnsignedByte();
		if (!bool_46_) {
			anInt11139 = 0;
			anInt11141 = buffer.readUnsignedByte();
			anInt11184 = buffer.readUnsignedByte();
			if (anInt11184 == 255) {
				anInt11184 = -1;
			}
		} else {
			anInt11139 = buffer.readUnsignedShort();
		...
		anInt11164 = buffer.readUnsignedByte();
		if (anInt11164 == 0) {
			...
			anInt11167 = buffer.readUnsignedShort();
			anInt11172 = buffer.readUnsignedShort();
			anInt11153 = buffer.readUnsignedShort();
			anInt11182 = buffer.readUnsignedShort();
			anInt11173 = buffer.readUnsignedByte();
