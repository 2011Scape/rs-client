...
public class Class194_Sub2 extends Class194
{
	...
	static final void method1970(int i) {
        ...
        Class12.aBoolean194 = !(CacheNode_Sub18.aGraphicsToolkit9607 instanceof oa);
	}
	...
	static final void method1972(int i) {
		...
		if (Class213.aNode_Sub27_2512.aClass320_Sub4_7304.method3694(false) == 2) {
			...
			for (int i_1_ = 0; i_1_ < 4; i_1_++) {
				for (int i_2_ = 0; Class377_Sub1.anInt8774 > i_2_; i_2_++)
					Node_Sub38_Sub15.aByteArrayArrayArray10261[i_1_][i_0_][i_2_] = b;
			}
			if (CacheNode_Sub20_Sub1.anInt11089 != 3) {
				...
				if (Class320_Sub22.anInt8415 == 1 || Class367.anInt4541 != -1) {
					...
					if (Class318.anInt4050 < 2560) {
						...
						if (i_10_ == 0 && i_11_ == 0 || -Node_Sub54.anInt7675 >= i_10_ || i_10_ >= Node_Sub54.anInt7675 || i_11_ <= -Class377_Sub1.anInt8774 || i_11_ >= Class377_Sub1.anInt8774) {
					...
					if (i_16_ + -Class190.anInt2331 < 3200 && (CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.anInt11089][Class98.anInt5061 >> 9][Node_Sub10.anInt7079 >> 9] & 0x4) != 0) {
