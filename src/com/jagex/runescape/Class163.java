...
public class Class163
{
	...
	static final Class144_Sub4 method1734(Buffer buffer, byte b) {
		anInt2007++;
		int i = 21 / ((b - 6) / 38);
		return new Class144_Sub4(buffer.method2193(-17), buffer.method2193(-91), buffer.method2193(-53), buffer.method2193(-125), buffer.read24BitInt(), buffer.readUnsignedByte());
	}
