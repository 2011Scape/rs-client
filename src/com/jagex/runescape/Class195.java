...
public class Class195
{
	...
	final DrawableModel method1986(byte b, boolean bool, int i, Animator animator, Plane plane, byte b_0_, int i_1_, Plane plane_2_, int i_3_, int i_4_, GraphicsToolkit graphicstoolkit) {
		...
		if (drawablemodel == null || graphicstoolkit.b(drawablemodel.ua(), i_5_) != 0) {
			...
			if (aShortArray2386 != null) {
				for (int i_8_ = 0; i_8_ < aShortArray2386.length; i_8_++)
		...
		if (anInt2400 != 128 || anInt2396 != 128) {
	...
	private final void method1987(int i, Buffer buffer, int i_11_) {
		anInt2393++;
		if (i == 1) {
			anInt2379 = buffer.readUnsignedShort();
		} else if (i != 2) {
			if (i == 4) {
				anInt2400 = buffer.readUnsignedShort();
			} else if (i != 5) {
				if (i == 6) {
					anInt2388 = buffer.readUnsignedShort();
				} else if (i == 7) {
					anInt2382 = buffer.readUnsignedByte();
				} else if (i != 8) {
					if (i == 9) {
						aByte2381 = (byte) 3;
						anInt2385 = 8224;
												...
												if (i != 40) {
													if (i == 41) {
														...
														for (int i_13_ = 0; i_13_ < i_12_; i_13_++) {
															aShortArray2389[i_13_] = (short) buffer.readUnsignedShort();
															aShortArray2395[i_13_] = (short) buffer.readUnsignedShort();
														}
													}
												} else {
													...
													for (int i_15_ = 0; i_14_ > i_15_; i_15_++) {
														aShortArray2386[i_15_] = (short) buffer.readUnsignedShort();
														aShortArray2384[i_15_] = (short) buffer.readUnsignedShort();
													}
												}
											} else {
												aByte2381 = (byte) 3;
					...
					anInt2390 = buffer.readUnsignedByte();
				}
			} else {
				anInt2396 = buffer.readUnsignedShort();
			}
		} else {
			anInt2394 = buffer.readUnsignedShort();
		}
	...
	static final void method1990(byte b) {
		...
		if (Node_Sub38_Sub8.anInt10163 != 0 && Node_Sub38_Sub8.anInt10163 != 10) {
			...
			try {
				...
				if (Class159.anInt1996 != 2 || Node_Sub38_Sub8.anInt10163 != 20 && Class339_Sub2.anInt8653 != 42) {
					Class262_Sub12.anInt7791++;
				}
				if (FixedAnimator.aBoolean5503 && Node_Sub38_Sub8.anInt10163 >= 6) {
					i = 6000;
				}
				if (Class262_Sub12.anInt7791 > i) {
				...
				if (Node_Sub38_Sub8.anInt10163 == 2) {
					if (Class320_Sub23.aClass123_8432.aClass241_1565.anInt2953 == 2) {
						throw new IOException();
					}
					if (Class320_Sub23.aClass123_8432.aClass241_1565.anInt2953 != 1) {
						return;
					}
					...
					if (FixedAnimator.aBoolean5503) {
						...
						buffer.method2222(0, Constants.LOGIN_RSA_MODULUS, Class262_Sub10.aBigInteger7775);
				...
				if (Node_Sub38_Sub8.anInt10163 == 4) {
					...
					Class320_Sub23.aClass123_8432.aPacket1570.anInt7002 = Class320_Sub23.aClass123_8432.aPacket1570.readUnsignedShort();
				...
				if (Node_Sub38_Sub8.anInt10163 == 5) {
					...
					if (!Animable_Sub2_Sub1.aBoolean10628 || Class188_Sub2_Sub1.method1910((byte) 84, Class240.aSignLink2946, string, string_36_, 1).anInt2953 == 2) {
						Class140.method1610(0, string, string_36_, Class240.aSignLink2946, Class213.aNode_Sub27_2512.aClass320_Sub29_7270.method3791(false) == 1, true);
					}
					Node_Sub38_Sub8.anInt10163 = 6;
				}
				if (Node_Sub38_Sub8.anInt10163 == 6) {
					...
					if ((Class320_Sub23.aClass123_8432.aPacket1570.aByteArray7019[0] & 0xff) == 1) {
				...
				if (Node_Sub38_Sub8.anInt10163 == 8) {
					...
					if (Class159.anInt1996 == 2) {
						...
						if (!FixedAnimator.aBoolean5503) {
							...
							packet.method2226(Class151.anInt1843 == 14 ? 1 : 0, false);
									...
									if (i_43_ == 15) {
										...
										if (i_43_ == 23 && Class45.anInt5264 < 3) {
											...
											if (i_43_ == 42) {
												...
												if (!Class296.aBoolean5428 || FixedAnimator.aBoolean5503 || Class336_Sub2.anInt8586 == -1 || i_43_ != 35) {
													Node_Sub38_Sub8.anInt10163 = 0;
													Animable_Sub2.method836(i_43_, true);
													Class320_Sub23.aClass123_8432.aClass365_1557.method4062(-2);
													Class320_Sub23.aClass123_8432.aClass365_1557 = null;
				...
				if (Node_Sub38_Sub8.anInt10163 == 11) {
					...
					Class320_Sub23.aClass123_8432.aClass365_1557 = null;
					Class297.method3479((byte) -119);
				} else if (Node_Sub38_Sub8.anInt10163 == 13) {
					...
					if (Node_Sub38_Sub8.anInt10163 == 14) {
						...
						if (Class159.anInt1996 != 2) {
							...
							Class64.aBoolean5046 = (0x1 & i_45_) != 0;
							Class229.aBoolean2725 = (0x2 & i_45_) != 0;
							Node_Sub33.anInt7402 = packet.readInt();
							Class364.aBoolean4512 = packet.readUnsignedByte() == 1;
							...
							Class225.aBoolean2676 = packet.readUnsignedByte() == 1;
							...
							Class236.anInt2902 = packet.readInt();
							Class312.aBoolean3960 = packet.readUnsignedByte() == 1;
							Class262_Sub23.aClass197_7884 = new Class197();
							Class262_Sub23.aClass197_7884.worldId = packet.readUnsignedShort();
							if (Class262_Sub23.aClass197_7884.worldId == 65535) {
							...
							if (CacheNode_Sub2.aClass329_9436 != Node_Sub38_Sub1.aClass329_10086 && (Node_Sub38_Sub1.aClass329_10086 != Class379.aClass329_4873 || Class339_Sub7.anInt8729 < 2) && Class181.aClass197_2155.method2002(-129, Class320_Sub24.aClass197_8443)) {
							...
							Class166.anInt5099 = packet.readUnsignedShort();
							Class64.aBoolean5046 = packet.readUnsignedByte() == 1;
							Class56.anInt837 = packet.method2229((byte) 94);
							Class101.aBoolean1313 = packet.readUnsignedByte() == 1;
							Node_Sub32.aString7378 = packet.readString();
