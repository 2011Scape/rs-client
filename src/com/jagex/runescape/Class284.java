...
public class Class284
{
	...
	static final void method3392(boolean bool) {
		...
		for (int i = 0; i < Node_Sub38_Sub6.anInt10132; i++) {
			...
			int i_3_ = packet.readUnsignedByte();
			if ((0x80 & i_3_) != 0) {
				i_3_ += packet.readUnsignedByte() << 8;
			}
			if ((0x8000 & i_3_) != 0) {
				i_3_ += packet.readUnsignedByte() << 16;
			}
			if ((i_3_ & 0x100000) != 0) {
			...
			if ((0x40000 & i_3_) != 0) {
				npc.aString11099 = packet.readString();
			...
			if ((0x400 & i_3_) != 0) {
				...
				npc.anInt10892 = packet.readUnsignedShort() + Class174.anInt2092;
			...
			if ((0x200 & i_3_) != 0) {
				...
				npc.anInt10882 = Class174.anInt2092 + packet.readUnsignedShort();
			}
		}
	}
}
