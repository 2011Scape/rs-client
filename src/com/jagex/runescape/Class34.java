...
abstract class Class34
{
	...
	static final Class345 method367(int i, Model model, int i_0_, int[] is) {
		...
		if (model.aByteArray2610 != null) {
			...
			for (int i_12_ = 0; i_12_ < i_0_; i_12_++) {
				int i_13_ = is[i_12_];
				if (model.aByteArray2610[i_13_] != -1) {
					...
					for (int i_15_ = 0; i_15_ < 3; i_15_++) {
						...
						if (i_17_ < is_7_[i_14_]) {
							is_7_[i_14_] = i_17_;
						}
						if (i_17_ > is_8_[i_14_]) {
							is_8_[i_14_] = i_17_;
						}
						if (i_18_ < is_9_[i_14_]) {
							is_9_[i_14_] = i_18_;
						}
	...
	static final void method370(Actor actor, byte b) {
		...
		for (; i < actor.aClass165Array10886.length; i++) {
			if (actor.aClass165Array10886[i].anInt2030 != -1) {
				...
				if (animator_24_.method242((byte) -77)) {
					...
					if (class195.aBoolean2402) {
						if (class48.anInt698 == 3) {
							if (actor.anInt10900 > 0 && actor.anInt10892 <= Class174.anInt2092 && actor.anInt10887 < Class174.anInt2092) {
								animator_24_.method249(true, -1);
								actor.aClass165Array10886[i].anInt2030 = -1;
								continue;
							}
						} else if (class48.anInt698 == 1 && actor.anInt10900 > 0 && actor.anInt10892 <= Class174.anInt2092 && actor.anInt10887 < Class174.anInt2092) {
							continue;
						}
					}
				}
		...
		do {
			if (animator_25_.method245(-127)) {
				...
				if (class48.anInt698 == 3) {
					if (actor.anInt10900 > 0 && actor.anInt10892 <= Class174.anInt2092 && Class174.anInt2092 > actor.anInt10887) {
						actor.anIntArray10817 = null;
						animator_25_.method249(true, -1);
						break;
					}
				} else if (class48.anInt698 == 1) {
