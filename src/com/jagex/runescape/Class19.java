...
public class Class19
{
	...
	static final void method268(int i, GraphicsToolkit graphicstoolkit, int i_0_, Widget widget, int i_1_) {
		...
		if (class127 != null) {
			...
			if (Class262_Sub20.anInt7861 == 2 || Class262_Sub20.anInt7861 == 5 || Class10.aGLSprite172 == null) {
				...
				for (int i_13_ = 0; i_13_ < Class283.anInt3590; i_13_++) {
					...
					if (objectdefinition.anIntArray2984 != null) {
						...
						if (objectdefinition == null || objectdefinition.anInt2994 == -1) {
							continue;
						}
					}
				...
				for (int i_25_ = 0; i_25_ < i_24_; i_25_++) {
					...
					if (player != null && player.method886((byte) 58) && !player.aBoolean11131 && Class295.aPlayer3692 != player && player.aByte5933 == Class295.aPlayer3692.aByte5933) {
						...
						boolean bool = false;
						for (int i_28_ = 0; Node_Sub38_Sub14.anInt10242 > i_28_; i_28_++) {
						...
						for (int i_30_ = 0; Node_Sub38_Sub37.anInt10473 > i_30_; i_30_++) {
							if (player.aString11142.equals(Class50.aClass211Array782[i_30_].aString2506)) {
								bool_29_ = true;
								break;
							}
						}
						boolean bool_31_ = Class295.aPlayer3692.anInt11134 != 0 && player.anInt11134 != 0 && Class295.aPlayer3692.anInt11134 == player.anInt11134;
				...
				for (int i_32_ = 0; class223s.length > i_32_; i_32_++) {
					...
					if (class223 != null && class223.anInt2654 != 0 && Class174.anInt2092 % 20 < 10) {
