...
public class Class157
{
	...
	static final void method1710(int i, int i_2_, boolean bool, int i_3_, int i_4_, int i_5_) {
		...
		if (Class175.aClass261ArrayArrayArray2099 == null) {
			...
			if (aa.anInt101 == 0) {
				if (Class295.aPlayer3692.anInt5934 < 0 || 512 * Node_Sub54.anInt7675 <= Class295.aPlayer3692.anInt5934 || Class295.aPlayer3692.anInt5940 < 0 || Class295.aPlayer3692.anInt5940 >= Class377_Sub1.anInt8774 * 512) {
					bool_6_ = true;
				}
			...
			if (bool_6_) {
				...
				Class110.anInt1412++;
				if (Class295.aPlayer3692 != null && Class359.anInt4467 == Class295.aPlayer3692.anInt5934 + (-(256 * Class295.aPlayer3692.method853((byte) 45)) + 256) >> 9 && Node_Sub15_Sub4.anInt9798 == Class295.aPlayer3692.anInt5940 + -(256 * (Class295.aPlayer3692.method853((byte) 48) + -1)) >> 9) {
				...
				if (Class320_Sub22.anInt8415 == 1) {
					...
					if (i_9_ < Class200_Sub1.anInt5145 >> 8) {
						i_9_ = Class200_Sub1.anInt5145 >> 8;
					}
					if (Plane.aBooleanArray3401[4] && i_9_ < Class262_Sub3.anIntArray7713[4] - -128) {
				...
				if (Class98.anInt5061 < 0) {
					Class98.anInt5061 = 0;
				}
				if (Node_Sub10.anInt7079 < 0) {
					Node_Sub10.anInt7079 = 0;
				}
				if ((Class328.anInt4115 << 9) + -1 < Class98.anInt5061) {
				...
				byte b = Class213.aNode_Sub27_2512.aClass320_Sub4_7304.method3694(false) != 2 ? (byte) 1 : (byte) Class110.anInt1412;
				if (Class71.aBoolean967) {
					...
					Class151.method1671(Class174.anInt2092, Class98.anInt5061, Class190.anInt2331, Node_Sub10.anInt7079, Node_Sub38_Sub15.aByteArrayArrayArray10261, Class259.anIntArray3296, Class6.anIntArray135, Class246.anIntArray3107, Class84.anIntArray1147, Class362.anIntArray4497, 1 + Class295.aPlayer3692.aByte5933, b, Class295.aPlayer3692.anInt5934 >> 9, Class295.aPlayer3692.anInt5940 >> 9, Class213.aNode_Sub27_2512.aClass320_Sub8_7280.method3712(false) == 0, true, !Node_Sub15_Sub10.aBoolean9850 ? -1 : Class308.anInt3912, 0, false);
				}
				CacheNode_Sub16_Sub1.method2387((byte) -114);
				...
				if (Class230.aBoolean5214 && Class267.aClass266_3449.method3236(0) == 0) {
