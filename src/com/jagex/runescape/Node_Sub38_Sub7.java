...
public class Node_Sub38_Sub7 extends Node_Sub38
{
			...
			for (;;) {
				...
				if (bool_8_) {
					...
					for (;;) {
						...
						if (i_25_ >= is_26_[0] && is_26_[1] >= i_25_) {
							break;
						}
						i_24_++;
						if (++i_22_ >= i_9_) {
					...
					if (i_7_ != i_22_) {
						...
						for (int i_28_ = 1; i_28_ <= i_24_; i_28_++) {
				...
				if (Node_Sub38_Sub1.anInt10083 < i_21_ - -i_19_) {
					i_19_ = -i_21_ + Node_Sub38_Sub1.anInt10083;
				} else {
					bool = false;
				}
				if (Class339_Sub7.anInt8728 == i_20_) {
					...
					for (;;) {
						...
						if (i_39_ >= is_40_[0] && is_40_[1] >= i_39_) {
							break;
						}
						i_7_++;
						if (i_9_ <= i_7_) {
	...
	private final void method2807(int[][] is, int i, Random random, int i_42_, int i_43_, int i_44_, byte b) {
		...
		int i_47_ = anInt10148 + -(i_46_ <= 0 ? 0 : Class330.method3838(b ^ 0x146e, i_46_, random));
		if (Class339_Sub7.anInt8728 <= i_43_) {
			i_43_ -= Class339_Sub7.anInt8728;
		}
		if (b == -58) {
			if (i_47_ <= 0) {
				if (i_44_ + i_43_ > Class339_Sub7.anInt8728) {
				...
				int i_52_ = i_44_ / 2;
				int i_53_ = i / 2;
				int i_54_ = i_52_ < i_47_ ? i_52_ : i_47_;
				int i_55_ = i_47_ <= i_53_ ? i_47_ : i_53_;
				...
				for (int i_58_ = 0; i > i_58_; i_58_++) {
					...
					if (i_55_ > i_58_) {
						...
						if (i_55_ > i_66_) {
							...
							if (anInt10140 != 0) {
								for (int i_68_ = 0; i_68_ < i_54_; i_68_++) {
							...
							for (int i_73_ = 0; i_54_ > i_73_; i_73_++)
							...
							if (i_56_ + i_57_ <= Class339_Sub7.anInt8728) {
	...
	static final int method2809(int i, int i_75_, int i_76_, int i_77_) {
		...
		int i_78_ = i_77_ >> 9;
		int i_79_ = i_76_ >> 9;
		if (i_78_ < 0 || i_79_ < 0 || -1 + Node_Sub54.anInt7675 < i_78_ || Class377_Sub1.anInt8774 + -1 < i_79_) {
			return 0;
		}
		int i_80_ = i;
		if (i_80_ < 3 && (CacheNode_Sub11.aByteArrayArrayArray9550[1][i_78_][i_79_] & 0x2) != 0) {
			i_80_++;
		}
								...
								do {
									do {
										if (i_89_ != 0) {
											...
											anInt10147 = buffer.readUnsignedByte();
											return;
										}
										anInt10155 = buffer.readUnsignedShort();
										return;
									} while (false);
									anInt10149 = buffer.readUnsignedShort();
									return;
								} while (false);
								anInt10156 = buffer.readUnsignedShort();
								return;
							} while (false);
							anInt10146 = buffer.readUnsignedShort();
							return;
						} while (false);
						anInt10145 = buffer.readUnsignedShort();
						return;
					} while (false);
					anInt10140 = buffer.readUnsignedByte();
					return;
				} while (false);
				anInt10141 = buffer.readUnsignedShort();
				return;
			} while (false);
			anInt10157 = buffer.readUnsignedShort();
		} while (false);
	}
