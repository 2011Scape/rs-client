	...
	static final void method3788(int i, Class257 class257) {
		...
		if (class257 == Class189_Sub1.aClass257_6882) {
			...
			if (Class266.aHashTable3380 != null) {
				...
				if (node_sub11 != null) {
					for (Node_Sub8 node_sub8 = (Node_Sub8) node_sub11.aClass312_7104.method3613(65280); node_sub8 != null; node_sub8 = (Node_Sub8) node_sub11.aClass312_7104.method3620(16776960)) {
						if (node_sub8.anInt7065 == (i_5_ & 0x7fff) && node_sub8.anInt7067 == i_6_) {
					...
					if (i_3_ >= 0 && i_1_ >= 0 && Node_Sub54.anInt7675 > i_3_ && i_1_ < Class377_Sub1.anInt8774) {
			...
			if (class257 == Node_Sub37.aClass257_7443) {
				...
				if (i_36_ >= 0 && i_37_ >= 0 && Node_Sub54.anInt7675 > i_36_ && i_37_ < Class377_Sub1.anInt8774) {
					int i_45_ = i_40_ - -1;
					if (-i_45_ + i_36_ <= Class295.aPlayer3692.anIntArray10910[0] && i_45_ + i_36_ >= Class295.aPlayer3692.anIntArray10910[0] && Class295.aPlayer3692.anIntArray10908[0] >= -i_45_ + i_37_ && Class295.aPlayer3692.anIntArray10908[0] <= i_45_ + i_37_) {
				...
				int i_46_ = packet.readUnsignedByte();
				...
				if (Class134_Sub1.method1581(Class61.anInt898, -25900) || i_47_ >= 0 && i_48_ >= 0 && Node_Sub54.anInt7675 > i_47_ && i_48_ < Class377_Sub1.anInt8774) {
				...
				int i_54_ = packet.readUnsignedByte();
				int i_55_ = Class333.anInt4155 * 2 + ((i_54_ & 0xfe) >> 4);
				int i_56_ = (0xf & i_54_) + 2 * Node_Sub21.anInt7184;
				int i_57_ = packet.readUnsignedByte();
				boolean bool = (i_57_ & 0x1) != 0;
				...
				if (i_55_ >= 0 && i_56_ >= 0 && Node_Sub54.anInt7675 * 2 > i_55_ && i_56_ < Node_Sub54.anInt7675 * 2 && i_60_ >= 0 && i_61_ >= 0 && 2 * Class377_Sub1.anInt8774 > i_60_ && Class377_Sub1.anInt8774 * 2 > i_61_ && i_64_ != 65535) {
					i_60_ = 256 * i_60_;
					i_70_ <<= 2;
					i_56_ = 256 * i_56_;
					i_61_ *= 256;
				...
				if (i_73_ != Class166.anInt5099) {
					boolean bool = i_77_ >= 0 && i_75_ >= 0 && Node_Sub54.anInt7675 > i_77_ && Class377_Sub1.anInt8774 > i_75_;
				...
				if (i_82_ >= 0 && i_83_ >= 0 && Node_Sub54.anInt7675 > i_82_ && i_83_ < Class377_Sub1.anInt8774) {
					int i_91_ = 1 + i_86_;
					if (Class295.aPlayer3692.anIntArray10910[0] >= -i_91_ + i_82_ && Class295.aPlayer3692.anIntArray10910[0] <= i_91_ + i_82_ && -i_91_ + i_83_ <= Class295.aPlayer3692.anIntArray10908[0] && Class295.aPlayer3692.anIntArray10908[0] <= i_83_ + i_91_) {
				...
				if (node_sub11 != null) {
					...
					if (i_96_ >= 0 && i_94_ >= 0 && i_96_ < Node_Sub54.anInt7675 && i_94_ < Class377_Sub1.anInt8774) {
						Node_Sub36.method2750(false, Class50.anInt783, i_94_, i_96_);
					}
				}
			} else if (Class262_Sub13.aClass257_7801 == class257) {
				packet.readUnsignedByte();
				int i_98_ = packet.readUnsignedByte();
				int i_99_ = Class333.anInt4155 - -((0x74 & i_98_) >> 4);
				int i_100_ = (0x7 & i_98_) + Node_Sub21.anInt7184;
				int i_101_ = packet.readUnsignedShort();
				int i_102_ = packet.readUnsignedByte();
				int i_103_ = packet.read24BitInt();
				...
				int i_104_ = packet.readUnsignedByte();
				boolean bool = (i_104_ & 0x80) != 0;
				...
				if (i_105_ >= 0 && i_106_ >= 0 && i_105_ < Node_Sub54.anInt7675 && i_106_ < Class377_Sub1.anInt8774 && i_107_ >= 0 && i_108_ >= 0 && i_107_ < Node_Sub54.anInt7675 && i_108_ < Class377_Sub1.anInt8774 && i_110_ != 65535) {
				...
				boolean bool = i_127_ >= 0 && i_125_ >= 0 && Node_Sub54.anInt7675 > i_127_ && i_125_ < Class377_Sub1.anInt8774;
				...
				if (i_132_ >= 0 && i_133_ >= 0 && i_132_ < Node_Sub54.anInt7675 && i_133_ < Class377_Sub1.anInt8774) {
					if (i_134_ == -1) {
