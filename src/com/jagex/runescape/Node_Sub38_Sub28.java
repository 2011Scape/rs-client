...
public class Node_Sub38_Sub28 extends Node_Sub38
{
	...
	static final void method2887(String string, String string_5_, byte b) {
		...
		Class320_Sub23.aClass123_8432 = Constants.ENABLE_LOBBY ? Class218.lobbyResponseBuffer : Class218.worldResponseBuffer;
		int i = 25 / ((-17 - b) / 32);
		anInt10398++;
		Class159.anInt1996 = Constants.ENABLE_LOBBY ? 1 : 2;
