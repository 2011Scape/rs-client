...
public class Class199
{
	...
	static final int method2006(byte b) {
		...
		int i = 0;
		int i_0_ = -67 / ((-81 - b) / 32);
		Field[] fields = (aClass2437 == null ? aClass2437 = method2011("com.jagex.runescape.Node_Sub27") : aClass2437).getDeclaredFields();
		Field[] fields_1_ = fields;
		for (int i_2_ = 0; fields_1_.length > i_2_; i_2_++) {
			Field field = fields_1_[i_2_];
			if ((aClass2438 == null ? aClass2438 = method2011("com.jagex.runescape.Class320") : aClass2438).isAssignableFrom(field.getType())) {
				i++;
			}
		}
		return i - -1;
