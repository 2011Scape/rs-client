...
public class Class352
{
	...
	static final void method4011(int[] is, int i, boolean bool, Actor actor, int i_8_) {
		...
		for (int i_13_ = 0; i_13_ < is.length; i_13_++) {
			...
			if (actor.anIntArray10817 == null || actor.anIntArray10817[i_13_] == -1 || Class18.aClass37_306.method395(actor.anIntArray10817[i_13_], (byte) -100).anInt710 <= Class18.aClass37_306.method395(is[i_13_], (byte) -125).anInt710) {
				...
				if (!bool) {
					...
					if (strings != null) {
						for (int i_16_ = strings.length - 1; i_16_ >= 0; i_16_--) {
							if (strings[i_16_] != null && (npcdefinition.aByte2855 == 0 || !strings[i_16_].equalsIgnoreCase(Class22.aClass22_386.method297(-12273, Class35.anInt537)) && !strings[i_16_].equalsIgnoreCase(Class22.aClass22_385.method297(-12273, Class35.anInt537)))) {
								int i_17_ = 0;
						...
						if (npcdefinition.aByte2855 == 1) {
							for (int i_19_ = 0; strings.length > i_19_; i_19_++) {
								if (strings[i_19_] != null && (strings[i_19_].equalsIgnoreCase(Class22.aClass22_386.method297(i ^ 0x6fb7, Class35.anInt537)) || strings[i_19_].equalsIgnoreCase(Class22.aClass22_385.method297(-12273, Class35.anInt537)))) {
									short s = 0;
									if (Class295.aPlayer3692.anInt11152 < npc.anInt11127) {
										s = (short) 2000;
									}
									short s_20_ = 0;
