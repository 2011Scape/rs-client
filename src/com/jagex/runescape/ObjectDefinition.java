...
public class ObjectDefinition
{
			...
			if (i == 1 || i == 5) {
				...
				for (int i_2_ = 0; i_2_ < i_1_; i_2_++) {
					...
					for (int i_4_ = 0; i_3_ > i_4_; i_4_++)
						anIntArrayArray3031[i_2_][i_4_] = buffer.readUnsignedShort();
				}
				if (i == 5 && !aClass112_3028.aBoolean1424) {
					method3052((byte) -111, buffer);
				}
										...
										if (i == 39) {
											...
											if (i != 40) {
												if (i != 41) {
													if (i == 42) {
														...
														for (int i_6_ = 0; i_6_ < i_5_; i_6_++)
															aByteArray2996[i_6_] = buffer.readByte();
													} else if (i != 62) {
														if (i != 64) {
															if (i == 65) {
																anInt2969 = buffer.readUnsignedShort();
															} else if (i != 66) {
																if (i == 67) {
																	anInt3009 = buffer.readUnsignedShort();
																} else if (i == 69) {
																	anInt3040 = buffer.readUnsignedByte();
																} else if (i == 70) {
																	...
																	if (i == 72) {
																		...
																		if (i == 74) {
																			...
																			if (i != 77 && i != 92) {
																				if (i != 78) {
																					if (i == 79) {
																						...
																						for (int i_8_ = 0; i_8_ < i_7_; i_8_++)
																							anIntArray3036[i_8_] = buffer.readUnsignedShort();
																					} else if (i != 81) {
																						if (i != 82) {
																							if (i == 88) {
																								aBoolean2972 = false;
																												...
																												if (i == 98) {
																													...
																													if (i != 100) {
																														if (i == 101) {
																															...
																															anInt3006 = buffer.readUnsignedShort();
																														} else if (i == 103) {
																															anInt2977 = 0;
																														} else if (i == 104) {
																															...
																															if (i == 106) {
																																...
																																for (int i_11_ = 0; i_11_ < i_9_; i_11_++) {
																																	anIntArray3019[i_11_] = buffer.readUnsignedShort();
																																	if (anIntArray3019[i_11_] == 65535) {
																																		anIntArray3019[i_11_] = -1;
																																	}
																																	i_10_ += anIntArray2995[i_11_] = buffer.readUnsignedByte();
																																}
																																...
																																if (i < 150 || i >= 155) {
																																	if (i != 160) {
																																		if (i != 162) {
																																			if (i == 163) {
																																				aByte2974 = buffer.readByte();
																																				aByte3045 = buffer.readByte();
																																				aByte3052 = buffer.readByte();
																																				aByte2960 = buffer.readByte();
																																			} else if (i != 164) {
																																				if (i == 165) {
																																					anInt2963 = buffer.method2193(-20);
																																				} else if (i != 166) {
																																					if (i == 167) {
																																						anInt2983 = buffer.readUnsignedShort();
																																					} else if (i != 168) {
																																						if (i == 169) {
																																							aBoolean2993 = true;
																																						} else if (i == 170) {
																																							...
																																							if (i == 173) {
																																								...
																																								anInt3020 = buffer.readUnsignedShort();
																																							} else if (i != 177) {
																																								if (i == 178) {
																																		...
																																		for (int i_18_ = 0; i_17_ > i_18_; i_18_++)
																																			anIntArray2981[i_18_] = buffer.readUnsignedShort();
																																	}
																																} else {
																																	aStringArray2980[-150 + i] = buffer.readString();
																																	if (!aClass112_3028.aBoolean1431) {
																																		aStringArray2980[-150 + i] = null;
																																	}
																																}
																															} else {
																																anInt2994 = buffer.readUnsignedShort();
																															}
																														} else {
																															aBoolean3007 = true;
																														}
																				...
																				anInt3017 = buffer.readUnsignedShort();
																				if (anInt3017 == 65535) {
																					anInt3017 = -1;
																				}
																				anInt3035 = buffer.readUnsignedShort();
																				if (anInt3035 == 65535) {
																					anInt3035 = -1;
																				}
																				int i_19_ = -1;
																				...
																				for (int i_21_ = 0; i_20_ >= i_21_; i_21_++) {
																					anIntArray2984[i_21_] = buffer.readUnsignedShort();
																			...
																			anInt2970 = buffer.readUnsignedByte();
																		}
																	} else {
																		aBoolean3051 = true;
																	}
																...
																anInt2973 = buffer.readUnsignedShort();
															}
														} else {
															aBoolean3033 = false;
														}
													...
													for (int i_23_ = 0; i_22_ > i_23_; i_23_++) {
														aShortArray3044[i_23_] = (short) buffer.readUnsignedShort();
														aShortArray2988[i_23_] = (short) buffer.readUnsignedShort();
													}
												}
											} else {
												...
												for (int i_25_ = 0; i_25_ < i_24_; i_25_++) {
													aShortArray3047[i_25_] = (short) buffer.readUnsignedShort();
													aShortArray3025[i_25_] = (short) buffer.readUnsignedShort();
												}
											}
										} else {
											aStringArray2980[i + -30] = buffer.readString();
										}
									} else {
	...
	final ObjectDefinition method3038(int i, Interface17 interface17) {
		...
		if (i_32_ < 0 || i_32_ >= -1 + anIntArray2984.length || anIntArray2984[i_32_] == -1) {
	...
	final boolean method3039(int i) {
		...
		synchronized (aClass112_3028.aClass302_1433) {
			for (int i_34_ = 0; i_34_ < anIntArrayArray3031.length; i_34_++) {
				for (int i_35_ = 0; anIntArrayArray3031[i_34_].length > i_35_; i_35_++)
		...
		synchronized (aClass112_3028.aClass302_1433) {
			...
			for (int i_39_ = 0; aByteArray2967.length > i_39_; i_39_++) {
				if (i == aByteArray2967[i_39_]) {
					for (int i_40_ = 0; anIntArrayArray3031[i_39_].length > i_40_; i_40_++) {
	...
	final Class243 method3046(int i, int i_44_, int i_45_, Plane plane, boolean bool, byte b, int i_46_, int i_47_, GraphicsToolkit graphicstoolkit, Class121 class121, int i_48_, Plane plane_49_) {
		...
		boolean bool_53_ = anInt2964 != 0 || anInt2963 != 0 || anInt3018 != 0;
	...
	final DrawableModel method3048(int i, int i_58_, int i_59_, int i_60_, Plane plane, Animator animator, int i_61_, GraphicsToolkit graphicstoolkit, Plane plane_62_, Class121 class121, int i_63_, int i_64_) {
		...
		if (drawablemodel == null || graphicstoolkit.b(drawablemodel.ua(), i_63_) != 0) {
			if (drawablemodel != null) {
		...
		if (anInt2964 != 0 || anInt2963 != 0 || anInt3018 != 0) {
			if (!bool) {
				drawablemodel = drawablemodel.method633((byte) 3, i_63_, true);
				bool = true;
			}
	...
	private final DrawableModel method3051(GraphicsToolkit graphicstoolkit, int i, Class121 class121, byte b, int i_66_, int i_67_) {
		...
		if (anInt2969 != 128 || anInt2973 != 128 || anInt3009 != 128) {
			drawablemodel_77_.O(anInt2969, anInt2973, anInt3009);
		}
		if (anInt2968 != 0 || anInt3037 != 0 || anInt2985 != 0) {
