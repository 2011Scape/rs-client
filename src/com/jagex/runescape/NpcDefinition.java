...
public class NpcDefinition
{
	...
	final boolean method2998(byte b) {
		...
		if (anIntArray2827 == null) {
            return anInt2812 != -1 || anInt2809 != -1 || anInt2810 != -1;
        }
		int i = 0;
		if (b != 91) {
			aClass61_2805 = null;
		...
		for (; i < anIntArray2827.length; i++) {
			if (anIntArray2827[i] != -1) {
				...
				if (npcdefinition_0_.anInt2812 != -1 || npcdefinition_0_.anInt2809 != -1 || npcdefinition_0_.anInt2810 != -1) {
					return true;
				}
			}
		}
	...
	final NpcDefinition method2999(int i, Interface17 interface17) {
		...
		if (i_1_ < 0 || i_1_ >= anIntArray2827.length + -1 || anIntArray2827[i_1_] == -1) {
	...
	private final void method3004(int i, Buffer buffer, byte b) {
		...
		if (i == 1) {
			...
			for (int i_7_ = 0; i_7_ < i_6_; i_7_++) {
				anIntArray2865[i_7_] = buffer.readUnsignedShort();
				if (anIntArray2865[i_7_] == 65535) {
					anIntArray2865[i_7_] = -1;
				}
			}
		} else if (i == 2) {
			aString2821 = buffer.readString();
		} else if (i == 12) {
				...
				if (i == 41) {
					...
					if (i == 60) {
						...
						for (int i_11_ = 0; i_11_ < i_10_; i_11_++)
							anIntArray2847[i_11_] = buffer.readUnsignedShort();
					} else if (i == 93) {
						aBoolean2879 = false;
					} else if (i != 95) {
						if (i == 97) {
													...
													if (i == 113) {
														...
														if (i != 121) {
															if (i != 122) {
																if (i != 123) {
																	if (i == 125) {
																		...
																		if (i == 128) {
																			...
																			if (i != 136) {
																				if (i == 137) {
																					anInt2860 = buffer.readUnsignedShort();
																				} else if (i != 138) {
																					if (i == 139) {
																						anInt2826 = buffer.readUnsignedShort();
																					} else if (i == 140) {
																						...
																						if (i == 142) {
																							...
																							aStringArray2834[-150 + i] = buffer.readString();
																							...
																							if (i != 158) {
																								if (i == 159) {
																									...
																									for (int i_16_ = 0; i_15_ > i_16_; i_16_++)
																										anIntArray2832[i_16_] = buffer.readUnsignedShort();
																								} else if (i != 162) {
																									if (i == 163) {
																							...
																							aByte2836 = buffer.readByte();
																							aByte2853 = buffer.readByte();
																							aByte2857 = buffer.readByte();
																							aByte2839 = buffer.readByte();
																						}
																					} else {
																						aBoolean2843 = true;
																					}
																				} else {
																					anInt2814 = buffer.readUnsignedShort();
																				}
																			} else {
																...
																anInt2878 = buffer.readUnsignedShort();
															}
														} else {
			...
			aStringArray2834[-30 + i] = buffer.readString();
		}
		if (b >= -66) {
			anInt2858 = 38;
		}
	...
	final DrawableModel method3006(int i, Animator animator, Class361 class361, int i_28_, GraphicsToolkit graphicstoolkit, Interface17 interface17) {
		...
		if (drawablemodel == null || i_30_ != (drawablemodel.ua() & i_30_)) {
		...
		if (drawablemodel == null || i_40_ != (drawablemodel.ua() & i_40_)) {
			...
			synchronized (aClass279_2861.aClass302_3564) {
				for (int i_46_ = 0; i_46_ < is_44_.length; i_46_++) {
					if (is_44_[i_46_] != -1 && !aClass279_2861.aClass302_3564.method3515(0, is_44_[i_46_], 0)) {
						bool_45_ = true;
					}
				}
			}
