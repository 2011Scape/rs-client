				...
				while_145_:
					...
					while_144_:
						...
						while_143_:
							...
							anInt10201 = buffer.readUnsignedShort();
							break while_148_;
						} while (false);
						anInt10213 = buffer.readUnsignedShort();
						break while_148_;
					} while (false);
					anInt10208 = buffer.readUnsignedShort();
					break while_148_;
				} while (false);
				anInt10205 = buffer.readUnsignedShort();
				break while_148_;
			} while (false);
			anInt10209 = buffer.readUnsignedShort();
		} while (false);
		if (bool != false) {
