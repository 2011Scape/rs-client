...
public class Class266
{
				...
				if (i_2_ > 0) {
					...
					if (i_2_ <= aBuffer3396.anInt7002) {
						if (aCacheNode_Sub16_Sub1_3397 == null) {
							...
							int i_5_ = aBuffer3396.readUnsignedByte();
							int i_6_ = aBuffer3396.readUnsignedShort();
							int i_7_ = aBuffer3396.readUnsignedByte();
							int i_8_ = aBuffer3396.readInt();
							int i_9_ = 0x7f & i_7_;
					...
					if (-aCacheNode_Sub16_Sub1_3397.aBuffer11072.anInt7002 + i_12_ < i_13_) {
					...
					if (aCacheNode_Sub16_Sub1_3397.aBuffer11072.anInt7002 == i_12_) {
	...
	static final int method3243(int i, Npc npc) {
		...
		if (i_16_ != -1 && !npc.aBoolean10867) {
			if (class259.anInt3252 != i_16_ && class259.anInt3271 != i_16_ && i_16_ != class259.anInt3293 && class259.anInt3270 != i_16_) {
