...
public class Class385
{
	...
	static final void method4204(GraphicsToolkit graphicstoolkit, int i, byte b) {
		...
		if (!Class12.aBoolean194 || !Mobile_Sub1.aBoolean10959) {
			...
			if ((int) ((float) FileOnDisk.anIntArray1329[0] / 3.0F) != Class144_Sub1.anInt6806 || Class331.anInt4130 != (int) ((float) FileOnDisk.anIntArray1329[1] / 3.0F)) {
			...
			if (Class320_Sub21.anInt8406 > 0) {
				...
				for (int i_6_ = 0; i_6_ < Class320_Sub21.anInt8406; i_6_++) {
	...
	static final void method4205(boolean bool, double d) {
		...
		if (GLSprite_Sub1.aDouble8857 != d) {
			for (int i = 0; i < 256; i++) {
				...
				Class323.anIntArray4084[i] = i_7_ > 255 ? 255 : i_7_;
			}
