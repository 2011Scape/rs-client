...
public class Class111
{
	...
	static final synchronized void method1137(byte[] bs, int i) {
		anInt1414++;
		if (bs.length == 100 && AnimableAnimator_Sub1.anInt9090 < 1000) {
			Class144.aByteArrayArray1782[AnimableAnimator_Sub1.anInt9090++] = bs;
		} else if (bs.length == 5000 && CacheNode_Sub16_Sub2.anInt11085 < 250) {
	...
	static final int method1138(String string, byte[] bs, byte b, int i) {
		...
		for (int i_3_ = 0; i_2_ > i_3_; i_3_ += 4) {
			...
			int i_5_ = i_2_ <= i_3_ - -1 ? -1 : Node_Sub16.method2591((byte) -115, string.charAt(i_3_ + 1));
			int i_6_ = i_3_ - -2 < i_2_ ? Node_Sub16.method2591((byte) -115, string.charAt(2 + i_3_)) : -1;
	...
	static final synchronized byte[] method1139(boolean bool, int i) {
		...
		if (i == 5000 && CacheNode_Sub16_Sub2.anInt11085 > 0) {
		...
		if (Class113.aByteArrayArrayArray1447 != null) {
			for (int i_8_ = 0; i_8_ < CacheNode_Sub1.anIntArray9427.length; i_8_++) {
				if (CacheNode_Sub1.anIntArray9427[i_8_] == i && Class132.anIntArray1682[i_8_] > 0) {
