...
public class Class78
{
	...
	static final void method776(int i, int i_0_, int i_1_, GraphicsToolkit graphicstoolkit) {
		...
		if (i_1_ >= 0 && i >= 0 && ClanChat.anInt764 != 0 && Class150_Sub2.anInt8955 != 0) {
			...
			if (Node_Sub38_Sub37.aPlaneArray10466 != null && (!Class87.aBoolean1185 || (0x40 & Class200_Sub2.anInt4943) != 0)) {
				...
				if (i_8_ != -1 && i_9_ != -1) {
					if (!Class87.aBoolean1185 || (0x40 & Class200_Sub2.anInt4943) == 0) {
			...
			for (int i_22_ = i_0_; (Class71.aBoolean967 ? 2 : 1) > i_22_; i_22_++) {
				...
				for (EntityNode_Sub6 entitynode_sub6 = (EntityNode_Sub6) class103.method1113((byte) -113); entitynode_sub6 != null; entitynode_sub6 = (EntityNode_Sub6) class103.method1108(115)) {
					if ((Node_Sub25_Sub1.aBoolean9952 || Class295.aPlayer3692.aByte5933 == entitynode_sub6.anAnimable5990.aByte5933) && entitynode_sub6.method971(graphicstoolkit, (byte) 126, i_24_, i_23_)) {
						...
						if (entitynode_sub6.anAnimable5990 instanceof Player) {
							...
							if ((0x1 & i_29_) == 0 && (0x1ff & player.anInt5934) == 0 && (0x1ff & player.anInt5940) == 0 || (0x1 & i_29_) == 1 && (0x1ff & player.anInt5934) == 256 && (player.anInt5940 & 0x1ff) == 256) {
								...
								for (int i_36_ = 0; i_35_ > i_36_; i_36_++) {
									...
									if (player_37_ != null && player_37_.anInt10863 != Class174.anInt2092 && player_37_ != player && player_37_.aBoolean10826) {
										...
										if (i_38_ >= i_30_ && player_37_.method853((byte) 71) <= -(i_38_ + -i_30_ >> 9) + player.method853((byte) 110) && i_31_ <= i_39_ && player_37_.method853((byte) 79) <= -(i_39_ + -i_31_ >> 9) + player.method853((byte) 100)) {
							...
							if (player.anInt10863 == Class174.anInt2092) {
								continue;
							}
							Class223.method2103(entitynode_sub6.anAnimable5990.aByte5933 != Class295.aPlayer3692.aByte5933, player, -15052);
						...
						if (entitynode_sub6.anAnimable5990 instanceof Npc) {
							...
							if (npc.aNpcDefinition11122 != null) {
								if ((npc.aNpcDefinition11122.anInt2811 & 0x1) == 0 && (0x1ff & npc.anInt5934) == 0 && (0x1ff & npc.anInt5940) == 0 || (0x1 & npc.aNpcDefinition11122.anInt2811) == 1 && (0x1ff & npc.anInt5934) == 256 && (0x1ff & npc.anInt5940) == 256) {
									...
									for (int i_42_ = 0; i_42_ < Node_Sub25_Sub3.anInt9987; i_42_++) {
									...
									for (int i_47_ = 0; i_46_ > i_47_; i_47_++) {
										...
										if (player != null && Class174.anInt2092 != player.anInt10863 && player.aBoolean10826) {
						...
						if (entitynode_sub6.anAnimable5990 instanceof Animable_Sub3_Sub1) {
							...
							if (node_sub11 != null) {
								...
								for (Node_Sub8 node_sub8 = (Node_Sub8) node_sub11.aClass312_7104.method3622((byte) -60); node_sub8 != null; node_sub8 = (Node_Sub8) node_sub11.aClass312_7104.method3623((byte) 106)) {
									...
									if (Class87.aBoolean1185 && entitynode_sub6.anAnimable5990.aByte5933 == Class295.aPlayer3692.aByte5933) {
										...
										if ((0x1 & Class200_Sub2.anInt4943) != 0 && (class267 == null || class267.anInt3443 != itemdefinition.method1678(Class324.anInt4087, class267.anInt3443, 10247))) {
											Class120.anInt1518++;
											Node_Sub32.method2731(false, -1, (long) node_sub8.anInt7065, i_27_, i_28_, Class84.aString1148, 17, true, Class201.anInt2444, Class66.aString5177 + " -> <col=ff9040>" + itemdefinition.name, (long) i_52_, (byte) -18, false);
										}
									}
									if (Class295.aPlayer3692.aByte5933 == entitynode_sub6.anAnimable5990.aByte5933) {
										String[] strings = itemdefinition.options;
										for (int i_53_ = -1 + strings.length; i_53_ >= 0; i_53_--) {
											if (strings[i_53_] != null) {
												...
												Class369.anInt4559++;
												Node_Sub32.method2731(false, -1, (long) node_sub8.anInt7065, i_27_, i_28_, strings[i_53_], i_54_, true, i_55_, "<col=ff9040>" + itemdefinition.name, (long) i_52_, (byte) -18, false);
											}
										}
									}
									i_52_++;
	...
	static final boolean method778(int i, int i_59_, int i_60_, boolean bool, int i_61_, int i_62_, int i_63_, int i_64_, int i_65_) {
		...
		if (i_67_ < 0 || i_67_ >= Node_Sub54.anInt7675 || i_68_ < 0 || i_68_ >= Class377_Sub1.anInt8774) {
			return false;
		}
		if (i_61_ < 0 || i_61_ >= Node_Sub54.anInt7675 || i_59_ < 0 || i_59_ >= Class377_Sub1.anInt8774) {
			return false;
		}
