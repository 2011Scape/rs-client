...
public class Class310
{
		...
		if (b < -54) {
			...
			if (i_8_ == -1) {
				...
				if (objectdefinition.anIntArray2984 != null) {
					objectdefinition = objectdefinition.method3038(13, aa.anInt101 != 3 ? (Interface17) Class24.aClass275_442 : ProducingGraphicsBuffer.anInterface17_9901);
				}
				...
				if (!objectdefinition.method3037(0)) {
					...
					if (objectdefinition.anInt3030 != anInt3928) {
	...
	final DrawableModel method3597(GraphicsToolkit graphicstoolkit, boolean bool, boolean bool_11_, boolean bool_12_, int i) {
		...
		if (!aBoolean3919 && objectdefinition.anInt3030 != anInt3928) {
		...
		if (anAnimator3918.method245(-125)) {
			...
			aDrawableModel3939 = null;
		} else if (aDrawableModel3939 != null && (i & aDrawableModel3939.ua()) == i && anInt3928 == objectdefinition.anInt3030) {
	...
	final void method3600(int i, DrawableModel drawablemodel, boolean bool, int i_14_, GraphicsToolkit graphicstoolkit, int i_15_, int i_16_, int i_17_, Class336 class336) {
		...
		if (i_14_ == -9827) {
			...
			if ((anEntityNode_Sub4_3931 == null || anEntityNode_Sub4_3931.aBoolean5972) && (class300s != null || class218s != null)) {
				...
				if (objectdefinition.anIntArray2984 != null) {
					objectdefinition = objectdefinition.method3038(i_14_ + 9840, aa.anInt101 == 3 ? (Interface17) ProducingGraphicsBuffer.anInterface17_9901 : Class24.aClass275_442);
				}
				if (objectdefinition != null) {
