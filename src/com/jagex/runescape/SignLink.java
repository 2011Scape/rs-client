...
public class SignLink implements Runnable
{
										...
										if (i == 6) {
											...
											if (aBoolean4005 && i == 14) {
												...
												if (aBoolean3985) {
													...
													Class.forName("com.jagex.runescape.Class208").getDeclaredMethod("method2046", new Class[] { Integer.TYPE, Integer.TYPE }).invoke(anObject3990, new Object[] { new Integer(i_16_), new Integer(i_17_) });
												}
												...
												if (aBoolean3985) {
													...
													Class.forName("com.jagex.runescape.Class208").getDeclaredMethod("method2045", new Class[] { aClass4007 == null ? aClass4007 = method3646("java.awt.Component") : aClass4007, Boolean.TYPE }).invoke(anObject3990, new Object[] { component, new Boolean(bool) });
												}
											} else if (!aBoolean3985 && i == 17) {
												Object[] objects = (Object[]) class241.anObject2954;
												Class.forName("com.jagex.runescape.Class208").getDeclaredMethod("method2047", new Class[] { aClass4007 == null ? aClass4007 = method3646("java.awt.Component") : aClass4007, aClass4008 == null ? aClass4008 = method3646("[I") : aClass4008, Integer.TYPE, Integer.TYPE, aClass4009 == null ? aClass4009 = method3646("java.awt.Point") : aClass4009 }).invoke(anObject3990, new Object[] { (Component) objects[0], (int[]) objects[1], new Integer(class241.anInt2952), new Integer(class241.anInt2951), (Point) objects[2] });
											} else if (i == 16) {
												try {
	...
	SignLink(int i, String string, int i_20_, boolean bool) throws Exception {
		...
		if (aBoolean4005) {
			...
			if (aBoolean3985) {
				try {
					anObject3991 = Class.forName("com.jagex.runescape.Class149").newInstance();
				} catch (Throwable throwable) {
					/* empty */
				}
			}
			...
			try {
				if (aBoolean3985) {
					...
					anObject3990 = Class.forName("com.jagex.runescape.Class208").newInstance();
				}
			} catch (Throwable throwable) {
				/* empty */
			}
