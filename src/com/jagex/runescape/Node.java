...
class Node
{
	...
	static final void method2162(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_) {
		...
		if (i_5_ < Class262_Sub4.anInt7722 || za_Sub2.anInt10513 < i_0_ || i_3_ < Class384.anInt4906 || Node_Sub25_Sub1.anInt9936 < i_4_) {
	...
	static final boolean method2163(int i, int i_7_, int i_8_, byte b, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_) {
		anInt2796++;
		if (i_7_ > 2000 || i_12_ > 2000 || i_10_ > 2000 || i > 2000 || i_14_ > 2000 || i_11_ > 2000) {
			return false;
		}
		if (i_7_ < -2000 || i_12_ < -2000 || i_10_ < -2000 || i < -2000 || i_14_ < -2000 || i_11_ < -2000) {
			return false;
		...
		if (Class320_Sub11.anInt8315 == 2) {
			...
			if (i_15_ >= 0 && Node_Sub38.anIntArray7451.length > i_15_ && (i_13_ << 8) - 38400 < Node_Sub38.anIntArray7451[i_15_]) {
				return false;
			}
			...
			if (i_15_ >= 0 && i_15_ < Node_Sub38.anIntArray7451.length && Node_Sub38.anIntArray7451[i_15_] > (i_8_ << 8) + -38400) {
				return false;
			}
		}
		int i_16_ = i_14_ - i;
		...
		if (i_7_ <= i_12_ && i_7_ <= i_10_) {
			...
			if (i_10_ > i_12_) {
				...
				if ((i_12_ == i_7_ || i_24_ >= i_22_) && (i_7_ != i_12_ || i_24_ <= i_23_)) {
					i_10_ -= i_12_;
					i_12_ -= i_7_;
			...
			if (i_7_ != i_10_ && i_24_ < i_22_ || i_7_ == i_10_ && i_22_ < i_23_) {
				i_12_ -= i_10_;
				i_10_ -= i_7_;
				i_7_ = Class144_Sub1.anInt6806 * i_7_;
				while (--i_10_ >= 0) {
		...
		if ((i_12_ == i_10_ || i_22_ >= i_23_) && (i_10_ != i_12_ || i_22_ <= i_24_)) {
			i_7_ -= i_10_;
			i_10_ -= i_12_;
			i_12_ *= Class144_Sub1.anInt6806;
			while (--i_10_ >= 0) {
