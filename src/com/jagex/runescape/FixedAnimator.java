...
public class FixedAnimator extends Animator
{
	...
	static final void method258(boolean bool, byte b, boolean bool_0_, int i, int i_1_, String string, String string_2_) {
		...
		for (int i_6_ = 0; EntityNode_Sub3_Sub1.aClass86_9166.anInt1175 > i_6_; i_6_++) {
			...
			if ((!bool_0_ || itemdefinition.isTradeable) && itemdefinition.notedTemplate == -1 && itemdefinition.anInt1852 == -1 && itemdefinition.anInt1928 == -1 && itemdefinition.anInt1877 == 0 && itemdefinition.name.toLowerCase().indexOf(string) != -1) {
				if (i_1_ != -1) {
					if (!bool) {
		...
		for (int i_9_ = 0; Class365_Sub1.anInt8759 > i_9_; i_9_++)
			strings[i_9_] = EntityNode_Sub3_Sub1.aClass86_9166.method1010(ses[i_9_], 14434).name;
