...
public class Class13
{
	...
	static int anInt208;
	static String[][] aStringArrayArray209 = { { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" }, { "Jan", "Feb", "M\u00e4r", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez" }, { "jan", "f\u00e9v", "mars", "avr", "mai", "juin", "juil", "ao\u00fbt", "sept", "oct", "nov", "dec" }, { "jan", "fev", "mar", "abr", "mai", "jun", "jul", "ago", "set", "out", "nov", "dez" }, { "jan", "feb", "mrt", "apr", "mei", "jun", "jul", "aug", "sep", "okt", "nov", "dec" } };
	static int anInt210;
	static int anInt211;
	...
	static final boolean method208(int i, int i_1_, int i_2_) {
		...
		anInt211++;
		return Class179.method1816(i_1_, i_2_ + -1, i) | (0x70000 & i_1_) != 0 || Class318.method3669(i_1_, (byte) 120, i);
	}
