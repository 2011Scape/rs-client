...
public class Node_Sub38_Sub27 extends Node_Sub38
{
	...
	static final Class38 method2882(Buffer buffer, ItemDefinition itemdefinition, int i) {
		...
		if (bool) {
			...
			if (itemdefinition.maleModel1 != -1 || itemdefinition.femaleModel1 != -1) {
				class38.anIntArray561[1] = buffer.method2183(false);
				class38.anIntArray566[1] = buffer.method2183(false);
			}
			if (itemdefinition.maleModel2 != -1 || itemdefinition.femaleModel2 != -1) {
		...
		if (bool_57_) {
			...
			if (itemdefinition.maleHeadModel2 != -1 || itemdefinition.femaleHeadModel2 != -1) {
		...
		if (bool_58_) {
			...
			for (int i_61_ = 0; i_61_ < 4; i_61_++) {
				if (is[i_61_] != 15) {
					class38.aShortArray567[is[i_61_]] = (short) buffer.readUnsignedShort();
				}
			}
		}
		if (bool_59_) {
			...
			for (int i_63_ = 0; i_63_ < 2; i_63_++) {
				if (is[i_63_] != 15) {
					class38.aShortArray563[is[i_63_]] = (short) buffer.readUnsignedShort();
				}
			}
		}
		return class38;
