...
public class Node_Sub29_Sub3 extends Node_Sub29
{
	...
	static final byte[][][] method2719(int i, int i_4_) {
		...
		bs_7_ = new byte[i_5_ * i_6_];
		i_8_ = 0;
		for (int i_13_ = 0; i_6_ > i_13_; i_13_++) {
		...
		for (int i_17_ = -1 + i_6_; i_17_ >= 0; i_17_--) {
			for (int i_18_ = 0; i_5_ > i_18_; i_18_++) {
				if (i_17_ >> 1 >= i_18_) {
					bs_7_[i_8_] = (byte) -1;
				}
				i_8_++;
		...
		i_8_ = 0;
		bs_7_ = new byte[i_6_ * i_5_];
		for (int i_35_ = 0; i_6_ > i_35_; i_35_++) {
		...
		for (int i_39_ = -1 + i_6_; i_39_ >= 0; i_39_--) {
			for (int i_40_ = -1 + i_5_; i_40_ >= 0; i_40_--) {
				if (i_40_ <= i_39_ << 1) {
					bs_7_[i_8_] = (byte) -1;
				}
				i_8_++;
		...
		bs_7_ = new byte[i_6_ * i_5_];
		i_8_ = 0;
		for (int i_41_ = -1 + i_6_; i_41_ >= 0; i_41_--) {
		...
		i_8_ = 0;
		bs_7_ = new byte[i_5_ * i_6_];
		for (int i_51_ = 0; i_6_ > i_51_; i_51_++) {
		...
		bs_7_ = new byte[i_6_ * i_5_];
		i_8_ = 0;
		for (int i_55_ = 0; i_6_ > i_55_; i_55_++) {
		...
		i_8_ = 0;
		bs_7_ = new byte[i_6_ * i_5_];
		for (int i_57_ = 0; i_6_ > i_57_; i_57_++) {
		...
		i_8_ = 0;
		bs_7_ = new byte[i_5_ * i_6_];
		for (int i_59_ = -1 + i_6_; i_59_ >= 0; i_59_--) {
			for (int i_60_ = 0; i_5_ > i_60_; i_60_++) {
		...
		i_8_ = 0;
		bs_7_ = new byte[i_5_ * i_6_];
		for (int i_63_ = 0; i_6_ > i_63_; i_63_++) {
		...
		bs_7_ = new byte[i_5_ * i_6_];
		i_8_ = 0;
		for (int i_65_ = 0; i_6_ > i_65_; i_65_++) {
		...
		for (int i_69_ = -1 + i_6_; i_69_ >= 0; i_69_--) {
			for (int i_70_ = -1 + i_5_; i_70_ >= 0; i_70_--) {
				if (-(i_6_ / 2) + i_69_ <= i_70_) {
					bs_7_[i_8_] = (byte) -1;
				}
				i_8_++;
			}
