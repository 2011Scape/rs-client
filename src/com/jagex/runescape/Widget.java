...
public class Widget
{
	...
	final void method4142(Buffer buffer, byte b) {
		...
		anInt4841 = buffer.readUnsignedByte();
		if ((anInt4841 & 0x80) != 0) {
			anInt4841 &= 0x7f;
			aString4765 = buffer.readString();
		}
		anInt4814 = buffer.readUnsignedShort();
		anInt4850 = buffer.method2193(-78);
		anInt4816 = buffer.method2193(-106);
		anInt4693 = buffer.readUnsignedShort();
		anInt4722 = buffer.readUnsignedShort();
		aByte4750 = buffer.readByte();
		aByte4741 = buffer.readByte();
		aByte4720 = buffer.readByte();
		aByte4851 = buffer.readByte();
		anInt4692 = buffer.readUnsignedShort();
		if (anInt4692 != 65535) {
		...
		if (anInt4841 == 0) {
			anInt4735 = buffer.readUnsignedShort();
			anInt4691 = buffer.readUnsignedShort();
			if (i < 0) {
				aBoolean4858 = buffer.readUnsignedByte() == 1;
			}
		}
		if (anInt4841 == 5) {
			anInt4820 = buffer.readInt();
			anInt4728 = buffer.readUnsignedShort();
			int i_18_ = buffer.readUnsignedByte();
			aBoolean4861 = (i_18_ & 0x1) != 0;
			aBoolean4738 = (i_18_ & 0x2) != 0;
			anInt4757 = buffer.readUnsignedByte();
			anInt4744 = buffer.readUnsignedByte();
			anInt4796 = buffer.readInt();
			aBoolean4732 = buffer.readUnsignedByte() == 1;
			aBoolean4743 = buffer.readUnsignedByte() == 1;
			anInt4754 = buffer.readInt();
			if (i >= 3) {
		...
		if (anInt4841 == 6) {
			anInt4844 = 1;
			anInt4864 = buffer.readUnsignedShort();
			if (anInt4864 == 65535) {
				anInt4864 = -1;
			}
			...
			if (bool) {
				...
				anInt4815 = buffer.readUnsignedShort();
				anInt4821 = buffer.readUnsignedShort();
				anInt4682 = buffer.readUnsignedShort();
				anInt4787 = buffer.readUnsignedShort();
			...
			anInt4773 = buffer.readUnsignedShort();
			if (anInt4773 == 65535) {
				anInt4773 = -1;
			}
			if (aByte4750 != 0) {
				anInt4800 = buffer.readUnsignedShort();
			}
			if (aByte4741 != 0) {
				anInt4849 = buffer.readUnsignedShort();
			}
		}
		if (anInt4841 == 4) {
			anInt4759 = buffer.readUnsignedShort();
			if (anInt4759 == 65535) {
				anInt4759 = -1;
			}
			if (i >= 2) {
				aBoolean4832 = buffer.readUnsignedByte() == 1;
			}
			aString4790 = buffer.readString();
			anInt4697 = buffer.readUnsignedByte();
			anInt4835 = buffer.readUnsignedByte();
			anInt4825 = buffer.readUnsignedByte();
			aBoolean4710 = buffer.readUnsignedByte() == 1;
			anInt4754 = buffer.readInt();
			anInt4757 = buffer.readUnsignedByte();
			if (i >= 0) {
				anInt4767 = buffer.readUnsignedByte();
			}
		}
		if (anInt4841 == 3) {
			anInt4754 = buffer.readInt();
			aBoolean4769 = buffer.readUnsignedByte() == 1;
			anInt4757 = buffer.readUnsignedByte();
		}
		if (anInt4841 == 9) {
			anInt4752 = buffer.readUnsignedByte();
			anInt4754 = buffer.readInt();
			aBoolean4721 = buffer.readUnsignedByte() == 1;
		}
		int i_20_ = buffer.read24BitInt();
		int i_21_ = buffer.readUnsignedByte();
		if (i_21_ != 0) {
			aByteArray4806 = new byte[11];
			aByteArray4733 = new byte[11];
			anIntArray4705 = new int[11];
			for (; i_21_ != 0; i_21_ = buffer.readUnsignedByte()) {
				int i_22_ = (i_21_ >> 4) - 1;
				i_21_ = buffer.readUnsignedByte() | i_21_ << 8;
				i_21_ &= 0xfff;
				if (i_21_ == 4095) {
					i_21_ = -1;
				}
				byte b_23_ = buffer.readByte();
				if (b_23_ != 0) {
					aBoolean4802 = true;
				}
				byte b_24_ = buffer.readByte();
				anIntArray4705[i_22_] = i_21_;
				aByteArray4806[i_22_] = b_23_;
				aByteArray4733[i_22_] = b_24_;
			}
		}
		aString4779 = buffer.readString();
		int i_25_ = buffer.readUnsignedByte();
		int i_26_ = 0xf & i_25_;
		if (i_26_ > 0) {
			aStringArray4686 = new String[i_26_];
			for (int i_27_ = 0; i_26_ > i_27_; i_27_++)
				aStringArray4686[i_27_] = buffer.readString();
		}
		int i_28_ = i_25_ >> 4;
		if (i_28_ > 0) {
			...
			anIntArray4863[i_29_] = buffer.readUnsignedShort();
		}
		if (i_28_ > 1) {
			int i_31_ = buffer.readUnsignedByte();
			anIntArray4863[i_31_] = buffer.readUnsignedShort();
		}
		...
		if (Animable_Sub4.method925(i_20_, 34933) != 0) {
			i_32_ = buffer.readUnsignedShort();
			if (i_32_ == 65535) {
				i_32_ = -1;
			}
		...
		if (i >= 0) {
			anInt4761 = buffer.readUnsignedShort();
			if (anInt4761 == 65535) {
				anInt4761 = -1;
			}
		}
		...
		if (i >= 0) {
			...
			for (int i_34_ = 0; i_33_ > i_34_; i_34_++) {
				int i_35_ = buffer.read24BitInt();
				int i_36_ = buffer.readInt();
	...
	private final int[] method4150(byte b, Buffer buffer) {
		anInt4716++;
		int i = buffer.readUnsignedByte();
		if (i == 0) {
			return null;
