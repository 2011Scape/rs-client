...
public class Class83 implements Interface10
{
	...
	static final Class144_Sub1 method801(byte b, Buffer buffer) {
		...
		anInt5184++;
		return new Class144_Sub1(buffer.method2193(-49), buffer.method2193(-87), buffer.method2193(-53), buffer.method2193(-57), buffer.read24BitInt(), buffer.read24BitInt(), buffer.readUnsignedByte());
	}
