...
class Class277
{
	...
	final void method3337(Buffer buffer, int i, Class84[] class84s, int i_0_, byte b, int i_1_, int i_2_) {
			...
			for (int i_3_ = 0; i_3_ < 4; i_3_++) {
				...
				for (int i_4_ = 0; i_4_ < 64; i_4_++) {
					for (int i_5_ = 0; i_5_ < 64; i_5_++) {
						int i_6_ = i_4_ + i_2_;
						int i_7_ = i_5_ + i;
						if (i_6_ >= 0 && i_6_ < anInt3524 && i_7_ >= 0 && i_7_ < anInt3521) {
		...
		int i_8_ = i_2_ + i_1_;
		int i_9_ = i_0_ + i;
		for (int i_10_ = 0; anInt3535 > i_10_; i_10_++) {
	...
	final void method3339(int i, int[][][] is, GraphicsToolkit graphicstoolkit, Class84[] class84s) {
		if (!aBoolean3516) {
			for (int i_18_ = 0; i_18_ < 4; i_18_++) {
				for (int i_19_ = 0; anInt3524 > i_19_; i_19_++) {
					for (int i_20_ = 0; anInt3521 > i_20_; i_20_++) {
						if ((0x1 & CacheNode_Sub11.aByteArrayArrayArray9550[i_18_][i_19_][i_20_]) != 0) {
							int i_21_ = i_18_;
			...
			for (int i_22_ = 0; i_22_ < anInt3535; i_22_++) {
				...
				if (!aBoolean3516) {
					...
					if (Class237.anInt2906 != 0) {
						i_23_ |= 0x1;
						if (i_22_ == 0 | Class339_Sub6.aBoolean8715) {
							i_24_ |= 0x10;
						}
					}
				}
	...
	private final void method3340(int i, byte b, GraphicsToolkit graphicstoolkit, int[][] is, Plane plane, Plane plane_26_, Plane plane_27_) {
		for (int i_28_ = 0; i_28_ < anInt3524; i_28_++) {
			for (int i_29_ = 0; i_29_ < anInt3521; i_29_++) {
				if (Class256.anInt3237 == -1 || Class369.method4085(i_29_, 0, Class256.anInt3237, i_28_, i)) {
					...
					if (class289 != null && class289.anInt3631 == -1 && class289.anInt3629 == -1) {
					...
					if (class289 != null || class236 != null) {
						...
						for (int i_56_ = 0; i_56_ < i_51_; i_56_++) {
						...
						if (bool && i > 1 || !bool && i > 0) {
							...
							if (class236 != null && !class236.aBoolean2892) {
								bool_71_ = false;
							} else if (i_33_ != 0 || b_30_ == 0) {
								if (i_32_ > 0 && class289_34_ != null && !class289_34_.aBoolean3636) {
									bool_71_ = false;
								}
							} else {
								bool_71_ = false;
							}
							if (bool_71_ && i_67_ == i_68_ && i_67_ == i_69_ && i_67_ == i_70_) {
	...
	private final void method3341(int i, Class289 class289, byte[][] bs, int i_75_, int i_76_, int i_77_, int i_78_, int i_79_, GraphicsToolkit graphicstoolkit, int i_80_, boolean[] bools, Class236 class236, byte[][] bs_81_, byte[][] bs_82_) {
		...
		if (i_80_ > 0) {
			if (i_77_ > 0) {
				...
				if (i_84_ > 0) {
					...
					if (class289_85_.anInt3631 != -1 && class289_85_.aBoolean3643) {
			...
			if (-1 + i_75_ > i_77_) {
				...
				if (i_88_ > 0) {
					...
					if (class289_89_.anInt3631 != -1 && class289_89_.aBoolean3643) {
				...
				if (class289_101_.anInt3631 != -1) {
					...
					if (class289_101_.aBoolean3643) {
						...
						for (int i_106_ = 0; i_106_ < 3; i_106_++) {
							i_103_ = 0x7 & i_103_;
							i_104_ &= 0x7;
							if (GLPlane.aBooleanArrayArray7950[b][i_104_] && Class327.anIntArray5348[i_103_] <= class289_101_.anInt3633) {
								...
								if (class289_101_.anInt3633 != Class327.anIntArray5348[i_103_]) {
					...
					if (class289_108_.aBoolean3643) {
						...
						for (int i_113_ = 0; i_113_ < 3; i_113_++) {
							...
							if (GLPlane.aBooleanArrayArray7950[b][i_111_] && Class327.anIntArray5348[i_110_] <= class289_108_.anInt3633) {
								...
								if (class289_108_.anInt3633 != Class327.anIntArray5348[i_110_]) {
					...
					if (class289_115_.aBoolean3643) {
						...
						for (int i_120_ = 0; i_120_ < 3; i_120_++) {
							...
							if (GLPlane.aBooleanArrayArray7950[b][i_118_] && Class327.anIntArray5348[i_117_] <= class289_115_.anInt3633) {
								...
								if (Class327.anIntArray5348[i_117_] == class289_115_.anInt3633) {
				...
				if (class289_122_.anInt3631 != -1) {
					...
					if (class289_122_.aBoolean3643) {
						...
						for (int i_127_ = 0; i_127_ < 3; i_127_++) {
							i_125_ &= 0x7;
							i_124_ = 0x7 & i_124_;
							if (GLPlane.aBooleanArrayArray7950[b][i_125_] && Class327.anIntArray5348[i_124_] <= class289_122_.anInt3633) {
		...
		if (class289 != null) {
			...
			if (class289.aBoolean3643) {
				for (int i_129_ = 0; i_129_ < 8; i_129_++) {
					int i_130_ = -(i_78_ * 2) + i_129_ & 0x7;
					if (GLPlane.aBooleanArrayArray7950[i][i_129_] && Class327.anIntArray5348[i_130_] <= class289.anInt3633) {
	...
	static final void method3344(int i, boolean bool, int i_135_) {
		...
		if (node_sub43 != null && i_135_ >= 0 && i_135_ < node_sub43.anInt7531) {
	...
	private final void method3345(int i, int i_136_, int i_137_, int i_138_, int i_139_, Buffer buffer, int i_140_, int i_141_, int i_142_, int i_143_, boolean bool) {
		...
		anInt3515++;
		if (i_138_ < 0 || i_138_ >= anInt3524 || i_136_ < 0 || i_136_ >= anInt3521) {
			for (;;) {
			...
			for (;;) {
				...
				if (i_145_ <= 49) {
					if (bool) {
						...
						aByteArrayArrayArray3528[i_142_][i_138_][i_136_] = buffer.readByte();
	...
	final void method3346(byte b, GraphicsToolkit graphicstoolkit, Plane plane, Plane plane_147_) {
		...
		if (b == 75) {
			...
			for (int i = 0; i < anInt3535; i++) {
				...
				for (int i_149_ = -5; i_149_ < anInt3524; i_149_++) {
				...
				if (!Class382.aBoolean5254) {
					method3340(i, (byte) -78, graphicstoolkit, is, i == 0 ? plane_147_ : null, Class320_Sub10.aPlaneArray8300[i], i == 0 ? plane : null);
				} else {
					method3348(i == 0 ? plane_147_ : null, false, is, i != 0 ? null : plane, Class320_Sub10.aPlaneArray8300[i], graphicstoolkit, i);
				}
	...
	final void method3347(int i, int i_163_, int i_164_, int i_165_, int i_166_, int i_167_) {
		anInt3523++;
		for (int i_168_ = i_164_; i_163_ + i_164_ > i_168_; i_168_++) {
			for (int i_169_ = i_165_; i_165_ + i_167_ > i_169_; i_169_++) {
				if (i_169_ >= 0 && i_169_ < anInt3524 && i_168_ >= 0 && i_168_ < anInt3521) {
					anIntArrayArrayArray3520[i_166_][i_169_][i_168_] = i_166_ <= 0 ? 0 : anIntArrayArrayArray3520[i_166_ + -1][i_169_][i_168_] + -960;
				}
			}
		}
		if (i_165_ > 0 && anInt3524 > i_165_) {
		...
		if (i_165_ >= 0 && i_164_ >= 0 && i_165_ < anInt3524 && i_164_ < anInt3521) {
			if (i_166_ == 0) {
				if (i_165_ > 0 && anIntArrayArrayArray3520[i_166_][i_165_ + -1][i_164_] != 0) {
					...
					if (i_165_ > 0 && i_164_ > 0 && anIntArrayArrayArray3520[i_166_][-1 + i_165_][-1 + i_164_] != 0) {
			...
			} else if (i_165_ <= 0 || anIntArrayArrayArray3520[i_166_][i_165_ - 1][i_164_] == anIntArrayArrayArray3520[i_166_ + -1][i_165_ + -1][i_164_]) {
				if (i_164_ <= 0 || anIntArrayArrayArray3520[i_166_][i_165_][i_164_ + -1] == anIntArrayArrayArray3520[i_166_ + -1][i_165_][-1 + i_164_]) {
					if (i_165_ > 0 && i_164_ > 0 && anIntArrayArrayArray3520[i_166_][i_165_ + -1][-1 + i_164_] != anIntArrayArrayArray3520[-1 + i_166_][i_165_ - 1][-1 + i_164_]) {
	...
	private final void method3348(Plane plane, boolean bool, int[][] is, Plane plane_172_, Plane plane_173_, GraphicsToolkit graphicstoolkit, int i) {
		...
		for (int i_177_ = 0; i_177_ < anInt3524; i_177_++) {
			int i_178_ = anInt3524 - 1 > i_177_ ? 1 + i_177_ : i_177_;
			for (int i_179_ = 0; i_179_ < anInt3521; i_179_++) {
				int i_180_ = anInt3521 - 1 > i_179_ ? 1 + i_179_ : i_179_;
				if (Class256.anInt3237 == -1 || Class369.method4085(i_179_, 0, Class256.anInt3237, i_177_, i)) {
					...
					if (i_184_ != 0 || i_185_ != 0) {
						Class289 class289 = i_184_ == 0 ? null : aClass71_3512.method743(-1 + i_184_, (byte) 118);
						...
						if (class289 != null) {
							if (class289.anInt3631 != -1 || class289.anInt3629 != -1) {
								if (class236 != null && b != 0) {
						...
						if ((b == 0 || b == 12) && i_177_ > 0 && i_179_ > 0 && i_177_ < anInt3524 && anInt3521 > i_179_) {
							int i_190_ = 0;
							int i_191_ = 0;
							int i_192_ = 0;
							...
							int i_193_ = 0;
							if (i_185_ != bs_175_[i_177_][i_179_ + -1]) {
								i_191_--;
								i_190_--;
							} else {
								i_191_++;
						...
						boolean bool_198_ = class289 != null && class289.anInt3629 != class289.anInt3631;
						if (!bool_198_) {
							for (int i_199_ = 0; i_199_ < 8; i_199_++) {
								if (Class327.anIntArray5348[i_199_] >= 0 && Class188_Sub1_Sub1.anIntArray9339[i_199_] != Class262_Sub10.anIntArray7773[i_199_]) {
									bool_198_ = true;
									break;
								}
							}
						...
						if (!bools_197_[0x3 & 1 + i_183_]) {
							bools[1] = Class313.method3647(bools[1], Node_Sub30.method2723(Class136.anIntArray1695[2], Class136.anIntArray1695[4]) == 0);
						}
						...
						if (!bools_197_[i_183_ & 0x3]) {
							bools[0] = Class313.method3647(bools[0], Node_Sub30.method2723(Class136.anIntArray1695[0], Class136.anIntArray1695[2]) == 0);
						}
						if (!bools_197_[0x3 & 2 + i_183_]) {
							bools[2] = Class313.method3647(bools[2], Node_Sub30.method2723(Class136.anIntArray1695[6], Class136.anIntArray1695[4]) == 0);
						}
						if (!bool_182_ && (b == 0 || b == 12)) {
						...
						if (i_207_ <= 0) {
							...
							if (class289 == null) {
								...
								for (int i_223_ = 0; i_223_ < i_204_; i_223_++) {
									...
									int i_225_;
									if (!bools[-i_183_ & 0x3] || i_208_ != is_201_[0]) {
										if (!bools[0x3 & 2 - i_183_] || i_208_ != is_201_[2]) {
											if (!bools[1 - i_183_ & 0x3] || i_208_ != is_201_[1]) {
												if (bools[3 + -i_183_ & 0x3] && i_208_ == is_201_[3]) {
								...
								if (b != 12 && class289.anInt3631 != -1 && class289.aBoolean3638) {
									bool_181_ = true;
								}
							}
							if (class236 != null) {
								...
								for (int i_243_ = 0; i_243_ < i_202_; i_243_++) {
									...
									if (bools[0x3 & -i_183_] && is_201_[0] == i_208_) {
										...
										if (!bools[-i_183_ + 3 & 0x3] || i_208_ != is_201_[3]) {
											Node_Sub38_Sub26.anIntArray10370[0] = is_205_[i_208_];
											Node_Sub38_Sub26.anIntArray10370[1] = is_206_[i_208_];
											i_245_ = 3;
											Node_Sub38_Sub26.anIntArray10370[2] = is_203_[i_208_];
							...
							if (bool_265_ && i > 1 || !bool_265_ && i > 0) {
								boolean bool_266_ = true;
								if (class236 == null || class236.aBoolean2892) {
									if (i_185_ == 0 && b != 0) {
										bool_266_ = false;
									} else if (i_184_ > 0 && class289_189_ != null && !class289_189_.aBoolean3636) {
										bool_266_ = false;
									}
								} else {
									bool_266_ = false;
								}
								if (bool_266_ && i_262_ == i_261_ && i_263_ == i_261_ && i_264_ == i_261_) {
		...
		if (!aBoolean3516) {
			...
			for (int i_278_ = 0; i_278_ < 8; i_278_++) {
				for (int i_279_ = 0; i_279_ < 8; i_279_++) {
					...
					if (i_280_ > 0 && i_280_ < anInt3524 + -1 && i_281_ > 0 && anInt3521 - 1 > i_281_) {
		...
		for (int i_286_ = 0; i_286_ < anInt3535; i_286_++) {
			for (int i_287_ = 0; i_287_ < 64; i_287_++) {
				for (int i_288_ = 0; i_288_ < 64; i_288_++) {
					if (i_286_ != i_270_ || i_276_ > i_287_ || i_287_ > 8 + i_276_ || i_288_ < i_277_ || i_288_ > 8 + i_277_) {
						method3345(0, -1, 0, -1, 0, buffer, 0, 0, 0, -682, false);
					} else {
						int i_289_;
						int i_290_;
						if (i_287_ == i_276_ - -8 || i_288_ == 8 + i_277_) {
							if (i_274_ != 0) {
								if (i_274_ == 1) {
						...
						if (i_287_ == 63 || i_288_ == 63) {
							...
							for (int i_292_ = 0; i_292_ < i_291_; i_292_++) {
								...
								if (i_292_ != 0) {
									...
									i_294_ = i_288_ == 63 ? 64 : i_288_;
									i_293_ = i_287_ != 63 ? i_287_ : 64;
								}
								int i_295_;
								int i_296_;
								if (i_274_ == 0) {
