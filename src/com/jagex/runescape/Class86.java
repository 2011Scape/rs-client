...
public class Class86
{
	...
	final GLSprite method1002(int i, GraphicsToolkit graphicstoolkit, GraphicsToolkit graphicstoolkit_0_, PlayerDefinition playerdefinition, boolean bool, int i_1_, int i_2_, boolean bool_3_, int i_4_, Class52 class52, int i_5_, int i_6_) {
		...
		if (i_2_ > 1 && itemdefinition.countObj != null) {
			int i_7_ = -1;
			for (int i_8_ = 0; i_8_ < 10; i_8_++) {
				if (i_2_ >= itemdefinition.countCo[i_8_] && itemdefinition.countCo[i_8_] != 0) {
					i_7_ = itemdefinition.countObj[i_8_];
				}
			}
			if (i_7_ != -1) {
	...
	final ItemDefinition method1010(int i, int i_16_) {
		...
		itemdefinition.options = (String[]) aStringArray1184.clone();
		itemdefinition.interfaceOptions = (String[]) aStringArray1183.clone();
		if (bs != null) {
			itemdefinition.method1675(new Buffer(bs), (byte) 122);
		}
		itemdefinition.method1691((byte) 106);
		if (itemdefinition.notedTemplate != -1) {
			itemdefinition.method1677(method1010(itemdefinition.notedTemplate, 14434), 45, method1010(itemdefinition.notedID, 14434));
		}
		...
		if (!aBoolean1162 && itemdefinition.members) {
			itemdefinition.name = Class22.aClass22_368.method297(i_16_ + -26707, anInt1161);
			itemdefinition.options = aStringArray1184;
			itemdefinition.interfaceOptions = aStringArray1183;
			itemdefinition.anIntArray1926 = null;
			itemdefinition.anInt1899 = 0;
			itemdefinition.isTradeable = false;
