...
public class Class262_Sub6 extends Class262 {
    ...
    static void method3164(int i, boolean bool, byte b) {
        anInt7744++;
        Node_Sub16 node_sub16 = Class295.method3472(i, (byte) 18, bool);
        if (node_sub16 != null) {
            int i_0_ = 0;
            int i_1_ = -16 / ((b + 58) / 52);
            for (/**/; (~i_0_) > (~node_sub16.anIntArray7137.length); i_0_++) {
    ...
    static void method3166(byte b, int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_) {
        anInt7743++;
        if (b <= 41) {
            aClass192_7748 = null;
        }
        for (EntityNode_Sub2 entitynode_sub2 = (EntityNode_Sub2) Class226.aClass103_2684.method1113((byte) 122); entitynode_sub2 != null; entitynode_sub2 = (EntityNode_Sub2) Class226.aClass103_2684.method1108(88)) {
            if ((~entitynode_sub2.anInt5947) >= (~Class174.anInt2092)) {
