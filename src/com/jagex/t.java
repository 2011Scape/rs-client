...
public class t extends Plane implements Interface3 {
    private final Class312 aClass312_5019 = new Class312();
    private final oa anOa5020;
    ...
    private native void V(int i, int i_77_, int i_78_, int i_79_, int i_80_, int i_81_, int[] is);
    ...
    private native void ga(oa var_oa, ya var_ya, int i, int i_89_, int[][] is, int[][] is_90_, int i_91_, int i_92_, int i_93_);
}
