...
public class Node_Sub31 extends Node {
    ...
    static byte[] method2725(int i, byte b, byte[] bs) {
        int i_0_ = 48 / ((40 - b) / 48);
        anInt7373++;
    ...
    final boolean method2728(int i, byte b, int i_2_) {
        ...
        if ((~i) <= (~anInt7374) && i <= anInt7369 && (~i_2_) <= (~anInt7365) && (~i_2_) >= (~anInt7370)) {
            return true;
        }
        if ((~anInt7371) >= (~i) && i <= anInt7364 && (~anInt7363) >= (~i_2_) && i_2_ <= anInt7366) {
            return true;
        }
        return false;
    }
