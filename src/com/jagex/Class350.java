...
public class Class350 implements Interface16 {
    ...
    static void method3992(int i, int i_1_, int i_2_) {
        anInt5395++;
        if (i_2_ != 10) {
    ...
    static boolean method3993(byte b) {
        if (b != 108) {
            return true;
        }
        anInt5401++;
    ...
    static int method3998(String string, int i) {
        if (i != -1) {
            aClass170_5391 = null;
        }
        anInt5362++;
    ...
    static String method3999(long l, boolean bool, int i, int i_5_) {
        anInt5376++;
        Calendar calendar;
        if (!bool) {
    ...
    private int method3991(byte b, int i) {
    ...
    private int method3994(int i, int i_3_) {
        if (i != -24768) {
            return -96;
        }
        anInt5365++;
    ...
    private void method3995(int i) throws IllegalAccessException, NoSuchFieldException {
        anInt5381++;
    ...
    private void method3996(boolean bool) {
    ...
    private int method3997(Class var_class, Object object, boolean bool, String string) throws IllegalAccessException, NoSuchFieldException {
        anInt5368++;
    ...
    private Object method4001(Class var_class, String string, byte b) throws IllegalAccessException, NoSuchFieldException {
        anInt5399++;
        Field field = var_class.getDeclaredField(string);
        if (b != -44) {
            return null;
        ...
        if (aBoolean5389) {
            ...
            if (graphics == null) {
                ...
                try {
                    ...
                    for (int i_35_ = 0; (~i_35_) > (~(-i_24_ + (anInt5371 + -i_22_))); i_35_ += i_27_)
                        graphics_34_.drawImage(anImage5382, i_35_, 0, null);
                    for (int i_36_ = 0; (~(-i_24_ + (anInt5371 - i_22_))) < (~i_36_); i_36_ = i_36_ + i_29_)
    ...
    private boolean method4002(Object object, Class var_class, boolean bool, String string) throws IllegalAccessException, NoSuchFieldException {
        if (bool != false) {
            anInt5366 = -90;
        }
        anInt5396++;
