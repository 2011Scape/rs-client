...
public class Node_Sub38_Sub26 extends Node_Sub38 {
    ...
    static byte[] method2875(byte[] bs, byte b) {
        anInt10362++;
        ...
        if (i != 0) {
            ...
            if (i_8_ < 0 || (~Class59.anInt866) != -1 && i_8_ > Class59.anInt866) {
                return new byte[1];
            }
    ...
    static void method2876(Animable[] animables, int i, int i_11_) {
        if (i < i_11_) {
            int i_12_ = (i + i_11_) / 2;
            int i_13_ = i;
    ...
    static boolean method2877(int i, int i_17_, int i_18_) {
        anInt10366++;
        if (i_18_ < 82) {
            aClass192_10368 = null;
        }
    ...
    private void method2873(int i, int i_0_) {
