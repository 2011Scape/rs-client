...
public class Node_Sub25_Sub1 extends Node_Sub25 {
    ...
    private final VorbisInfo aVorbisInfo9931 = new VorbisInfo();
    private final VorbisComment aVorbisComment9942 = new VorbisComment();
    ...
    static void method2657(int i, int i_0_) {
    ...
    static void method2659(Node_Sub9_Sub1 node_sub9_sub1, boolean bool, int i, int i_2_, Class302 class302, int i_3_, int i_4_) {
    ...
    static Node_Sub13 method2660(int i) {
        anInt9934++;
    ...
    static int method2664(int i, int i_7_, int i_8_, int i_9_) {
        anInt9946++;
        if (i_9_ == i) {
            return i_9_;
        }
    ...
    final void method2654(int i, OggPacket oggpacket) {
        ...
        if ((~anInt7234) <= -4) {
            ...
            for (int i_5_ = 0; (aVorbisInfo9931.channels ^ 0xffffffff) < (~i_5_); i_5_++)
