...
class Buffer extends Node {
    ...
    static void method2205(int i, Node node, Node node_38_) {
    ...
    final void method2181(int i, int i_3_, byte[] bs, int i_4_) {
        for (int i_5_ = i; (~i_5_) > (~(i_3_ + i)); i_5_++)
    ...
    final String method2195(int i) {
        anInt6953++;
        int i_21_ = anInt7002;
        while ((~aByteArray7019[anInt7002++]) != -1) {
            /* empty */
        }
