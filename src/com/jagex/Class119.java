...
public class Class119 {
    ...
    private void method1218(int i, int i_14_, int i_15_, GraphicsToolkit graphicstoolkit, boolean bool, boolean bool_16_, int i_17_, int i_18_, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_) {
        anInt1486++;
        int i_25_ = 255 - i_22_;
        if (aDrawableModel1504 != null) {
            ...
            if (anInt1491 == -1 || anInt1507 == 0) {
                ...
                if (aGLSprite1490 == null && Class376.aD4661.method7(i_19_ + 40162, anInt1491)) {
                    int[] is = (~class91.anInt1226) == -3 ? Class376.aD4661.method8(0.7F, anInt1491, anInt1507, false, false, anInt1507) : Class376.aD4661.method11(anInt1507, false, anInt1507, anInt1491, (byte) 0, 0.7F);
                    anInt1481 = is[0];
    ...
    private void method1221(int i, int i_44_, int i_45_, int i_46_, int i_47_, GraphicsToolkit graphicstoolkit) {
        anInt1498++;
    ...
    private void method1223(int i, GraphicsToolkit graphicstoolkit) {
        if (i != 0) {
            method1223(-82, null);
        }
        try {
            Class302 class302 = Class188_Sub2_Sub2.aClass302_9361;
            boolean bool = class302.method3536(~i, anInt1501);
            if (bool) {
    ...
    final boolean method1225(int i, int i_50_, int i_51_, GraphicsToolkit graphicstoolkit) {
        if ((~anInt1494) != (~i_51_)) {
            ...
            if (aClass182Array1483 != null) {
                ...
                for (int i_53_ = 0; (~aClass182Array1483.length) < (~i_53_); i_53_++) {
        ...
        if (aBoolean1500) {
            aBoolean1500 = false;
            for (int i_54_ = anInt1492 - 1; (~i_54_) <= -1; i_54_--) {
        ...
        } else if (aDrawableModel1504 == null && (~anInt1501) <= -1) {
