...
abstract class r extends CacheNode {
    ...
    static boolean method2357(byte b, char c) {
        anInt9581++;
        if (b != -117) {
            anIntArray9580 = null;
        }
    ...
    static void method2358(int i, byte b, int i_3_) {
        anInt9582++;
        if (b == -106) {
    ...
    static int method2359(String string, byte b, int i, String string_4_) {
        anInt9583++;
    ...
    static void method2360(int i, int i_20_, int i_21_, String string, int i_22_, int i_23_, int i_24_, int i_25_) {
        anInt9579++;
    ...
    static boolean method2361(int i, int i_26_) {
        if (i_26_ < 1) {
            method2361(-95, -35);
        }
        anInt9584++;
