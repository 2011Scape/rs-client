    ...
    static void method1972(int i) {
        ...
        if ((~Class213.aNode_Sub27_2512.aClass320_Sub4_7304.method3694(false)) == -3) {
            ...
            for (int i_1_ = 0; i_1_ < 4; i_1_++) {
                for (int i_2_ = 0; (~i_2_) > (~Class377_Sub1.anInt8774); i_2_++)
                    Node_Sub38_Sub15.aByteArrayArrayArray10261[i_1_][i_0_][i_2_] = b;
            }
            if ((~CacheNode_Sub20_Sub1.anInt11089) != -4) {
                ...
                if ((~Class320_Sub22.anInt8415) == -2 || Class367.anInt4541 != -1) {
                    ...
                    if (Class318.anInt4050 < 2560) {
                        ...
                        if (i_10_ == 0 && (~i_11_) == -1 || (~i_10_) >= (~-Node_Sub54.anInt7675) || i_10_ >= Node_Sub54.anInt7675 || (~-Class377_Sub1.anInt8774) <= (~i_11_) || (~Class377_Sub1.anInt8774) >= (~i_11_)) {
                            ...
                            while ((~i_8_) != (~i_6_)) {
                                ...
                                if ((~i_15_) <= -65537) {
                                    ...
                                    i_15_ -= 65536;
                                    if ((~(0x4 & CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.anInt11089][i_6_][i_7_])) != -1) {
                    ...
                    if ((~(i_16_ + -Class190.anInt2331)) > -3201 && (~(CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.anInt11089][Class98.anInt5061 >> 9][Node_Sub10.anInt7079 >> 9] & 0x4)) != -1) {
