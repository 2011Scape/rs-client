...
public class GLSprite_Sub1 extends GLSprite {
    ...
    GLSprite_Sub1(GLToolkit gltoolkit, int i, int i_119_, boolean bool) {
        ...
        aClass169_Sub2_Sub1_8855 = Node_Sub38_Sub38.method2913(i_119_, i, bool ? 6408 : 6407, gltoolkit);
    }
    ...
    static void method1201(int i, int i_39_, int i_40_, int i_41_, int i_42_, int i_43_) {
        if (i_41_ == -12935) {
    ...
    static boolean method1202(byte b) {
        int i = -39 % ((b - 59) / 36);
        anInt8871++;
    ...
    static void method1205(CacheNode_Sub4 cachenode_sub4, byte b) {
        anInt8866++;
        boolean bool = false;
        int i = -90 % ((b + 44) / 32);
    ...
    final void method1184(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
        aClass169_Sub2_Sub1_8855.method1757(false, (~(i_8_ & 0x1)) != -1);
        anInt8858++;
    ...
    final void method1188(float f, float f_14_, float f_15_, float f_16_, float f_17_, float f_18_, int i, aa var_aa, int i_19_, int i_20_) {
        ...
        aClass169_Sub2_Sub1_8855.method1757(false, (~(i & 0x1)) != -1);
        aGLToolkit8861.method1461(34962);
        aGLToolkit8861.method1444(-2, aClass169_Sub2_Sub1_8855);
    ...
    final void method1178(int i, int i_58_, int i_59_, int i_60_) {
        ...
        anInt8875 = i_59_;
        anInt8878 = i_60_;
        aBoolean8852 = anInt8879 != 0 || anInt8865 != 0 || anInt8875 != 0 || (~anInt8878) != -1;
    }
    ...
    final void method1194(float f, float f_65_, float f_66_, float f_67_, float f_68_, float f_69_, int i, int i_70_, int i_71_, int i_72_) {
        ...
        aClass169_Sub2_Sub1_8855.method1757(false, (~(0x1 & i_72_)) != -1);
        aGLToolkit8861.method1461(34962);
        aGLToolkit8861.method1444(-2, aClass169_Sub2_Sub1_8855);
    ...
    private void method1204(int i, int i_113_, int i_114_, int i_115_, int[] is, int i_116_, int i_117_) {
        aClass169_Sub2_Sub1_8855.method1772((byte) -28, is, true, i, i_115_, i_114_, i_113_, i_117_, i_116_);
        anInt8853++;
    }

    private void method1206(boolean bool, int i) {
        aGLToolkit8861.method1457(33984, 1);
        anInt8867++;
        if (bool == true) {
            aGLToolkit8861.method1444(-2, aClass169_Sub2_Sub1_8855);
