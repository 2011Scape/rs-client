...
public class Class262_Sub1 extends Class262 {
    ...
    static void method3150(int i, Player player, int i_0_, int i_1_, Npc npc, ObjectDefinition objectdefinition, byte b, int i_2_) {
        anInt7703++;
    ...
    static void method3151(float[] fs, float f, int i, int i_5_, int i_6_, float[] fs_7_, float f_8_, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_) {
        i_5_ -= i_13_;
        i_12_ -= i;
        if (i_10_ != -2356) {
            aClass124_7696 = null;
