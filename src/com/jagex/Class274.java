...
public class Class274 implements d {
    ...
    Class274(Class302 class302, Class302 class302_38_, Class302 class302_39_) {
        ...
        for (int i = 0; anInt4976 > i; i++) {
            if (aClass91Array4967[i] != null) {
                aClass91Array4967[i].aBoolean1205 = (~buffer.method2233(255)) == -2;
            }
        }
        for (int i = 0; (~anInt4976) < (~i); i++) {
            if (aClass91Array4967[i] != null) {
        ...
        for (int i = 0; (~i) > (~anInt4976); i++) {
            if (aClass91Array4967[i] != null) {
                aClass91Array4967[i].aBoolean1222 = (~buffer.method2233(255)) == -2;
            }
        }
        for (int i = 0; anInt4976 > i; i++) {
            if (aClass91Array4967[i] != null) {
        ...
        for (int i = 0; anInt4976 > i; i++) {
            if (aClass91Array4967[i] != null) {
                aClass91Array4967[i].aBoolean1215 = (~buffer.method2233(255)) == -2;
            }
        }
        for (int i = 0; (~i) > (~anInt4976); i++) {
            if (aClass91Array4967[i] != null) {
    ...
    static CacheNode_Sub11 method3323(Class302 class302, int i, int i_3_, int i_4_) {
        anInt4980++;
        Buffer buffer = new Buffer(class302.method3524(false, i_3_, i));
        CacheNode_Sub11 cachenode_sub11 = new CacheNode_Sub11(i_3_, buffer.method2195(-1), buffer.method2195(~i_4_), buffer.method2186(-76), buffer.method2186(-58), (~buffer.method2233(255)) == -2, buffer.method2233(255), buffer.method2233(255));
    ...
    static void method3325(boolean bool, int i, int i_9_, int i_10_) {
        anInt4973++;
    ...
    static void method3326(boolean bool, byte[][][] bs, int i, byte b, int i_11_, int i_12_, boolean bool_13_) {
        int i_14_ = bool ? 1 : 0;
    ...
    private static void method3327(Animable animable) {
    ...
    private CacheNode_Sub19 method3322(int i, byte b) {
        anInt4972++;
