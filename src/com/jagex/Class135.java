...
public class Class135 {
    ...
    static void method1587(int i, Player player) {
        if (i > 40) {
            anInt1689++;
            Node_Sub47 node_sub47 = (Node_Sub47) Class320_Sub3.aHashTable8234.method1518(3512, player.anInt10858);
            if (node_sub47 != null) {
    ...
    static Object method1588(byte[] bs, int i, boolean bool) {
        anInt1691++;
        if (bs == null) {
            return null;
        }
        if ((~bs.length) < -137 && !Class169_Sub1.aBoolean8783) {
            try {
