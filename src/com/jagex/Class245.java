...
public class Class245 {
    ...
    static void method3069(int i, boolean bool) {
        anInt3091++;
        if (bool) {
    ...
    private void method3068(byte b) {
        anInt3094++;
        if (aBoolean3099) {
            aBoolean3099 = false;
            ...
            if (anInterface13_Impl1_3093 != null && (~i) == (~anInt3097)) {
                aBoolean3099 = false;
            } else {
                anInt3097 = i;
                int i_5_ = 0;
                ...
                if (!anAbstractToolkit3098.method1295(Node_Sub52.aClass68_7639, Class372.aClass372_4594, 1)) {
                    ...
                    for (int i_10_ = -128; (~i_10_) > -1; i_10_++) {
