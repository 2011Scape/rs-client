...
public class Class320_Sub9 extends Class320 {
    ...
    static boolean method3713(int i, int i_0_, int i_1_) {
        if (i < 78) {
    ...
    static void method3714(int i, byte b, int i_2_, int i_3_, int i_4_) {
        ...
        if (b < -123) {
            for (Node_Sub47 node_sub47 = (Node_Sub47) Class200_Sub2.aClass312_4942.method3613(65280); node_sub47 != null; node_sub47 = (Node_Sub47) Class200_Sub2.aClass312_4942.method3620(16776960)) {
                ...
                if ((~i_6_) == 0 || node_sub47.aNpc7583.aBoolean10867) {
                    i_5_ = 0;
                } else if ((~i_6_) != (~class259.anInt3252) && i_6_ != class259.anInt3271 && (~i_6_) != (~class259.anInt3293) && class259.anInt3270 != i_6_) {
                    if ((~class259.anInt3262) == (~i_6_) || (~i_6_) == (~class259.anInt3297) || class259.anInt3304 == i_6_ || i_6_ == class259.anInt3269) {
                        i_5_ = 3;
                    }
                } else {
                    i_5_ = 2;
                }
                if ((~node_sub47.anInt7586) != (~i_5_)) {
                    ...
                    if (npcdefinition != null && (~i_7_) != 0) {
                        if ((~i_7_) != (~node_sub47.anInt7564) || node_sub47.aBoolean7580 == !npcdefinition.aBoolean2883) {
                            boolean bool = false;
                            if (node_sub47.aNode_Sub9_Sub2_7568 == null) {
                                bool = true;
                            } else {
                                node_sub47.anInt7570 -= 512;
                                if ((~node_sub47.anInt7570) >= -1) {
            ...
            for (Node_Sub47 node_sub47 = (Node_Sub47) Class320_Sub3.aHashTable8234.method1516(false); node_sub47 != null; node_sub47 = (Node_Sub47) Class320_Sub3.aHashTable8234.method1520(69)) {
                ...
                if (i_9_ == -1 || node_sub47.aPlayer7573.aBoolean10867) {
                    i_8_ = 0;
                } else if ((~i_9_) == (~class259.anInt3252) || (~i_9_) == (~class259.anInt3271) || (~class259.anInt3293) == (~i_9_) || i_9_ == class259.anInt3270) {
                    i_8_ = 2;
                } else if ((~class259.anInt3262) == (~i_9_) || (~i_9_) == (~class259.anInt3297) || (~class259.anInt3304) == (~i_9_) || i_9_ == class259.anInt3269) {
                    i_8_ = 3;
                }
                if ((~i_8_) != (~node_sub47.anInt7586)) {
    ...
    static void method3716(boolean bool, int i, boolean bool_11_, int i_12_, Widget[] widgets, int i_13_) {
        anInt8286++;
        int i_14_ = 0;
        if (bool == true) {
            for (/**/; (~widgets.length) < (~i_14_); i_14_++) {
                Widget widget = widgets[i_14_];
                if (widget != null && (~widget.anInt4692) == (~i_13_)) {
                    ...
                    if ((~(widget.anInt4691 + -widget.anInt4695)) > (~widget.anInt4734)) {
                        widget.anInt4734 = -widget.anInt4695 + widget.anInt4691;
                    }
                    if ((~widget.anInt4734) > -1) {
                        widget.anInt4734 = 0;
                    }
    ...
    static boolean method3717(Class42 class42, Class302 class302, Class302 class302_15_, Class302 class302_16_, int i, Node_Sub9_Sub1 node_sub9_sub1) {
        ...
        for (int i_17_ = 0; (~i_17_) > -17; i_17_++)
