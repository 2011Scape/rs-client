...
public class Class89 {
    ...
    static int method1019(int i, int i_0_, int i_1_) {
        if (i_0_ != 26817) {
            anInt1197 = -44;
        }
        anInt1196++;
    ...
    static void method1021(GraphicsToolkit graphicstoolkit, byte b) {
        anInt1200++;
        int i = 0;
        int i_4_ = 0;
    ...
    static void method1022(boolean bool) {
        anInt1194++;
        if (!Class26.method311(Class151.anInt1843, -5) && !Class329.method3833((byte) -61, Class151.anInt1843)) {
            ...
            if ((~i) > -1 || Node_Sub54.anInt7675 >> 3 <= i || (~i_14_) > -1 || Class377_Sub1.anInt8774 >> 3 <= i_14_) {
