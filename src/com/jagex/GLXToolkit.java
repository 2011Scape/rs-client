...
public class GLXToolkit extends AbstractToolkit {
    ...
    GLXToolkit(OpenGL opengl, java.awt.Canvas canvas, long l, d var_d, Class302 class302, int i) {
        super(canvas, Long.valueOf(l), var_d, class302, i, 1);
        ...
        try {
            ...
            if ((~aString9323.indexOf("radeon")) != 0) {
                int i_76_ = 0;
                boolean bool = false;
                boolean bool_77_ = false;
                String[] strings_78_ = Class106.method1120((byte) 78, aString9323.replace('/', ' '), ' ');
                for (int i_79_ = 0; (~strings_78_.length) < (~i_79_); i_79_++) {
                    String string_80_ = strings_78_[i_79_];
                    try {
                        if (string_80_.length() > 0) {
                            if ((~string_80_.charAt(0)) == -121 && (~string_80_.length()) <= -4 && Class290_Sub7.method3441(2, string_80_.substring(1, 3))) {
                                bool_77_ = true;
                            ...
                            if (string_80_.equals("hd")) {
                                ...
                                if ((~string_80_.length()) <= -5 && Class290_Sub7.method3441(2, string_80_.substring(0, 4))) {
    ...
    static byte[] method1399(byte b, byte[] bs, int i, int i_18_) {
        anInt9212++;
        byte[] bs_19_;
        if (i_18_ > 0) {
            bs_19_ = new byte[i];
            System.arraycopy(bs, 0 + i_18_, bs_19_, 0, i);
        } else {
            bs_19_ = bs;
        }
    ...
    static boolean method1401(int i) {
        anInt9261++;
        if (i != -6279) {
            anInt9276 = -87;
        }
    ...
    static void method1405(byte[] bs, int i, int i_63_, int i_64_, int i_65_, int i_66_, int i_67_, byte[] bs_68_, int i_69_) {
        anInt9269++;
        int i_70_ = -(i_64_ >> 2);
        i_64_ = -(i_64_ & 0x3);
        if (i_67_ >= 0) {
        ...
        for (int i_71_ = -i_65_; i_71_ < 0; i_71_++) {
            for (int i_72_ = i_70_; (~i_72_) > -1; i_72_++) {
                bs[i_63_++] += bs_68_[i_69_++];
                bs[i_63_++] += bs_68_[i_69_++];
                bs[i_63_++] += bs_68_[i_69_++];
                bs[i_63_++] += bs_68_[i_69_++];
            }
            for (int i_73_ = i_64_; (~i_73_) > -1; i_73_++)
                bs[i_63_++] += bs_68_[i_69_++];
            i_63_ += i_66_;
            i_69_ += i;
        }
    ...
    final void method1308(byte b) {
        if (!aBoolean6338 || !aBoolean6299 || (~anInt6355) > -1) {
    ...
    private void method1397(byte b) {
        if (aBoolean9313) {
            OpenGL.glPopMatrix();
        }
        anInt9241++;
    ...
    final synchronized void e(int i) {
        ...
        if ((~this.E()) < -100663297 && 60000L + aLong9312 < Class313.method3650(false)) {
            System.gc();
    ...
    final void method1338(Class213 class213, int i) {
        ...
        if (i == 9422) {
            for (int i_33_ = 0; class207s.length > i_33_; i_33_++) {
                ...
                for (int i_36_ = 0; (~i_36_) > (~class207.method2042(-1)); i_36_++) {
            ...
            if ((~anInt9311) > (~i_30_)) {
                for (int i_37_ = anInt9311; (~i_37_) > (~i_30_); i_37_++) {
                    OpenGL.glClientActiveTexture(i_37_ + 33984);
                    OpenGL.glEnableClientState(32888);
                }
                anInt9311 = i_30_;
            } else if ((~i_30_) > (~anInt9311)) {
    ...
    final Renderer c() {
        ...
        if (aString9318.indexOf("nvidia") == -1) {
            if ((~aString9318.indexOf("intel")) != 0) {
                i = 32902;
