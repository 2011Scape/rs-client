...
public class Node_Sub49 extends Node {
    ...
    static Node_Sub49 method2954(Class302 class302, int i) {
    ...
    private static void method2960(byte[] bs) {
        method2964(bs, 0);
    ...
    private static boolean method2961(Class302 class302) {
        if (!aBoolean7600) {
    ...
    static Node_Sub49 method2962(Class302 class302, int i, int i_110_) {
        if (!method2961(class302)) {
    ...
    private static void method2964(byte[] bs, int i) {
        aByteArray7592 = bs;
        anInt7610 = i;
        anInt7593 = 0;
    }

    static int method2965() {
    ...
    private void method2955(byte[] bs) {
    ...
    private float[] method2959(int i) {
