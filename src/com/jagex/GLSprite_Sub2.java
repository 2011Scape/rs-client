...
abstract class GLSprite_Sub2 extends GLSprite {
    ...
    private boolean method1211(float f, float f_67_, float f_68_, float f_69_, float f_70_, float f_71_) {
        ...
        int anInt8912 = (int) (f_87_ * 16.0F + 8.0F - (f + f_68_ + f_70_ + f_85_) / 4.0F * 16.0F);
        int anInt8898 = (int) (f_89_ * 16.0F + 8.0F - (f_67_ + f_69_ + f_71_ + f_86_) / 4.0F * 16.0F);
