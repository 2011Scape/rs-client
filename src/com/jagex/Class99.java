...
public class Class99 {
    ...
    static boolean method1087(int i, int i_1_, int i_2_, int i_3_, int i_4_, byte b, int i_5_, int i_6_, int i_7_, int i_8_) {
        anInt1285++;
        if (b != 89) {
            method1085(91);
        }
    ...
    final boolean method1089(int i, int i_9_, int i_10_, int i_11_) {
        ...
        boolean bool;
        if ((~anInt1284) == -1) {
            if ((~i) < (~anInt1281) && (~i) >= (~(i_11_ + anInt1281)) || anInt1281 > i && (~(-i_11_ + anInt1281)) >= (~i)) {
                anInt1281 = i;
                return false;
            }
            bool = true;
        } else if (anInt1284 > 0 && (~anInt1281) > (~i)) {
