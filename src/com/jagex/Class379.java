...
public class Class379 {
    ...
    static void method4159(int i, boolean bool) {
        anInt4871++;
    ...
    static String method4161(byte b, String string) {
        anInt4866++;
    ...
    static int method4164(int i, byte b) {
        if (b < 18) {
            return 28;
        }
        anInt4867++;
    ...
    final int method4160(int i, int i_0_, int i_1_) {
        anInt4870++;
        int i_2_ = (~Class360.windowWidth) < (~i_0_) ? Class360.windowWidth : i_0_;
