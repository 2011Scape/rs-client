...
public class CacheNode_Sub10 extends CacheNode {
    ...
    final Class151 method2324(int i, int i_0_) {
        anInt9526++;
        int i_1_ = 19 % ((43 - i) / 62);
        if (anIntArray9518 == null || (~i_0_) > -1 || (~i_0_) < (~anIntArray9518.length)) {
            return null;
        }
    ...
    final int method2326(int i, boolean bool, int i_3_) {
        anInt9523++;
        if (anIntArray9518 == null || (~i) > -1 || (~i) < (~anIntArray9518.length)) {
            return -1;
        }
        if (anIntArrayArray9515[i] == null || i_3_ < 0 || (~i_3_) < (~anIntArrayArray9515[i].length)) {
            return -1;
        }
        if (bool != true) {
    ...
    final String method2329(byte b, Buffer buffer) {
        ...
        if (anIntArray9518 != null) {
            for (int i = 0; (~i) > (~anIntArray9518.length); i++) {
    ...
    private void method2333(Buffer buffer, int i, int i_8_) {
        anInt9517++;
        if ((~i_8_) != -2) {
            if ((~i_8_) == -3) {
            ...
            aStringArray9529 = Class106.method1120((byte) -102, buffer.method2195(~i), '<');
        }
        if (i != 0) {
