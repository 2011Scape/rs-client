...
public class CacheNode_Sub6 extends CacheNode {
    ...
    static Class365 method2311(Socket socket, int i, byte b) throws IOException {
        int i_0_ = -31 % ((b - 72) / 39);
        anInt9478++;
    ...
    static String method2313(byte b, long l) {
        anInt9481++;
    ...
    private void method2314(int i, Buffer buffer, byte b) {
        if (b >= -93) {
            aClass57_9480 = null;
        }
        if ((~i) == -3) {
