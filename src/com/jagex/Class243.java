...
public class Class243 {
    ...
    static void method3059(int i, byte b, int i_0_, Widget widget) {
    ...
    static void method3060(byte b, boolean bool, boolean bool_1_, Node_Sub2 node_sub2) {
        anInt3073++;
    ...
    static boolean method3062(int i, byte b) {
        anInt3066++;
        if (b < 44) {
            return true;
        }
