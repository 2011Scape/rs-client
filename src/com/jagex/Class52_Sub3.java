...
public class Class52_Sub3 extends Class52 {
    ...
    private void method546(byte[] bs, int[] is, int i, int i_14_, int i_15_, int i_16_, int i_17_, int i_18_, int i_19_) {
        int i_20_ = -(i_16_ >> 2);
        i_16_ = -(i_16_ & 0x3);
    ...
    private void method547(byte[] bs, int[] is, int[] is_24_, int i, int i_25_, int i_26_, int i_27_, int i_28_, int i_29_) {
        int i_30_ = -(i_26_ >> 2);
        i_26_ = -(i_26_ & 0x3);
        boolean bool = false;
    ...
    private void method548(byte[] bs, int[] is, int[] is_36_, int i, int i_37_, int i_38_, int i_39_, int i_40_, int i_41_, int i_42_, int i_43_, int i_44_, int i_45_, aa var_aa, int i_46_, int i_47_) {
    ...
    private void method549(byte[] bs, int[] is, int i, int i_62_, int i_63_, int i_64_, int i_65_, int i_66_, int i_67_, int i_68_, int i_69_, int i_70_, aa var_aa, int i_71_, int i_72_) {
        aa_Sub1 var_aa_Sub1 = (aa_Sub1) var_aa;
