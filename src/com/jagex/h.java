...
public class h extends Class52 implements Interface3 {
    ...
    private native void JA(oa var_oa, ya var_ya, byte[][] bs, int[] is, int[] is_4_, int[] is_5_, int[] is_6_);

    final native void fa(char c, int i, int i_10_, int i_11_, boolean bool);

    private native void NA(char c, int i, int i_12_, int i_13_, boolean bool, aa var_aa, int i_14_, int i_15_);
