...
public class FixedAnimator extends Animator {
    ...
    static boolean method257(Node_Sub4 node_sub4, int i) {
        anInt5504++;
        if (node_sub4 == null) {
            return true;
        }
    ...
    static void method258(boolean bool, byte b, boolean bool_0_, int i, int i_1_, String string, String string_2_) {
        ...
        for (int i_6_ = 0; EntityNode_Sub3_Sub1.aClass86_9166.anInt1175 > i_6_; i_6_++) {
            ...
            if ((!bool_0_ || itemdefinition.aBoolean1933) && itemdefinition.anInt1857 == -1 && itemdefinition.anInt1852 == -1 && (~itemdefinition.anInt1928) == 0 && itemdefinition.anInt1877 == 0 && itemdefinition.aString1860.toLowerCase().indexOf(string) != -1) {
                if ((~i_1_) != 0) {
                    if (!bool) {
                        if ((~i) != (~itemdefinition.method1678(i_1_, i_3_, 10247))) {
                            continue;
                        }
        ...
        for (int i_9_ = 0; (~i_9_) > (~Class365_Sub1.anInt8759); i_9_++)
