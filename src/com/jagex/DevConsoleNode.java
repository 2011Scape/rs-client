...
public class DevConsoleNode extends Node {
    ...
    static Class151[] method2934(int i) {
        if (i >= -6) {
            anInt7527 = -24;
        }
        anInt7524++;
    ...
    static boolean method2935(byte b, int i, int i_0_) {
        anInt7520++;
        if (i_0_ >= 1000 && (~i) > -1001) {
            return true;
        }
    ...
    static void drawDevConsole(GraphicsToolkit graphicstoolkit, int i) {
        int offsetX = 0;
        int offsetY = 0;
        int totalHeight = 350;
    ...
    static void processConsoleCommands(int i, boolean bool, boolean bool_11_, String string) {
        Class126.anInt1618++;
        try {
