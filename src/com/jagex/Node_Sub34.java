...
public class Node_Sub34 extends Node {
    ...
    static void method2741(boolean bool) {
        anInt7408++;
    ...
    static String method2742(Widget widget, int i, int i_3_) {
        anInt7409++;
        ...
        if (widget.aStringArray4686 == null || (~i) <= (~widget.aStringArray4686.length) || widget.aStringArray4686[i] == null || (~widget.aStringArray4686[i].trim().length()) == -1) {
