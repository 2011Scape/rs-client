...
public class Class173 {
    ...
    static void method1799(boolean bool, String string, byte b) {
        anInt2082++;
        if (b != -96) {
            aClass192_2088 = null;
        }
    ...
    static void method1800(byte b, GLSprite[] glsprites) {
        int i = 100 % ((63 - b) / 63);
    ...
    static int method1801(String string, int i, byte[] bs, boolean bool, int i_2_, int i_3_) {
        anInt2081++;
        int i_4_ = -i_3_ + i;
        if (bool != true) {
            return 5;
