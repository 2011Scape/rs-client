...
public class Class262_Sub13 extends Class262 {
    ...
    static void method3182(boolean bool) {
        anInt7802++;
    ...
    static Class170[] method3184(int i) {
        if (i != 0) {
            aClass257_7801 = null;
        }
        anInt7794++;
    ...
    static void method3185(byte b, EntityNode entitynode, EntityNode entitynode_3_) {
        anInt7803++;
