...
public class Class300 {
    ...
    static void method3497(byte b, GraphicsToolkit graphicstoolkit) {
        anInt3772++;
        Node_Sub5_Sub2.aClass49Array9413 = new Class49[Class291.anIntArray3665.length];
        if (b == 107) {
            for (int i = 0; (~i) > (~Class291.anIntArray3665.length); i++) {
    ...
    static Class234 method3498(int i) {
        anInt3759++;
        try {
    ...
    static int method3499(int i, byte b) {
        if (b != -6) {
            aClass192_3750 = null;
        }
        anInt3770++;
    ...
    static Buffer method3500(int i) {
        anInt3760++;
