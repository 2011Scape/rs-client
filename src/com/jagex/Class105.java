...
public class Class105 implements Interface10 {
    ...
    static void method1116(int i, int i_0_, int i_1_, byte b, int i_2_, int i_3_, boolean bool) {
        int i_4_ = 113 / ((b - 10) / 47);
        if ((bool ? Class213.aNode_Sub27_2512.aClass320_Sub25_7276.method3776(false) : Class213.aNode_Sub27_2512.aClass320_Sub25_7295.method3776(false)) != 0 && i_0_ != 0 && Class23.anInt434 < 50 && (~i) != 0) {
            Node_Sub38_Sub19.aClass78Array10284[Class23.anInt434++] = new Class78(bool ? (byte) 3 : (byte) 2, i, i_0_, i_2_, i_3_, 0, i_1_, null);
        }
        anInt5198++;
    }

    static CacheNode_Sub11 method1117(int i) {
        if (i < 104) {
    ...
    static void method1119(int i, int i_9_, int i_10_) {
