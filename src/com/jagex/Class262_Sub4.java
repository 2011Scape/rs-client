...
public class Class262_Sub4 extends Class262 {
    ...
    static void method3159(int i, int i_0_) {
        anInt7728++;
    ...
    static void method3160(int i, int i_1_, byte b, int i_2_, int i_3_, int i_4_) {
        if (b != -21) {
            aClass379_7731 = null;
        }
        anInt7725++;
        ...
        } else if (i_4_ - i_3_ < anInt7722 || i_3_ + i_4_ > za_Sub2.anInt10513 || Class384.anInt4906 > i_2_ - i || (~Node_Sub25_Sub1.anInt9936) > (~(i_2_ - -i))) {
