...
public class Class32 {
    ...
    static int method354(int i, int i_1_, byte b, int i_2_, int i_3_, int i_4_, int i_5_) {
        i_5_ &= 0x3;
        if ((i_3_ & 0x1) == 1) {
            int i_6_ = i;
            i = i_2_;
    ...
    static CacheNode_Sub9 method356(byte[] bs, boolean bool) {
        anInt513++;
        ...
        while (buffer.anInt7002 < i_9_) {
            ...
            if ((~i_17_) == -4) {
                ...
                if ((~i_17_) > -151 && i_17_ != 21 && i_17_ != 38 && i_17_ != 39) {
    ...
    static Node_Sub9_Sub1 method359(Node_Sub9_Sub1 node_sub9_sub1, int i) {
        anInt511++;
