...
public class Class263 {
    ...
    static void method3223(int i, int i_67_, int i_68_, int i_69_, int i_70_, int i_71_, int i_72_, int i_73_) {
        anInt3338++;
        int i_74_ = 0;
        int i_75_ = i_69_;
        int i_76_ = 0;
    ...
    private void method3217(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
        if (i_1_ == 0) {
            anInt3329++;
    ...
    final void method3218(boolean[][] bools, int i, int i_10_, int i_11_, boolean bool, int i_12_) {
        ...
        if (bool) {
            for (int i_13_ = 0; (~anInt3345) < (~i_13_); i_13_++) {
            ...
            for (int i_21_ = 0; (~anInt3345) < (~i_21_); i_21_++) {
