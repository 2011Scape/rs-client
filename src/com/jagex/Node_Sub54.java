...
public class Node_Sub54 extends Node {
    ...
    private final AbstractToolkit anAbstractToolkit7672;
    private final int[] anIntArray7677;
    private final StandardPlane aStandardPlane7681;
    ...
    static void method2981(int i, Node_Sub14 node_sub14, int i_1_, Class79 class79, Class299 class299, int i_2_, byte b, GraphicsToolkit graphicstoolkit, int i_3_) {
        anInt7674++;
    ...
    static void method2982(int i, java.awt.Canvas canvas) {
        if (i >= -18) {
            method2982(-128, null);
        }
        anInt7682++;
    ...
    static Node_Sub27 method2983(int i) {
        anInt7678++;
        if (i != -17555) {
            return null;
        }
    ...
    final void method2985(byte b, int[] is, int i) {
        ...
        if (buffer != null) {
            ...
            if (interface15_impl1.method53(-3308) && i_11_ > 0) {
                anAbstractToolkit7672.method1332(3, (~(0x7 & aStandardPlane7681.anInt7981)) != -1, anInt7689, (0x8 & aStandardPlane7681.anInt7981) != 0);
    ...
    final void method2989(int i, int i_31_, float f, int i_32_, int i_33_) {
        ...
        if ((~anInt7689) != 0) {
            ...
            if ((~i_34_) != -1 && (~class91.aByte1214) != -5) {
                int i_35_;
                if (i_31_ >= 0) {
                    if ((~i_31_) < -128) {
                        i_35_ = 16777215;
        ...
        if ((~anAbstractToolkit7672.anInt6360) != -1) {
