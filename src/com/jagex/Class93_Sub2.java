...
public class Class93_Sub2 extends Class93 implements MouseListener, MouseMotionListener {
    ...
    private final boolean aBoolean6074;
    ...
    static void method1061(GraphicsToolkit graphicstoolkit, boolean bool) {
    ...
    private void method1057(int i, int i_0_, byte b, int i_1_, int i_2_) {
        int i_3_ = -49 / ((-19 - b) / 57);
        anInt6053++;
    ...
    final boolean method1040(int i) {
        ...
        return (anInt6065 & 0x4) != 0;
    }

    private int method1058(int i, MouseEvent mouseevent) {
        anInt6060++;
        int i_4_ = mouseevent.getModifiers();
        boolean bool = (i_4_ & 0x10) != 0;
        boolean bool_5_ = (~(i_4_ & 0x8)) != -1;
    ...
    private void method1059(Component component, int i) {
        anInt6055++;
        method1060((byte) 97);
    ...
    private void method1060(byte b) {
        anInt6050++;
    ...
    final boolean method1044(int i) {
        ...
        anInt6066++;
        return (anInt6065 & 0x2) != 0;
    }

    private void method1062(int i, byte b, int i_8_) {
        anInt6070 = i_8_;
        anInt6056++;
        anInt6071 = i;
        if (b != 36) {
