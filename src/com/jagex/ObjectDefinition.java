...
public class ObjectDefinition {
    ...
    static void method3036(int i, int i_29_, int i_30_, Animable_Sub1 animable_sub1) {
    ...
    static void method3045(long[] ls, Object[] objects, boolean bool) {
        anInt3046++;
    ...
    static int method3047(int i, int i_54_) {
        if (i_54_ != -1) {
    ...
    static void method3049(SignLink signlink, Object object, byte b) {
        anInt3001++;
        if (b <= 63) {
    ...
    static int method3050(byte b, int i) {
        anInt3041++;
        if (b > -122) {
            return -61;
        }
    ...
    private void method3033(Buffer buffer, int i, int i_0_) {
        if (i_0_ == 21120) {
            anInt2982++;
            if (i == 1 || i == 5) {
    ...
    final ObjectDefinition method3038(int i, Interface17 interface17) {
        ...
        if ((~i_32_) > -1 || (~(-1 + anIntArray2984.length)) >= (~i_32_) || anIntArray2984[i_32_] == -1) {
    ...
    final boolean method3039(int i) {
        ...
        synchronized (aClass112_3028.aClass302_1433) {
            for (int i_34_ = 0; (~anIntArrayArray3031.length) < (~i_34_); i_34_++) {
                for (int i_35_ = 0; (~i_35_) > (~anIntArrayArray3031[i_34_].length); i_35_++)
    ...
    final boolean method3041(int i, int i_38_) {
        ...
        synchronized (aClass112_3028.aClass302_1433) {
            ...
            for (int i_39_ = 0; (~i_39_) > (~aByteArray2967.length); i_39_++) {
                if (i == aByteArray2967[i_39_]) {
                    for (int i_40_ = 0; (~i_40_) > (~anIntArrayArray3031[i_39_].length); i_40_++) {
    ...
    final int method3044(int i) {
        ...
        if (anIntArray3019 != null) {
            if ((~anIntArray3019.length) >= -2) {
                return anIntArray3019[0];
            }
            int i_42_ = (int) (65535.0 * Math.random());
            for (int i_43_ = 0; (~i_43_) > (~anIntArray3019.length); i_43_++) {
    ...
    final Class243 method3046(int i, int i_44_, int i_45_, Plane plane, boolean bool, byte b, int i_46_, int i_47_, GraphicsToolkit graphicstoolkit, Class121 class121, int i_48_, Plane plane_49_) {
        ...
        boolean bool_53_ = anInt2964 != 0 || (~anInt2963) != -1 || anInt3018 != 0;
    ...
    final DrawableModel method3048(int i, int i_58_, int i_59_, int i_60_, Plane plane, Animator animator, int i_61_, GraphicsToolkit graphicstoolkit, Plane plane_62_, Class121 class121, int i_63_, int i_64_) {
        ...
        if ((~anInt2964) != -1 || (~anInt2963) != -1 || (~anInt3018) != -1) {
            if (!bool) {
                drawablemodel = drawablemodel.method633((byte) 3, i_63_, true);
                bool = true;
            }
    ...
    private DrawableModel method3051(GraphicsToolkit graphicstoolkit, int i, Class121 class121, byte b, int i_66_, int i_67_) {
        anInt3054++;
        int i_68_ = 64 + anInt3042;
        int i_69_ = anInt3026 + 850;
        int i_70_ = i;
        boolean bool = aBoolean3039 || i_67_ == 2 && (~i_66_) < -4;
        if (bool) {
            i |= 0x10;
        }
        if (i_66_ != 0) {
            ...
            if (anInt2969 != 128 || (~anInt2968) != -1) {
                i |= 0x1;
            }
            if ((~anInt3009) != -129 || anInt2985 != 0) {
                i |= 0x4;
            }
        }
        if ((~anInt2973) != -129 || (~anInt3037) != -1) {
            i |= 0x2;
        }
        ...
        if (aShortArray3047 != null) {
            ...
            for (int i_78_ = 0; (~i_78_) > (~aShortArray3047.length); i_78_++) {
        ...
        if (anInt2969 != 128 || anInt2973 != 128 || (~anInt3009) != -129) {
            drawablemodel_77_.O(anInt2969, anInt2973, anInt3009);
        }
        if ((~anInt2968) != -1 || (~anInt3037) != -1 || (~anInt2985) != -1) {
    ...
    private void method3052(byte b, Buffer buffer) {
        anInt3004++;
        if (b == -111) {
            int i = buffer.method2233(255);
