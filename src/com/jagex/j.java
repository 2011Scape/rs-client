...
public class j extends GLSprite implements Interface3 {
    ...
    private native void h(oa var_oa, int i, int i_17_, int i_18_, int i_19_, boolean bool);

    private native void V(long l, int i, int i_20_, long l_21_, int i_22_, int i_23_);
    ...
    private native void RA(long l, int i, int i_30_, int i_31_, int i_32_, int i_33_, int i_34_, int i_35_, int i_36_);

    private native void b(long l, float f, float f_37_, float f_38_, float f_39_, float f_40_, float f_41_, int i, int i_42_, int i_43_, int i_44_);

    private native int JA(long l);

    private native void ma(oa var_oa, int[] is, byte[] bs, byte[] bs_45_, int i, int i_46_, int i_47_, int i_48_);

    private native void N(long l, int i, int i_49_, int i_50_);
    ...
    private native void ua(oa var_oa, int[] is, int i, int i_59_, int i_60_, int i_61_, boolean bool);

    private native int wa(long l);

    private native void P(long l, int i, int i_62_, int i_63_, int i_64_, int i_65_, int i_66_, int i_67_);
    ...
    private native void EA(oa var_oa, int i, int i_80_);

    private native void UA(long l, float f, float f_81_, float f_82_, float f_83_, float f_84_, float f_85_, int i, long l_86_, int i_87_, int i_88_);

    private native void YA(long l, int i, int i_89_, int i_90_, int i_91_, int i_92_, int i_93_);
    ...
    private native void W(long l, int i, int i_100_, int i_101_, int i_102_, int i_103_);
}
