...
abstract class Class201 {
            ...
            for (int i_1_ = 0; i_0_ > i_1_; i_1_++) {
                if (Class194.aByteArrayArray2373[i_1_] != null) {
                    ...
                    while (Class194.aByteArrayArray2373[i_1_].length > buffer.anInt7002) {
                        if (i_4_ >= 511 || (~Node_Sub25_Sub3.anInt9987) <= -1024) {
                            break;
                        }
                        ...
                        if (node_sub41 == null && (0x1 & npcdefinition.aByte2816) > 0 && i_7_ == Class94.anInt1249 && i_10_ >= 0 && (~(npcdefinition.anInt2811 + i_10_)) > (~Node_Sub54.anInt7675) && i_11_ >= 0 && (~(i_11_ + npcdefinition.anInt2811)) > (~Class377_Sub1.anInt8774)) {
                            Npc npc = new Npc();
                            npc.anInt10858 = i_5_;
    ...
    static void method2023(GraphicsToolkit graphicstoolkit, int i) {
        anInt2441++;
        if (i != -22880) {
            method2025(false);
        }
