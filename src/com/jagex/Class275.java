...
public class Class275 implements Interface17 {
    ...
    static int method3332(int i, int i_13_, boolean bool, int i_14_, int i_15_, int i_16_, int[] is, byte b, int i_17_, int i_18_, int i_19_, Class84 class84, int[] is_20_, int i_21_, int i_22_) {
        anInt5418++;
    ...
    static int method3336(int i, int i_54_, int i_55_, int i_56_, int i_57_, int i_58_, int i_59_) {
        anInt5416++;
        if ((~(0x1 & i_56_)) == -2) {
            int i_60_ = i_57_;
            i_57_ = i_55_;
    ...
    final void method3330(byte b, int i, int i_6_) {
        if (b == 38) {
            ...
            i_10_ <<= i_8_;
            method3328(-45, i_7_, (~i_10_) & anIntArray5417[i_7_] | i_10_ & i << i_8_);
        }
    }
    ...
    final void method3333(int i, int i_44_, int i_45_) {
        ...
        i_49_ <<= i_47_;
        method3335((byte) -97, i_46_, i << i_47_ & i_49_ | anIntArray5421[i_46_] & (~i_49_));
    }
