...
public class Class262_Sub11 extends Class262 {
    ...
    static void method3175(int i, int i_0_) {
    ...
    static void method3178(int i, int i_22_, Class48 class48) {
        anInt7783++;
        if (Class23.anInt434 < 50 && (class48 != null && class48.anIntArrayArray700 != null && (~class48.anIntArrayArray700.length) < (~i) && class48.anIntArrayArray700[i] != null)) {
    ...
    static void method3179(long l, byte b) {
        if (b > 106) {
            anInt7777++;
            try {
                Thread.sleep(l);
