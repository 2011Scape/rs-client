...
public class Class264 {
    ...
    private void method3225(byte b, int i, Buffer buffer) {
        anInt3361++;
        if ((~i) != -2) {
            if (i != 2) {
                if (i != 3) {
    ...
    final Model method3227(byte b) {
        ...
        if (aShortArray3349 != null) {
            for (int i_8_ = 0; (~i_8_) > (~aShortArray3349.length); i_8_++)
                model.method2089(aShortArray3349[i_8_], aShortArray3359[i_8_], -93);
        }
        if (aShortArray3356 != null) {
            for (int i_9_ = 0; (~i_9_) > (~aShortArray3356.length); i_9_++)
    ...
    final boolean method3228(boolean bool) {
        ...
        synchronized (aClass181_3360.aClass302_2156) {
            for (int i = 0; (~i) > -6; i++) {
                if ((~anIntArray3362[i]) != 0 && !aClass181_3360.aClass302_2156.method3515(0, anIntArray3362[i], 0)) {
                    bool_10_ = false;
                }
            }
        }
    ...
    final boolean method3229(int i) {
        ...
        boolean bool = true;
        synchronized (aClass181_3360.aClass302_2156) {
            for (int i_11_ = i; (~anIntArray3357.length) < (~i_11_); i_11_++) {
    ...
    final Model method3231(int i) {
        ...
        synchronized (aClass181_3360.aClass302_2156) {
            for (int i_12_ = i; (~i_12_) > (~anIntArray3357.length); i_12_++)
                models[i_12_] = Renderer.method3448(anIntArray3357[i_12_], i + 7, 0, aClass181_3360.aClass302_2156);
        }
        for (int i_13_ = 0; (~i_13_) > (~anIntArray3357.length); i_13_++) {
        ...
        if (aShortArray3349 != null) {
            for (int i_14_ = 0; (~i_14_) > (~aShortArray3349.length); i_14_++)
