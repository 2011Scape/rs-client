...
public class Class58 {
    ...
    static Class302 method576(boolean bool, int i, int i_5_, int i_6_) {
        anInt857++;
        Class6 class6 = null;
    ...
    static boolean method577(int i, int i_7_) {
        if (i_7_ != -22906) {
            anInt862 = 81;
        }
        anInt854++;
    ...
    final Class236 method573(int i, int i_0_) {
        ...
        synchronized (aClass61_853) {
            class236 = (Class236) aClass61_853.method607((long) i_0_, 0);
        }
        if (class236 != null) {
            return class236;
        }
