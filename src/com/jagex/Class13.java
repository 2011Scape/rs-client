...
public class Class13 {
    ...
    static boolean method206(char c, int i) {
        if (i <= 3) {
            method208(21, 86, -113);
        }
        anInt200++;
        if ((~c) != -161 && (~c) != -33 && c != 95 && (~c) != -46) {
            return false;
        }
        return true;
    }

    static boolean method208(int i, int i_1_, int i_2_) {
        if (i_2_ != 0) {
            return false;
        }
        anInt211++;
    ...
    static void method209(boolean bool, int i, int i_3_, int i_4_, int i_5_) {
        anInt204++;
