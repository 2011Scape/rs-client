...
public class PlayerDefinition {
    ...
    static Class77[] method3277(int i) {
        anInt3432++;
        if (i != 12247) {
            return null;
        }
    ...
    private void method3276(int i) {
        ...
        if (aClass38Array3431 != null) {
            for (int i_1_ = 0; (~i_1_) > (~aClass38Array3431.length); i_1_++) {
                if (aClass38Array3431[i_1_] != null) {
                    ...
                    if (aClass38Array3431[i_1_].aShortArray567 != null) {
                        for (int i_5_ = 0; (~aClass38Array3431[i_1_].aShortArray567.length) < (~i_5_); i_5_++) {
                    ...
                    if (aClass38Array3431[i_1_].aShortArray563 != null) {
                        for (int i_6_ = 0; (~aClass38Array3431[i_1_].aShortArray563.length) < (~i_6_); i_6_++) {
