...
public class i extends DrawableModel implements Interface3 {
    ...
    private native void J(long l, int i, boolean bool);
    ...
    private native void l(long l, int i, int[] is, int i_67_, int i_68_, int i_69_, int i_70_, boolean bool);
    ...
    private void method652(int[] is, Class336 class336) {
