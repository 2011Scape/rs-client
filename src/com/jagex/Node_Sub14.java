...
public class Node_Sub14 extends Node {
    ...
    static String method2550(CacheNode_Sub4 cachenode_sub4, byte b) {
        if (b != 62) {
            anInt7119 = 96;
        }
        anInt7124++;
    ...
    static int method2551(CacheNode_Sub4 cachenode_sub4, int i) {
        if (i != -1) {
            anInt7119 = -77;
        }
        anInt7117++;
    ...
    static EntityNode_Sub1 method2552(int i) {
        anInt7123++;
        if (i > -7) {
            return null;
        }
    ...
    static void method2553(String string, int i, String string_0_, int i_1_) {
