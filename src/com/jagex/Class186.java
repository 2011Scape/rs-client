...
public class Class186 {
    ...
    static void method1870(byte b, Actor actor) {
        anInt2253++;
        Animator animator = actor.anAnimator10876;
        if ((~Class174.anInt2092) == (~actor.anInt10887) || !animator.method245(-124) || animator.method226((byte) -105, 1)) {
