...
public class CacheNode_Sub16_Sub1 extends CacheNode_Sub16 {
    ...
    static Class377_Sub1 method2389(int i) {
        anInt11075++;
    ...
    final byte[] method2385(int i) {
        anInt11071++;
        if (aBoolean9602 || (~(aBuffer11072.aByteArray7019.length - aByte11069)) < (~aBuffer11072.anInt7002)) {
