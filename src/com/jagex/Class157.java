...
public class Class157 {
    ...
    static Class106 method1709(GLXToolkit glxtoolkit, int i, int i_0_, byte[] bs) {
        anInt1982++;
        if (bs == null) {
            return null;
        }
    ...
    static void method1710(int i, int i_2_, boolean bool, int i_3_, int i_4_, int i_5_) {
        anInt1978++;
        if (Class175.aClass261ArrayArrayArray2099 == null) {
            ...
            if (aa.anInt101 == 0) {
                if (Class295.aPlayer3692.anInt5934 < 0 || (~Class295.aPlayer3692.anInt5934) <= (~(512 * Node_Sub54.anInt7675)) || Class295.aPlayer3692.anInt5940 < 0 || Class295.aPlayer3692.anInt5940 >= Class377_Sub1.anInt8774 * 512) {
                    bool_6_ = true;
                }
            ...
            if (bool_6_) {
                ...
                Class110.anInt1412++;
                if (Class295.aPlayer3692 != null && (~(Class295.aPlayer3692.anInt5934 + (-(256 * Class295.aPlayer3692.method853((byte) 45)) + 256) >> 9)) == (~Class359.anInt4467) && (~(Class295.aPlayer3692.anInt5940 + -(256 * (Class295.aPlayer3692.method853((byte) 48) + -1)) >> 9)) == (~Node_Sub15_Sub4.anInt9798)) {
                ...
                if ((~Class98.anInt5061) > -1) {
                    Class98.anInt5061 = 0;
                }
                if ((~Node_Sub10.anInt7079) > -1) {
                    Node_Sub10.anInt7079 = 0;
                }
                if ((~Class98.anInt5061) < (~((Class328.anInt4115 << 9) + -1))) {
                ...
                byte b = (~Class213.aNode_Sub27_2512.aClass320_Sub4_7304.method3694(false)) != -3 ? (byte) 1 : (byte) Class110.anInt1412;
                if (Class71.aBoolean967) {
                    ...
                    Class151.method1671(Class174.anInt2092, Class98.anInt5061, Class190.anInt2331, Node_Sub10.anInt7079, Node_Sub38_Sub15.aByteArrayArrayArray10261, Class259.anIntArray3296, Class6.anIntArray135, Class246.anIntArray3107, Class84.anIntArray1147, Class362.anIntArray4497, 1 + Class295.aPlayer3692.aByte5933, b, Class295.aPlayer3692.anInt5934 >> 9, Class295.aPlayer3692.anInt5940 >> 9, (~Class213.aNode_Sub27_2512.aClass320_Sub8_7280.method3712(false)) == -1, true, !Node_Sub15_Sub10.aBoolean9850 ? -1 : Class308.anInt3912, 0, false);
                }
                CacheNode_Sub16_Sub1.method2387((byte) -114);
    ...
    static Node_Sub38 method1712(int i, Buffer buffer) {
