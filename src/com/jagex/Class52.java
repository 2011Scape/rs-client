...
abstract class Class52 {
    ...
    static void method528(int i, int i_22_) {
        anInt793++;
        if (i != 255) {
    ...
    static Node_Sub38 method530(int i, int i_39_) {
        anInt803++;
        int i_40_ = i;
        while_64_:
        do {
    ...
    static void method544(int i, int i_117_, int i_118_, int i_119_, byte b) {
        anInt791++;
    ...
    private void method529(int[] is, String string, int i, GLSprite[] glsprites, int i_23_, int[] is_24_, boolean bool, int[] is_25_) {
    ...
    private void method531(byte b, int i, String string) {
        anInt796++;
        int i_41_ = 0;
        boolean bool = false;
    ...
    private void method533(GLSprite[] glsprites, int i, int i_44_, String string, int i_45_, boolean bool, aa var_aa, int i_46_, int[] is) {
                ...
                if (c == 60) {
                                        ...
                                        if (!string_51_.equals("reg")) {
                                            if (string_51_.startsWith("img=")) {
                                                try {
                                                    ...
                                                    if ((~(Class270_Sub2_Sub2.anInt10558 & ~0xffffff)) == 16777215) {
                    ...
                    if (i_47_ == -1) {
                        ...
                        if ((~c) == -33) {
                            ...
                            if ((~(CacheNode_Sub4.anInt9465 & ~0xffffff)) != -1) {
    ...
    private void method534(int i, int i_55_, int i_56_) {
        if (i != 1) {
            aCacheNode_Sub13_788 = null;
        }
        Class25.anInt446 = 0;
    ...
    final int method539(int i, int i_81_, int i_82_, int i_83_, GLSprite[] glsprites, int i_84_, int i_85_, int i_86_, int i_87_, int i_88_, aa var_aa, int i_89_, int i_90_, int i_91_, int i_92_, int[] is, String string) {
        ...
        int[] is_93_;
        if ((~(i_89_ + (aClass357_789.anInt4442 + aClass357_789.anInt4434))) >= (~i_87_) || (~i_87_) <= (~(i_89_ - -i_89_))) {
