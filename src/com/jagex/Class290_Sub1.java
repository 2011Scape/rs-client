...
public class Class290_Sub1 extends Class290 {
    ...
    Class290_Sub1(GLXToolkit glxtoolkit, Class302 class302, Class5 class5) {
        super(glxtoolkit);
        aClass5_8057 = class5;
        if (class302 != null && aClass5_8057.method173(4) && glxtoolkit.aBoolean9326) {
            aClass106_8063 = Class157.method1709(glxtoolkit, 34336, -99, class302.method3529("gl", "transparent_water", 1));
        } else {
            aClass106_8063 = null;
        }
    }
    ...
    static void method3424(int i, int i_0_) {
        anInt8059++;
    ...
    static void method3425(int i, int i_1_, int i_2_) {
