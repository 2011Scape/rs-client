...
public class CacheNode_Sub7 extends CacheNode {
    ...
    static void method2317(byte[][] bs, byte b, Class277_Sub1 class277_sub1) {
        for (int i = 0; (~i) > (~class277_sub1.anInt3535); i++) {
            CacheNode_Sub16_Sub1.method2387((byte) -114);
            for (int i_0_ = 0; (~(Node_Sub54.anInt7675 >> 3)) < (~i_0_); i_0_++) {
                for (int i_1_ = 0; Class377_Sub1.anInt8774 >> 3 > i_1_; i_1_++) {
                    ...
                    if (i_2_ != -1) {
                        ...
                        if (!class277_sub1.aBoolean3516 || (~i_3_) == -1) {
                            int i_4_ = i_2_ >> 1 & 0x3;
                            int i_5_ = (0xffe240 & i_2_) >> 14;
                            int i_6_ = (i_2_ & 0x3ff9) >> 3;
                            int i_7_ = i_6_ / 8 + (i_5_ / 8 << 8);
                            for (int i_8_ = 0; (~i_8_) > (~Class262_Sub1.anIntArray7704.length); i_8_++) {
