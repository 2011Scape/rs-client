...
public class Class303 {
    ...
    static boolean method3538(int i, int i_0_, int i_1_) {
        if (i_0_ >= -125) {
            anInt3831 = 77;
        }
        anInt3829++;
    ...
    static boolean method3540(boolean bool) {
        anInt3821++;
        try {
    ...
    final Node method3539(int i) {
        ...
        while ((~aHashTable3822.anInt1592) < (~anInt3823)) {
