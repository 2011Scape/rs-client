...
public class Node_Sub24 extends Node {
    ...
    private final Interface15_Impl1 anInterface15_Impl1_7208;
    private final int anInt7210;
    private final int anInt7213;
    private final int anInt7215;
    private final StandardPlane aStandardPlane7217;
    private final Interface15_Impl2 anInterface15_Impl2_7218;
    private final int anInt7219;
    private final AbstractToolkit anAbstractToolkit7230;
    private final Node_Sub29 aNode_Sub29_7231;
    ...
    Node_Sub24(AbstractToolkit abstracttoolkit, StandardPlane standardplane, Node_Sub29 node_sub29, int[] is) {
        try {
            ...
            for (int i_51_ = 0; i_51_ <= i_50_; i_51_++) {
                ...
                if ((~i_52_) < -1 && i_52_ < aStandardPlane7217.anInt3404 - 1) {
                    for (int i_53_ = 0; i_49_ >= i_53_; i_53_++) {
                        int i_54_ = anInt7210 + i_53_;
                        if (i_54_ > 0 && (~i_54_) > (-aStandardPlane7217.anInt3408)) {
                            ...
                            float f = (float) (1.0 / Math.sqrt(i_56_ * i_56_ + (i_55_ * i_55_ + 65536)));
            ...
            if ((~anInt7212) >= -1) {
                ...
                for (; ; ) {
                    ...
                    if (buffer != null) {
                        ...
                        int i_63_ = 0;
                        i_57_ = 0;
                        for (int i_64_ = anInt7213; (~anInt7219) <= (~i_64_); i_64_++) {
    ...
    static void method2647(byte b, float f, float f_38_, float f_39_, float f_40_, int i, byte[] bs, int i_41_, int i_42_, float f_43_, int i_44_, Class328 class328, int i_45_) {
        anInt7216++;
    ...
    static void method2649(boolean bool) {
        anInt7222++;
    ...
    static void method2650(boolean bool, int i) {
        anInt7228++;
    ...
    private void method2643(byte b, short s) {
        if (!Stream.b()) {
            aStream7211.c(s);
        } else {
            aStream7211.b(s);
    ...
    private void method2645(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
        anInt7207++;
        long l = -1L;
        ...
        } else if ((~aStandardPlane7217.anInt3398) == (~i_4_) && (~i_2_) == -1) {
            f = aFloatArrayArray7227[i_0_ + 1][i_5_];
            f_9_ = aFloatArrayArray7206[i_0_ + 1][i_5_];
            f_10_ = aFloatArrayArray7220[i_0_ + 1][i_5_];
        } else if (aStandardPlane7217.anInt3398 != i_4_ || (~i_2_) != (~aStandardPlane7217.anInt3398)) {
            if (i_4_ != 0 || (~i_2_) != (~aStandardPlane7217.anInt3398)) {
        ...
        float f_22_ = (float) Math.sqrt(f_20_ * f_20_ + f_19_ * f_19_ + f_21_ * f_21_);
        ...
        if ((~anAbstractToolkit7230.anInt6360) == -1) {
            aStream7232.d(i_31_);
            aStream7232.d(i_30_);
            aStream7232.d(i_29_);
        } else {
    ...
    final void method2646(int i, int i_32_, byte b, int i_33_, boolean[][] bools) {
        anInt7223++;
        if (anInterface15_Impl1_7208 != null && (~(i_33_ + i)) <= (~anInt7210) && (~(-i_33_ + i)) >= (~anInt7215) && i_32_ + i_33_ >= anInt7213 && i_32_ - i_33_ <= anInt7219) {
