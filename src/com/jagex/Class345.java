...
public class Class345 {
    ...
    static void method3971(Class302 class302, int i, boolean bool, Class302 class302_0_) {
        if (bool == true) {
    ...
    static EntityNode_Sub6 method3972(boolean bool, byte b, int i) {
        anInt4271++;
        synchronized (Class30.aClass103Array494) {
            int i_1_ = -111 % ((b - 16) / 39);
            EntityNode_Sub6 entitynode_sub6;
            if ((~Class30.aClass103Array494.length) >= (~i) || Class30.aClass103Array494[i].method1105(-92)) {
