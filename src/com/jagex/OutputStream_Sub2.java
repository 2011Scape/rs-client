...
public class OutputStream_Sub2 extends OutputStream {
    ...
    static void method138(int i, int i_0_, int i_1_, byte b, int i_2_, int i_3_, int i_4_) {
        anInt92++;
        int i_5_ = 101 % ((b + 46) / 57);
        if (-i_0_ + i_3_ >= Class262_Sub4.anInt7722 && (~(i_0_ + i_3_)) >= (~za_Sub2.anInt10513) && (~Class384.anInt4906) >= (~(i_2_ - i_0_)) && i_0_ + i_2_ <= Node_Sub25_Sub1.anInt9936) {
    ...
    static void method139(byte b) {
        ...
        System.arraycopy(is, 0, Node_Sub28.anIntArray7329, 0, i);
    }
