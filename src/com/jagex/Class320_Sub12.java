...
public class Class320_Sub12 extends Class320 {
    ...
    static void method3727(Class121 class121, byte b, int i, int i_0_, int i_1_, int i_2_) {
        anInt8318++;
        int i_3_ = -41 / ((-70 - b) / 56);
        ...
        for (Node_Sub19 node_sub19_4_ = (Node_Sub19) Class262_Sub8.aClass312_7755.method3613(65280); node_sub19_4_ != null; node_sub19_4_ = (Node_Sub19) Class262_Sub8.aClass312_7755.method3620(16776960)) {
            if (node_sub19_4_.anInt7165 == i && node_sub19_4_.anInt7171 == i_1_ && (~node_sub19_4_.anInt7161) == (~i_2_) && (~i_0_) == (~node_sub19_4_.anInt7166)) {
