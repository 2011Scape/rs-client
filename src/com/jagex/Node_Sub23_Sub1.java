...
public class Node_Sub23_Sub1 extends Node_Sub23 {
    ...
    static void method2637(int i, int i_0_, boolean bool) {
        anInt9910++;
        if (bool != false) {
    ...
    static Class371 method2638(int i, byte b) {
        anInt9919++;
    ...
    static boolean method2640(int i, int i_1_) {
        anInt9918++;
    ...
    final void method2632(int i, int i_10_, int i_11_) {
        ...
        if (anInt9909 != i_12_ || (~anInt9917) != (~i_13_)) {
            if (aClass169_Sub2Array9921 != null) {
                for (int i_14_ = 0; (~i_14_) > (~aClass169_Sub2Array9921.length); i_14_++)
