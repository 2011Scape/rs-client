...
public class Class158 {
    ...
    static void method1718(int i, int i_0_, int i_1_) {
        anInt1985++;
        if (i == -5091) {
    ...
    static Class169_Sub2_Sub1 method1724(int i, int i_3_, int i_4_, byte b, int i_5_, GLToolkit gltoolkit) {
    ...
    static void method1725(int i, int i_7_, int i_8_, int i_9_, int i_10_) {
