...
public class Class262_Sub5 extends Class262 {
    ...
    Class262_Sub5(Buffer buffer) {
        super(buffer);
        anInt7740 = buffer.method2219(-130546744);
        anInt7735 = buffer.method2219(-130546744);
        aString7733 = buffer.method2195(-1);
        anInt7741 = buffer.method2186(127);
        anInt7736 = buffer.method2219(-130546744);
    }
    ...
    static boolean method3163(String string, boolean bool) {
        if (bool != false) {
            anInt7737 = -72;
        }
        anInt7738++;
