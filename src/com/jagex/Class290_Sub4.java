...
public class Class290_Sub4 extends Class290 {
    ...
    Class290_Sub4(AbstractToolkit abstracttoolkit) {
        ...
        if (abstracttoolkit.aBoolean6310) {
            aBoolean8090 = (~abstracttoolkit.anInt6370) > -4;
    ...
    static void method3430(boolean bool) {
        if (bool != true) {
    ...
    static Class145 method3431(GLToolkit gltoolkit, int i, Class210[] class210s) {
        anInt8099++;
        for (int i_12_ = i; (~class210s.length) < (~i_12_); i_12_++) {
    ...
    static void method3432(int i, int i_15_, int i_16_) {
