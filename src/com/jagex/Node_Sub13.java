...
public class Node_Sub13 extends Node {
    ...
    static int method2546(int i, int i_0_, int i_1_) {
        if (i_0_ != -1) {
    ...
    static boolean method2548(boolean bool, Class329 class329) {
        anInt7115++;
        if (bool != false) {
            return false;
        }
    ...
    static void method2549(int i, int i_3_, int i_4_, int i_5_, boolean bool, int i_6_, int i_7_, int i_8_) {
        if ((~(bool ? Class213.aNode_Sub27_2512.aClass320_Sub25_7276.method3776(false) : Class213.aNode_Sub27_2512.aClass320_Sub25_7295.method3776(false))) != -1 && (~i) != -1 && (~Class23.anInt434) > -51 && i_8_ != -1) {
