...
abstract class DrawableModel {
    ...
    static void method616(int i, int i_33_, int i_34_, int i_35_, int i_36_, int i_37_, int i_38_, int i_39_, int i_40_, int i_41_) {
        anInt908++;
        if (i_34_ > -52) {
            aStringArray911 = null;
        }
        if (i >= Class262_Sub4.anInt7722 && i <= za_Sub2.anInt10513 && (~Class262_Sub4.anInt7722) >= (~i_41_) && za_Sub2.anInt10513 >= i_41_ && i_37_ >= Class262_Sub4.anInt7722 && (~i_37_) >= (~za_Sub2.anInt10513) && Class262_Sub4.anInt7722 <= i_40_ && i_40_ <= za_Sub2.anInt10513 && (~i_39_) <= (~Class384.anInt4906) && i_39_ <= Node_Sub25_Sub1.anInt9936 && (~i_33_) <= (~Class384.anInt4906) && (~Node_Sub25_Sub1.anInt9936) <= (~i_33_) && i_35_ >= Class384.anInt4906 && (~i_35_) >= (~Node_Sub25_Sub1.anInt9936) && (~i_38_) <= (~Class384.anInt4906) && (~i_38_) >= (~Node_Sub25_Sub1.anInt9936)) {
    ...
    static void method638(int i, String[] strings, int[] is, int i_149_, int i_150_) {
        if (i != -20788) {
            aFrame907 = null;
        }
        if (i_150_ < i_149_) {
    ...
    private void method613(int i, int i_5_, int i_6_, int[] is, int[] is_7_, boolean bool, boolean bool_8_, int i_9_, int i_10_, int i_11_) {
        if ((~i_9_) == -2) {
            if (i_5_ == 0 || (~i_5_) == -2) {
                int i_12_ = -i_10_;
                i_10_ = i;
    ...
    private void method635(Class222 class222, boolean[] bools, int i, boolean bool, byte b, int[] is, int i_107_, int i_108_, Class222 class222_109_, Node_Sub40 node_sub40, int i_110_, boolean bool_111_) {
        anInt910++;
