...
public class Class145 {
    ...
    static int method1638(int i, String string, int i_0_, boolean bool) {
        anInt1796++;
        if (i_0_ < 2 || (~i_0_) < -37) {
    ...
    static void method1639(boolean bool) {
        anInt1794++;
        if (bool != true) {
            aClass192_1798 = null;
        }
    ...
    static void method1641(int i, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, byte b, int i_13_, int i_14_) {
        anInt1792++;
        if (b < -60) {
