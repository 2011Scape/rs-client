...
public class Mobile_Sub2 extends Mobile implements Interface19 {
    ...
    private DrawableModel method902(byte b, GraphicsToolkit graphicstoolkit, int i) {
        if (b != 69) {
            aBoolean10729 = true;
        }
        anInt10713++;
    ...
    private Class243 method904(GraphicsToolkit graphicstoolkit, byte b, boolean bool, int i) {
        anInt10735++;
        ...
        return objectdefinition.method3046(aByte10731 == 11 ? (int) (aByte10725 + 4) : aByte10725, anInt5940, anInt5934, plane, bool, (byte) 0, anInt5937, (~aByte10731) != -12 ? aByte10731 : 10, graphicstoolkit, null, i, plane_19_);
    }
