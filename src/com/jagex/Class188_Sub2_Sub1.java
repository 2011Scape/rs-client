...
public class Class188_Sub2_Sub1 extends Class188_Sub2 {
    ...
    static void method1907(int i, byte b) {
        anInt9353++;
    ...
    static Class241 method1910(byte b, SignLink signlink, String string, String string_7_, int i) {
        anInt9357++;
        if ((~i) == -1) {
