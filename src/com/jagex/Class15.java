...
public class Class15 {
    ...
    static void method220(int i, int i_0_, float[] fs, int[] is, int i_1_, float[] fs_2_, int i_3_, int i_4_, int[] is_5_, int i_6_, int i_7_, int i_8_, int i_9_) {
        if (i_8_ == -5) {
            anInt221++;
    ...
    private void method217(Buffer buffer, byte b) {
        if (b != -20) {
            anIntArrayArray224 = null;
        }
    ...
    final void method219(int i, ClanChat clanchat) {
        anInt227++;
        if ((~aLong223) != (~clanchat.aLong747) || (~anInt226) != (~clanchat.anInt757)) {
