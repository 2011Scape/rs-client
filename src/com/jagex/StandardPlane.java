...
public class StandardPlane extends Plane {
    ...
    private final Class312 aClass312_7989 = new Class312();
    private final int anInt7993;
    private final byte[][] aByteArrayArray7996;
    ...
    StandardPlane(AbstractToolkit abstracttoolkit, int i, int i_123_, int i_124_, int i_125_, int[][] is, int[][] is_126_, int i_127_) {
        ...
        for (int i_128_ = 0; i_128_ <= anInt3404; i_128_++) {
            for (int i_129_ = 0; (~i_129_) >= (~anInt3408); i_129_++) {
                ...
                if (i_129_ > 0 && (~i_128_) < -1 && i_129_ < anInt3408 && (~i_128_) > (~anInt3404)) {
                    int i_131_ = -is_126_[i_129_ - 1][i_128_] + is_126_[i_129_ + 1][i_128_];
                    int i_132_ = is_126_[i_129_][1 + i_128_] - is_126_[i_129_][-1 + i_128_];
                    float f = (float) (1.0 / Math.sqrt(i_132_ * i_132_ + i_131_ * i_131_ + 4 * (i_127_ * i_127_)));
    ...
    final void U(int i, int i_3_, int[] is, int[] is_4_, int[] is_5_, int[] is_6_, int[] is_7_, int[] is_8_, int[] is_9_, int[] is_10_, int i_11_, int i_12_, int i_13_, boolean bool) {
        ...
        for (int i_14_ = 0; (~i_14_) > (~is_7_.length); i_14_++) {
            int i_15_ = is_9_[i_14_];
            int i_16_ = is_10_[i_14_];
            if ((~(0x20 & anInt7981)) != -1 && (~i_15_) != 0 && var_d.method10(i_15_, -8217).aBoolean1223) {
                i_16_ = 128;
                i_15_ = -1;
            }
            long l = (long) i_15_ | ((long) i_11_ << 28 | ((long) i_13_ << 48 | (long) i_12_ << 42) | (long) ((long) i_16_ << 14));
            Node node;
            for (node = aHashTable8022.method1518(3512, l); node != null; node = aHashTable8022.method1524((byte) 84)) {
                ...
                if ((~node_sub54.anInt7689) == (~i_15_) && (float) i_16_ == node_sub54.aFloat7690 && (~node_sub54.anInt7680) == (~i_11_) && i_12_ == node_sub54.anInt7676 && i_13_ == node_sub54.anInt7686) {
                    break;
                }
            }
            if (node != null) {
    ...
    final void ka(int i, int i_21_, int i_22_) {
        anInt7994++;
        if ((~(aByteArrayArray8026[i][i_21_] & 0xff)) > (~i_22_)) {
            aByteArrayArray8026[i][i_21_] = (byte) i_22_;
        }
    }

    private void method3273(boolean[][] bools, boolean bool, int i, int i_23_, int i_24_, int i_25_, int i_26_, int i_27_) {
        anInt8012++;
        if (i_24_ != 1) {
        ...
        if (aNode_Sub54Array8024 != null) {
            ...
            i_28_ *= i_28_;
            if ((~Class47.anIntArray689.length) > (~i_28_)) {
            ...
            for (int i_35_ = i_29_; (~i_33_) <= (~i_35_); i_35_++) {
                boolean[] bools_36_ = bools[-i_30_ + i_35_];
                for (int i_37_ = i_31_; (~i_37_) >= (~i_34_); i_37_++) {
    ...
    final void YA() {
        ...
        if ((~anInt8023) >= -1) {
            ...
            for (int i = 0; (~node_sub54s.length) < (~i); i++)
            ...
            for (int i_47_ = 0; anInt3408 > i_47_; i_47_++) {
                for (int i_48_ = 0; anInt3404 > i_48_; i_48_++) {
                    if (anIntArrayArrayArray8006[i_47_][i_48_] != null) {
                        ...
                        for (int i_73_ = 0; (~i_73_) > (~is_52_.length); i_73_++) {
                            ...
                            if ((~i_81_) == -1 && (~i_82_) == -1) {
                                ...
                                f_87_ = f;
                                i_83_ -= i_66_;
                            } else if (i_81_ == 0 && (~anInt3398) == (~i_82_)) {
                                f_86_ = f_58_;
                                i_83_ -= i_67_;
                                f_87_ = f_57_;
                                f_88_ = f_59_;
                            } else if (anInt3398 == i_81_ && (~anInt3398) == (~i_82_)) {
                                f_86_ = f_61_;
                                f_87_ = f_60_;
                                f_88_ = f_62_;
                                i_83_ -= i_68_;
                            ...
                            Node node = null;
                            if ((~(-1 + anInt7982 & i_74_)) == -1 && (~(-1 + anInt7982 & i_75_)) == -1) {
                            ...
                            if (node != null) {
                                ...
                                if (i_78_ != -1 && (~node_sub54s_44_[i_100_].aLong2797) < (~node_sub54s_49_[i_73_].aLong2797)) {
                                ...
                                if ((~anAbstractToolkit8004.anInt6360) == -1) {
            ...
            int i_119_ = 0;
            for (int i_120_ = 0; (~i_120_) > (~node_sub54s.length); i_120_++) {
            ...
            for (int i_121_ = 0; (~i_119_) < (~i_121_); i_121_++) {
                ...
                if (buffer != null) {
                    ...
                    if (!Stream.b()) {
                        for (int i_148_ = i_141_; i_143_ > i_148_; i_148_++) {
                            ...
                            for (int i_150_ = i_140_; (~i_142_) < (~i_150_); i_150_++) {
                                if (bools[-i_140_ + i_150_][-i_141_ + i_148_]) {
                                    short[] ses = aShortArrayArray7985[i_149_];
                                    if (ses != null) {
                                        for (int i_151_ = 0; (~i_151_) > (~ses.length); i_151_++) {
                        ...
                        for (int i_153_ = i_141_; i_153_ < i_143_; i_153_++) {
                            ...
                            for (int i_155_ = i_140_; i_155_ < i_142_; i_155_++) {
                                if (bools[i_155_ - i_140_][-i_141_ + i_153_]) {
                                    ...
                                    if (ses != null) {
                                        for (int i_156_ = 0; (~ses.length) < (~i_156_); i_156_++) {
    ...
    private void method3275(int i, int i_191_, r_Sub1 var_r_Sub1, int i_192_) {
        anInt8011++;
        int[] is = anIntArrayArrayArray7986[i][i_191_];
        int[] is_193_ = anIntArrayArrayArray7997[i][i_191_];
        int i_194_ = is.length;
        if ((~Node_Sub23.anIntArray7200.length) > (~i_194_)) {
        ...
        while (i_194_ > i_196_) {
            ...
            if ((~(-((-i_199_ + i_201_) * (-i_198_ + i_200_)) + (-i_199_ + i_197_) * (i_200_ + -i_202_))) < -1) {
