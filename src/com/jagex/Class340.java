...
public class Class340 implements Runnable {
    ...
    final int method3955(int i) {
        ...
        if (aClass110_4223.aBoolean1393 && (~aClass110_4223.anInt1382) < (~anInt4230)) {
            return 1 + anInt4230;
        }
        if ((~i_2_) > -1 || (~i_2_) <= (~(Node_Sub25_Sub4.aClass110Array10006.length + -1))) {
            return 100;
        }
        if ((~anInt4230) == (~aClass110_4223.anInt1383)) {
            ...
            synchronized (this) {
                try {
                    ...
                    if (!(anInterface16_4216 instanceof Class350)) {
                        ...
                        if (Class93.aGraphicsToolkit1241 != null && anInterface16_4228 != null && anInterface16_4228.method60(66) != 0 && (~aLong4222) <= (~(-(long) anInterface16_4228.method60(36) + l_4_))) {
