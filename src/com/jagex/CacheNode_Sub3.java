...
public class CacheNode_Sub3 extends CacheNode {
    ...
    static void method2292(int i) {
        ...
        i_2_ = 0;
        for (int i_3_ = (-(Node_Sub54.anInt7675 >> 4) + i_0_) / 8; (~((i_0_ - -(Node_Sub54.anInt7675 >> 4)) / 8)) <= (~i_3_); i_3_++) {
        ...
        for (int i_6_ = i_2_; (~Class204.anIntArray2460.length) < (~i_6_); i_6_++) {
    ...
    static boolean method2296(int i, byte b, int i_13_) {
        anInt9447++;
        int i_14_ = -28 / ((b - 43) / 32);
        return (~(0x84080 & i_13_)) != -1;
    }
    ...
    private void method2294(int i, Buffer buffer, int i_8_) {
        anInt9450++;
        if ((~i_8_) == -2) {
            ...
            for (int i_12_ = 0; i_12_ < i_11_; i_12_++) {
                ...
                aCharArray9452[i_12_] = (~b) != -1 ? Class20_Sub1.method294(b, (byte) 121) : '\0';
            }
        }
        if (i > -12) {
            method2297('\uff88', -122);
