...
public class Class24 {
    ...
    static Class237 method304(int i, int i_0_, byte[] bs, GLXToolkit glxtoolkit) {
        anInt440++;
    ...
    static boolean method305(int i, int i_2_, int i_3_, boolean bool, int[] is, int i_4_, int i_6_) {
        if (bool != false) {
            return false;
        }
        anInt439++;
