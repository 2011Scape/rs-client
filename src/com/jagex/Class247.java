...
public class Class247 {
    ...
    Class247(GLToolkit gltoolkit) {
        ...
        if (aGLToolkit3121.aBoolean6719 && aGLToolkit3121.aBoolean6649) {
            ...
            if ((~aGLToolkit3121.anInt6599) < -2 && aGLToolkit3121.aBoolean6662 && aGLToolkit3121.aBoolean6735) {
    ...
    private boolean method3075(byte b) {
        if (aBoolean3139) {
    ...
    private void method3078(int i) {
        ...
        int i_8_ = (~anInt3136) >= -3 ? anInt3136 : 2;
    ...
    final boolean method3081(int i, int i_10_, int i_11_, int i_12_, int i_13_) {
        ...
        if (i_10_ != anInt3114 || (~i_12_) != (~anInt3113)) {
            anInt3114 = i_10_;
            anInt3113 = i_12_;
