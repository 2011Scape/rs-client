...
public class Class140 {
    ...
    static void method1610(int i, String string, String string_3_, SignLink signlink, boolean bool, boolean bool_4_) {
        if (i != 0) {
    ...
    private void method1608(int i, int i_2_, Buffer buffer) {
        if ((~i_2_) != -2) {
            if (i_2_ != 2) {
                if ((~i_2_) == -4) {
                    aBoolean1741 = true;
