...
public class Class170 {
    ...
    static void method1789(int i) {
        ...
        if (i_4_ == 2) {
            int i_5_ = (~Class36.anInt542) >= -801 ? Class36.anInt542 : 800;
            ...
            int i_8_ = (~CacheNode_Sub3.anInt9441) >= -769 ? CacheNode_Sub3.anInt9441 : 768;
    ...
    static int method1790(int i, int i_9_, byte b, int i_10_, int i_11_, int i_12_) {
        anInt2049++;
        if (b < 107) {
            method1791((byte) 40);
        }
        ...
        if ((~i_9_) > -4) {
            int i_13_ = i_12_ >> 9;
            int i_14_ = i >> 9;
            if (i_10_ < 0 || i_11_ < 0 || Node_Sub54.anInt7675 - 1 < i_10_ || (~(-1 + Class377_Sub1.anInt8774)) > (~i_11_)) {
                return 0;
            }
            if (i_13_ < 1 || (~i_14_) > -2 || (~i_13_) < (~(Node_Sub54.anInt7675 + -1)) || i_14_ > -1 + Class377_Sub1.anInt8774) {
                return 0;
            }
            boolean bool = (~(CacheNode_Sub11.aByteArrayArrayArray9550[1][i_12_ >> 9][i >> 9] & 0x2)) != -1;
            if ((0x1ff & i_12_) == 0) {
                boolean bool_15_ = (~(0x2 & CacheNode_Sub11.aByteArrayArrayArray9550[1][-1 + i_13_][i >> 9])) != -1;
            ...
            if ((~(0x1ff & i)) == -1) {
                boolean bool_17_ = (~(0x2 & CacheNode_Sub11.aByteArrayArrayArray9550[1][i_12_ >> 9][i_14_ + -1])) != -1;
