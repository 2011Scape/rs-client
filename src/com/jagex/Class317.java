...
public class Class317 {
    ...
    static int method3663(int i, int i_0_, int i_1_, boolean bool) {
        anInt4042++;
        if (i_0_ != -1) {
        ...
        if (i_1_ < 0 || (~i_1_) <= (~node_sub16.anIntArray7137.length)) {
            return -1;
        }
        return node_sub16.anIntArray7137[i_1_];
    }

    static byte[] method3664(int i, byte[] bs, int i_2_) {
        anInt4040++;
        if (i != 1) {
            return null;
        }
    ...
    static void method3665(int i, Widget widget, boolean bool, int i_4_) {
        anInt4041++;
