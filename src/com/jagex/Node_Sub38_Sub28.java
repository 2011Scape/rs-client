...
public class Node_Sub38_Sub28 extends Node_Sub38 {
    ...
    static void method2887(String string, String string_5_, byte b) {
    ...
    static void method2888(byte b, Class302 class302) {
            ...
            if (anInt10393 != 0) {
                for (int i_8_ = 0; (~Class339_Sub7.anInt8728) < (~i_8_); i_8_++) {
                    ...
                    for (i_12_ = 0; anInt10399 > i_12_; i_12_++) {
                        if ((~i_9_) <= (~anIntArray10391[i_12_]) && i_9_ < anIntArray10391[1 + i_12_]) {
                ...
                for (int i_14_ = 0; anInt10399 > i_14_; i_14_++) {
                    if ((~anIntArray10391[i_14_]) >= (~i_7_) && anIntArray10391[1 + i_14_] > i_7_) {
