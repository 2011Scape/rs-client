...
public class Class284 {
    ...
    static void method3392(boolean bool) {
        if (!bool) {
            method3390((byte) 2);
        }
        anInt3594++;
        ...
        for (int i = 0; i < Node_Sub38_Sub6.anInt10132; i++) {
            ...
            Npc npc = ((Node_Sub41) Class12.aHashTable187.method1518(3512, i_2_)).aNpc7518;
            ...
            if ((~(i_3_ & 0x20000)) != -1) {
                ...
                boolean bool_15_ = (~(i_12_ >> 7 & 0x1)) == -2;
            ...
            if ((0x1000 & i_3_) != 0) {
                ...
                boolean bool_58_ = (~(i_55_ >> 7 & 0x1)) == -2;
            ...
            if ((i_3_ & 0x4) != 0) {
                ...
                boolean bool_64_ = (~((i_61_ & 0xb7) >> 7)) == -2;
