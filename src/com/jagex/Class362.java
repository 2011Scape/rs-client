...
public class Class362 {
    ...
    private final Class61 aClass61_4491 = new Class61(128);
    private final Class302 aClass302_4493;
    ...
    static String method4049(int i, String string) {
        anInt4490++;
        int i_0_ = 30 / ((i + 57) / 46);
    ...
    static void method4052(int i, int i_3_) {
        int i_4_ = -63 % ((-10 - i) / 54);
        anInt4495++;
        CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(3, 20, i_3_);
        cachenode_sub2.method2291((byte) 121);
    }

    static void method4053(int i, int i_6_, int i_7_, byte b, int i_8_) {
        anInt4499++;
        if ((~Class320_Sub20.anInt8397) == -2) {
            ...
            if ((~i_9_) > (~Class117.anInt1479) && (~i_10_) <= -1 && (~i_11_) > (~Class290_Sub11.anInt8181) && (~i_12_) <= -1) {
                if (i_9_ < 0) {
                    i_9_ = 0;
                }
                if (i_11_ < 0) {
    ...
    final Class39 method4051(int i, int i_2_) {
        ...
        synchronized (aClass61_4491) {
            class39 = (Class39) aClass61_4491.method607(i, 0);
        }
        if (class39 != null) {
            return class39;
        }
        ...
        synchronized (aClass61_4491) {
            aClass61_4491.method601(class39, 25566, i);
        }
        return class39;
    }
}
