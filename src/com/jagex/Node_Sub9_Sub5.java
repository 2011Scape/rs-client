...
public class Node_Sub9_Sub5 extends Node_Sub9 {
    ...
    final synchronized void method2426(int i) {
        ...
        if (!aBoolean9759) {
            for (; ; ) {
                ...
                if ((~(-anInt9762 + cachenode_sub8.aShortArrayArray9491[0].length)) < (~i)) {
                    anInt9762 += i;
                    break;
                }
    ...
    private synchronized void method2533(byte b) {
        anInt9748++;
        CacheNode_Sub8 cachenode_sub8 = method2534((byte) -10);
        if (cachenode_sub8 != null) {
    ...
    private synchronized CacheNode_Sub8 method2534(byte b) {
        if (b != -10) {
            method2526(true);
        }
        anInt9758++;
