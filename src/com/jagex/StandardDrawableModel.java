...
public class StandardDrawableModel extends DrawableModel {
    ...
    StandardDrawableModel(AbstractToolkit abstracttoolkit, Model model, int i, int i_8_, int i_9_, int i_10_) {
        ...
        for (int i_11_ = 0; i_11_ < model.anInt2572; i_11_++) {
            if (model.aByteArray2594 == null || (~model.aByteArray2594[i_11_]) != -3) {
                if (model.aShortArray2587 != null && (~model.aShortArray2587[i_11_]) != 0) {
                    Class91 class91 = var_d.method10(model.aShortArray2587[i_11_] & 0xffff, -8217);
                    if (((~(0x40 & anInt5896)) == -1 || !class91.aBoolean1223) && class91.aBoolean1205) {
                        continue;
                    }
                }
                is[anInt5813++] = i_11_;
        ...
        for (int i_12_ = 0; (~i_12_) > (~anInt5813); i_12_++) {
            int i_13_ = is[i_12_];
            ...
            boolean bool_22_ = model.aByteArray2622 != null && (~model.aByteArray2622[i_13_]) != -1 || class91 != null && (~class91.anInt1226) != -1;
            ...
            standarddrawablemodel_23_.aBoolean5866 = standarddrawablemodel_23_.aBoolean5866 | (class91 != null && ((~class91.aByte1211) != -1 || class91.aByte1203 != 0));
        }
        ...
        if (model.aClass17Array2621 != null) {
            ...
            for (int i_24_ = 0; anInt5811 > i_24_; i_24_++) {
                ...
                Class352 class352 = Class215.method2067(0, class17.anInt279);
                int i_25_ = -1;
                for (int i_26_ = 0; (~anInt5813) < (~i_26_); i_26_++) {
                    if ((~class17.anInt273) == (~is[i_26_])) {
                        i_25_ = i_26_;
                        break;
                    }
                }
        ...
        int i_29_ = 0;
        for (int i_30_ = 0; (~model.anInt2573) < (~i_30_); i_30_++) {
        ...
        for (int i_32_ = 0; model.anInt2572 > i_32_; i_32_++) {
            ...
            int i_43_;
            for (i_43_ = i_39_ * i_35_ - i_38_ * i_36_; (~i_41_) < -8193 || i_42_ > 8192 || (~i_43_) < -8193 || i_41_ < -8192 || (~i_42_) > 8191 || i_43_ < -8192; i_42_ >>= 1) {
                i_41_ >>= 1;
                i_43_ >>= 1;
            }
        ...
        for (int i_45_ = 0; (~i_45_) > (~anInt5813); i_45_++) {
            int i_46_ = is[i_45_];
            ...
            if (b == 0) {
                ...
                long l = ((long) i_49_ + ((long) (i_57_ << 24) + (long) (i_47_ << 8)) << 32) + (long) ((class221.anInt2629 + 256 << 12) + (((~class221.anInt2631) >= -1 ? 2048 : 1024) + (i_48_ << 2) + (256 + class221.anInt2632 << 22)));
        ...
        if ((~anInt5859) < -1) {
            ...
            int i_123_ = 0;
            s = aShortArray5862[0];
            for (int i_124_ = 0; (~anInt5859) < (~i_124_); i_124_++) {
        ...
        if (model.anIntArray2602 != null && EntityNode_Sub3.method940(-1, anInt5896, i)) {
            ...
            for (int i_129_ = 0; (~anInt5813) < (~i_129_); i_129_++) {
            ...
            for (int i_132_ = 0; (~anInt5813) < (~i_132_); i_132_++) {
    ...
    static void method704(int i, int i_715_, int i_716_, int i_717_, Animable_Sub3 animable_sub3) {
    ...
    private boolean method688(byte b) {
        anInt5807++;
    ...
    final void p(int i, int i_134_, Plane plane, Plane plane_135_, int i_136_, int i_137_, int i_138_) {
        ...
        if (i != 1 && i != 2 && i != 3 && (~i) != -6 || (~i_139_) <= -1 && (~plane.anInt3408) < (~(plane.anInt3398 + i_140_ >> plane.anInt3410)) && (~i_141_) <= -1 && i_142_ + plane.anInt3398 >> plane.anInt3410 < plane.anInt3404) {
            if (i != 4 && i != 5) {
                ...
                if (plane.method3251(i_141_, i_139_, (byte) -118) == i_137_ && plane.method3251(i_141_, i_140_, (byte) -118) == i_137_ && (~i_137_) == (~plane.method3251(i_142_, i_139_, (byte) -118)) && plane.method3251(i_142_, i_140_, (byte) -118) == i_137_) {
                    return;
                }
            } else if (plane_135_ == null || ((~i_139_) > -1 || (~plane_135_.anInt3408) >= (~(plane_135_.anInt3398 + i_140_ >> plane_135_.anInt3410)) || i_141_ < 0 || (~(plane_135_.anInt3398 + i_142_ >> plane_135_.anInt3410)) <= (~plane_135_.anInt3404))) {
                return;
            }
            if (i == 1) {
                ...
                if ((~i) != -4) {
                    if (i != 4) {
                        ...
                        for (int i_152_ = 0; (~anInt5912) < (~i_152_); i_152_++)
                    ...
                    if ((~(-(i_153_ >> 1) + i_136_)) > -1 || (~(plane.anInt3408 << plane.anInt3410)) >= (~((i_153_ >> 1) + (i_136_ + plane.anInt3398))) || -(i_154_ >> 1) + i_138_ < 0 || i_138_ + (i_154_ >> 1) + plane.anInt3398 >= plane.anInt3404 << plane.anInt3410) {
                        return;
                    }
    ...
    private boolean method691(int i) {
        anInt5806++;
        ...
        if (buffer != null) {
            ...
            if (!Stream.b()) {
                ...
                for (int i_162_ = 0; (~i_162_) > (~anInt5859); i_162_++) {
    ...
    final void s(int i) {
        ...
        anInt5881 = i;
        aBoolean5826 = true;
        if (aClass284_5867 != null && (~(0x10000 & anInt5881)) == -1) {
    ...
    final void P(int i, int i_171_, int i_172_, int i_173_) {
        ...
        if ((~i) == -1) {
            ...
            for (int i_175_ = 0; (~anInt5912) < (~i_175_); i_175_++) {
            ...
            for (int i_188_ = 0; (~i_188_) > (~anInt5813); i_188_++) {
    ...
    final void method614(Class336 class336) {
        ...
        if (aClass300Array5905 != null) {
            for (int i = 0; (~i) > (~aClass300Array5905.length); i++) {
        ...
        if (aClass218Array5817 != null) {
            for (int i = 0; (~i) > (~aClass218Array5817.length); i++) {
    ...
    private boolean method693(int i, Class336 class336, int i_202_, int i_203_, boolean bool, boolean bool_204_, int i_205_) {
        anInt5893++;
        Class336_Sub1 class336_sub1 = (Class336_Sub1) class336;
        ...
        for (int i_228_ = 0; (~i_228_) > -9; i_228_++) {
        ...
        if (bool_209_ && f_210_ < (float) i_205_ && (float) i_205_ < f_211_ && f_212_ < (float) i_203_ && f_213_ > (float) i_203_) {
            ...
            if ((~anInt5885) < (~Class107.anIntArray1363.length)) {
            ...
            for (int i_237_ = 0; i_237_ < anInt5912; i_237_++) {
                ...
                if (!((float) anAbstractToolkit5916.anInt6364 <= f_243_)) {
                    ...
                    for (int i_252_ = i_250_; (~i_251_) < (~i_252_); i_252_++) {
    ...
    final void VA(int i) {
        ...
        for (int i_257_ = 0; (~anInt5912) < (~i_257_); i_257_++) {
    ...
    final void O(int i, int i_259_, int i_260_) {
        anInt5848++;
        for (int i_261_ = 0; (~anInt5912) < (~i_261_); i_261_++) {
            if ((~i) != -129) {
    ...
    final void method637(int i, int[] is, int i_262_, int i_263_, int i_264_, int i_265_, boolean bool) {
        ...
        if (i == 0) {
            ...
            for (int i_268_ = 0; i_266_ > i_268_; i_268_++) {
                ...
                if ((~i_269_) > (~anIntArrayArray5847.length)) {
            ...
            i_264_ <<= 4;
            i_263_ <<= 4;
            for (int i_273_ = 0; (~i_266_) < (~i_273_); i_273_++) {
            ...
            for (int i_278_ = 0; i_266_ > i_278_; i_278_++) {
                ...
                if (i_279_ < anIntArrayArray5847.length) {
                    ...
                    if ((~(0x1 & i_265_)) != -1) {
                        for (int i_281_ = 0; (~is_280_.length) < (~i_281_); i_281_++) {
            ...
            if (bool) {
                for (int i_303_ = 0; (~i_303_) > (~i_266_); i_303_++) {
                    int i_304_ = is[i_303_];
                    if ((~i_304_) > (~anIntArrayArray5847.length)) {
                        ...
                        for (int i_306_ = 0; i_306_ < is_305_.length; i_306_++) {
                            ...
                            for (int i_310_ = i_308_; (~i_310_) > (~i_309_); i_310_++) {
            ...
            for (int i_321_ = 0; i_321_ < i_266_; i_321_++) {
                ...
                if ((~i_322_) > (~anIntArrayArray5847.length)) {
            ...
            if (anIntArrayArray5900 != null) {
                ...
                for (int i_327_ = 0; (~i_266_) < (~i_327_); i_327_++) {
                    int i_328_ = is[i_327_];
                    if ((~anIntArrayArray5900.length) < (~i_328_)) {
                        ...
                        bool_326_ = bool_326_ | (~is_329_.length) < -1;
                    }
                }
                if (bool_326_) {
                    if (aClass268Array5856 != null) {
                        for (int i_333_ = 0; (~anInt5811) < (~i_333_); i_333_++) {
            ...
            if (anIntArrayArray5900 != null) {
                ...
                for (int i_335_ = 0; i_335_ < i_266_; i_335_++) {
                    ...
                    if ((~i_336_) > (~anIntArrayArray5900.length)) {
                        int[] is_337_ = anIntArrayArray5900[i_336_];
                        for (int i_338_ = 0; (~is_337_.length) < (~i_338_); i_338_++) {
                ...
                if (bool_334_) {
                    if (aClass268Array5856 != null) {
                        for (int i_344_ = 0; (~i_344_) > (~anInt5811); i_344_++) {
            ...
            if (anIntArrayArray5892 != null) {
                for (int i_345_ = 0; i_345_ < i_266_; i_345_++) {
                    ...
                    if ((~i_346_) > (~anIntArrayArray5892.length)) {
            ...
            if (anIntArrayArray5892 != null) {
                for (int i_349_ = 0; (~i_349_) > (~i_266_); i_349_++) {
                    int i_350_ = is[i_349_];
                    if ((~i_350_) > (~anIntArrayArray5892.length)) {
                        int[] is_351_ = anIntArrayArray5892[i_350_];
                        for (int i_352_ = 0; (~i_352_) > (~is_351_.length); i_352_++) {
        ...
        } else if ((~i) == -10 && anIntArrayArray5892 != null) {
    ...
    final void v() {
        anInt5850++;
        for (int i = 0; (~i) > (~anInt5912); i++)
            anIntArray5913[i] = -anIntArray5913[i];
        for (int i = 0; (~anInt5885) < (~i); i++)
    ...
    final void I(int i, int[] is, int i_357_, int i_358_, int i_359_, boolean bool, int i_360_, int[] is_361_) {
        ...
        if (i == 0) {
            ...
            for (int i_364_ = 0; i_364_ < i_362_; i_364_++) {
                ...
                if (anIntArrayArray5847.length > i_365_) {
                    ...
                    for (int i_367_ = 0; i_367_ < is_366_.length; i_367_++) {
                        ...
                        if (aShortArray5814 == null || (~(aShortArray5814[i_368_] & i_360_)) != -1) {
            ...
            i_357_ <<= 4;
            i_358_ <<= 4;
            for (int i_372_ = 0; (~i_372_) > (~i_362_); i_372_++) {
                ...
                if (i_373_ < anIntArrayArray5847.length) {
                    ...
                    for (int i_375_ = 0; (~i_375_) > (~is_374_.length); i_375_++) {
                        ...
                        if (aShortArray5814 == null || (~(i_360_ & aShortArray5814[i_376_])) != -1) {
            ...
            if (is_361_ != null) {
                ...
                for (int i_402_ = 0; (~i_402_) > -4; i_402_++) {
                    for (int i_403_ = 0; (~i_403_) > -4; i_403_++) {
                        int i_404_ = 0;
                ...
                for (int i_410_ = 0; (~i_410_) > -4; i_410_++) {
                    for (int i_411_ = 0; i_411_ < 3; i_411_++) {
                        int i_412_ = 0;
                        for (int i_413_ = 0; (~i_413_) > -4; i_413_++)
                ...
                for (int i_417_ = 0; i_417_ < i_362_; i_417_++) {
                    ...
                    if (i_418_ < anIntArrayArray5847.length) {
                        ...
                        for (int i_420_ = 0; (~is_419_.length) < (~i_420_); i_420_++) {
                ...
                if (bool) {
                    for (int i_439_ = 0; (~i_439_) > (~i_362_); i_439_++) {
                        int i_440_ = is[i_439_];
                        if ((~i_440_) > (~anIntArrayArray5847.length)) {
                            int[] is_441_ = anIntArrayArray5847[i_440_];
                            for (int i_442_ = 0; (~is_441_.length) < (~i_442_); i_442_++) {
                                int i_443_ = is_441_[i_442_];
                                if (aShortArray5814 == null || (~(i_360_ & aShortArray5814[i_443_])) != -1) {
            ...
            if (is_361_ != null) {
                ...
                for (int i_495_ = 0; (~i_495_) > (~i_362_); i_495_++) {
                    int i_496_ = is[i_495_];
                    if ((~anIntArrayArray5847.length) < (~i_496_)) {
            ...
            if (anIntArrayArray5900 != null) {
                ...
                for (int i_501_ = 0; i_501_ < i_362_; i_501_++) {
                    ...
                    if ((~i_502_) > (~anIntArrayArray5900.length)) {
                        ...
                        bool_500_ = bool_500_ | (~is_503_.length) < -1;
                    }
                }
                if (bool_500_) {
                    if (aClass268Array5856 != null) {
                        for (int i_507_ = 0; (~i_507_) > (~anInt5811); i_507_++) {
            ...
            if (anIntArrayArray5900 != null) {
                ...
                for (int i_509_ = 0; (~i_362_) < (~i_509_); i_509_++) {
                    int i_510_ = is[i_509_];
                    if (i_510_ < anIntArrayArray5900.length) {
                        int[] is_511_ = anIntArrayArray5900[i_510_];
                        for (int i_512_ = 0; (~is_511_.length) < (~i_512_); i_512_++) {
                            int i_513_ = is_511_[i_512_];
                            if (aShortArray5861 == null || (~(aShortArray5861[i_513_] & i_360_)) != -1) {
                ...
                if (bool_508_) {
                    if (aClass268Array5856 != null) {
                        for (int i_518_ = 0; (~anInt5811) < (~i_518_); i_518_++) {
            ...
            if (anIntArrayArray5892 != null) {
                for (int i_523_ = 0; i_523_ < i_362_; i_523_++) {
                    ...
                    if ((~i_524_) > (~anIntArrayArray5892.length)) {
            ...
            for (int i_527_ = 0; i_527_ < i_362_; i_527_++) {
                ...
                if (i_528_ < anIntArrayArray5892.length) {
                    ...
                    for (int i_530_ = 0; (~is_529_.length) < (~i_530_); i_530_++) {
                ...
                if (!(f_538_ / (float) i >= anAbstractToolkit5916.aFloat6317) && !(f_539_ / (float) i <= anAbstractToolkit5916.aFloat6298)) {
                    ...
                    if (!(anAbstractToolkit5916.aFloat6308 <= f_542_ / (float) i) && !(anAbstractToolkit5916.aFloat6282 >= f_543_ / (float) i)) {
                        ...
                        if (entitynode_sub5 != null) {
                            ...
                            if ((~i_548_) <= (~anAbstractToolkit5916.anInt6364) || anAbstractToolkit5916.anInt6364 <= i_551_) {
    ...
    private short method695(int i, int i_552_, float f, int i_553_, int i_554_, int i_555_, int i_556_, float f_557_, long l, int i_558_, Model model) {
        anInt5801++;
    ...
    private boolean method696(int i, int i_563_, int i_564_, byte b, int i_565_, int i_566_, int i_567_, int i_568_, int i_569_) {
        anInt5904++;
        if (i_566_ < i_564_ && i > i_566_ && (~i_569_) < (~i_566_)) {
            return false;
        }
        if (i_564_ < i_566_ && i_566_ > i && (~i_566_) < (~i_569_)) {
            return false;
        }
        if (i_568_ > i_563_ && (~i_563_) > (~i_567_) && i_565_ > i_563_) {
            return false;
        }
        if (b != 37) {
            return false;
    ...
    final void FA(int i) {
        ...
        for (int i_572_ = 0; (~i_572_) > (~anInt5912); i_572_++) {
    ...
    final boolean method612() {
        ...
        for (int i = 0; (~i) > (~aShortArray5862.length); i++) {
                ...
                if (!(f_587_ / f_583_ >= anAbstractToolkit5916.aFloat6317) && !(anAbstractToolkit5916.aFloat6298 >= f_586_ / f_583_)) {
                    ...
                    if (!(f_591_ / f_583_ >= anAbstractToolkit5916.aFloat6308) && !(f_590_ / f_583_ <= anAbstractToolkit5916.aFloat6282)) {
                        ...
                        if (entitynode_sub5 != null) {
                            ...
                            if ((~anAbstractToolkit5916.anInt6364) >= (~i_597_)) {
                            ...
                            if ((~anAbstractToolkit5916.anInt6364) >= (~i_600_)) {
                            ...
                            if (bool) {
                                if ((~i_597_) <= (~anAbstractToolkit5916.anInt6364) || (~i_600_) <= (~anAbstractToolkit5916.anInt6364)) {
    ...
    private DrawableModel method697(int i, StandardDrawableModel standarddrawablemodel_607_, boolean bool, boolean bool_608_, StandardDrawableModel standarddrawablemodel_609_, int i_610_) {
        ...
        if (bool_614_) {
            if (bool_611_) {
                if (standarddrawablemodel_607_.anIntArray5879 == null || (~standarddrawablemodel_607_.anIntArray5879.length) > (~anInt5902)) {
            ...
            if (bool_613_) {
                if (standarddrawablemodel_607_.anIntArray5913 != null && (~standarddrawablemodel_607_.anIntArray5913.length) <= (~anInt5902)) {
            ...
            for (int i_615_ = 0; (~i_615_) > (~anInt5902); i_615_++) {
                if (bool_611_) {
        ...
        if (!Class46.method470(anInt5896, -10, i)) {
            ...
            for (int i_616_ = 0; (~i_616_) > (~anInt5813); i_616_++)
                standarddrawablemodel_609_.aShortArray5802[i_616_] = aShortArray5802[i_616_];
        }
        if (Class234.method2150(anInt5896, i_610_ ^ ~0x100, i)) {
            if (standarddrawablemodel_607_.aByteArray5886 == null || (~anInt5813) < (~standarddrawablemodel_607_.aByteArray5886.length)) {
            ...
            for (int i_617_ = 0; (~anInt5813) < (~i_617_); i_617_++)
        ...
        if (!Class278.method3367(anInt5896, i, (byte) -105)) {
            ...
            if (aClass284_5867 == null) {
                ...
                if (class284.aShortArray3595 == null || (~anInt5885) < (~class284.aShortArray3595.length)) {
        ...
        if (Class219.method2094(i, anInt5896, i_610_ - 97)) {
            if (standarddrawablemodel_607_.aFloatArray5875 == null || (~standarddrawablemodel_607_.aFloatArray5875.length) > (~anInt5813)) {
            ...
            for (int i_623_ = 0; (~i_623_) > (~anInt5885); i_623_++) {
        ...
        if (Class144_Sub2.method1634(anInt5896, i, false)) {
            if (standarddrawablemodel_607_.aShortArray5841 != null && (~anInt5813) >= (~standarddrawablemodel_607_.aShortArray5841.length)) {
        ...
        if (!Class294.method3466(i, i_610_, anInt5896)) {
            ...
            for (int i_627_ = 0; (~anInt5813) < (~i_627_); i_627_++)
    ...
    private void method698(int i) {
        ...
        if (aBoolean5826) {
            ...
            if (aByteArray5834 != null && !Node_Sub38_Sub8.method2812(anInt5881, false, anInt5896)) {
                if (!((~(0x37 & anInt5896)) == -1 ? aClass347_5852 == null || aClass347_5852.method3979((byte) -94) : aClass347_5908 == null || aClass347_5908.method3979((byte) -52))) {
                    aBoolean5826 = true;
                } else {
                    aByteArray5834 = null;
    ...
    final void aa(short s, short s_633_) {
        ...
        if ((~s_633_) != 0) {
            ...
            if ((~class91.aByte1211) != -1 || class91.aByte1203 != 0) {
                aBoolean5866 = true;
            }
    ...
    final void method619(DrawableModel drawablemodel, int i, int i_644_, int i_645_, boolean bool) {
        ...
        if (anInt5813 != 0 && (~standarddrawablemodel_646_.anInt5813) != -1) {
            ...
            for (int i_668_ = 0; (~i_668_) > (~anInt5912); i_668_++) {
                int i_669_ = -i_644_ + anIntArray5897[i_668_];
                if ((~i_662_) >= (~i_669_) && (~i_669_) >= (~i_663_)) {
                    int i_670_ = -i + anIntArray5879[i_668_];
                    if (i_670_ >= i_664_ && (~i_665_) <= (~i_670_)) {
                                ...
                                for (int i_676_ = 0; i_647_ > i_676_; i_676_++) {
                                    if ((~is[i_676_]) == (~i_670_) && is_649_[i_676_] == i_671_ && i_669_ == is_648_[i_676_]) {
                                        ...
                                        if ((~i_677_) != 0) {
                                            ...
                                            for (int i_681_ = i_673_; (~i_681_) > (~i_674_); i_681_++) {
    ...
    private void method701(byte b) {
        ...
        int i_693_ = 0;
        int i_694_ = 0;
        for (int i_695_ = 0; (~i_695_) > (~anInt5912); i_695_++) {
    ...
    final r ba(r var_r) {
        ...
        int i;
        int i_700_;
        if ((~anAbstractToolkit5916.anInt6337) < -1) {
        ...
        int i_701_;
        int i_702_;
        if ((~anAbstractToolkit5916.anInt6286) < -1) {
    ...
    private void method705(int i, r_Sub1 var_r_Sub1) {
        ...
        for (int i_729_ = 0; anInt5859 > i_729_; i_729_++) {
            if (aByteArray5886 == null || aByteArray5886[i_729_] <= 128) {
                ...
                if ((~(-((-i_735_ + i_736_) * (-i_733_ + i_734_)) + (i_732_ - i_733_) * (-i_737_ + i_736_))) < -1) {
    ...
    final void method630(Class336 class336, int i, boolean bool) {
        ...
        if (aShortArray5814 != null) {
            int[] is = new int[3];
            for (int i_741_ = 0; (~i_741_) > (~anInt5912); i_741_++) {
