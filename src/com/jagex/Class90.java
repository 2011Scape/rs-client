...
public class Class90 {
    ...
    static int method1023(byte[] bs, int i, byte[] bs_0_, int i_1_, int i_2_) {
    ...
    private static void method1024(Class231 class231) {
        boolean bool = false;
        ...
        while (bool_22_) {
            ...
            System.arraycopy(class231.anIntArray2735, 0, class231.anIntArray2763, 1, 256);
    ...
    private static void method1025(int[] is, int[] is_73_, int[] is_74_, byte[] bs, int i, int i_75_, int i_76_) {
        int i_77_ = 0;
    ...
    private static void method1026(Class231 class231) {
    ...
    private static int method1028(int i, Class231 class231) {
        for (; ; ) {
    ...
    private static void method1029(Class231 class231) {
    ...
    private static byte method1030(Class231 class231) {
        return (byte) method1028(1, class231);
    }

    private static byte method1031(Class231 class231) {
