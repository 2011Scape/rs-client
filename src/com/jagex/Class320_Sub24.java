...
public class Class320_Sub24 extends Class320 {
    ...
    static void method3772(int i, byte b, int i_0_, int i_1_, int i_2_) {
        int i_3_ = 78 % ((23 - b) / 49);
        ...
        if (i <= -7) {
            for (CacheNode_Sub12 cachenode_sub12 = (CacheNode_Sub12) Class270.aClass312_3477.method3613(65280); cachenode_sub12 != null; cachenode_sub12 = (CacheNode_Sub12) Class270.aClass312_3477.method3620(16776960)) {
                ...
                if (Class174.anInt2092 <= mobile_sub1.anInt10923) {
                    if ((~Class174.anInt2092) <= (~mobile_sub1.anInt10958)) {
                        ...
                        if ((~mobile_sub1.anInt10942) < -1) {
                            if ((~aa.anInt101) == -4) {
                                ...
                                if (actor != null && (~actor.anInt5934) <= -1 && actor.anInt5934 < Node_Sub54.anInt7675 * 512 && actor.anInt5940 >= 0 && (~actor.anInt5940) > (~(512 * Class377_Sub1.anInt8774))) {
                                ...
                                if (node_sub41 != null) {
                                    ...
                                    if (npc.anInt5934 >= 0 && npc.anInt5934 < Node_Sub54.anInt7675 * 512 && npc.anInt5940 >= 0 && (~npc.anInt5940) > (~(512 * Class377_Sub1.anInt8774))) {
    ...
    static void method3775(int i, int i_5_, int i_6_) {
