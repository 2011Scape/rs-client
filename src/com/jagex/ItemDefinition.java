...
public class ItemDefinition
{
	...
	private short[] aShortArray1850;
	protected int anInt1851 = -1;
	protected int anInt1852;
	protected int anInt1853;
	...
	protected int anInt1878;
	protected int anInt1879;
	protected int anInt1880;
	...
	protected short[] aShortArray1909;
	...
	final ItemDefinition method1674(int i, int i_1_) {
		...
		anInt1902++;
		if (anIntArray1918 != null && (i ^ 0xffffffff) < -2) {
			int i_2_ = -1;
			for (int i_3_ = 0; (i_3_ ^ 0xffffffff) > -11; i_3_++) {
				if ((anIntArray1872[i_3_] ^ 0xffffffff) >= (i ^ 0xffffffff) && (anIntArray1872[i_3_] ^ 0xffffffff) != -1) {
	...
	final void method1676(byte b, ItemDefinition itemdefinition_5_, ItemDefinition itemdefinition_6_) {
		...
		anInt1867 = itemdefinition_5_.anInt1867;
		...
		aShortArray1909 = itemdefinition_5_.aShortArray1909;
		anInt1930 = itemdefinition_5_.anInt1930;
		anInt1883 = itemdefinition_5_.anInt1883;
		...
		anInt1880 = itemdefinition_5_.anInt1880;
		...
		aShortArray1850 = itemdefinition_5_.aShortArray1850;
		anInt1890 = itemdefinition_5_.anInt1890;
		anInt1878 = itemdefinition_5_.anInt1878;
		anInt1924 = 0;
		...
		anInt1915 = itemdefinition_5_.anInt1915;
		anInt1853 = itemdefinition_5_.anInt1853;
		...
		aStringArray1901[4] = Localization.discard1.getLocalizationString(-12273, aClass86_1868.languageId);
	}
	...
	final void method1677(ItemDefinition itemdefinition_7_, int i, ItemDefinition itemdefinition_8_) {
		...
		aShortArray1909 = itemdefinition_7_.aShortArray1909;
		anInt1869 = itemdefinition_7_.anInt1869;
		anInt1866 = itemdefinition_7_.anInt1866;
		aShortArray1850 = itemdefinition_7_.aShortArray1850;
	...
	private final void method1681(Buffer buffer, boolean bool, int i) {
		if (i == 1) {
			anInt1898 = buffer.method2219(-130546744);
		} else if (i != 2) {
			if (i == 4) {
				anInt1874 = buffer.method2219(-130546744);
			} else if (i == 5) {
				anInt1884 = buffer.method2219(-130546744);
			} else if ((i ^ 0xffffffff) == -7) {
				anInt1869 = buffer.method2219(-130546744);
			} else if (i == 7) {
				anInt1905 = buffer.method2219(-130546744);
				if ((anInt1905 ^ 0xffffffff) < -32768) {
					anInt1905 -= 65536;
				}
			} else if (i == 8) {
				anInt1875 = buffer.method2219(-130546744);
				if (anInt1875 > 32767) {
					anInt1875 -= 65536;
				}
				...
				anInt1924 = buffer.method2186(82);
				...
				if (i != 18) {
					if ((i ^ 0xffffffff) != -24) {
						if (i != 24) {
							if (i != 25) {
								if ((i ^ 0xffffffff) == -27) {
									anInt1883 = buffer.method2219(-130546744);
								} else if ((i ^ 0xffffffff) > -31 || (i ^ 0xffffffff) <= -36) {
									if ((i ^ 0xffffffff) <= -36 && (i ^ 0xffffffff) > -41) {
										aStringArray1901[-35 + i] = buffer.method2195(-1);
									} else if (i != 40) {
										if (i == 41) {
											int i_18_ = buffer.method2233(255);
											aShortArray1850 = new short[i_18_];
											aShortArray1909 = new short[i_18_];
											for (int i_19_ = 0; (i_18_ ^ 0xffffffff) < (i_19_ ^ 0xffffffff); i_19_++) {
												aShortArray1850[i_19_] = (short) buffer.method2219(-130546744);
												aShortArray1909[i_19_] = (short) buffer.method2219(-130546744);
											}
										} else if (i != 42) {
											if ((i ^ 0xffffffff) != -66) {
												if ((i ^ 0xffffffff) == -79) {
													anInt1867 = buffer.method2219(-130546744);
												} else if (i != 79) {
													if (i != 90) {
														if (i == 91) {
															anInt1863 = buffer.method2219(-130546744);
														} else if (i != 92) {
															if ((i ^ 0xffffffff) == -94) {
																anInt1897 = buffer.method2219(-130546744);
															} else if ((i ^ 0xffffffff) != -96) {
																if ((i ^ 0xffffffff) != -97) {
																	if (i != 97) {
																		if ((i ^ 0xffffffff) == -99) {
																			anInt1857 = buffer.method2219(-130546744);
																		} else if (i < 100 || i >= 110) {
																			if ((i ^ 0xffffffff) != -111) {
																				if (i != 111) {
																					if ((i ^ 0xffffffff) == -113) {
																						anInt1896 = buffer.method2219(-130546744);
																					} else if ((i ^ 0xffffffff) == -114) {
																						anInt1876 = buffer.method2214((byte) -85);
																					} else if ((i ^ 0xffffffff) != -115) {
																						if (i != 115) {
																							if (i != 121) {
																								if (i == 122) {
																									anInt1852 = buffer.method2219(-130546744);
																								} else if ((i ^ 0xffffffff) != -126) {
																									if (i != 126) {
																										if ((i ^ 0xffffffff) == -128) {
																											anInt1908 = buffer.method2233(255);
																											anInt1889 = buffer.method2219(-130546744);
																										} else if (i != 128) {
																											if (i != 129) {
																												if (i == 130) {
																													anInt1864 = buffer.method2233(255);
																													anInt1862 = buffer.method2219(-130546744);
																												} else if (i == 132) {
																													int i_20_ = buffer.method2233(255);
																													anIntArray1926 = new int[i_20_];
																													for (int i_21_ = 0; i_20_ > i_21_; i_21_++)
																														anIntArray1926[i_21_] = buffer.method2219(-130546744);
																												} else if (i == 134) {
																													anInt1919 = buffer.method2233(255);
																												} else if ((i ^ 0xffffffff) == -140) {
																													anInt1891 = buffer.method2219(-130546744);
																												} else if ((i ^ 0xffffffff) == -141) {
																													anInt1928 = buffer.method2219(-130546744);
																													...
																													for (int i_24_ = 0; i_22_ > i_24_; i_24_++) {
																														boolean bool_25_ = buffer.method2233(255) == 1;
																														int i_26_ = buffer.method2220(1819759595);
																														Node node;
																														if (!bool_25_) {
																															node = new Node_Sub32(buffer.method2186(-109));
																														} else {
																												...
																												anInt1900 = buffer.method2233(255);
																												anInt1859 = buffer.method2219(-130546744);
																											}
																										} else {
																											anInt1849 = buffer.method2233(255);
																											anInt1851 = buffer.method2219(-130546744);
																										}
																									} else {
																										anInt1890 = buffer.method2214((byte) 32) << 2;
																										anInt1893 = buffer.method2214((byte) 101) << 2;
																										anInt1916 = buffer.method2214((byte) 52) << 2;
																									}
																								} else {
																									anInt1931 = buffer.method2214((byte) 32) << 2;
																									anInt1930 = buffer.method2214((byte) -61) << 2;
																									anInt1895 = buffer.method2214((byte) -61) << 2;
																								}
																							} else {
																								anInt1927 = buffer.method2219(-130546744);
																							}
																						} else {
																							anInt1899 = buffer.method2233(255);
																						}
																					} else {
																						anInt1886 = buffer.method2214((byte) -99) * 5;
																					}
																				} else {
																					anInt1911 = buffer.method2219(-130546744);
																				}
																			} else {
																				anInt1904 = buffer.method2219(-130546744);
																			}
																		} else {
																			...
																			anIntArray1918[i - 100] = buffer.method2219(-130546744);
																			anIntArray1872[-100 + i] = buffer.method2219(-130546744);
																		}
																	} else {
																		anInt1887 = buffer.method2219(-130546744);
																	}
																} else {
																	anInt1877 = buffer.method2233(255);
																}
															} else {
																anInt1866 = buffer.method2219(-130546744);
															}
														} else {
															anInt1888 = buffer.method2219(-130546744);
														}
													} else {
														anInt1913 = buffer.method2219(-130546744);
													}
												} else {
													anInt1915 = buffer.method2219(-130546744);
												}
											} else {
												aBoolean1933 = true;
											}
											...
											for (int i_28_ = 0; i_27_ > i_28_; i_28_++)
												aByteArray1882[i_28_] = buffer.method2214((byte) -108);
										}
									} else {
										...
										for (int i_30_ = 0; i_29_ > i_30_; i_30_++) {
											aShortArray1856[i_30_] = (short) buffer.method2219(-130546744);
											aShortArray1865[i_30_] = (short) buffer.method2219(-130546744);
										}
									}
								} else {
									aStringArray1920[i + -30] = buffer.method2195(-1);
								}
							} else {
								anInt1880 = buffer.method2219(-130546744);
							}
						} else {
							anInt1878 = buffer.method2219(-130546744);
						}
					} else {
						anInt1853 = buffer.method2219(-130546744);
					}
				} else {
					anInt1879 = buffer.method2219(-130546744);
				}
			} else {
				aBoolean1871 = true;
			}
	...
	final int[] method1682(int i, GraphicsToolkit graphicstoolkit, int i_31_, byte b, int i_32_, boolean bool, PlayerDefinition playerdefinition, GraphicsToolkit graphicstoolkit_33_, Class52 class52, int i_34_) {
		...
		if (aShortArray1856 != null) {
			for (int i_35_ = 0; (i_35_ ^ 0xffffffff) > (aShortArray1856.length ^ 0xffffffff); i_35_++) {
				if (aByteArray1882 == null || (i_35_ ^ 0xffffffff) <= (aByteArray1882.length ^ 0xffffffff)) {
					model.method2089(aShortArray1856[i_35_], aShortArray1865[i_35_], -126);
				} else {
					model.method2089(aShortArray1856[i_35_], Class129.aShortArray1665[0xff & aByteArray1882[i_35_]], -89);
				}
			}
		}
		if (aShortArray1850 != null) {
			for (int i_36_ = 0; (aShortArray1850.length ^ 0xffffffff) < (i_36_ ^ 0xffffffff); i_36_++)
				model.method2087(aShortArray1850[i_36_], aShortArray1909[i_36_], -78);
		}
		...
		if ((anInt1904 ^ 0xffffffff) != -129 || (anInt1911 ^ 0xffffffff) != -129 || anInt1896 != 128) {
			bool_40_ = true;
			i_39_ |= 0x7;
		}
		...
		if (anInt1857 != -1) {
			glsprite = aClass86_1868.method1002(1, graphicstoolkit_33_, graphicstoolkit, playerdefinition, true, 0, 10, true, 0, class52, anInt1887, -16139);
			if (glsprite == null) {
				return null;
			}
		} else if ((anInt1852 ^ 0xffffffff) != 0) {
		...
		} else if ((anInt1928 ^ 0xffffffff) != 0) {
	...
	final Model method1683(Class38 class38, boolean bool, int i) {
		...
		if (aShortArray1850 != null) {
			...
			for (int i_53_ = 0; i_53_ < aShortArray1850.length; i_53_++)
				model.method2087(aShortArray1850[i_53_], ses[i_53_], -84);
		}
		if (i >= -34) {
			return null;
		}
	...
	final Model method1685(boolean bool, Class38 class38, int i) {
		...
		if (aShortArray1856 != null) {
			...
			for (int i_58_ = 0; (i_58_ ^ 0xffffffff) > (aShortArray1856.length ^ 0xffffffff); i_58_++)
		...
		if (aShortArray1850 != null) {
			...
			for (int i_59_ = 0; (aShortArray1850.length ^ 0xffffffff) < (i_59_ ^ 0xffffffff); i_59_++)
				model.method2087(aShortArray1850[i_59_], ses[i_59_], 101);
		}
		return model;
	}
	...
	private final String method1687(int i, int i_65_) {
		...
		if ((i_65_ ^ 0xffffffff) > -10000001) {
			return "<col=ffffff>" + i_65_ / 1000 + Localization.thousandsCharacter2.getLocalizationString(-12273, aClass86_1868.languageId) + "</col>";
		}
		return "<col=00ff80>" + i_65_ / 1000000 + Localization.millionsCharacter2.getLocalizationString(i + -34323, aClass86_1868.languageId) + "</col>";
	}
	...
	final DrawableModel method1689(Animator animator, int i, PlayerDefinition playerdefinition, int i_70_, GraphicsToolkit graphicstoolkit, int i_71_) {
		anInt1906++;
		if (anIntArray1918 != null && (i_70_ ^ 0xffffffff) < -2) {
			int i_72_ = -1;
			for (int i_73_ = 0; i_73_ < 10; i_73_++) {
				if ((i_70_ ^ 0xffffffff) <= (anIntArray1872[i_73_] ^ 0xffffffff) && (anIntArray1872[i_73_] ^ 0xffffffff) != -1) {
		...
		if (drawablemodel == null || (graphicstoolkit.b(drawablemodel.ua(), i_74_) ^ 0xffffffff) != -1) {
			...
			if ((anInt1904 ^ 0xffffffff) != -129 || anInt1911 != 128 || (anInt1896 ^ 0xffffffff) != -129) {
				drawablemodel.O(anInt1904, anInt1911, anInt1896);
			}
			if (aShortArray1856 != null) {
				for (int i_76_ = 0; aShortArray1856.length > i_76_; i_76_++) {
					if (aByteArray1882 == null || (aByteArray1882.length ^ 0xffffffff) >= (i_76_ ^ 0xffffffff)) {
						drawablemodel.ia(aShortArray1856[i_76_], aShortArray1865[i_76_]);
					} else {
						drawablemodel.ia(aShortArray1856[i_76_], Class129.aShortArray1665[aByteArray1882[i_76_] & 0xff]);
					}
				}
			}
			if (aShortArray1850 != null) {
				for (int i_77_ = 0; (aShortArray1850.length ^ 0xffffffff) < (i_77_ ^ 0xffffffff); i_77_++)
					drawablemodel.aa(aShortArray1850[i_77_], aShortArray1909[i_77_]);
			}
			if (playerdefinition != null) {
	...
	final void method1693(ItemDefinition itemdefinition_83_, byte b, ItemDefinition itemdefinition_84_) {
		anInt1924 = 0;
		anInt1867 = itemdefinition_84_.anInt1867;
		...
		anInt1878 = itemdefinition_84_.anInt1878;
		aStringArray1901 = new String[5];
		...
		anInt1880 = itemdefinition_84_.anInt1880;
		anInt1929++;
		...
		anInt1915 = itemdefinition_84_.anInt1915;
		aShortArray1909 = itemdefinition_84_.aShortArray1909;
