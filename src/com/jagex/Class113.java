...
public class Class113 {
    ...
    static int method1148(boolean bool, int i, int i_0_) {
        anInt1445++;
        if (bool != true) {
            return 95;
        }
    ...
    static void method1151(int i, int i_2_, int i_3_, byte b, int i_4_) {
        if (b > -103) {
    ...
    static boolean method1152(int i) {
        anInt1451++;
        if (i > -65) {
            method1152(-37);
        }
    ...
    static long method1153(int i, String string) {
        anInt1442++;
        if (i != 1) {
            method1153(79, null);
        }
