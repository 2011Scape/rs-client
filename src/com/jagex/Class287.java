...
public class Class287 {
    ...
    static void method3401(Node_Sub19 node_sub19, boolean bool, int i) {
        if (!node_sub19.aBoolean7156) {
            if (node_sub19.aBoolean7159 && node_sub19.anInt7171 >= 1 && node_sub19.anInt7161 >= 1 && -2 + Node_Sub54.anInt7675 >= node_sub19.anInt7171 && (~(-2 + Class377_Sub1.anInt8774)) <= (~node_sub19.anInt7161) && ((~node_sub19.anInt7169) > -1 || Class128.method1547(node_sub19.anInt7169, 1, node_sub19.anInt7168))) {
                if (bool) {
                ...
                if (bool || node_sub19.anInt7154 != node_sub19.anInt7169 || (~node_sub19.anInt7154) != 0) {
                    if (!bool && (~node_sub19.anInt7154) == (~node_sub19.anInt7169) && node_sub19.anInt7167 == node_sub19.anInt7170 && (~node_sub19.anInt7168) == (~node_sub19.anInt7164)) {
    ...
    private void method3398(int i, AbstractToolkit abstracttoolkit) {
        if (i > -16) {
            method3398(-52, null);
        }
    ...
    private void method3400(int i, byte b, AbstractToolkit abstracttoolkit) {
    ...
    private void method3402(byte b, AbstractToolkit abstracttoolkit) {
        anInt3611++;
        if (b != -45) {
    ...
    private void method3403(int i, boolean bool, AbstractToolkit abstracttoolkit) {
        anInt3613++;
        int i_18_ = 0;
        ...
        if (bool == false) {
            ...
            if (buffer != null) {
                ...
                if (Stream.b()) {
                    for (int i_33_ = i - 1; (~i_33_) <= -1; i_33_--) {
                        int i_34_ = (~anIntArray3619[i_33_]) < -65 ? 64 : anIntArray3619[i_33_];
                        if ((~i_34_) < -1) {
                            for (int i_35_ = -1 + i_34_; i_35_ >= 0; i_35_--) {
                                ...
                                if ((~abstracttoolkit.anInt6360) != -1) {
                            ...
                            if ((~anIntArray3619[i_33_]) < -65) {
                                int i_44_ = -1 + anIntArray3619[i_33_] - 64;
                                for (int i_45_ = -1 + anIntArray3616[i_44_]; (~i_45_) <= -1; i_45_--) {
                    ...
                    for (int i_54_ = i - 1; i_54_ >= 0; i_54_--) {
                        ...
                        if ((~i_55_) < -1) {
                            ...
                            if ((~anIntArray3619[i_54_]) < -65) {
                                int i_65_ = -65 + anIntArray3619[i_54_];
                                for (int i_66_ = anIntArray3616[i_65_] - 1; (~i_66_) <= -1; i_66_--) {
