...
public class Class296 implements Interface18 {
    ...
    static boolean method3474(int i, int i_0_, int i_1_, int i_2_) {
        anInt5441++;
        boolean bool = true;
    ...
    static void method3477(int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
        anInt5430++;
    ...
    public final boolean method66(int i, Interface18 interface18) {
        ...
        if ((~anInt5427) != (~class296_3_.anInt5427)) {
            return false;
        }
        if ((~class296_3_.anInt5433) != (~anInt5433)) {
            return false;
        }
        if (anInt5435 != class296_3_.anInt5435) {
            return false;
        }
        if ((~anInt5434) != (~class296_3_.anInt5434)) {
            return false;
        }
        if (i != 28071) {
            anInt5431 = 7;
