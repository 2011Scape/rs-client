...
public class Node_Sub40 extends Node {
    ...
    Node_Sub40(int i, byte[] bs) {
        ...
        for (int i_31_ = 0; (~i_31_) > (~anInt7503); i_31_++) {
        ...
        for (int i_33_ = 0; (~i_33_) > (~anInt7503); i_33_++)
            anIntArray7510[i_33_] = buffer.method2219(-130546744);
        for (int i_34_ = 0; (~anInt7503) < (~i_34_); i_34_++)
            anIntArrayArray7499[i_34_] = new int[buffer.method2233(255)];
        for (int i_35_ = 0; i_35_ < anInt7503; i_35_++) {
            for (int i_36_ = 0; (~i_36_) > (~anIntArrayArray7499[i_35_].length); i_36_++)
                anIntArrayArray7499[i_35_][i_36_] = buffer.method2233(255);
        }
    }

    static void method2924(int i, int i_0_, int i_1_, int i_2_, int i_3_, GraphicsToolkit graphicstoolkit, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, CacheNode_Sub4 cachenode_sub4) {
        anInt7500++;
    ...
    static void method2926(byte b, int i, GraphicsToolkit graphicstoolkit, int i_9_, int i_10_, int i_11_) {
        ...
        if ((~Node_Sub25_Sub1.anInt9947) <= -101) {
                ...
                for (Node_Sub14 node_sub14 = (Node_Sub14) Class20.aClass312_331.method3613(65280); node_sub14 != null; node_sub14 = (Node_Sub14) Class20.aClass312_331.method3620(16776960)) {
                    ...
                    if (Class220.method2099(true, class79)) {
                        if ((~Class253.anInt3201) != (~node_sub14.anInt7128)) {
                            if ((~Node_Sub38_Sub19.anInt10296) != 0 && Node_Sub38_Sub19.anInt10296 == class79.anInt1067) {
    ...
    static void method2927(boolean bool, int i, int i_24_, int i_25_) {
    ...
    static Class235 method2928(Buffer buffer, byte b) {
        anInt7504++;
        if (b != -24) {
            return null;
        }
    ...
    static boolean method2929(int i, int i_29_, int i_30_) {
        if (i_29_ != 0) {
            aStringArrayArray7505 = null;
        }
        anInt7507++;
