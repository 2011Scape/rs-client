...
public class Class215 {
    ...
    static boolean method2062(int i, int i_0_, int i_1_) {
        anInt2530++;
        if (i != 36) {
            return true;
        }
        if (!((~(0x70000 & i_1_)) != -1 | Node_Sub38_Sub4.method2797(0, i_0_, i_1_)) && !Class318.method3669(i_1_, (byte) 123, i_0_)) {
            return false;
        }
        return true;
    }

    static int method2063(byte b) {
        if (b <= 67) {
            return -69;
        }
        anInt2531++;
    ...
    static void method2065(int i, int i_2_) {
    ...
    static Class352 method2067(int i, int i_4_) {
        anInt2536++;
    ...
    static int method2072(int i, boolean bool) {
        anInt2544++;
        int i_7_ = i >>> 1;
        i_7_ |= i_7_ >>> 1;
        i_7_ |= i_7_ >>> 2;
