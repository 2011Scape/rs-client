...
public class CacheNode_Sub5 extends CacheNode {
    ...
    static boolean method2307(int i, int i_0_, int i_1_) {
        anInt9469++;
        if ((~(i_0_ & i_1_)) != -1 | Class73.method749((byte) -65, i_1_, i) || FloatBuffer.method2248(i_1_, i, 51)) {
            return true;
        }
    ...
    static Class169_Sub2_Sub1 method2308(GLToolkit gltoolkit, int i, int i_2_, boolean bool, int i_3_, int[] is, int i_4_, int i_5_) {
        anInt9474++;
        if (i != 25448) {
            return null;
        }
