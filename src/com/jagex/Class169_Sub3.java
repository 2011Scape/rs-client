...
public class Class169_Sub3 extends Class169 {
    ...
    static byte[] method1778(int i, boolean bool) {
        anInt8807++;
        if (bool != true) {
            method1780((byte) -62);
        }
    ...
    static void method1779(GraphicsToolkit graphicstoolkit, String string, boolean bool, Class357 class357, Class52 class52, int i) {
        anInt8816++;
    ...
    static void method1782(int i) {
        ...
        for (int i_19_ = 0; Class290_Sub11.anInt8181 > i_19_; i_19_++) {
            ...
            for (int i_21_ = 0; Class117.anInt1479 > i_21_; i_21_++) {
                ...
                if ((~Class290_Sub4.anIntArray8102[i_22_]) == (~Class225.anInt2675)) {
