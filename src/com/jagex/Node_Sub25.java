...
abstract class Node_Sub25 extends Node {
    ...
    static int method2651(int i, int i_0_, boolean bool, int i_1_) {
        if (bool != false) {
    ...
    static boolean method2653(int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_) {
        anInt7238++;
        int i_9_ = i_4_ + i;
        int i_10_ = i_3_ + i_7_;
        int i_11_ = i_8_ + i_6_;
