...
public class Class260 implements Interface10 {
    ...
    static int method3136(Class94 class94, int i) {
        anInt5220++;
        if (i != 30716) {
            aClass124_5230 = null;
        }
    ...
    static Class method3139(String string, int i) throws ClassNotFoundException {
        anInt5229++;
        if (string.equals("B")) {
            return Byte.TYPE;
        }
    ...
    static CacheNode_Sub9 method3140(int i, int i_5_) {
        anInt5223++;
    ...
    private int method3135(byte b, Class52 class52, String string, int i, int i_0_, int i_1_) {
        anInt5222++;
        if (b != -122) {
            aClass77_5225 = null;
        }
