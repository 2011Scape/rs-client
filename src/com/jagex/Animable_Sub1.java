...
abstract class Animable_Sub1 extends Animable {
    ...
    static void method826(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_) {
        anInt9097++;
        if (i_0_ != -1) {
            method824((byte) -108);
        }
