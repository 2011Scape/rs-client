...
public class Class78 {
    ...
    static void method776(int i, int i_0_, int i_1_, GraphicsToolkit graphicstoolkit) {
        anInt1029++;
        if ((~i_1_) <= -1 && (~i) <= -1 && (~ClanChat.anInt764) != -1 && Class150_Sub2.anInt8955 != 0) {
            ...
            if (Node_Sub38_Sub37.aPlaneArray10466 != null && (!Class87.aBoolean1185 || (0x40 & Class200_Sub2.anInt4943) != 0)) {
                ...
                if (f > 0.0F) {
                    ...
                    if ((~i_21_) > -4 && (~(0x2 & CacheNode_Sub11.aByteArrayArrayArray9550[1][i_19_ >> 9][i_20_ >> 9])) != -1) {
                        i_21_++;
                    }
                }
                if (i_8_ != -1 && i_9_ != -1) {
                    if (!Class87.aBoolean1185 || (~(0x40 & Class200_Sub2.anInt4943)) == -1) {
                        if (Class377_Sub1.aBoolean8778) {
                            Node_Sub32.method2731(false, -1, 0L, i_8_, i_9_, Class22.aClass22_390.method297(-12273, Class35.anInt537), 11, true, -1, "", (long) (i_9_ | i_8_), (byte) -18, true);
                        }
                        Node_Sub32.method2731(false, -1, 0L, i_8_, i_9_, Class173.aString2085, 58, true, Class173.anInt2086, "", (long) (i_9_ | i_8_), (byte) -18, true);
                        InputStream_Sub1.anInt76++;
                    } else {
                        Widget widget = Node_Sub3.method2169(i_0_ ^ ~0x64, Class46.anInt681, Node_Sub15_Sub9.anInt9839);
                        if (widget != null) {
                            Node_Sub32.method2731(false, -1, 0L, i_8_, i_9_, Class84.aString1148, 21, true, Class201.anInt2444, " ->", (long) (i_8_ | i_9_), (byte) -18, true);
                        } else {
            ...
            for (int i_22_ = i_0_; (~i_22_) > (~(Class71.aBoolean967 ? 2 : 1)); i_22_++) {
                ...
                for (EntityNode_Sub6 entitynode_sub6 = (EntityNode_Sub6) class103.method1113((byte) -113); entitynode_sub6 != null; entitynode_sub6 = (EntityNode_Sub6) class103.method1108(115)) {
                    if ((Node_Sub25_Sub1.aBoolean9952 || (~entitynode_sub6.anAnimable5990.aByte5933) == (~Class295.aPlayer3692.aByte5933)) && entitynode_sub6.method971(graphicstoolkit, (byte) 126, i_24_, i_23_)) {
                        ...
                        if (entitynode_sub6.anAnimable5990 instanceof Player) {
                            ...
                            if ((0x1 & i_29_) == 0 && (0x1ff & player.anInt5934) == 0 && (0x1ff & player.anInt5940) == 0 || (0x1 & i_29_) == 1 && (0x1ff & player.anInt5934) == 256 && (player.anInt5940 & 0x1ff) == 256) {
                                ...
                                for (int i_32_ = 0; (~Node_Sub25_Sub3.anInt9987) < (~i_32_); i_32_++) {
                                    ...
                                    if (node_sub41 != null) {
                                        ...
                                        if ((~Class174.anInt2092) != (~npc.anInt10863) && npc.aBoolean10826) {
                                            ...
                                            if ((~i_30_) >= (~i_33_) && npc.aNpcDefinition11122.anInt2811 <= -(-i_30_ + i_33_ >> 9) + player.method853((byte) 126) && i_34_ >= i_31_ && (~npc.aNpcDefinition11122.anInt2811) >= (~(player.method853((byte) 121) - (-i_31_ + i_34_ >> 9)))) {
                                ...
                                for (int i_36_ = 0; (~i_36_) > (~i_35_); i_36_++) {
                                    ...
                                    if (player_37_ != null && player_37_.anInt10863 != Class174.anInt2092 && player_37_ != player && player_37_.aBoolean10826) {
                                        ...
                                        if (i_38_ >= i_30_ && player_37_.method853((byte) 71) <= -(i_38_ - i_30_ >> 9) + player.method853((byte) 110) && (~i_39_) <= (~i_31_) && player_37_.method853((byte) 79) <= -(i_39_ - i_31_ >> 9) + player.method853((byte) 100)) {
                            ...
                            if ((~Class174.anInt2092) == (~player.anInt10863)) {
                                continue;
                            }
                            Class223.method2103((~Class295.aPlayer3692.aByte5933) != (~entitynode_sub6.anAnimable5990.aByte5933), player, -15052);
                        ...
                        if (entitynode_sub6.anAnimable5990 instanceof Npc) {
                            ...
                            if (npc.aNpcDefinition11122 != null) {
                                if ((~(npc.aNpcDefinition11122.anInt2811 & 0x1)) == -1 && (~(0x1ff & npc.anInt5934)) == -1 && (0x1ff & npc.anInt5940) == 0 || (~(0x1 & npc.aNpcDefinition11122.anInt2811)) == -2 && (0x1ff & npc.anInt5934) == 256 && (0x1ff & npc.anInt5940) == 256) {
                                    ...
                                    for (int i_42_ = 0; (~Node_Sub25_Sub3.anInt9987) < (~i_42_); i_42_++) {
                                        ...
                                        if (node_sub41 != null) {
                                            ...
                                            if (npc_43_.anInt10863 != Class174.anInt2092 && npc_43_ != npc && npc_43_.aBoolean10826) {
                                                ...
                                                if ((~i_40_) >= (~i_44_) && (~(-(-i_40_ + i_44_ >> 9) + npc.aNpcDefinition11122.anInt2811)) <= (~npc_43_.aNpcDefinition11122.anInt2811) && (~i_45_) <= (~i_41_) && (~npc_43_.aNpcDefinition11122.anInt2811) >= (~(-(-i_41_ + i_45_ >> 9) + npc.aNpcDefinition11122.anInt2811))) {
                                    ...
                                    for (int i_47_ = 0; i_46_ > i_47_; i_47_++) {
                                        ...
                                        if (player != null && (~player.anInt10863) != (~Class174.anInt2092) && player.aBoolean10826) {
                                            int i_48_ = player.anInt5934 - (player.method853((byte) 125) - 1 << 8);
                                            int i_49_ = player.anInt5940 - (-1 + player.method853((byte) 76) << 8);
                                            if ((~i_40_) >= (~i_48_) && player.method853((byte) 98) <= -(i_48_ - i_40_ >> 9) + npc.aNpcDefinition11122.anInt2811 && i_41_ <= i_49_ && (~player.method853((byte) 127)) >= (~(-(i_49_ - i_41_ >> 9) + npc.aNpcDefinition11122.anInt2811))) {
                                ...
                                if ((~Class174.anInt2092) == (~npc.anInt10863)) {
                                    continue;
                                }
                            ...
                            if (node_sub11 != null) {
                                ...
                                for (Node_Sub8 node_sub8 = (Node_Sub8) node_sub11.aClass312_7104.method3622((byte) -60); node_sub8 != null; node_sub8 = (Node_Sub8) node_sub11.aClass312_7104.method3623((byte) 106)) {
                                    ...
                                    if (Class87.aBoolean1185 && (~Class295.aPlayer3692.aByte5933) == (~entitynode_sub6.anAnimable5990.aByte5933)) {
                                        ...
                                        if ((~(0x1 & Class200_Sub2.anInt4943)) != -1 && (class267 == null || (~itemdefinition.method1678(Class324.anInt4087, class267.anInt3443, 10247)) != (~class267.anInt3443))) {
                                            Class120.anInt1518++;
                                    ...
                                    if ((~entitynode_sub6.anAnimable5990.aByte5933) == (~Class295.aPlayer3692.aByte5933)) {
                                        ...
                                        for (int i_53_ = -1 + strings.length; i_53_ >= 0; i_53_--) {
                                            if (strings[i_53_] != null) {
                                                ...
                                                if ((~i_53_) == (~itemdefinition.anInt1908)) {
                                                    i_55_ = itemdefinition.anInt1889;
                                                }
                                                if ((~i_53_) == (~itemdefinition.anInt1849)) {
                        ...
                        if (entitynode_sub6.anAnimable5990 instanceof Interface19) {
                            ...
                            if (objectdefinition != null) {
                                if (Class87.aBoolean1185 && Class295.aPlayer3692.aByte5933 == entitynode_sub6.anAnimable5990.aByte5933) {
                                    Class267 class267 = (~Class324.anInt4087) != 0 ? Class188_Sub2_Sub2.aClass36_9366.method394(Class324.anInt4087, -95) : null;
                                ...
                                if (Class295.aPlayer3692.aByte5933 == entitynode_sub6.anAnimable5990.aByte5933) {
                                    ...
                                    if (strings != null) {
                                        for (int i_56_ = strings.length - 1; (~i_56_) <= -1; i_56_--) {
                                            if (strings[i_56_] != null) {
                                                ...
                                                if ((~i_56_) == (~objectdefinition.anInt2987)) {
    ...
    static boolean method778(int i, int i_59_, int i_60_, boolean bool, int i_61_, int i_62_, int i_63_, int i_64_, int i_65_) {
        anInt1040++;
        int i_66_ = 10 % ((i_64_ + 14) / 44);
        int i_67_ = Class295.aPlayer3692.anIntArray10910[0];
        int i_68_ = Class295.aPlayer3692.anIntArray10908[0];
        if ((~i_67_) > -1 || i_67_ >= Node_Sub54.anInt7675 || (~i_68_) > -1 || (~Class377_Sub1.anInt8774) >= (~i_68_)) {
            return false;
        }
        if (i_61_ < 0 || (~Node_Sub54.anInt7675) >= (~i_61_) || (~i_59_) > -1 || i_59_ >= Class377_Sub1.anInt8774) {
            return false;
        }
    ...
    static void method779(int i, int i_70_, byte b) {
        anInt1032++;
    ...
    static void method780(long l, int i, GraphicsToolkit graphicstoolkit) {
