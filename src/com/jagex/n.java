...
public class n extends Class52 implements Interface3 {
    ...
    private native void PA(char c, int i, int i_2_, int i_3_, boolean bool, aa var_aa, int i_4_, int i_5_);

    private native void S(oa var_oa, ya var_ya, byte[][] bs, int[] is, int[] is_9_, int[] is_10_, int[] is_11_, int[] is_12_);
