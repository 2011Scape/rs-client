...
public class Class75 {
    ...
    Class75(int[] is) {
        ...
        for (int i_15_ = 0; i_15_ < is.length; i_15_++) {
            int i_16_;
            for (i_16_ = -1 + i & is[i_15_]; (~anIntArray1001[i_16_ + (i_16_ + 1)]) != 0; i_16_ = -1 + i & i_16_ + 1) {
                /* empty */
            }
    ...
    static void method763(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
        anInt1008++;
        if (i_2_ == -1) {
            if ((~(i_1_ + -i_3_)) <= (~Class262_Sub4.anInt7722) && (~za_Sub2.anInt10513) <= (~(i_1_ - -i_3_)) && -i_3_ + i >= Class384.anInt4906 && (~(i - -i_3_)) >= (~Node_Sub25_Sub1.anInt9936)) {
    ...
    static String method765(int i, byte b, int i_4_, String[] strings) {
        anInt1006++;
        if ((~i) == -1) {
            return "";
        }
    ...
    final int method766(int i, int i_10_) {
        ...
        for (; ; ) {
            ...
            if ((~i_10_) == (~anIntArray1001[i_12_ + i_12_])) {
                return i_13_;
            }
            i_12_ = i_11_ & i_12_ + 1;
        }
