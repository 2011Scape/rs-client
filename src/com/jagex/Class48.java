...
public class Class48 {
    ...
    static void method478(int i, byte b) {
        anInt709++;
        if ((~Class151.anInt1843) != (~i)) {
            if (i == 14 || i == 15) {
                Node_Sub38_Sub32.method2897(29);
            }
            if ((~i) != -15 && Class290_Sub7.aClass365_8135 != null) {
            ...
            } else if ((~i) == -7 || (~i) == -10 && Class151.anInt1843 != 10) {
                Node_Sub38_Sub32.method2897(29);
            }
            ...
            boolean bool_1_ = (~Class151.anInt1843) == -3 || Class26.method311(Class151.anInt1843, -5) || Class329.method3833((byte) -61, Class151.anInt1843);
            if (!bool_1_ == bool) {
                if (!bool) {
                    ...
                    if ((~Class213.aNode_Sub27_2512.aClass320_Sub25_7309.method3776(false)) != -1) {
            ...
            if (Class315.method3655(i, 128) || (~i) == -15 || (~i) == -16) {
    ...
    static CacheNode_Sub2 method479(int i) {
        if (i != 1) {
        ...
        } while ((~(cachenode_sub2.aLong7037 & ~0x7fffffffffffffffL)) == -1L);
        return cachenode_sub2;
    }

    static void method481(int i) {
        anInt695++;
        Class182.method1832();
        if (i != 0) {
            anInt704 = 16;
    ...
    static void method483(String string, int i, String string_19_, boolean bool, int i_20_) {
        anInt717++;
    ...
    private void method480(int i, byte b, Buffer buffer) {
        int i_2_ = -8 / ((-14 - b) / 62);
        anInt697++;
        if ((~i) == -2) {
                                    ...
                                    if (i != 18) {
                                        if ((~i) == -20) {
                                            if (anIntArray701 == null) {
                                                ...
                                                for (int i_16_ = 0; (~anIntArrayArray700.length) < (~i_16_); i_16_++)
                                            ...
                                            if (anIntArray690 == null || anIntArray692 == null) {
                                                ...
                                                for (int i_17_ = 0; (~anIntArrayArray700.length) < (~i_17_); i_17_++) {
