...
abstract class Class213 {
    static int anInt2509;
    static boolean aBoolean2510 = false;
    static int anInt2511 = 0;
    static Node_Sub27 aNode_Sub27_2512;
    ...
    static Class251[] method2056(boolean bool) {
        anInt2509++;
        if (bool != false) {
            anInt2511 = 114;
        }
