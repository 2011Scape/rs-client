...
public class Node_Sub25_Sub3 extends Node_Sub25 {
    ...
    private final SetupInfo aSetupInfo9968 = new SetupInfo();
    private final TheoraInfo aTheoraInfo9972 = new TheoraInfo();
    private final TheoraComment aTheoraComment9981 = new TheoraComment();
    ...
    static String method2671(int i, String string) {
        anInt9985++;
        if (string == null) {
            return null;
        }
    ...
    static Class299 method2672(boolean bool, int i) {
        if (!bool) {
            anIntArray9966 = null;
        }
        anInt9977++;
    ...
    static int method2673(int i, boolean bool, int i_6_, boolean bool_7_, int i_8_) {
        if (i <= 54) {
        ...
        int i_9_ = 0;
        for (int i_10_ = 0; (~i_10_) > (~node_sub16.anIntArray7137.length); i_10_++) {
            if (node_sub16.anIntArray7137[i_10_] >= 0 && (~node_sub16.anIntArray7137[i_10_]) > (~EntityNode_Sub3_Sub1.aClass86_9166.anInt1175)) {
    ...
    static boolean method2674(int i, int i_12_, int i_13_) {
        anInt9982++;
        if (i_12_ != 393216) {
            aWidget9990 = null;
        }
        return Class262_Sub16.method3193(i_13_, i, (byte) -109) | (~(i & 0x60000)) != -1 || Class110.method1135(i, i_13_, false) || Class188_Sub1_Sub1.method1894(i, (byte) -29, i_13_);
    }
    ...
    private void method2669(byte b, int i) {
        anInt9975 = i;
        anInt9988++;
        if (aBoolean9991) {
            if ((~anInt9975) < (~anInt9963)) {
                anInt9975 = anInt9963;
            }
            if ((~anInt9975) > -1) {
                anInt9975 = 0;
