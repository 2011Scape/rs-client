...
public class EntityNode_Sub4 extends EntityNode {
    ...
    static EntityNode_Sub4 method963(int i, boolean bool) {
    ...
    private void method957(Class218[] class218s, boolean bool) {
        for (int i = 0; i < 8; i++)
    ...
    private void method960(GraphicsToolkit graphicstoolkit, Class300[] class300s, boolean bool) {
        for (int i = 0; i < 32; i++)
    ...
    private void method966(int i, boolean bool) {
