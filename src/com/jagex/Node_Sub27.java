...
public class Node_Sub27 extends Node {
    ...
    Node_Sub27(Class353 class353, int i) {
        ...
        aClass187_7292 = new Class187(Class240.aSignLink2946.aBoolean4005, Class201.anInt2446, Class263.anInt3336, (~SignLink.osArchitecture.toLowerCase().indexOf("arm")) != 0);
    ...
    Node_Sub27(Buffer buffer, Class353 class353, int i) {
        aClass353_7263 = class353;
        aClass187_7292 = new Class187(Class240.aSignLink2946.aBoolean4005, Class201.anInt2446, Class263.anInt3336, (~SignLink.osArchitecture.indexOf("arm")) != 0);
        aClass320_Sub29_7270 = new Class320_Sub29(i, this);
    ...
    static boolean method2699(int i, int i_8_) {
        if (i != 18) {
            aFloat7310 = -1.5500692F;
        }
        anInt7281++;
        if (i_8_ != 21 && i_8_ != 60 && i_8_ != 23 && (~i_8_) != -18 && (~i_8_) != -45 && (~i_8_) != -5 && i_8_ != 18) {
            return false;
        }
        return true;
    }
    ...
    private void method2688(Buffer buffer, boolean bool) {
        anInt7307++;
    ...
    private void method2689(boolean bool, byte b) {
        anInt7278++;
    ...
    private void method2695(int i) {
        anInt7285++;
        try {
            Field[] fields = this.getClass().getDeclaredFields();
            Field[] fields_1_ = fields;
            for (int i_2_ = 0; (~i_2_) > (~fields_1_.length); i_2_++) {
    ...
    private void method2698(boolean bool, int i, Buffer buffer) {
        anInt7312++;
        aClass320_Sub22_7299 = new Class320_Sub22(buffer.method2233(255), this);
        aClass320_Sub19_7277 = new Class320_Sub19(buffer.method2233(255), this);
        ...
        if ((~i) > -3) {
            ...
            bool_6_ = buffer.method2233(255) == 1;
            if (i >= 17) {
                bool_7_ = (~buffer.method2233(255)) == -2;
            }
        }
