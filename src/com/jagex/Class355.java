...
public class Class355 {
    ...
    static int[] method4014(int i, Node_Sub13 node_sub13) {
        anInt4363++;
    ...
    static void method4017(int i, boolean bool, String string, boolean bool_14_, SignLink signlink) {
        if (i >= -43) {
            aBoolean4366 = false;
        }
        anInt4392++;
    ...
    static void method4019(boolean bool) {
        if (bool == false) {
            anInt4421++;
    ...
    static int method4020(int i, String string) {
        anInt4397++;
        if (string == null) {
            return -1;
        }
    ...
    private void method4015(byte b, Buffer buffer, int i) {
    ...
    final void method4016(int i) {
        ...
        int anInt4415 = (anInt4356 & 0xff0ca5) >> 16;
        anInt4420 = anInt4415 - anInt4383;
        anInt4403 = (anInt4359 & 0xff60) >> 8;
        int anInt4418 = (0xff28 & anInt4356) >> 8;
        if (i == 2) {
            int anInt4351 = anInt4356 & 0xff;
            anInt4400 = -anInt4403 + anInt4418;
            anInt4389 = anInt4359 & 0xff;
            int anInt4370 = anInt4356 >> 24 & 0xff;
            ...
            if (anInt4409 != 0) {
                ...
                class355_10_.anInt4405 = class355_10_.anInt4405 + ((~anInt4405) >= -1 ? 4 : -4);
                anInt4364 = (-(anInt4349 / 2) - anInt4394 + (anInt4409 >> 24 & 0xff) << 8) / anInt4416;
                Class355 class355_11_ = this;
                class355_11_.anInt4422 = class355_11_.anInt4422 + ((~anInt4422) >= -1 ? 4 : -4);
                Class355 class355_12_ = this;
                class355_12_.anInt4410 = class355_12_.anInt4410 + ((~anInt4410) < -1 ? -4 : 4);
                Class355 class355_13_ = this;
                class355_13_.anInt4364 = class355_13_.anInt4364 + ((~anInt4364) >= -1 ? 4 : -4);
            }
        }
    }
