...
public class Class64 implements Interface6 {
    ...
    Class64(PureJavaToolkit purejavatoolkit, GLSprite glsprite, Class131 class131) {
        ...
        if (class131 != null) {
            if (anInt5041 != class131.anInt5446 || (~class131.anInt5445) != (~anInt5037)) {
                throw new RuntimeException();
            }
            aFloatArray5049 = class131.aFloatArray5444;
        }
    }
    ...
    static void method710(byte b, int i) {
        if (b != -90) {
            method712(55);
        }
        anInt5035++;
    ...
    static void method711(GraphicsToolkit graphicstoolkit, int i, int i_0_, int i_1_, int i_2_, int i_3_, byte b, int i_4_) {
        anInt5045++;
