...
public class Class127 {
    ...
    static void method1540(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
        anInt1640++;
        if (i != 3) {
            method1541(103);
        }
        ...
        for (int i_6_ = 0; (~class223s.length) < (~i_6_); i_6_++) {
            ...
            if (class223 != null && (~class223.anInt2654) == -3) {
                ...
                if ((~Class119.anIntArray1516[0]) < 0 && Class174.anInt2092 % 20 < 10) {
    ...
    static void method1542(int i, boolean bool) {
        anInt1643++;
        if (i != 11582) {
            method1541(34);
        }
