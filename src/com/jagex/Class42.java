...
class Class42 {
    ...
    private final Node_Sub9[] aNode_Sub9Array652;
    ...
    static int method444(long l, boolean bool) {
        anInt637++;
        if (bool) {
            return 123;
        }
    ...
    private void method443(int i, int i_0_) {
        anInt655 -= i_0_;
        anInt634++;
        if (i == -26994) {
            if ((~anInt655) > -1) {
    ...
    private void method450(boolean bool, int i, Node_Sub9 node_sub9) {
        anInt636++;
        int i_3_ = i >> 5;
    ...
    final synchronized void method453(byte b) {
        ...
        if (!aBoolean647) {
            ...
            try {
                ...
                for (/**/; (~l) < (~(5000L + aLong641)); l = Class313.method3650(false)) {
                    method443(-26994, 256);
                    aLong641 += 256000 / Class365.anInt4523;
                }
            } catch (Exception exception) {
                aLong641 = l;
            }
    ...
    private void method454(int[] is, int i) {
        int i_6_ = i;
