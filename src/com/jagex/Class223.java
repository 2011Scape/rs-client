		...
		if (Class315.anInt4035 < 400) {
			if (player == Class295.aPlayer3692) {
				if (Class87.aBoolean1185 && (0x10 & Class200_Sub2.anInt4943) != 0) {
					Node_Sub32.method2731(false, -1, 0L, 0, 0, Class84.aString1148, 4, true, Class201.anInt2444, Class66.aString5177 + " -> <col=ffffff>" + Localization.self.getLocalizationString(-12273, Class35.clientLanguage), (long) player.anInt10858, (byte) -18, false);
					Class231.anInt2761++;
				}
			} else {
				String string;
				if (player.anInt11139 == 0) {
					...
					String string_3_ = Class169_Sub4.aClass353_8825 != Class209.aClass353_2483 ? Localization.level.getLocalizationString(-12273, Class35.clientLanguage) : Localization.rating.getLocalizationString(-12273, Class35.clientLanguage);
					...
					string = player.method893(false, true) + " (" + Localization.skill.getLocalizationString(-12273, Class35.clientLanguage) + player.anInt11139 + ")";
				}
				...
				if (!bool) {
					for (int i_4_ = 7; i_4_ >= 0; i_4_--) {
						if (Class320_Sub13.aStringArray8338[i_4_] != null) {
							short s = 0;
							if (Class209.aClass353_2483 == Node_Sub38_Sub34.aClass353_10443 && Class320_Sub13.aStringArray8338[i_4_].equalsIgnoreCase(Localization.attack.getLocalizationString(-12273, Class35.clientLanguage))) {
