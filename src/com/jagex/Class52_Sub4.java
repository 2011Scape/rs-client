...
public class Class52_Sub4 extends Class52 {
    private final byte[][] aByteArrayArray5574;
    private final int[] anIntArray5575;
    private final int[] anIntArray5576;
    private final int[] anIntArray5577;
    private final int[] anIntArray5578;
    ...
    private void method550(byte[] bs, int[] is, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, aa var_aa, int i_9_, int i_10_) {
    ...
    private void method551(byte[] bs, int[] is, int i, int i_44_, int i_45_, int i_46_, int i_47_, int i_48_, int i_49_) {
