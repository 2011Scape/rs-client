...
public class Class169_Sub4 extends Class169 {
    ...
    Class169_Sub4(GLToolkit gltoolkit, int i, int i_0_, byte[] bs, int i_1_) {
        ...
        OpenGL.glTexImage1Dub(anInt4951, 0, anInt4950, i_0_, 0, i_1_, 5121, bs, 0);
    ...
    static void method1787(byte b) {
        ...
        int i_7_ = 0;
        if ((~i_3_) < -4 && (~i_4_) < -4 && -4 + Node_Sub54.anInt7675 > i_3_ && i_4_ < Class377_Sub1.anInt8774 - 4) {
