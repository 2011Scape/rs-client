...
class Class194 {
    ...
    static void method1960(int i, String[] strings) {
        if (i != -32416) {
    ...
    static int method1961(int i, int i_2_, int i_3_) {
        anInt2376++;
    ...
    static void method1962(int i, int i_9_, int i_10_, int i_11_, int i_12_, boolean bool) {
        anInt2371++;
        if (i_11_ > 13) {
            ...
            if (i_10_ == 3 && DrawableModel.aFrame907 == null) {
                ...
                if (Node_Sub38_Sub1.aClass329_10086 != Class240.aClass329_2943) {
                    if ((~Class360.windowWidth) > -1025 && Class205.anInt5115 < 768) {
                        /* empty */
                    }
                }
                if (bool) {
