...
class Class194
{
	...
	static final int method1961(int i, int i_2_, int i_3_) {
		...
		if ((i_2_ ^ 0xffffffff) != (Class213.aNode_Sub27_2512.aClass320_Sub29_7270.method3791(false) ^ 0xffffffff)) {
			Class356.method4024(true, true, Localization.profiling.getLocalizationString(-12273, Class35.clientLanguage), i_2_);
		...
		try {
			...
			Class169_Sub3.method1779(Class93.aGraphicsToolkit1241, Localization.profiling.getLocalizationString(-12273, Class35.clientLanguage), true, Class169_Sub3.aClass357_8820, StandardSprite.aClass52_8945, -16777216);
