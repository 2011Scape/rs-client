...
public class Node_Sub9_Sub4 extends Node_Sub9 {
    ...
    static Class116 method2521(Buffer buffer, int i) {
        if (i != -30746) {
            anInt9732 = -68;
        }
        anInt9726++;
    ...
    static boolean method2522(int i, int i_5_, int i_6_) {
        anInt9737++;
        if (i != 0) {
    ...
    static GLSprite method2523(byte b, int i, Class302 class302) {
        if (b < 89) {
            return null;
        }
        anInt9728++;
    ...
    private void method2520(Node_Sub10 node_sub10, int i, int i_1_) {
        if ((~(0x4 & aNode_Sub9_Sub1_9734.anIntArray9680[node_sub10.anInt7080])) != -1 && (~node_sub10.anInt7100) > -1) {
            ...
            if ((~i_3_) >= (~i_1_)) {
                if ((~aNode_Sub9_Sub1_9734.anIntArray9659[node_sub10.anInt7080]) == -1) {
    ...
    private void method2525(int[] is, Node_Sub10 node_sub10, int i, int i_7_, int i_8_, int i_9_) {
        if (i_9_ != 12073) {
            anInt9733 = 44;
        }
        if ((~(0x4 & aNode_Sub9_Sub1_9734.anIntArray9680[node_sub10.anInt7080])) != -1 && node_sub10.anInt7100 < 0) {
