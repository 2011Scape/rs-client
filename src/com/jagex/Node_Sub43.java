...
public class Node_Sub43 extends Node {
    ...
    static void method2941(int i, long l) {
        anInt7536++;
        if (i == 6) {
    ...
    final int[] method2937(int i) {
        ...
        if (anIntArray7535 == null) {
            ...
            for (int i_0_ = 0; (~anInt7531) < (~i_0_); i_0_++) {
    ...
    final void method2938(byte b, Class24 class24) {
        ...
        if (aClass24Array7533 == null || (~aClass24Array7533.length) >= (~anInt7531)) {
    ...
    private void method2939(int i, Buffer buffer) {
        anInt7545++;
    ...
    private void method2940(byte b, int i) {
        if (b == -79) {
            anInt7528++;
    ...
    final int method2943(String string, byte b) {
        anInt7529++;
        int i = 82 / ((b + 25) / 60);
        for (int i_5_ = 0; (~anInt7531) < (~i_5_); i_5_++) {
