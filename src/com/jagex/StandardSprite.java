...
public class StandardSprite extends GLSprite {
    ...
    StandardSprite(AbstractToolkit abstracttoolkit, int i, int i_99_, boolean bool) {
        ...
        aBoolean8936 = (~anInterface13_Impl1_8925.method44(19809)) != (~i);
        aBoolean8941 = (~anInterface13_Impl1_8925.method46((byte) 122)) != (~i_99_);
    ...
    static void method1213(int i, Packet packet) {
        anInt8919++;
    ...
    static boolean method1215(int i, int i_86_, int i_87_) {
        if (i != -30061) {
    ...
    private void method1212(int i, int i_0_, int i_1_, int i_2_, int[] is, int i_3_, int i_4_) {
    ...
    final void method1178(int i, int i_5_, int i_6_, int i_7_) {
        ...
        anInt8922 = i_7_;
        anInt8929 = i;
        aBoolean8933 = anInt8929 != 0 || anInt8939 != 0 || anInt8940 != 0 || (~anInt8922) != -1;
    }
    ...
    final void method1183(int i, int i_24_, int i_25_, int i_26_, int i_27_, int i_28_, int i_29_) {
        ...
        boolean bool_31_ = aBoolean8916 && (~anInt8929) == -1 && anInt8940 == 0;
        if (bool_31_ & bool) {
            ...
            for (int i_42_ = i_41_ + anInt8915; (~i_37_) <= (~i_42_); i_42_ += i_40_) {
        ...
        if ((~i_72_) != -1) {
            if (i_72_ == 1) {
                for (int i_74_ = 0; i_74_ < anInt8915; i_74_++) {
                    ...
                    for (int i_76_ = 0; (~i_76_) > (~anInt8942); i_76_++)
                ...
                for (int i_77_ = 0; i_77_ < anInt8915; i_77_++) {
                    ...
                    for (int i_79_ = 0; (~i_79_) > (~anInt8942); i_79_++)
                ...
                for (int i_80_ = 0; (~i_80_) > (~anInt8915); i_80_++) {
                    int i_81_ = i_80_ * anInt8942;
                    for (int i_82_ = 0; (~anInt8942) < (~i_82_); i_82_++)
    ...
    final void method1188(float f, float f_88_, float f_89_, float f_90_, float f_91_, float f_92_, int i, aa var_aa, int i_93_, int i_94_) {
        ...
        aa_Sub2 var_aa_Sub2 = (aa_Sub2) var_aa;
        Interface13_Impl1 interface13_impl1 = var_aa_Sub2.anInterface13_Impl1_5489;
        anInterface13_Impl1_8925.method41((byte) -117, aBoolean8936 || aBoolean8941 || (~(0x1 & i)) == -1 ? Class194.aClass228_2377 : Node_Sub38_Sub5.aClass228_10123);
        anAbstractToolkit8935.method1323((byte) 28);
        anAbstractToolkit8935.method1312((byte) -21, anInterface13_Impl1_8925);
        anAbstractToolkit8935.method1277((byte) 61, 1);
        anAbstractToolkit8935.method1278((byte) -12, 1);
    ...
    final void method1194(float f, float f_100_, float f_101_, float f_102_, float f_103_, float f_104_, int i, int i_105_, int i_106_, int i_107_) {
        ...
        anInterface13_Impl1_8925.method41((byte) -124, aBoolean8936 || aBoolean8941 || (~(i_107_ & 0x1)) == -1 ? Class194.aClass228_2377 : Node_Sub38_Sub5.aClass228_10123);
        anAbstractToolkit8935.method1323((byte) 28);
        anAbstractToolkit8935.method1312((byte) -21, anInterface13_Impl1_8925);
