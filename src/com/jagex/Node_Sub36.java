...
abstract class Node_Sub36 extends Node {
    ...
    static void method2750(boolean bool, int i, int i_0_, int i_1_) {
        anInt7422++;
        int i_2_ = i_1_ + Node_Sub53.anInt7668;
        int i_3_ = Class320_Sub4.anInt8243 + i_0_;
        if (Class175.aClass261ArrayArrayArray2099 != null && (~i_1_) <= -1 && (~i_0_) <= -1 && i_1_ < Node_Sub54.anInt7675 && Class377_Sub1.anInt8774 > i_0_ && ((~Class213.aNode_Sub27_2512.aClass320_Sub19_7301.method3751(bool)) != -1 || i == Class295.aPlayer3692.aByte5933)) {
            long l = (long) i_3_ << 14 | (long) i << 28 | i_2_;
    ...
    static void method2752(boolean bool, boolean bool_7_) {
        anInt7424++;
    ...
    static int method2753(byte b, Class68 class68) {
        anInt7426++;
    ...
    static void method2754(Animator animator, DrawableModel drawablemodel, Animator animator_8_, byte b) {
    ...
    static int method2757(int i, int i_10_, byte b) {
        anInt7425++;
