...
public class Class262_Sub23 extends Class262 {
    ...
    static void method3212(boolean bool, int i) {
    ...
    static Class123 method3213(byte b) {
        if (b >= -52) {
            return null;
        }
        anInt7890++;
    ...
    static int method3214(int i, int i_0_) {
        if (i_0_ != -20139) {
            return -83;
        }
        anInt7894++;
            ...
            if (i_4_ != 80) {
                if ((~i_4_) != -67 || (i_5_ & 0x4) == 0) {
                    if ((~i_4_) == -68 && (~(i_5_ & 0x4)) != -1) {
                        ...
                        Class315.anInt4034--;
                    } else if ((~i_4_) == -102 && (~Class315.anInt4034) > (~Node_Sub10.aString7081.length())) {
                        ...
                        if ((~i_4_) == -98 && Class315.anInt4034 < Node_Sub10.aString7081.length()) {
                            Class315.anInt4034++;
                        } else if ((~i_4_) != -103) {
                            if (i_4_ != 103) {
                                if ((~i_4_) != -105 || Class210.aStringArray2502.length <= Class332.anInt4145) {
                                    if ((~i_4_) == -106 && Class332.anInt4145 > 0) {
                                        Class332.anInt4145--;
