...
public class Class257 {
    ...
    static Class192 aClass192_3245 = new Class192(49, 1);
    ...
    static void method3121(int i, boolean bool, int i_0_) {
        anInt3242++;
        ...
        node_sub13.aPacket7113.method2207(21226, i);
        Class218.worldResponseBuffer.method1514(127, node_sub13);
    }

    static void method3122(int i, int i_2_, int i_3_, int i_4_, int i_5_) {
        anInt3247++;
