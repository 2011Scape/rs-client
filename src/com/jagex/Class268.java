...
public class Class268 {
    ...
    static Class49 method3290(boolean bool, byte b, GraphicsToolkit graphicstoolkit, boolean bool_0_, int i) {
        anInt3452++;
        if ((~i) == 0) {
            return null;
        }
        if (Class291.anIntArray3665 != null) {
            for (int i_1_ = 0; (~Class291.anIntArray3665.length) < (~i_1_); i_1_++) {
                if (Class291.anIntArray3665[i_1_] == i) {
                    return Node_Sub5_Sub2.aClass49Array9413[i_1_];
                }
            }
        }
        Class49 class49 = (Class49) Class335.aClass61_4161.method607((bool ? 1 : 0) | (long) i << 1, b - 75);
        if (class49 != null) {
    ...
    static Class150_Sub2 method3291(byte b, Buffer buffer) {
        anInt3464++;
    ...
    static void method3292(byte b, byte[] bs) {
        anInt3463++;
                ...
                if ((~i) != -5) {
                    if ((~i) == -6) {
                        ...
                        for (int i_4_ = 0; i_3_ > i_4_; i_4_++) {
                            ...
                            if ((~Class83.anIntArray5188[i_4_]) == -65536) {
