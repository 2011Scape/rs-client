...
public class Class31 {
    ...
    private static int method344(int[] is, int i) {
        int i_0_ = is[i];
        int i_1_ = -1;
        int i_2_ = -2147483648;
    ...
    private static int method346(int[] is, int i) {
        int i_21_ = is[i];
        int i_22_ = -1;
    ...
    private int method347(int i, int i_26_, int i_27_, int i_28_, int i_29_) {
    ...
    final boolean method348() {
        ...
        System.arraycopy(anIntArray503, 0, anIntArray502, 0, i);
    ...
    private void method350(int i, int i_47_, int i_48_, int i_49_, float[] fs, int i_50_) {
    ...
    private void method351(int i, int i_59_) {
        if (i < i_59_) {
            int i_60_ = i;
