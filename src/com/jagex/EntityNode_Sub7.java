...
public class EntityNode_Sub7 extends EntityNode {
    ...
    static void method973(byte b, Player player, int i, int i_0_) {
        anInt5997++;
        int[] is = new int[4];
    ...
    static void method978(int i, int i_45_) {
        anInt6002++;
        CacheNode_Sub2 cachenode_sub2 = Class320_Sub19.method3754(3, 7, i_45_);
    ...
    final void method974(int i, byte b, boolean bool, long l, GraphicsToolkit graphicstoolkit) {
        if (!aBoolean6012) {
            if ((~aClass355_6011.anInt4379) < (~Node_Sub39.anInt7498)) {
                bool = false;
            } else if (Class94.anIntArray1247[Node_Sub39.anInt7498] >= CacheNode_Sub12.anInt9555) {
                if (!aBoolean6020) {
                    if ((~aClass355_6011.anInt4411) != 0) {
                        ...
                        if (aClass355_6011.aBoolean4375 && (~aClass355_6011.anInt4361) >= (~i_1_)) {
                            bool = false;
                        }
                    }
                } else {
        ...
        if (bool) {
            ...
            if ((~i_2_) != (~aClass143_6005.anInt1767) || i_3_ != aClass143_6005.anInt1776 || (~aClass143_6005.anInt1769) != (~i_4_)) {
                ...
                for (anInt6021 = -(i_10_ * i_5_) + i_8_ * i_7_; (~anInt6018) < -32768 || (~anInt6021) < -32768 || (~anInt6022) < -32768 || anInt6018 < -32767 || anInt6021 < -32767 || (~anInt6022) > 32766; anInt6021 >>= 1) {
                    anInt6022 >>= 1;
                    anInt6018 >>= 1;
                }
                int i_11_ = (int) Math.sqrt(anInt6018 * anInt6018 - (-(anInt6021 * anInt6021) - (anInt6022 * anInt6022)));
                if (i_11_ <= 0) {
                    i_11_ = 1;
                }
                ...
                if (aClass355_6011.aShort4369 > 0 || (~aClass355_6011.aShort4382) < -1) {
                    int i_12_ = (int) (2607.5945876176133 * Math.atan2(anInt6022, anInt6018));
                    int i_13_ = (int) (Math.atan2(anInt6021, Math.sqrt(anInt6018 * anInt6018 + anInt6022 * anInt6022)) * 2607.5945876176133);
    ...
    final void method977(byte b) {
        ...
        aClass143_6005.anInt1777 = aClass300_6003.anInt3769;
        aClass143_6005.anInt1765 = aClass300_6003.anInt3752;
        if (aClass143_6005.anInt1779 != aClass143_6005.anInt1777 || aClass143_6005.anInt1774 != aClass143_6005.anInt1779 || aClass143_6005.anInt1778 != aClass143_6005.anInt1781 || (~aClass143_6005.anInt1781) != (~aClass143_6005.anInt1765) || (~aClass143_6005.anInt1766) != (~aClass143_6005.anInt1775) || aClass143_6005.anInt1772 != aClass143_6005.anInt1775) {
            if (aBoolean6020) {
                aClass143_6014.anInt1778 = aClass143_6005.anInt1778;
                aClass143_6014.anInt1766 = aClass143_6005.anInt1766;
                aClass143_6014.anInt1777 = aClass143_6005.anInt1777;
