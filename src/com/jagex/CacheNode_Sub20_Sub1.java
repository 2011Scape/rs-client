...
public class CacheNode_Sub20_Sub1 extends CacheNode_Sub20 {
    ...
    static float method2412(byte b, float f, float f_0_, int i, float f_1_, float f_2_, float f_3_, float f_4_) {
        anInt11090++;
        float f_5_ = 0.0F;
        float f_6_ = -f + f_4_;
        ...
        while (f_5_ < 1.1F) {
            ...
            if ((~i_15_) < -1 && (~i_16_) < -1 && Node_Sub54.anInt7675 > i_15_ && (~i_16_) > (~Class377_Sub1.anInt8774)) {
                int i_17_ = Class295.aPlayer3692.aByte5933;
                if (i_17_ < 3 && (~(CacheNode_Sub11.aByteArrayArrayArray9550[1][i_15_][i_16_] & 0x2)) != -1) {
                    i_17_++;
                }
    ...
    static void method2413(boolean bool, int i, String string) {
        anInt11088++;
