...
public class Player extends Actor {
    ...
    static void method892(int i, int i_77_) {
    ...
    final void method820(GraphicsToolkit graphicstoolkit, int i) {
        ...
        if (aPlayerDefinition11137 != null && (aBoolean10906 || method890(0, -119, graphicstoolkit))) {
            ...
            for (int i_0_ = 0; (~i_0_) > (~aDrawableModelArray10909.length); i_0_++)
    ...
    private void method883(byte b, int i, int i_3_, int i_4_, DrawableModel drawablemodel, Class336 class336, GraphicsToolkit graphicstoolkit, int i_5_) {
        anInt11159++;
        if (b != -74) {
            method820(null, 41);
        }
    ...
    final boolean method810(int i, int i_9_, boolean bool, GraphicsToolkit graphicstoolkit) {
        ...
        for (int i_12_ = 0; (~i_12_) > (~aDrawableModelArray10909.length); i_12_++) {
    ...
    private void method885(DrawableModel drawablemodel, int i, byte b, GraphicsToolkit graphicstoolkit, int i_16_, int i_17_, Class336 class336, int i_18_, int i_19_) {
        anInt11174++;
    ...
    final int method853(byte b) {
        anInt11146++;
        if (aPlayerDefinition11137 != null && (~aPlayerDefinition11137.anInt3439) != 0) {
    ...
    final EntityNode_Sub6 method807(int i, GraphicsToolkit graphicstoolkit) {
        ...
        if (class261 != null && class261.anAnimable_Sub1_3317 != null) {
            ...
            anInt10849 -= (int) ((float) i_31_ / 10.0F);
        } else {
            anInt10849 -= (int) ((float) anInt10849 / 10.0F);
        }
        ...
        if (Class295.aPlayer3692 == this) {
            for (int i_33_ = Class320_Sub24.aClass223Array8438.length - 1; (~i_33_) <= -1; i_33_--) {
        ...
        for (int i_44_ = 0; (~i_44_) > (~aDrawableModelArray10909.length); i_44_++) {
    ...
    final void method889(Buffer buffer, int i) {
        ...
        aBoolean11131 = (~buffer.method2214((byte) 32)) == -2;
        ...
        for (int i_58_ = i; (~i_58_) > -11; i_58_++) {
        ...
        if ((~anInt11164) == -1) {
            ...
            if (aBoolean11149 == !bool || (~anInt11164) != (~i_60_) || i_61_ != anInt11167 || (~i_62_) != (~anInt11172) || anInt11153 != i_63_ || (~anInt11182) != (~i_64_) || i_65_ != anInt11173) {
        ...
        aPlayerDefinition11137.method3278(is_57_, is, class38s, i_48_, method871(0), (~aByte11150) == -2, (byte) -110);
        if (i_48_ != i_66_) {
    ...
    private boolean method890(int i, int i_69_, GraphicsToolkit graphicstoolkit) {
        anInt11144++;
        int i_70_ = i;
        if (i_69_ >= -110) {
            return true;
        ...
        boolean bool = aByte10888 != 0 && (~Class174.anInt2092) <= (~anInt10895) && Class174.anInt2092 < anInt10882;
        if (bool) {
            i |= 0x80000;
        }
    ...
    final String method893(boolean bool, boolean bool_79_) {
        ...
        int[] is;
        if ((~aByte11150) == -2 && Class83.anIntArray5188 != null) {
            is = Class83.anIntArray5188;
        } else {
            is = InputStream_Sub1.anIntArray77;
        }
        if (is != null && (~is[aByte11145]) != 0) {
    ...
    final Class59 method869(int i) {
        ...
        if (aClass59_10861 != null) {
            ...
            if ((~Class69.anInt943) == -1 || (~Class69.anInt943) == -4 || Class69.anInt943 == 1 && Class193.method1955(i + 3109, aString11142)) {
    ...
    final void method894(int i, int i_80_, int i_81_, byte b) {
        if (anAnimator10876.method245(-126) && (~anAnimator10876.method243((byte) -24).anInt718) == -2) {
            anIntArray10817 = null;
            anAnimator10876.method249(true, -1);
        }
        anInt11143++;
        for (int i_82_ = 0; (~i_82_) > (~aClass165Array10886.length); i_82_++) {
            if ((~aClass165Array10886[i_82_].anInt2030) != 0) {
        ...
        anInt11180 = -1;
        if (i_80_ >= 0 && (~Node_Sub54.anInt7675) < (~i_80_) && (~i) <= -1 && (~Class377_Sub1.anInt8774) < (~i)) {
            if ((~anIntArray10910[0]) > -1 || (~anIntArray10910[0]) <= (~Node_Sub54.anInt7675) || anIntArray10908[0] < 0 || (~Class377_Sub1.anInt8774) >= (~anIntArray10908[0])) {
