...
public class Mobile_Sub4 extends Mobile {
    ...
    static void method913(int i, String string, boolean bool) {
        anInt10973++;
        ...
        for (int i_22_ = i_20_; i_22_ < i_21_; i_22_++) {
            ...
            if (cachenode_sub10.aBoolean9521 && (~cachenode_sub10.method2332(-19244).toLowerCase().indexOf(string)) != 0) {
                ...
                if ((~i_19_) <= (~ses.length)) {
                    ...
                    if (i_19_ >= 0) System.arraycopy(ses, 0, ses_23_, 0, i_19_);
                    ses = ses_23_;
                }
    ...
    static void method915(int i, Class54 class54, int i_27_, GraphicsToolkit graphicstoolkit) {
        ...
        } else if (class54.aByte822 == i_27_ || (~class54.aByte822) == -9) {
    ...
    private void method907(Class336 class336, DrawableModel drawablemodel, int i, GraphicsToolkit graphicstoolkit) {
    ...
    private DrawableModel method908(int i, int i_0_, GraphicsToolkit graphicstoolkit, int i_1_) {
        anInt10984++;
    ...
    final EntityNode_Sub6 method807(int i, GraphicsToolkit graphicstoolkit) {
        anInt10990++;
        DrawableModel drawablemodel = method908(14437, anInt10979, graphicstoolkit, ((~anInt10976) == -1 ? 0 : 5) | 0x800);
        if (drawablemodel == null) {
            return null;
        }
        if (anInt10976 != 0) {
