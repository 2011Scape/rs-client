...
public class aa_Sub3 extends aa {
    ...
    static void method162(int i, int i_0_, byte[] bs, int i_1_, int i_2_, int i_3_, byte[] bs_4_, int i_5_, int i_6_) {
        anInt5492++;
        int i_7_ = -(i_5_ >> 2);
        i_5_ = -(i_3_ & i_5_);
        for (int i_8_ = -i_1_; (~i_8_) > -1; i_8_++) {
            for (int i_9_ = i_7_; i_9_ < 0; i_9_++) {
                bs[i_2_++] += (byte) -bs_4_[i_0_++];
                bs[i_2_++] += (byte) -bs_4_[i_0_++];
                bs[i_2_++] += (byte) -bs_4_[i_0_++];
                bs[i_2_++] += (byte) -bs_4_[i_0_++];
            }
