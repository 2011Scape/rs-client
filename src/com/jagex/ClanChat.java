...
public class ClanChat {
    ...
    static boolean method494(byte b, int i, int i_11_) {
        anInt728++;
        if (b != 14) {
            return true;
        }
    ...
    static void method507(Throwable throwable, String string, int i) {
        if (i > -105) {
            aClass151_756 = null;
        }
        anInt766++;
    ...
    private void method487(byte b, int i) {
        if (aBoolean758) {
    ...
    final void method488(int i, String string, long l, int i_8_) {
        ...
        if (l > 0L && (aLongArray768 == null || anInt734 >= aLongArray768.length) || string != null && (aStringArray740 == null || (~aStringArray740.length) >= (~anInt734))) {
    ...
    final Long method489(byte b, int i) {
        ...
        Node node = aHashTable735.method1518(3512, i);
        if (b != -24) {
        ...
        return Long.valueOf(((Node_Sub44) node).aLong7550);
    }
    ...
    final boolean method492(String string, int i, boolean bool) {
        ...
        if (aHashTable735 != null) {
            Node node = aHashTable735.method1518(3512, i);
            if (node != null) {
                if (node instanceof Node_Sub18 node_sub18) {
        ...
        aHashTable735.method1515(i, new Node_Sub18(string), -125);
        return true;
    }

    private void method493(byte b) {
        anInt730++;
        if ((~anInt734) == -1) {
            anInt749 = -1;
            anInt765 = -1;
            ...
            if (b <= -115) {
                ...
                for (int i_10_ = 1; i_10_ < anInt734; i_10_++) {
                    if (b_9_ >= aByteArray770[i_10_]) {
                        if (anInt749 == -1 && (~aByteArray770[i_10_]) == -126) {
                            anInt749 = i_10_;
                        }
                    } else {
                        if (b_9_ == 125) {
    ...
    final String method495(int i, int i_12_) {
        ...
        Node node = aHashTable735.method1518(3512, i_12_);
    ...
    final void method497(String string, long l, int i) {
        ...
        if (l > 0L && (aLongArray753 == null || (~aLongArray753.length) >= (~anInt739)) || string != null && (aStringArray769 == null || (~anInt739) <= (~aStringArray769.length))) {
    ...
    final int[] method498(int i) {
        ...
        if (anIntArray771 == null) {
            ...
            for (int i_16_ = 0; (~anInt734) < (~i_16_); i_16_++) {
    ...
    final boolean method499(byte b, int i, long l) {
        ...
        if (aHashTable735 == null) {
            ...
            Node node = aHashTable735.method1518(3512, i);
            if (node != null) {
                if (node instanceof Node_Sub44 node_sub44) {
        ...
        aHashTable735.method1515(i, new Node_Sub44(l), -127);
        return true;
    }
    ...
    final int method500(byte b, byte b_17_, int i) {
        ...
        if (anInt765 == i && ((~anInt749) == 0 || (~aByteArray770[anInt749]) > -126)) {
            return -1;
        }
    ...
    final Integer method501(int i, int i_18_) {
        ...
        return Integer.valueOf(((Node_Sub32) node).anInt7381);
    }
    ...
    private void method503(int i, byte b) {
        if (aBoolean758) {
            if (aLongArray753 != null) {
    ...
    final boolean method504(int i, int i_19_, int i_20_, int i_21_, int i_22_) {
        ...
        if (aHashTable735 == null) {
            ...
            Node node = aHashTable735.method1518(3512, i_21_);
            if (node != null) {
                if (node instanceof Node_Sub32 node_sub32) {
        ...
        aHashTable735.method1515(i_21_, new Node_Sub32(i_20_), -126);
        return true;
    }

    private void method505(int i, Buffer buffer) {
        anInt725++;
        ...
        aBoolean750 = (~buffer.method2233(255)) == -2;
        ...
        if (anInt734 > 0) {
            ...
            for (int i_28_ = 0; (~anInt734) < (~i_28_); i_28_++) {
                if (aBoolean758) {
        ...
        if (anInt739 > 0) {
            if (aBoolean758 && (aLongArray753 == null || (~aLongArray753.length) > (~anInt739))) {
            ...
            if (i_30_ > 0) {
                ...
                while ((~i_30_--) < -1) {
                    ...
                    if ((~i_33_) == -1) {
                        ...
                        aHashTable735.method1515(i_32_, new Node_Sub32(i_34_), -124);
                    } else if ((~i_33_) == -2) {
                        long l = buffer.method2235(-2023329376);
                        aHashTable735.method1515(i_32_, new Node_Sub44(l), -123);
                    } else if ((~i_33_) == -3) {
                        String string = buffer.method2195(-1);
                        aHashTable735.method1515(i_32_, new Node_Sub18(string), -127);
                    }
                }
            }
        }
    ...
    final Integer method506(byte b, int i, int i_35_, int i_36_) {
        ...
        return Integer.valueOf((((Node_Sub32) node).anInt7381 & i_37_) >>> i_36_);
    }
    ...
    final boolean method509(int i, int i_43_, int i_44_) {
        ...
        if (aHashTable735 == null) {
            ...
            Node node = aHashTable735.method1518(i_44_ ^ ~0xf90, i_43_);
            if (node != null) {
                if (node instanceof Node_Sub32 node_sub32) {
        ...
        aHashTable735.method1515(i_43_, new Node_Sub32(i), -127);
        return true;
    }
}
