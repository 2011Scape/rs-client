...
public class SeekableFile {
    ...
    static int method3569(int i, int i_11_, int i_12_, int i_13_, int i_14_) {
        anInt3877++;
        int i_15_ = i - Class335.anIntArray4165[i_14_ * 8192 / i_11_] >> 1;
        return (i_15_ * i_13_ >> 16) + (i_12_ * (-i_15_ + 65536) >> 16);
    }

    static boolean method3571(byte b, int i, int i_21_) {
        anInt3889++;
        if (b != 61) {
            method3578(13);
        }
    ...
    final void method3568(int i, int i_0_, byte[] bs, int i_1_) throws IOException {
        ...
        try {
            ...
            if ((~aLong3895) != 0L && (~aLong3878) <= (~aLong3895) && (~((long) i_0_ + aLong3878)) >= (~((long) anInt3880 + aLong3895))) {
            ...
            int i_2_ = i_1_;
            int i_3_ = i_0_;
            if (aLong3878 >= aLong3893 && (~aLong3878) > (~(aLong3893 - -(long) anInt3891))) {
            ...
            if ((~aLong3895) != 0L) {
                ...
                long l_8_ = -1L;
                if (l > aLong3895 || (~aLong3895) <= (~(l - -(long) i_3_))) {
                    if (aLong3895 <= l && (~(aLong3895 + (long) anInt3880)) < (~l)) {
                        l_8_ = l;
                    }
                } else {
                    l_8_ = aLong3895;
                ...
                if (l >= aLong3895 + (long) anInt3880 || (long) i_3_ + l < aLong3895 + (long) anInt3880) {
                    if ((~aLong3895) > (~(l - -(long) i_3_)) && (~((long) anInt3880 + aLong3895)) <= (~(l - -(long) i_3_))) {
                        l_9_ = (long) i_3_ + l;
                    }
                } else {
    ...
    final void method3570(int i, int i_16_, int i_17_, byte[] bs) throws IOException {
        ...
        try {
            ...
            if ((~aLong3895) != 0L && ((~aLong3895) < (~aLong3878) || (long) anInt3880 + aLong3895 < aLong3878)) {
                method3576(true);
            }
            if ((~aLong3895) != 0L && aLong3895 + (long) aByteArray3894.length < aLong3878 + (long) i_17_) {
            ...
            if (i_17_ > aByteArray3894.length) {
                ...
                if (aLong3893 > aLong3878 || aLong3878 >= (long) anInt3891 + aLong3893) {
                    if ((~aLong3878) >= (~aLong3893) && (long) i_17_ + aLong3878 > aLong3893) {
                        l = aLong3893;
                    }
                } else {
                    l = aLong3878;
            ...
            if (i_17_ > 0) {
                ...
                aLong3878 += (long) i_17_;
                if ((~((long) anInt3880)) > (~(aLong3878 + -aLong3895))) {
    ...
    private void method3572(byte b) throws IOException {
        anInt3886++;
        anInt3891 = 0;
        if (b > -119) {
            anInt3880 = -97;
        ...
        aLong3893 = aLong3878;
        while ((~anInt3891) > (~aByteArray3885.length)) {
    ...
    private void method3576(boolean bool) throws IOException {
        if (bool != true) {
            aLong3888 = 87L;
        }
        if ((~aLong3895) != 0L) {
            if ((~aLong3895) != (~aLong3887)) {
            ...
            long l = -1L;
            long l_23_ = -1L;
            if ((~aLong3893) >= (~aLong3895) && (~aLong3895) > (~(aLong3893 + (long) anInt3891))) {
                l = aLong3895;
            } else if (aLong3893 >= aLong3895 && (~((long) anInt3880 + aLong3895)) < (~aLong3893)) {
                l = aLong3893;
            }
            if (aLong3893 >= aLong3895 + (long) anInt3880 || (long) anInt3891 + aLong3893 < aLong3895 + (long) anInt3880) {
                if (aLong3895 < aLong3893 + (long) anInt3891 && (~((long) anInt3880 + aLong3895)) <= (~(aLong3893 - -(long) anInt3891))) {
