...
public class Node_Sub38_Sub12 extends Node_Sub38 {
    ...
    static Animable_Sub2 method2830(int i, int i_30_, int i_31_) {
    ...
    final int[][] method2778(int i, boolean bool) {
        ...
        if (aClass348_7454.aBoolean4300) {
            ...
            for (int i_5_ = -anInt10229 + i; (~(i + anInt10229)) <= (~i_5_); i_5_++) {
                ...
                int[] is_12_ = is_6_[1];
                int[] is_13_ = is_6_[2];
                for (int i_14_ = -anInt10224; (~i_14_) >= (~anInt10224); i_14_++) {
            ...
            for (int i_24_ = 0; i_24_ < Class339_Sub7.anInt8728; i_24_++) {
                ...
                int i_26_ = 0;
                int i_27_ = 0;
                for (int i_28_ = 0; (~i_0_) < (~i_28_); i_28_++) {
    ...
    final int[] method2775(int i, int i_32_) {
        ...
        if (aClass146_7460.aBoolean1819) {
            ...
            for (int i_44_ = 0; (~i_44_) > (~Class339_Sub7.anInt8728); i_44_++) {
                int i_45_ = 0;
                for (int i_46_ = 0; (~i_33_) < (~i_46_); i_46_++)
