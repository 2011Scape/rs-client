...
public class Class369 {
    ...
    static int method4083(boolean bool) {
        if (bool != false) {
            aBoolean4555 = false;
        }
        anInt4565++;
    ...
    static boolean method4085(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
        anInt4561++;
        ...
        if ((~Class374.method4113(i, -1145, i_2_, i_3_)) == (~i_1_)) {
            return true;
        }
        return false;
    }

    static void method4086(int i, int i_4_, int i_5_, int[] is, int i_6_) {
        anInt4554++;
        i_5_--;
        if (i_6_ != 0) {
            method4084((byte) 88);
