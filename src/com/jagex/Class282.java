...
public class Class282 {
    ...
    static void method3385(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, boolean bool, int i_6_) {
        anInt3582++;
        if (!CacheNode_Sub15.method2379(7015, i)) {
            ...
            if (Class79.aWidgetArrayArray1082[i] == null) {
                ...
                Node_Sub6.method2416(-1, i_5_, Class79.aWidgetArrayArray1082[i], i_0_, i_2_, i_6_, i_4_, (~i_4_) > -1, 27, i_1_, i_3_);
            }
            if (Class71.aBoolean967) {
    ...
    static void method3386(int i, byte b) {
    ...
    static void method3387(int i, int i_13_) {
        anInt3586++;
