...
public class Class258 implements Interface12 {
    ...
    private final String aString5286;
    private final Class302 aClass302_5287;
    ...
    static void method3124(int i, int i_0_, int[] is, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
        anInt5294++;
    ...
    static void method3126(int i, Buffer buffer, SignLink signlink, int i_26_) {
        anInt5295++;
        if (i != -9821) {
