...
public class Node_Sub38_Sub1 extends Node_Sub38 {
    ...
    static void method2788(int i, int i_0_, int i_1_) {
        anInt10077++;
    ...
    static void method2789(int i, byte b, int i_12_, int i_13_, Node_Sub8 node_sub8) {
        anInt10074++;
    ...
    static void method2791(int i, int i_17_) {
        anInt10076++;
        int i_18_ = 8 / ((i - 65) / 43);
        if ((~i_17_) == -38) {
    ...
    static boolean method2792(int i, int i_21_, int i_22_) {
        if (i_22_ != -1) {
            method2791(22, 59);
        }
        anInt10088++;
    ...
    final int[][] method2778(int i, boolean bool) {
        ...
        if (aClass348_7454.aBoolean4300) {
            int i_3_ = ((~anInt10079) == (~anInt10083) ? i : i * anInt10079 / anInt10083) * anInt10090;
            int[] is_4_ = is[0];
            int[] is_5_ = is[1];
            int[] is_6_ = is[2];
            if ((~anInt10090) != (~Class339_Sub7.anInt8728)) {
