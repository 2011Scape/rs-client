...
public class Class326 {
    ...
    Class326(GraphicsToolkit graphicstoolkit, Buffer buffer, int i) {
        if (CacheNode_Sub20.anIntArray9628 == null) {
            Class181.method1826((byte) -115);
        }
        anInt4092 = buffer.method2233(255);
        aBoolean4090 = (0x10 & anInt4092) != 0;
        aBoolean4102 = (~(anInt4092 & 0x8)) != -1;
        ...
        for (int i_21_ = 0; (~aShortArray4105.length) < (~i_21_); i_21_++) {
            ...
            if ((~i_24_) < (~(-i_23_ + i_20_))) {
                i_24_ = i_20_ - i_23_;
            }
            aShortArray4105[i_21_] = (short) Node_Sub16.method2590(i_24_, i_23_ << 8);
        }
        i_19_ = (i_19_ << Class36.anInt549) + Class135.anInt1692;
        int i_25_ = Class85.anIntArray1158 != null ? Class85.anIntArray1158[buffer.method2219(-130546744)] : Class170.anIntArray2054[0xffff & Node_Sub15_Sub2.method2560(5310, buffer.method2219(-130546744))];
    ...
    static int method3817(boolean bool, long l) {
    ...
    static String method3818(long l, byte b, int i) {
        anInt4101++;
        Node_Sub43.method2941(6, l);
        if (b != 73) {
            method3815(49);
    ...
    static void method3820(int i) {
        ...
        if (i <= -73) {
            ...
            Class305.aClass61_3867.method598(5, -11819);
        }
    }
    ...
    private void method3821(GraphicsToolkit graphicstoolkit, int i, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_) {
