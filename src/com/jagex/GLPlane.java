...
public class GLPlane extends Plane {
    ...
    GLPlane(GLToolkit gltoolkit, int i, int i_126_, int i_127_, int i_128_, int[][] is, int[][] is_129_, int i_130_) {
        ...
        for (int i_131_ = 1; (~anInt3404) < (~i_131_); i_131_++) {
            for (int i_132_ = 1; (~i_132_) > (~anInt3408); i_132_++) {
    ...
    static char method3264(char c, boolean bool) {
        anInt7927++;
        if (c == 198) {
            return 'E';
        }
    ...
    private void method3261(r_Sub2 var_r_Sub2, int i, byte b, int i_3_) {
        anInt7921++;
        int[] is = anIntArrayArrayArray7929[i][i_3_];
        int[] is_4_ = anIntArrayArrayArray7909[i][i_3_];
        if (b <= -29) {
            int i_5_ = is.length;
            if ((~aGLToolkit7926.anIntArray6747.length) > (~i_5_)) {
    ...
    final void method3255(int i, int i_16_, int i_17_, int i_18_, int i_19_, int i_20_, int i_21_, boolean[][] bools) {
        ...
        if (anInt7948 > 0) {
            ...
            if (aGLToolkit7926.aBoolean6736) {
                for (int i_23_ = i_19_; i_23_ < i_21_; i_23_++) {
                    ...
                    for (int i_25_ = i_18_; i_20_ > i_25_; i_25_++) {
                        if (bools[i_25_ - i_18_][-i_19_ + i_23_]) {
                            ...
                            if (ses != null) {
                                for (int i_26_ = 0; (~i_26_) > (~ses.length); i_26_++) {
                                    i_22_++;
                ...
                for (int i_27_ = i_19_; (~i_27_) > (~i_21_); i_27_++) {
    ...
    final void YA() {
        ...
        if (anInt7948 <= 0) {
            ...
            for (int i = 0; (~aNode_Sub33Array7955.length) < (~i); i++)
            ...
            for (int i_39_ = 0; anInt3408 > i_39_; i_39_++) {
                for (int i_40_ = 0; (~anInt3404) < (~i_40_); i_40_++) {
                    if (anIntArrayArrayArray7934[i_39_][i_40_] != null) {
                        ...
                        for (int i_65_ = 0; i_65_ < is_44_.length; i_65_++) {
                            ...
                            float f_80_;
                            if (i_73_ != 0 || i_74_ != 0) {
                                if ((~i_73_) == -1 && i_74_ == anInt3398) {
                                    f_79_ = f_51_;
                                    i_75_ -= i_59_;
                                    f_78_ = f_50_;
                                    f_80_ = f_49_;
                                } else if ((~anInt3398) == (~i_73_) && (~anInt3398) == (~i_74_)) {
                                    i_75_ -= i_60_;
                                    f_79_ = f_54_;
                                    f_78_ = f_53_;
                                    f_80_ = f_52_;
                                } else if ((~anInt3398) == (~i_73_) && i_74_ == 0) {
                                    i_75_ -= i_61_;
                                    f_78_ = f_56_;
                                    f_80_ = f_55_;
                                    f_79_ = f_57_;
                            ...
                            Node node = null;
                            if ((~(anInt7933 - 1 & i_66_)) == -1 && (-1 + anInt7933 & i_67_) == 0) {
            ...
            for (int i_100_ = 0; (~anInt7932) < (~i_100_); i_100_++) {
            ...
            for (int i_101_ = 0; i_101_ < anInt3408; i_101_++) {
                for (int i_102_ = 0; (~i_102_) > (~anInt3404); i_102_++) {
                    ...
                    if (ses != null) {
                        ...
                        while (ses.length > i_104_) {
                            ...
                            if (node_sub33_108_ != null) {
                                ...
                                if (node_sub33_110_ == null || (~node_sub33_110_.aLong2797) < (~node_sub33_108_.aLong2797)) {
                                    node_sub33_110_ = node_sub33_108_;
                                }
                            }
                            if (node_sub33_109_ != null) {
                                node_sub33_109_.method2738(i_101_, i_103_, true, i_102_);
                                if (node_sub33_110_ == null || (~node_sub33_110_.aLong2797) < (~node_sub33_109_.aLong2797)) {
            ...
            stream.c();
            Interface9 anInterface9_7956 = aGLToolkit7926.method1459(-1, i, nativeheapbuffer, false, stream.a());
    ...
    final void ka(int i, int i_114_, int i_115_) {
        if ((~i_115_) < (~(aByteArrayArray7951[i][i_114_] & 0xff))) {
    ...
    final void U(int i, int i_135_, int[] is, int[] is_136_, int[] is_137_, int[] is_138_, int[] is_139_, int[] is_140_, int[] is_141_, int[] is_142_, int i_143_, int i_144_, int i_145_, boolean bool) {
        ...
        for (int i_146_ = 0; i_146_ < is_139_.length; i_146_++) {
            ...
            if ((0x20 & anInt7911) != 0 && (~i_147_) != 0 && var_d.method10(i_147_, -8217).aBoolean1223) {
                i_147_ = -1;
                i_148_ = 128;
            }
            ...
            for (node = aHashTable7949.method1518(3512, l); node != null; node = aHashTable7949.method1524((byte) 84)) {
                ...
                if ((~node_sub33.anInt7400) == (~i_147_) && (float) i_148_ == node_sub33.aFloat7389 && (~i_143_) == (~node_sub33.anInt7401) && node_sub33.anInt7403 == i_144_ && (~node_sub33.anInt7392) == (~i_145_)) {
                    break;
                }
            }
            if (node != null) {
    ...
    private void method3262(boolean bool, boolean[][] bools, int i, int i_153_, int i_154_, int i_155_, int i_156_, int i_157_) {
        anInt7923++;
        if (aNode_Sub33Array7955 != null) {
            ...
            if ((~aGLToolkit7926.aFloatBuffer6661.aByteArray7019.length) > (~(anInt7919 * 2))) {
                aGLToolkit7926.aFloatBuffer6661 = new FloatBuffer(anInt7919 * 2);
            }
            ...
            if ((~(-1 + anInt3408)) > (~i_163_)) {
                i_163_ = -1 + anInt3408;
            }
            int i_164_ = i_155_ + i_156_;
            if ((~i_164_) < (~(anInt3404 + -1))) {
                i_164_ = anInt3404 - 1;
            }
            int i_165_ = 0;
            ...
            for (int i_169_ = 0; (~i_169_) > (~aNode_Sub33Array7955.length); i_169_++)
