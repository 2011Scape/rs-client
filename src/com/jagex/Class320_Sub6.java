...
public class Class320_Sub6 extends Class320 {
    ...
    static void method3703(int i, byte b, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
        if ((~i) == -9 || (~i) == -17) {
            if ((~i) == -9) {
    ...
    static void method3705(int i, int i_18_, int i_19_, Animable_Sub4 animable_sub4, Animable_Sub4 animable_sub4_20_) {
    ...
    final boolean method3702(byte b) {
        ...
        return aNode_Sub27_4063.method2691(3) == Node_Sub38_Sub34.aClass353_10443;
    }
