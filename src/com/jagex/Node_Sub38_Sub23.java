...
public class Node_Sub38_Sub23 extends Node_Sub38 {
    ...
    static void method2862(Widget widget, int i, int i_0_, int i_1_) {
        if (i_1_ != -8525) {
            method2864(22);
        }
        anInt10336++;
        if (widget.aByte4851 != 0) {
            if (widget.aByte4851 != 1) {
                ...
                } else if ((~widget.aByte4851) != -4) {
                    if ((~widget.aByte4851) == -5) {
    ...
    static boolean method2866(boolean bool) {
        anInt10331++;
        if ((~Class151.anInt1843) != -4) {
            return false;
        }
        if (Node_Sub38_Sub8.anInt10163 != 0 || (~Class4.anInt124) != -1) {
            return false;
        }
        if (bool != false) {
            aClass124_10344 = null;
    ...
    private void method2861(byte b) {
        anInt10338++;
    ...
    final int[] method2775(int i, int i_3_) {
        ...
        if (aClass146_7460.aBoolean1819) {
            ...
            int i_7_ = 0;
            while_217_:
            for (/**/; (~Class339_Sub7.anInt8728) < (~i_7_); i_7_++) {
                ...
                for (int i_11_ = -1 + i_5_; (~i_11_) >= (~i_6_); i_11_++) {
                    ...
                    for (int i_13_ = -1 + i_9_; (~i_10_) <= (~i_13_); i_13_++) {
                        int i_14_ = 2 * (0xff & aByteArray10341[i_12_ + ((~i_13_) <= (~anInt10334) ? -anInt10334 + i_13_ : i_13_) & 0xff]);
