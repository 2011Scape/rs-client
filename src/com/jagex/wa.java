...
public class wa implements Interface6 {
    ...
    private native void Z(long l, long l_0_, long l_1_, int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, boolean bool, boolean bool_7_);
    ...
    private native void X(long l, long l_14_, long l_15_, int i, int i_16_, int i_17_, int i_18_, int i_19_, int i_20_, boolean bool, boolean bool_21_);
