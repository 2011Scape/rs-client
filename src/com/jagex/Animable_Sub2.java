...
abstract class Animable_Sub2 extends Animable {
    ...
    static void method834(int i, Class163 class163) {
    ...
    static boolean method835(Class171 class171, byte b) {
        anInt9112++;
        if (class171 == null) {
            return false;
        }
    ...
    static void method836(int i, boolean bool) {
    ...
    static void method837(byte b, int i) {
        anInt9113++;
    ...
    final int method819(Node_Sub29[] node_sub29s, int i) {
        ...
        if (Class216.anInt2551 == i_0_) {
            i_2_++;
        } else if ((~Class216.anInt2551) > (~i_0_)) {
            i_2_ += 2;
        }
        ...
        if ((~aShort9110) == -9 && i_1_ > 0) {
            return this.method808(-23024, node_sub29s, -1 + i_1_, i_0_);
        }
        if ((~aShort9110) == -3 && (~Node_Sub50.anInt7623) <= (~i_1_)) {
            return this.method808(-23024, node_sub29s, 1 + i_1_, i_0_);
        }
        if ((~aShort9110) == -17 && (~i_0_) < -1 && i_1_ <= Node_Sub50.anInt7623) {
        ...
        if ((~aShort9110) == -129 && (~i_0_) < -1 && i_1_ > 0) {
            return this.method808(-23024, node_sub29s, -1 + i_1_, i_0_ - 1);
        }
        if ((~aShort9110) == -65 && Class328.anInt4115 >= i_0_ && i_1_ > 0) {
