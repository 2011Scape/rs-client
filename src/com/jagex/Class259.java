...
public class Class259 {
    ...
    static void method3132(int i, int i_9_, int i_10_, byte b) {
        anInt3248++;
        i = Class213.aNode_Sub27_2512.aClass320_Sub25_7274.method3776(false) * i >> 8;
        if ((~i) != -1 && (~i_9_) != 0) {
            if (!Class377_Sub1.aBoolean8775 && (~Class313.anInt4013) != 0 && Class36.method390(b ^ 0x11) && !Class113.method1152(-85)) {
    ...
    final boolean method3130(int i, byte b) {
        ...
        if (anIntArray3294 != null) {
            for (int i_1_ = 0; (~anIntArray3294.length) < (~i_1_); i_1_++) {
                if ((~anIntArray3294[i_1_]) == (~i)) {
                    return true;
                }
            }
        }
    ...
    final Class336[] method3131(int i, GraphicsToolkit graphicstoolkit) {
        anInt3257++;
        if (aClass336Array3280 != null && (~anInt3295) == (~graphicstoolkit.anInt1537)) {
    ...
    private void method3133(int i, Buffer buffer, int i_11_) {
        if (i < -114) {
            if (i_11_ == 1) {
