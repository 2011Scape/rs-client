...
public class Node_Sub39 extends Node {
        ...
        if (bool) {
            ...
            if ((~anInt7485) == -2) {
                if (SignLink.osVersion.indexOf("4.0") != -1) {
                    anInt7488 = 1;
                } else if ((~SignLink.osVersion.indexOf("4.1")) == 0) {
                    if ((~SignLink.osVersion.indexOf("4.9")) == 0) {
                        if ((~SignLink.osVersion.indexOf("5.0")) == 0) {
                            if ((~SignLink.osVersion.indexOf("5.1")) != 0) {
                                anInt7488 = 5;
                ...
                if (SignLink.osVersion.indexOf("10.4") != -1) {
                    anInt7488 = 20;
                } else if ((~SignLink.osVersion.indexOf("10.5")) != 0) {
                    anInt7488 = 21;
                } else if ((~SignLink.osVersion.indexOf("10.6")) == 0) {
                    if ((~SignLink.osVersion.indexOf("10.7")) != 0) {
                        anInt7488 = 23;
                    }
                } else {
                    anInt7488 = 22;
    ...
    static void method2921(boolean bool, int i, int i_0_, int i_1_, Widget widget) {
        anInt7471++;
        ...
        if (Class54.aBoolean817 && ((~client.method113(widget).anInt7418) != -1 || widget.anInt4841 == 0)) {
            if ((~widget.anInt4695) <= -6 || (~widget.anInt4809) <= -6) {
                if ((~widget.anInt4809) >= -1) {
                    widget.anInt4809 = 5;
                }
        ...
        if (bool && widget.anObjectArray4777 != null && ((~i_2_) != (~widget.anInt4809) || i_3_ != widget.anInt4695)) {
    ...
    static void method2922(boolean bool) {
        anInt7473++;
        if (bool == false) {
    ...
    private void method2918(boolean bool) {
        ...
        if ((~aString7483.length()) < -11) {
            aString7483 = aString7483.substring(0, 10);
        }
        if ((~aString7469.length()) < -11) {
