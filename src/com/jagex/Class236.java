...
public class Class236 {
    ...
    static boolean method3012(int i, int i_0_, int i_1_) {
        anInt2887++;
        if (i_0_ != 0) {
            return false;
        }
    ...
    private void method3013(int i, Buffer buffer, int i_2_) {
        anInt2900++;
        if ((~i) == -2) {
            int anInt2893 = buffer.method2220(1819759595);
    ...
    private void method3015(int i, int i_5_) {
        anInt2889++;
