...
public class Class98 implements Interface7 {
    ...
    Class98(String string, Class379 class379, Class77 class77, int i, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_) {
        anInt5064 = i_12_;
        anInt5056 = i_6_;
        aString5057 = string;
        anInt5068 = i_7_;
        ...
        anInt5062 = i_9_;
        anInt5055 = i_10_;
        aClass77_5069 = class77;
        anInt5059 = i_13_;
        aClass379_5066 = class379;
        anInt5054 = i_11_;
        anInt5067 = i_5_;
    }

    static void method1081(int i, byte b) {
        if (b != -68) {
            anInt5061 = 113;
        }
        anInt5070++;
    ...
    static void method1082(byte b, int i) {
        ...
        for (int i_0_ = 0; i_0_ < 4; i_0_++) {
            for (int i_1_ = 0; i_1_ < Node_Sub54.anInt7675; i_1_++) {
    ...
    static void method1083(int i, int i_3_) {
