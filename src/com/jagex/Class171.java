...
public class Class171 {
    ...
    static Class52 method1792(boolean bool, boolean bool_0_, int i, int i_1_, GraphicsToolkit graphicstoolkit) {
        anInt2057++;
        if (i_1_ > -88) {
            aBoolean2058 = false;
        }
    ...
    final boolean method1795(int i, byte b, int i_12_, int i_13_) {
        ...
        if ((~anInt2072) < (~i) || i > anInt2073) {
            return false;
        }
        if (b < 105) {
            method1793(87, 15, -33, 83, -55, -120, -79, 45, -10, -121, 6);
        }
        if (i_12_ < anInt2068 || (~anInt2061) > (~i_12_)) {
            return false;
        }
        int i_14_ = -anInt2060 + i_13_;
        int i_15_ = i_12_ - anInt2067;
        if ((~(i_15_ * i_15_ + i_14_ * i_14_)) <= (~anInt2069)) {
            return false;
        }
        return true;
    }
