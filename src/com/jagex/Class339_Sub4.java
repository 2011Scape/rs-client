...
public class Class339_Sub4 extends Class339 {
    ...
    static void method3932(byte b, int[] is, String[] strings) {
        anInt8673++;
    ...
    static boolean method3933(GraphicsToolkit graphicstoolkit, int i, Class79 class79, int i_2_, Node_Sub14 node_sub14, int i_3_) {
        anInt8675++;
        int i_4_ = 2147483647;
        int i_5_ = -2147483648;
        int i_6_ = 2147483647;
        ...
        if (i_5_ < Class20.anInt344 || (~Class20.anInt348) > (~i_4_) || Class20.anInt350 > i_7_ || (~i_6_) < (~Class20.anInt339)) {
            return true;
        }
        Class20.method281(graphicstoolkit, node_sub14, class79);
        if (glsprite != null) {
            if (Class168.anInt2044 > 0 && ((~Class253.anInt3201) != 0 && node_sub14.anInt7128 == Class253.anInt3201 || (~Node_Sub38_Sub19.anInt10296) != 0 && class79.anInt1067 == Node_Sub38_Sub19.anInt10296)) {
                int i_23_;
