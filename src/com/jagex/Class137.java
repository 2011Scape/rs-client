...
public class Class137 {
    ...
    final void method1596(int i, boolean bool, boolean bool_12_, int i_13_, boolean[][] bools, int i_14_) {
        ...
        if (bool) {
            for (int i_15_ = 0; (~anInt1708) < (~i_15_); i_15_++) {
            ...
            for (int i_23_ = 0; (~anInt1708) < (~i_23_); i_23_++) {
                int i_24_ = i_23_ << anInt1711;
                int i_25_ = 1 + i_23_ << anInt1711;
                for (int i_26_ = 0; (~i_26_) > (~anInt1702); i_26_++) {
                    int i_27_ = 0;
    ...
    private void method1599(int i, int i_57_, int i_58_, int i_59_, int i_60_) {
        anInt1716++;
