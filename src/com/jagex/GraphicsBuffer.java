...
abstract class GraphicsBuffer extends Node {
    ...
    static boolean method2596(int i, int i_1_, int i_2_) {
        anInt7143++;
        if (i != -1) {
            return true;
        }
        return Class144_Sub2.method1634(i_2_, i_1_, false) & Node_Sub9_Sub4.method2522(~i, i_1_, i_2_);
    }

    static boolean method2598(int i, int i_8_, int i_9_) {
        if (i != 2048) {
            return true;
        }
        anInt7141++;
        if ((~(i_8_ & 0x800)) == -1 || (i_9_ & 0x37) == 0) {
            return false;
        }
        return true;
    }
