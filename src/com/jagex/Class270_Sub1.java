...
abstract class Class270_Sub1 extends Class270 {
    ...
    static byte[] method3299(byte[] bs, int i) {
        anInt8035++;
        if (bs == null) {
            return null;
        }
    ...
    static void method3300(Widget widget, byte b, boolean bool) {
        anInt8031++;
        int i = (~widget.anInt4735) != -1 ? widget.anInt4735 : widget.anInt4809;
        int i_1_ = -101 / ((-76 - b) / 36);
        int i_2_ = (~widget.anInt4691) != -1 ? widget.anInt4691 : widget.anInt4695;
