...
public class EntityNode_Sub6 extends EntityNode {
    ...
    static boolean method969(GraphicsToolkit graphicstoolkit, int i, int i_0_) {
        anInt5989++;
        ...
        if (!Class320_Sub3.aBoolean8235) {
            for (int i_32_ = i_1_; (~i_32_) > (~(104 + i_1_)); i_32_++) {
                for (int i_33_ = i_2_; (~i_33_) > (~(i_2_ + 104)); i_33_++) {
                                    ...
                                    if (objectdefinition.anIntArray2984 != null) {
                                        for (int i_36_ = 0; i_36_ < objectdefinition.anIntArray2984.length; i_36_++) {
                                            if (objectdefinition.anIntArray2984[i_36_] != -1) {
                                                ...
                                                if ((~objectdefinition_37_.anInt2994) <= -1) {
                                    ...
                                    if ((~i_35_) <= -1) {
                                        ...
                                        if (bool_38_) {
                                            ...
                                            for (int i_44_ = 0; i_44_ < 10; i_44_++) {
                                                ...
                                                if ((~i_45_) == -1 && (~i_1_) > (~i_39_) && (~(-3 + i_32_)) > (~i_39_) && (is_41_[-1 + i_39_ - i_42_][i_40_ - i_43_] & 0x2c0108) == 0) {
                                                    i_39_--;
                                                }
                                                if (i_45_ == 1 && -1 + i_1_ + 104 > i_39_ && (~(i_32_ - -3)) < (~i_39_) && (~(is_41_[-i_42_ + i_39_ + 1][-i_43_ + i_40_] & 0x2c0180)) == -1) {
                                                    i_39_++;
                                                }
                                                if ((~i_45_) == -3 && (~i_40_) < (~i_2_) && (~(i_33_ + -3)) > (~i_40_) && (~(is_41_[i_39_ - i_42_][-i_43_ + (-1 + i_40_)] & 0x2c0102)) == -1) {
                                                    i_40_--;
                                                }
                                                if ((~i_45_) == -4 && (~i_40_) > (~(104 + (i_2_ + -1))) && i_33_ + 3 > i_40_ && (0x2c0120 & is_41_[i_39_ - i_42_][1 + i_40_ - i_43_]) == 0) {
                                                    i_40_++;
                                                }
                                            }
                                        }
            ...
            if (Class262_Sub15_Sub1.aClass224_10520 != null) {
                ...
                for (int i_46_ = 0; i_46_ < Class262_Sub15_Sub1.aClass224_10520.anInt2670; i_46_++) {
                    ...
                    if (Class295.aPlayer3692.aByte5933 == i_47_ >> 28) {
                        ...
                        if ((~i_48_) > -1 || (~i_48_) <= (~Node_Sub54.anInt7675) || (~i_49_) > -1 || i_49_ >= Class377_Sub1.anInt8774) {
                            Class79 class79 = Class304.aClass215_3834.method2069((byte) 116, Class262_Sub15_Sub1.aClass224_10520.anIntArray2669[i_46_]);
                            if (class79.anIntArray1049 != null && (~(class79.anInt1089 + i_48_)) <= -1 && (~(i_48_ - -class79.anInt1068)) > (~Node_Sub54.anInt7675) && class79.anInt1060 + i_49_ >= 0 && (~(i_49_ + class79.anInt1051)) > (~Class377_Sub1.anInt8774)) {
