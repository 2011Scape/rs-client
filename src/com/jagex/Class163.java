...
public class Class163 {
    ...
    private final byte[] aByteArray2016;
    private final int[] anIntArray2017;
        ...
        for (int i_28_ = 0; (~i_28_) > (~i); i_28_++) {
            ...
            if ((~i_29_) != -1) {
                ...
                for (int i_38_ = 0; (~i_29_) < (~i_38_); i_38_++) {
                    ...
                    i_39_ >>>= 1;
                    if ((~anIntArray2010.length) >= (~i_37_)) {
                        int[] is_40_ = new int[anIntArray2010.length * 2];
                        System.arraycopy(anIntArray2010, 0, is_40_, 0, anIntArray2010.length);
                        anIntArray2010 = is_40_;
                    }
                }
                anIntArray2010[i_37_] = ~i_28_;
                if (i_27_ <= i_37_) {
                    i_27_ = 1 + i_37_;
                }
            }
    ...
    static Class144_Sub4 method1734(Buffer buffer, byte b) {
        anInt2007++;
        int i = 21 / ((b - 6) / 38);
    ...
    static void method1736(int i, Color color, Color color_7_, Color color_8_, String string, byte b) {
        anInt2011++;
        try {
    ...
    static void method1738(int i) {
        ...
        for (int i_42_ = 0; CacheNode_Sub11.aByteArrayArrayArray9550.length > i_42_; i_42_++) {
            for (int i_43_ = 0; CacheNode_Sub11.aByteArrayArrayArray9550[0].length > i_43_; i_43_++) {
                for (int i_44_ = 0; (~CacheNode_Sub11.aByteArrayArrayArray9550[0][0].length) < (~i_44_); i_44_++)
