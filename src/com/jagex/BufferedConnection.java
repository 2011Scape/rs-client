...
public class BufferedConnection implements Runnable {
    ...
    static void method422(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_) {
        anInt597++;
    ...
    static void method427(Class48 class48, int i, Animable animable, byte b) {
        anInt600++;
        if ((~Class23.anInt434) > -51 && (class48 != null && class48.anIntArrayArray700 != null && (~class48.anIntArrayArray700.length) < (~i) && class48.anIntArrayArray700[i] != null)) {
            if (b != -63) {
                aClass346_615 = null;
            }
    ...
    final void method430(int i) {
        ...
        if (!aBoolean601) {
            ...
            if (aClass241_596 != null) {
                while ((~aClass241_596.anInt2953) == -1)
                    Class262_Sub22.method3208(1L, false);
                if ((~aClass241_596.anInt2953) == -2) {
                    try {
