...
public class Class188_Sub1_Sub2 extends Class188_Sub1 {
    ...
    static void method1897(int i, int[][] is) {
        anInt9343++;
        if (i != 1) {
            method1897(116, null);
        }
    ...
    static boolean method1899(int i, byte b, String string) {
        anInt9341++;
        if (b != 27) {
            anIntArray9345 = null;
        }
    ...
    static void method1900(byte b) throws Exception_Sub1 {
        if (b != 2) {
            aLong9342 = 3L;
        }
    ...
    static void method1901(String string, int i, int i_10_) {
        anInt9348++;
