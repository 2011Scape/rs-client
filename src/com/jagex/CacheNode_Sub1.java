...
public class CacheNode_Sub1 extends CacheNode {
    ...
    private void method2281(int i, Buffer buffer, int i_2_) {
        if (i == 249) {
            ...
            for (int i_5_ = 0; i_3_ > i_5_; i_5_++) {
                ...
                aHashTable9423.method1515(i_6_, node, -124);
            }
        }
        if (i_2_ <= -118) {
            anInt9422++;
    ...
    final int method2282(int i, int i_7_, int i_8_) {
        ...
        Node_Sub32 node_sub32 = (Node_Sub32) aHashTable9423.method1518(3512, i_8_);
        if (node_sub32 == null) {
            return i;
        }
    ...
    final String method2284(int i, String string, int i_10_) {
        ...
        Node_Sub18 node_sub18 = (Node_Sub18) aHashTable9423.method1518(3512, i);
        if (node_sub18 == null) {
            return string;
        }
