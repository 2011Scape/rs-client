...
abstract class Actor extends Mobile {
    ...
    static boolean method859(int i, int i_48_, int i_49_, Animable_Sub2 animable_sub2, int i_50_) {
        anInt10830++;
        ...
        if ((~animable_sub2.aShort9110) == -17) {
        ...
        if ((~animable_sub2.aShort9110) == -33) {
        ...
        if ((~animable_sub2.aShort9110) == -65) {
        ...
        if ((~animable_sub2.aShort9110) == -129) {
    ...
    static void method863(byte[][] bs, byte b, Class277_Sub1 class277_sub1) {
        anInt10821++;
        int i = bs.length;
            ...
            if (class165.anInt2030 == -1 || class165.anAnimator2026.method242((byte) -77)) {
                ...
                if (drawablemodel != null) {
                    if ((~class165.anInt2025) <= -1 && class259.anIntArrayArray3273 != null && class259.anIntArrayArray3273[class165.anInt2025] != null) {
                        ...
                        if ((~i_8_) != -1 || i_6_ != 0) {
                            int i_9_ = i_1_;
                            if (anIntArray10881 != null && (~anIntArray10881[class165.anInt2025]) != 0) {
    ...
    final void method849(int i, int i_16_, boolean bool) {
        ...
        if (bool || (~class259.anInt3258) != -1 || anInt10890 != 0) {
            anInt10889 = i & 0x3fff;
    ...
    final void method852(int i, int i_17_, int i_18_, byte b, int i_19_, int i_20_, int i_21_, int i_22_) {
        ...
        for (int i_24_ = 0; (~i_24_) > (~CacheNode_Sub4.aClass1_9466.anInt117); i_24_++) {
            if ((~i_20_) > (~anIntArray10829[i_24_])) {
                bool = false;
            } else {
                bool_23_ = false;
            }
        ...
        if (bool_23_) {
            ...
            for (int i_29_ = 1; i_29_ < CacheNode_Sub4.aClass1_9466.anInt117; i_29_++) {
                if ((~i_26_) != -1) {
                    if (i_26_ == 1 && (~i_28_) < (~anIntArray10819[i_29_])) {
    ...
    final void method865(int i, int i_79_, int i_80_, int i_81_, int i_82_, int i_83_) {
        ...
        if (i_83_ < -78) {
            if (anInt10872 != 0 && i_79_ != 0) {
                ...
                } else if ((~anInt10872) < (~i_79_)) {
                    anInt10872 = i_79_;
                }
            }
            anInt10832 = i_107_ + i_92_;
            if (anInt10862 != 0 && (~i_80_) != -1) {
    ...
    final void method866(int[] is, int[] is_114_, byte b) {
        ...
        for (int i = 0; (~anIntArray10845.length) < (~i); i++)
            anIntArray10845[i] = -1;
        for (int i = 0; is_114_.length > i; i++) {
            int i_115_ = is[i];
            for (int i_116_ = 0; (~i_116_) > (~anIntArray10845.length); i_116_++) {
                if ((~(i_115_ & 0x1)) != -1) {
    ...
    final void method870(GraphicsToolkit graphicstoolkit, byte b, boolean bool, DrawableModel[] drawablemodels, Class336 class336) {
        if (bool) {
            ...
            if ((anEntityNode_Sub4_10902 == null || anEntityNode_Sub4_10902.aBoolean5972) && ((~i_117_) < -1 || i_119_ > 0)) {
