...
public class oa extends GraphicsToolkit implements Interface3 {
    ...
    static {
        ...
        float[] aFloatArray5005 = new float[20];
    ...
    private native void MA(d var_d, int i, int i_9_);

    private void a(Class198 class198, boolean bool) {
        int i = 0;
        int i_10_ = 0;
        int i_11_ = 0;
        int i_12_ = 0;
    ...
    private native void AA(short s, short s_74_, int i, byte b, byte b_75_, int i_76_, boolean bool, byte b_77_, byte b_78_, byte b_79_, byte b_80_, boolean bool_81_, boolean bool_82_, boolean bool_83_, boolean bool_84_, boolean bool_85_, byte b_86_, boolean bool_87_, boolean bool_88_, int i_89_);
    ...
    private native void n(long l, long l_144_);
    ...
    private native void wa(int i, int i_153_, int i_154_, int i_155_, int i_156_, int i_157_);

    private boolean WA(short s) {
        synchronized (aD1543) {
    ...
    private native void CA(short s, int[] is, short s_158_, int i, byte b, byte b_159_, int i_160_, boolean bool, byte b_161_, byte b_162_, byte b_163_, byte b_164_, boolean bool_165_, boolean bool_166_, boolean bool_167_, boolean bool_168_, boolean bool_169_, byte b_170_, boolean bool_171_, boolean bool_172_, int i_173_);
    ...
    private native void Z(int i, int i_209_, int i_210_, int i_211_, int i_212_, int i_213_, aa var_aa, int i_214_, int i_215_);
