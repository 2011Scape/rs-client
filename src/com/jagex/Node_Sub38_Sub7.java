...
public class Node_Sub38_Sub7 extends Node_Sub38 {
    ...
    static int method2809(int i, int i_75_, int i_76_, int i_77_) {
        if (i_75_ != -29754) {
        ...
        int i_78_ = i_77_ >> 9;
        int i_79_ = i_76_ >> 9;
        if ((~i_78_) > -1 || (~i_79_) > -1 || -1 + Node_Sub54.anInt7675 < i_78_ || Class377_Sub1.anInt8774 - 1 < i_79_) {
            return 0;
        }
        int i_80_ = i;
        if (i_80_ < 3 && (~(CacheNode_Sub11.aByteArrayArrayArray9550[1][i_78_][i_79_] & 0x2)) != -1) {
            i_80_++;
        }
        return Class320_Sub10.aPlaneArray8300[i_80_].method3260(i_76_, -121, i_77_);
    }

    static boolean method2810(Mobile mobile, boolean bool) {
    ...
    static String method2811(boolean bool, int i, int i_90_, boolean bool_91_) {
        anInt10154++;
        if (i_90_ < 2 || (~i_90_) < -37) {
    ...
    private void method2807(int[][] is, int i, Random random, int i_42_, int i_43_, int i_44_, byte b) {
        anInt10158++;
        int i_45_ = anInt10157 <= 0 ? 4096 : -Class330.method3838(b - 5150, anInt10157, random) + 4096;
        int i_46_ = anInt10141 * anInt10148 >> 12;
        int i_47_ = anInt10148 - ((~i_46_) >= -1 ? 0 : Class330.method3838(b ^ 0x146e, i_46_, random));
