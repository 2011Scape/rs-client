...
abstract class Class93 {
    ...
    static String method1043(long l, int i) {
        if (i != 10) {
            return null;
        }
    ...
    static byte[] method1046(byte[] bs, int i) {
        anInt1245++;
        if (i != 7348) {
            aFloatArray1242 = null;
        }
    ...
    static Node_Sub2 method1047(int i, int i_9_, int i_10_, int i_11_, boolean bool) {
        anInt1239++;
        Node_Sub2 node_sub2 = new Node_Sub2();
        node_sub2.anInt6933 = i_9_;
        node_sub2.anInt6932 = i;
        Class289.aHashTable3630.method1515(i_10_, node_sub2, -126);
        ...
        if (!bool && (~Class320_Sub15.anInt8355) != 0) {
            Class76.method770(i_11_ + 115, 1, Class320_Sub15.anInt8355);
        }
        return node_sub2;
    }

    static void method1049(int[] is, int i, int[] is_12_, int i_13_, int i_14_) {
        if (i_14_ == 28627) {
            if (i_13_ < i) {
                int i_15_ = (i + i_13_) / 2;
                int i_16_ = i_13_;
    ...
    final boolean method1041(byte b) {
        ...
        anInt1243++;
        return method1039(-82) || method1044(29) || method1040(-95);
    }
