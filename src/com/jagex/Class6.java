...
public class Class6 {
    ...
    static void method174(byte b) {
        Class315.aClass61_4031.method608(false);
        anInt141++;
        int i = -61 / ((-52 - b) / 45);
    }

    static void method175(byte[] bs, boolean bool) {
        if (bool == true) {
            anInt142++;
    ...
    final byte[] method177(int i, int i_3_) {
        ...
        synchronized (aSeekableFile134) {
            try {
                if ((~aSeekableFile137.method3573(-1)) > (~((long) (i * 6 - -6)))) {
                    return null;
                }
                ...
                if ((~i_5_) >= -1 || aSeekableFile134.method3573(-1) / 520L < (long) i_5_) {
                    return null;
                }
                ...
                while ((~i_4_) < (~i_6_)) {
                    ...
                    if ((~i) != (~i_9_) || (~i_7_) != (~i_10_) || (~i_12_) != (~anInt143)) {
                        return null;
                    }
                    if ((~i_11_) > -1 || (long) i_11_ > aSeekableFile134.method3573(-1) / 520L) {
                        return null;
                    }
                    i_7_++;
    ...
    private boolean method179(byte[] bs, int i, int i_14_, int i_15_, boolean bool) {
        anInt147++;
        synchronized (aSeekableFile134) {
            if (i != 11233) {
                method177(114, 33);
            ...
            try {
                int i_16_;
                if (bool) {
                    if ((~aSeekableFile137.method3573(-1)) > (~((long) (6 + i_14_ * 6)))) {
                        return false;
                    }
                ...
                while (i_17_ < i_15_) {
                    ...
                    if (bool) {
                        ...
                        if ((~i_14_) != (~i_20_) || (~i_18_) != (~i_21_) || i_22_ != anInt143) {
                            return false;
                        }
                        if ((~i_19_) > -1 || (~(aSeekableFile134.method3573(i + -11234) / 520L)) > (~((long) i_19_))) {
                            return false;
                        }
                    }
                    if ((~i_19_) == -1) {
