...
public class Animable_Sub1_Sub1 extends Animable_Sub1 implements Interface19 {
    ...
    private final boolean aBoolean10598;
    private final boolean aBoolean10614;
    ...
    static void method829(int i, int i_15_, int i_16_, int i_17_, d var_d, GraphicsToolkit graphicstoolkit, int i_18_) {
        anInt10597++;
    ...
    final void method816(int i, boolean bool, GraphicsToolkit graphicstoolkit, int i_1_, byte b, int i_2_, Animable animable) {
        ...
        if (animable instanceof Animable_Sub1_Sub1 animable_sub1_sub1_3_) {
    ...
    private Class243 method828(int i, int i_12_, GraphicsToolkit graphicstoolkit, boolean bool) {
        anInt10604++;
    ...
    private DrawableModel method831(int i, GraphicsToolkit graphicstoolkit, int i_35_) {
        anInt10589++;
