...
public class Animable_Sub2_Sub2 extends Animable_Sub2 implements Interface19 {
    ...
    Animable_Sub2_Sub2(GraphicsToolkit graphicstoolkit, ObjectDefinition objectdefinition, int i, int i_0_, int i_1_, int i_2_, int i_3_, boolean bool, int i_4_, int i_5_, boolean bool_6_) {
        ...
        aBoolean10740 = graphicstoolkit.r() && objectdefinition.aBoolean2972 && !aBoolean10737 && (~Class213.aNode_Sub27_2512.aClass320_Sub12_7282.method3730(false)) != -1;
        int i_7_ = 2048;
        if (aBoolean10746) {
            i_7_ |= 0x10000;
        }
    ...
    static long method843(String string, int i) {
        anInt10761++;
        if (i >= -87) {
    ...
    private DrawableModel method841(GraphicsToolkit graphicstoolkit, byte b, int i) {
        if (b != 62) {
            aBoolean10740 = false;
        }
        anInt10759++;
        if (aDrawableModel10756 != null && (~graphicstoolkit.b(aDrawableModel10756.ua(), i)) == -1) {
    ...
    private Class243 method842(GraphicsToolkit graphicstoolkit, boolean bool, int i, boolean bool_12_) {
        anInt10739++;
