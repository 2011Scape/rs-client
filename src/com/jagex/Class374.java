...
public class Class374 {
    ...
    static int method4112(int i, int i_0_) {
        anInt4625++;
        if (i != 1) {
            aClass151_4614 = null;
        }
    ...
    static int method4113(int i, int i_1_, int i_2_, int i_3_) {
        if (i_1_ != -1145) {
            aClass151_4614 = null;
        }
        anInt4623++;
        if ((~(CacheNode_Sub11.aByteArrayArrayArray9550[i_3_][i_2_][i] & 0x8)) != -1) {
            return 0;
        }
