...
public class Node_Sub6 extends Node {
    ...
    Node_Sub6(byte[] bs) {
        ...
        int i_78_;
        for (i_78_ = 0; (~buffer.aByteArray7019[i_78_ + buffer.anInt7002]) != -1; i_78_++) {
            /* empty */
        }
        ...
        int i_91_;
        for (i_91_ = 0; (~buffer.aByteArray7019[i_91_ + buffer.anInt7002]) != -1; i_91_++) {
            /* empty */
        }
        ...
        for (int i_96_ = 0; i_96_ < 128; i_96_++) {
            i_94_ += buffer.method2233(255);
            aShortArray7044[i_96_] += (short) (i_94_ << 8);
        }
        int i_97_ = 0;
        int i_98_ = 0;
        int i_99_ = 0;
        for (int i_100_ = 0; i_100_ < 128; i_100_++) {
            ...
            aShortArray7044[i_100_] += (short) (Node_Sub30.method2723(-1 + i_99_, 2) << 14);
    ...
    static void method2416(int i, int i_0_, Widget[] widgets, int i_1_, int i_2_, int i_3_, int i_4_, boolean bool, int i_5_, int i_6_, int i_7_) {
        anInt7048++;
        Class93.aGraphicsToolkit1241.KA(i_1_, i_2_, i_6_, i_3_);
        for (int i_8_ = 0; (~widgets.length) < (~i_8_); i_8_++) {
            Widget widget = widgets[i_8_];
            if (widget != null && (i == widget.anInt4692 || (~i) == 1412584498 && Class58.aWidget861 == widget)) {
                ...
                if (!client.method112(widget)) {
                    ...
                    if (Class54.aBoolean817 && ((~client.method113(widget).anInt7418) != -1 || widget.anInt4841 == 0) && i_18_ > 127) {
                        i_18_ = 127;
                    }
                    if (Class58.aWidget861 == widget) {
                        ...
                        if (Class99.aBoolean1282 && Class180.aBoolean2135) {
                            ...
                            if ((~(Class62.anInt905 + Class186.aWidget2257.anInt4809)) > (~(i_19_ - -widget.anInt4809))) {
                                i_19_ = Class62.anInt905 + Class186.aWidget2257.anInt4809 - widget.anInt4809;
                            }
                            i_14_ = i_19_;
                            if ((~(Class339_Sub2.anInt8650 - -Class186.aWidget2257.anInt4695)) > (~(i_20_ + widget.anInt4695))) {
                    ...
                    if (i_24_ > i_21_ && (~i_23_) > (~i_22_)) {
                        if ((~widget.anInt4814) != -1) {
                            ...
                            if (widget.anInt4814 == Class264.anInt3355 && (~aa.anInt101) == -1) {
                            ...
                            if ((~widget.anInt4814) == (~Class114.anInt1462)) {
                                if (widget.method4145(Class93.aGraphicsToolkit1241, 1) != null) {
                            ...
                            if (widget.anInt4814 == AnimableAnimator_Sub1.anInt9093) {
                                if (Node_Sub15_Sub2.displayRenderData || Class186.aBoolean2259) {
                                    ...
                                    if (Node_Sub15_Sub2.displayRenderData) {
                                        ...
                                        int i_35_ = 0;
                                        int i_36_ = 0;
                                        for (int i_37_ = 0; (~i_37_) > -38; i_37_++) {
                        ...
                        if (widget.anInt4841 == 0) {
                            ...
                            if ((~widget.anInt4814) == (~Class193.anInt2368)) {
                                ...
                                if (aa.anInt101 == 3) {
                                    ...
                                    if ((~Class174.anInt2092) > (~Class1.anInt115)) {
                        ...
                        if (Class190.aBooleanArray2326[i_13_] || Class12.anInt193 > 1) {
                            if (widget.anInt4841 == 3) {
                                ...
                                if (widget.anInt4848 < 0) {
                                    ...
                                    if (glsprite == null) {
                                        ...
                                        if (widget.aBoolean4861) {
                                            ...
                                            Class93.aGraphicsToolkit1241.KA(i_1_, i_2_, i_6_, i_3_);
                                        } else if ((~widget.anInt4754) == -1 && i_18_ == 0) {
                                            if (widget.anInt4728 != 0) {
                                            ...
                                            } else if ((~i_47_) != (~widget.anInt4809) || widget.anInt4695 != i_48_) {
                                                glsprite.method1200(i_14_, i_15_, widget.anInt4809, widget.anInt4695);
                                            } else {
                                                glsprite.method1196(i_14_, i_15_);
                                            }
                                        } else if ((~widget.anInt4728) == -1) {
                                            if ((~i_47_) != (~widget.anInt4809) || widget.anInt4695 != i_48_) {
                                ...
                                if (widget.anInt4718 == -1) {
                                    ...
                                    } else if (widget.anInt4844 != 8 && (~widget.anInt4844) != -10) {
    ...
    static void method2417(int i, byte b) {
        if (b != -74) {
            anObject7050 = null;
        }
        anInt7042++;
    ...
    static boolean method2418(int i, String string) {
        anInt7051++;
        if (string == null) {
            return false;
        }
    ...
    static boolean method2419(int i) {
        anInt7059++;
        boolean bool = true;
