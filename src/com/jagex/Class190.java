...
public class Class190 {
    ...
    static int method1938(int i, int i_0_) {
        anInt2336++;
        if (i_0_ != 128) {
            method1940(-126);
        }
    ...
    static int method1939(int[] is, int i, int i_1_, int[] is_2_, int i_3_, byte[][] bs, byte[] bs_4_, byte[][] bs_5_) {
        anInt2334++;
        int i_6_ = is[i_3_];
