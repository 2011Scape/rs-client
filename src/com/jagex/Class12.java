...
public class Class12 {
    ...
    private final Class158 aClass158_188 = new Class158();
    private final HashTable aHashTable190;
    ...
    private void method195(int i, Interface18 interface18) {
        anInt180++;
    ...
    private void method198(boolean bool, CacheNode_Sub14 cachenode_sub14) {
        if (bool) {
            anInt185 = -28;
        }
        anInt181++;
    ...
    private void method203(boolean bool, int i, Object object, Interface18 interface18) {
        anInt186++;
        if (i > anInt185) {
