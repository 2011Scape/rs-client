...
public class Class117_Sub2 extends Class117 implements Interface9 {
    ...
    static int method1172(int i, int i_2_) {
    ...
    static void method1174(int i, byte[][][] bs, int i_3_, int i_4_, int i_5_, int i_6_, GraphicsToolkit graphicstoolkit, int i_7_, int i_8_, byte b, int i_9_, int i_10_, int i_11_) {
        anInt5153++;
        if ((~i_11_) != -1 && i_5_ != 0) {
            if (i_11_ == 9) {
                i_8_ = i_8_ + 1 & 0x3;
