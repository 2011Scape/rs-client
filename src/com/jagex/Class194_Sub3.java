...
class Class194_Sub3 extends Class194 {
    ...
    static boolean method1973(int i, int i_0_) {
        anInt6908++;
    ...
    static int method1975(int i, Buffer buffer, String string) {
        anInt6905++;
        if (i <= 8) {
            return 38;
        }
    ...
    static void method1976(boolean bool, int i) {
    ...
    static int method1977(int i) {
        anInt6902++;
        if (Class213.aNode_Sub27_2512.aClass320_Sub10_7300.method3718(false) == 0) {
            for (int i_2_ = 0; (~i_2_) > (~Class357.anInt4429); i_2_++) {
                if ((~Class320_Sub7.anInterface21Array8275[i_2_].method77(-24069)) == -116 || Class320_Sub7.anInterface21Array8275[i_2_].method77(i ^ ~0x5e05) == 'S') {
        ...
        if (Class110.aClass110_1396 == Class252.aClass110_3189) {
            if (Class235_Sub1.anInterface16Array8978 != null && (~Class235_Sub1.anInterface16Array8978.length) < -1) {
                ...
                if ((~Class235_Sub1.anInterface16Array8978.length) < -2 && Class174.aClass250_2094.method3092(false) && (~Class235_Sub1.anInterface16Array8978[1].method58(27285)) > -101) {
                    return 0;
                }
            }
        ...
        if (Class110.aClass110_1403 == Class252.aClass110_3189) {
            if ((~CacheNode_Sub4.aClass1_9466.anInt110) != 0 && !Class107.aClass302_1364.method3515(0, CacheNode_Sub4.aClass1_9466.anInt110, 0)) {
                return 99;
            }
        ...
        if (Class110.aClass110_1410 == Class252.aClass110_3189) {
            ...
            } else if (Class213.aNode_Sub27_2512.aClass320_Sub29_7291.aBoolean8486 && Node_Sub23.instance.anInt7484 < 512 && (~Node_Sub23.instance.anInt7484) != -1) {
    ...
    static void method1978(boolean bool, Widget widget) {
        anInt6903++;
        if (bool == false) {
