...
public class Class368 {
    ...
    static String method4077(int i, int i_0_, int i_1_) {
        anInt4545++;
        int i_2_ = i_0_ - i_1_;
        if (i_2_ < -9) {
            return "<col=ff0000>";
    ...
    static void method4078(byte[][] bs, byte b, Class277_Sub1 class277_sub1) {
        anInt4543++;
        for (int i = 0; (~i) > (~class277_sub1.anInt3535); i++) {
            CacheNode_Sub16_Sub1.method2387((byte) -114);
            for (int i_3_ = 0; (~(Node_Sub54.anInt7675 >> 3)) < (~i_3_); i_3_++) {
                for (int i_4_ = 0; (~i_4_) > (~(Class377_Sub1.anInt8774 >> 3)); i_4_++) {
                    int i_5_ = Class330.anIntArrayArrayArray4128[i][i_3_][i_4_];
                    if ((~i_5_) != 0) {
                        int i_6_ = i_5_ >> 24 & 0x3;
                        if (!class277_sub1.aBoolean3516 || (~i_6_) == -1) {
                            int i_7_ = (0x6 & i_5_) >> 1;
    ...
    static void method4081(int i, int i_16_, int i_17_) {
        if (i_17_ != -278174944) {
            aPlaneArray4548 = null;
        }
        anInt4547++;
