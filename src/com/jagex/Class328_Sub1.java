...
public class Class328_Sub1 extends Class328 {
    ...
    Class328_Sub1(int i) {
        ...
        for (int i_38_ = 0; (~i_38_) > -257; i_38_++) {
    ...
    static Class93 method3830(Component component, int i, boolean bool) {
        anInt8503++;
        try {
            if (i != -19397) {
                return null;
            ...
            return (Class93) constructor.newInstance(new Object[]{component, Boolean.valueOf(bool)});
