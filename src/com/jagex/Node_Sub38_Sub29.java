...
public class Node_Sub38_Sub29 extends Node_Sub38 {
    ...
    static int method2889(Class377_Sub1 class377_sub1, int i, int i_9_, boolean bool, int i_10_, Class377_Sub1 class377_sub1_11_, boolean bool_12_) {
        anInt10408++;
        if (i_10_ < 14) {
    ...
    final int[] method2775(int i, int i_1_) {
        ...
        if (aClass146_7460.aBoolean1819) {
            ...
            for (int i_3_ = 0; (~i_3_) > (~Class339_Sub7.anInt8728); i_3_++) {
                ...
                if ((~i_4_) < (~anInt10410) && i_4_ < 4096 - anInt10410 && i_2_ > 2048 - anInt10410 && i_2_ < anInt10410 + 2048) {
                    int i_5_ = 2048 - i_4_;
                    i_5_ = (~i_5_) <= -1 ? i_5_ : -i_5_;
                    i_5_ <<= 12;
                    i_5_ /= -anInt10410 + 2048;
                    is[i_3_] = -i_5_ + 4096;
                } else if (-anInt10410 + 2048 < i_4_ && (~i_4_) > (~(2048 + anInt10410))) {
                    int i_6_ = -2048 + i_2_;
                    i_6_ = (~i_6_) > -1 ? -i_6_ : i_6_;
                    i_6_ -= anInt10410;
                    i_6_ <<= 12;
                    is[i_3_] = i_6_ / (-anInt10410 + 2048);
                } else if ((~anInt10410) < (~i_2_) || i_2_ > -anInt10410 + 4096) {
                    int i_7_ = -2048 + i_4_;
                    i_7_ = i_7_ < 0 ? -i_7_ : i_7_;
                    i_7_ -= anInt10410;
                    i_7_ <<= 12;
                    is[i_3_] = i_7_ / (-anInt10410 + 2048);
                } else if ((~anInt10410) < (~i_4_) || (~i_4_) < (~(-anInt10410 + 4096))) {
                    int i_8_ = 2048 - i_2_;
