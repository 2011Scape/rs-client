...
public class Class262_Sub22 extends Class262 {
    ...
    static Class42 method3207(SignLink signlink, byte b, int i, int i_1_, Component component) {
        anInt7871++;
        ...
        try {
            ...
            try {
                ...
                if ((~Class87.anInt1193) < -1 && Widget.aClass92_4845 == null) {
                    Widget.aClass92_4845 = new Class92();
                    Widget.aClass92_4845.aSignLink1237 = signlink;
                    signlink.method3641((byte) 50, Widget.aClass92_4845, Class87.anInt1193);
                }
    ...
    static void method3208(long l, boolean bool) {
        anInt7870++;
        if ((~l) < -1L && bool == false) {
            if ((~(l % 10L)) != -1L) {
    ...
    static Class115 method3209(boolean bool) {
        anInt7869++;
        try {
            if (bool != true) {
                return null;
    ...
    static void method3210(int i, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_) {
    ...
    static Animable_Sub3 method3211(int i, int i_15_, int i_16_) {
