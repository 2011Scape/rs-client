...
public class PureJavaDrawableModel extends DrawableModel {
    ...
    private void method655(boolean bool) {
    ...
    private boolean method658(int i) {
        if (aByteArray5784 == null) {
            return false;
        }
    ...
    private void method660(int i, boolean bool, boolean bool_241_) {
    ...
    private void method664(boolean bool) {
        if (anInt5744 == 1) {
            method661();
        } else if (anInt5744 == 2) {
    ...
    private boolean method665(int i, int i_403_, Class336 class336, boolean bool, int i_404_, int i_405_) {
    ...
    private DrawableModel method666(PureJavaDrawableModel purejavadrawablemodel_455_, PureJavaDrawableModel purejavadrawablemodel_456_, int i, boolean bool, boolean bool_457_) {
        ...
        if (bool_459_ || bool_460_ || bool_461_) {
            if (bool_459_) {
                ...
                if (anInt5718 >= 0)
                    System.arraycopy(anIntArray5748, 0, purejavadrawablemodel_455_.anIntArray5748, 0, anInt5718);
            } else {
            ...
            if (bool_460_) {
                ...
                if (anInt5718 >= 0)
                    System.arraycopy(anIntArray5772, 0, purejavadrawablemodel_455_.anIntArray5772, 0, anInt5718);
            } else {
            ...
            if (bool_461_) {
                ...
                if (anInt5718 >= 0)
                    System.arraycopy(anIntArray5717, 0, purejavadrawablemodel_455_.anIntArray5717, 0, anInt5718);
            } else {
        ...
        if ((i & 0x84080) != 0) {
            ...
            if (anInt5711 >= 0)
                System.arraycopy(aShortArray5740, 0, purejavadrawablemodel_455_.aShortArray5740, 0, anInt5711);
        } else {
        ...
        if ((i & 0x100) != 0) {
            ...
            if (aByteArray5784 != null) {
                if (anInt5711 >= 0)
                    System.arraycopy(aByteArray5784, 0, purejavadrawablemodel_455_.aByteArray5784, 0, anInt5711);
            } else {
        ...
        if ((i & 0x8000) != 0) {
            if (aShortArray5773 == null) {
                ...
                if (anInt5711 >= 0)
                    System.arraycopy(aShortArray5773, 0, purejavadrawablemodel_455_.aShortArray5773, 0, anInt5711);
            }
        } else {
        ...
        if ((i & 0x10000) != 0) {
            if (aByteArray5736 == null) {
                ...
                if (anInt5711 >= 0)
                    System.arraycopy(aByteArray5736, 0, purejavadrawablemodel_455_.aByteArray5736, 0, anInt5711);
            }
        } else {
    ...
    private void method668(boolean bool, boolean bool_496_, int i, int i_497_) {
        if (aClass209Array5790 != null) {
    ...
    private void method671(Thread thread) {
    ...
    private boolean method672(int i, int i_542_, int i_543_, int i_544_, int i_545_, int i_546_, int i_547_, int i_548_) {
    ...
    private void method674(int i, boolean bool, boolean bool_583_) {
        if (anIntArray5761[i] != -2) {
            short s = aShortArray5767[i];
    ...
    private boolean method678(int i) {
    ...
    private void method680(Class336 class336, EntityNode_Sub5 entitynode_sub5, int i, int i_624_) {
        if (anInt5753 >= 1) {
            aClass336_Sub2_5778 = (Class336_Sub2) class336;
            Class336_Sub2 class336_sub2 = aPureJavaToolkit5770.aClass336_Sub2_6788;
            if (!aBoolean5792) {
    ...
    private void method681(boolean bool, boolean bool_712_, int i, int i_713_) {
        if (aClass209Array5790 != null) {
    ...
    private int method683(int i, short s, int i_722_) {
    ...
    private int method686(int i, int i_849_) {
    ...
    private void method687(Thread thread) {
        Class374 class374 = aPureJavaToolkit5770.method1494(thread);
