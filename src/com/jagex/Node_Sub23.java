...
abstract class Node_Sub23 extends Node {
    ...
    static void method2622(int i, GraphicsToolkit graphicstoolkit, int i_0_, int i_1_, int i_2_, byte b, int i_3_) {
        anInt7196++;
        if (b != -77) {
            instance = null;
        }
    ...
    static void method2624(int i, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_) {
        anInt7195++;
        int i_16_ = -334 + i_10_;
        if ((~i_16_) > -1) {
            i_16_ = 0;
    ...
    static void method2636(r var_r, int i, int i_27_, int i_28_, boolean[] bools) {
