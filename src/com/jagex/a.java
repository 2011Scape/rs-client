...
public class a implements Interface3 {
    private final oa anOa4983;
    private final i[] anIArray4985 = new i[7];
    private final i[] anIArray4986 = new i[7];
    ...
    private native void na(long l, GraphicsToolkit graphicstoolkit, int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_);

    private native void O(long l, GraphicsToolkit graphicstoolkit, int[] is, int[] is_6_, int[] is_7_, short[] ses, int i);

    private native void Z(long l, long l_8_, int i, int i_9_, int i_10_);
    ...
    private native void f(long l, long l_11_, long l_12_, int[] is, int i, int i_13_);
    ...
    private native void r(long l, long l_15_, long l_16_, int i, int i_17_, int i_18_, boolean bool);

    private native void ta(long l, long l_19_, int i, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_, int i_25_, boolean[][] bools);
    ...
    private native void H(long l, long l_33_, int i, int i_34_);
    ...
    private native void UA(long l, long l_35_, long l_36_, int[] is, int i);
    ...
    private native boolean n(long l, long l_43_, int i, int i_44_, long l_45_, boolean bool, int i_46_);

    private native void E(long l, boolean bool);
    ...
    private native void e(long l, long l_48_, int[] is, long l_49_);

    private native void HA(long l, GraphicsToolkit graphicstoolkit, int i, int i_50_);
    ...
    private native boolean R(long l, long l_59_, int i, int i_60_, long l_61_, boolean bool);

    private native void W(long l);

    private native void M(long l);
