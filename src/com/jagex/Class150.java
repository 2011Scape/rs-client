...
class Class150 implements Interface7 {
    ...
    static boolean method1652(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
        anInt5089++;
    ...
    static void method1653(File file, int i, byte[] bs, int i_6_) throws IOException {
        anInt5078++;
    ...
    static float method1654(float f, float f_7_, float f_8_, int i, byte b) {
        int i_9_ = -69 / ((-17 - b) / 33);
        anInt5091++;
