	...
	static final String method844(CacheNode_Sub13 cachenode_sub13, byte b) {
		...
		if (cachenode_sub13.aString9565 != null && (cachenode_sub13.aString9565.length() ^ 0xffffffff) != -1) {
			if (cachenode_sub13.aString9558 != null && (cachenode_sub13.aString9558.length() ^ 0xffffffff) < -1) {
				return cachenode_sub13.aString9560 + Localization.spaceCharacter.getLocalizationString(-12273, Class35.clientLanguage) + cachenode_sub13.aString9558 + Localization.spaceCharacter.getLocalizationString(-12273, Class35.clientLanguage) + cachenode_sub13.aString9565;
			}
			return cachenode_sub13.aString9560 + Localization.spaceCharacter.getLocalizationString(-12273, Class35.clientLanguage) + cachenode_sub13.aString9565;
		}
		if (cachenode_sub13.aString9558 != null && cachenode_sub13.aString9558.length() > 0) {
			return cachenode_sub13.aString9560 + Localization.spaceCharacter.getLocalizationString(-12273, Class35.clientLanguage) + cachenode_sub13.aString9558;
		}
