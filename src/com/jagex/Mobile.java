...
abstract class Mobile extends Animable {
    ...
    static String method844(CacheNode_Sub13 cachenode_sub13, byte b) {
        if (b < 125) {
            method844(null, (byte) 118);
        }
        anInt9117++;
        if (cachenode_sub13.aString9565 != null && (~cachenode_sub13.aString9565.length()) != -1) {
            if (cachenode_sub13.aString9558 != null && (~cachenode_sub13.aString9558.length()) < -1) {
    ...
    final int method819(Node_Sub29[] node_sub29s, int i) {
        ...
        for (int i_1_ = aShort9119; aShort9130 >= i_1_; i_1_++) {
            for (int i_2_ = aShort9120; (~i_2_) >= (~aShort9124); i_2_++) {
    ...
    final boolean method806(int i) {
        ...
        for (int i_14_ = aShort9119; (~aShort9130) <= (~i_14_); i_14_++) {
