...
public class Node_Sub41 extends Node {
    ...
    static int method2931(byte b) {
        ...
        if (Class240.aSignLink2946.aBoolean4005 && !Class240.aSignLink2946.aBoolean3985) {
            bool = true;
            if (Node_Sub23.instance.anInt7484 < 512 && (~Node_Sub23.instance.anInt7484) != -1) {
                bool = false;
            }
            ...
            if (bool_1_) {
                try {
                    ...
                    if ((~Class213.aNode_Sub27_2512.aClass320_Sub29_7270.method3791(false)) == -4) {
                        ...
                        bool_0_ = bool_0_ & (~l) <= -60129613780L;
                    }
                } catch (Exception exception) {
                    /* empty */
                }
    ...
    static boolean method2932(int i, int i_6_, int i_7_) {
        anInt7517++;
        if (i > -59) {
        ...
        if (Class46.method470(i_7_, -77, i_6_) | (~(0x9000 & i_6_)) != -1 | Class234.method2150(i_7_, 256, i_6_)) {
            return true;
        }
        return (~(0x37 & i_7_)) == -1 & (Class278.method3367(i_7_, i_6_, (byte) -119) | (~(0x2000 & i_6_)) != -1 | Class320_Sub9.method3713(122, i_6_, i_7_));
    }
}
