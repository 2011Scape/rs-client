...
public class Animable_Sub4_Sub1 extends Animable_Sub4 implements Interface19 {
    ...
    Animable_Sub4_Sub1(GraphicsToolkit graphicstoolkit, ObjectDefinition objectdefinition, int i, int i_10_, int i_11_, int i_12_, int i_13_, boolean bool, int i_14_, int i_15_, int i_16_, int i_17_) {
        ...
        aBoolean10702 = (~objectdefinition.anInt3057) != -1 && !bool;
        aBoolean10673 = bool;
        aBoolean10684 = graphicstoolkit.r() && objectdefinition.aBoolean2972 && !aBoolean10673 && (~Class213.aNode_Sub27_2512.aClass320_Sub12_7282.method3730(false)) != -1;
    ...
    static void method927(int i, int i_0_, int i_1_, Node_Sub13 node_sub13, int i_2_) {
    ...
    static long method929(Interface19 interface19, int i, int i_6_, boolean bool) {
        anInt10694++;
        long l = 4194304L;
        if (bool != true) {
    ...
    static boolean method930(int i, char c) {
        if (i != -31853) {
            anInt10687 = -94;
        }
        anInt10680++;
    ...
    static boolean method931(int i, boolean bool, int i_18_) {
        anInt10674++;
        if (bool != true) {
            method930(122, '.');
        }
    ...
    private DrawableModel method928(int i, int i_4_, GraphicsToolkit graphicstoolkit) {
        anInt10695++;
    ...
    private Class243 method932(byte b, GraphicsToolkit graphicstoolkit, int i, boolean bool) {
        if (b != 24) {
            return null;
        }
        anInt10678++;
