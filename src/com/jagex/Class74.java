...
public class Class74 {
    ...
    private static void method753() {
        anInt995 = 0;
    }

    private static boolean method754(int i) {
        int i_0_ = anInt994;
        int i_1_ = anInt993;
        int i_2_ = anInt1000;
        int i_3_;
    ...
    static void method755(GraphicsToolkit graphicstoolkit, int[] is, int i) {
        method760(graphicstoolkit, is, 0, is.length, i, null, null);
    }

    private static void method756(int i, int i_12_) {
        if (i_12_ > i + 4) {
            int i_13_ = i;
    ...
    private static void method758(int[] is, int i, int i_20_) {
        int i_21_ = anInt995 + (i_20_ << 1);
        if (anIntArray997 == null || anIntArray997.length < i_21_) {
            int[] is_22_ = new int[i_21_];
            if (anInt995 >= 0) System.arraycopy(anIntArray997, 0, is_22_, 0, anInt995);
    ...
    private static void method759(int i, int i_28_) {
    ...
    private static void method760(GraphicsToolkit graphicstoolkit, int[] is, int i, int i_32_, int i_33_, int[] is_34_, int[] is_35_) {
    ...
    static void method761(GraphicsToolkit graphicstoolkit, int[] is, int i, int[] is_41_, int[] is_42_) {
        method760(graphicstoolkit, is, 0, is.length, i, is_41_, is_42_);
    }

    private static void method762(int i) {
        if (anInt995 < 0) {
