...
public class Class125 {
    ...
    static void method1527(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_) {
        anInt1610++;
    ...
    static boolean method1529(int i, int i_10_, int i_11_) {
        if (i != 2048) {
            aClass61_1609 = null;
        }
        anInt1608++;
        return (~(i_11_ & 0x800)) != -1;
    }

    static void method1530(byte b, int i, int[] is, long[] ls, int i_12_) {
        if (b != -114) {
            aClass61_1609 = null;
        }
        anInt1606++;
        if (i > i_12_) {
            ...
            is[i_13_] = is[i];
            is[i] = i_15_;
            int i_16_ = (~l) != -9223372036854775808L ? 1 : 0;
