...
public class IOException_Sub1 extends IOException {
    ...
    static boolean method131(boolean bool, byte b) {
        if (bool != true) {
        ...
        if (i >= 128 && (~i) > -161 && Class204.aCharArray2455[-128 + i] == 0) {
            return false;
        }
        return true;
    }
    ...
    static void method133(int i, Class302 class302, SignLink signlink) {
